...
func (j *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) CacheDataEncrypted() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) CachingEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"cachingEnabled",
...
func (j *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) DataTraceEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"dataTraceEnabled",
...
func (j *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) MetricsEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"metricsEnabled",
...
func (j *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference {
	_init_.Initialize()
...
func NewDataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference_Override(d DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccApigatewayDeploymentStageDescriptionMethodSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
