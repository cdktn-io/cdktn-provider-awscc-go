...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/medialivesignalmap/internal"
...
func (j *jsiiProxy_MedialiveSignalMap) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MedialiveSignalMap) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MedialiveSignalMap) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MedialiveSignalMap) MonitorChangesPendingDeployment() cdktn.IResolvable {
...
func (j *jsiiProxy_MedialiveSignalMap) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MedialiveSignalMap) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/medialive_signal_map awscc_medialive_signal_map} Resource.
...
func (j *jsiiProxy_MedialiveSignalMap)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MedialiveSignalMap)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MedialiveSignalMap)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MedialiveSignalMap_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MedialiveSignalMap) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MedialiveSignalMap) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MedialiveSignalMap) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MedialiveSignalMap) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MedialiveSignalMap) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MedialiveSignalMap) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
