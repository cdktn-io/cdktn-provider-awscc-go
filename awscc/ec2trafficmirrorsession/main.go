...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2TrafficMirrorSessionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ec2TrafficMirrorSession.Ec2TrafficMirrorSessionTagsList",
		reflect.TypeOf((*Ec2TrafficMirrorSessionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2TrafficMirrorSessionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_Ec2TrafficMirrorSessionTagsOutputReference{}
