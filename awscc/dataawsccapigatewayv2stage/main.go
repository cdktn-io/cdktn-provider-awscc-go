...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2Stage)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2StageAccessLogSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccApigatewayv2Stage.DataAwsccApigatewayv2StageAccessLogSettingsOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayv2StageAccessLogSettingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccApigatewayv2StageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccApigatewayv2Stage.DataAwsccApigatewayv2StageDefaultRouteSettings",
		reflect.TypeOf((*DataAwsccApigatewayv2StageDefaultRouteSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccApigatewayv2Stage.DataAwsccApigatewayv2StageDefaultRouteSettingsOutputReference",
		reflect.TypeOf((*DataAwsccApigatewayv2StageDefaultRouteSettingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
