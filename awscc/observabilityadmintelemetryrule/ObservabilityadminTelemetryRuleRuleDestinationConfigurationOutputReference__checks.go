...
func (o *jsiiProxy_ObservabilityadminTelemetryRuleRuleDestinationConfigurationOutputReference) validatePutCloudtrailParametersParameters(value *ObservabilityadminTelemetryRuleRuleDestinationConfigurationCloudtrailParameters) error {
	if value == nil {
...
func (o *jsiiProxy_ObservabilityadminTelemetryRuleRuleDestinationConfigurationOutputReference) validatePutElbLoadBalancerLoggingParametersParameters(value *ObservabilityadminTelemetryRuleRuleDestinationConfigurationElbLoadBalancerLoggingParameters) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (o *jsiiProxy_ObservabilityadminTelemetryRuleRuleDestinationConfigurationOutputReference) validatePutLogDeliveryParametersParameters(value *ObservabilityadminTelemetryRuleRuleDestinationConfigurationLogDeliveryParameters) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (o *jsiiProxy_ObservabilityadminTelemetryRuleRuleDestinationConfigurationOutputReference) validatePutWafLoggingParametersParameters(value *ObservabilityadminTelemetryRuleRuleDestinationConfigurationWafLoggingParameters) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func validateNewObservabilityadminTelemetryRuleRuleDestinationConfigurationOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
