...
func (j *jsiiProxy_IotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList {
	_init_.Initialize()
...
func NewIotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList_Override(i IotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IotsitewiseAssetModelAssetModelPropertiesTypeMetricVariablesList) Resolve(context cdktn.IResolveContext) interface{} {
