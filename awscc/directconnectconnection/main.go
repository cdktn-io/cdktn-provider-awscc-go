...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectconnectConnection)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DirectconnectConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.directconnectConnection.DirectconnectConnectionTags",
		reflect.TypeOf((*DirectconnectConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.directconnectConnection.DirectconnectConnectionTagsList",
		reflect.TypeOf((*DirectconnectConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectconnectConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
