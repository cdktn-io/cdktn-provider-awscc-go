...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccIotEncryptionConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccIotEncryptionConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccIotEncryptionConfiguration.DataAwsccIotEncryptionConfigurationConfigurationDetails",
		reflect.TypeOf((*DataAwsccIotEncryptionConfigurationConfigurationDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccIotEncryptionConfigurationConfigurationDetailsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
