...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/snssubscription/internal"
...
func (j *jsiiProxy_SnsSubscription) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SnsSubscription) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SnsSubscription) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SnsSubscription) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SnsSubscription) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/sns_subscription awscc_sns_subscription} Resource.
...
func (j *jsiiProxy_SnsSubscription)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SnsSubscription)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SnsSubscription)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SnsSubscription_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SnsSubscription) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SnsSubscription) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SnsSubscription) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SnsSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SnsSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SnsSubscription) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
