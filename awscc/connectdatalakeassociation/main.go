...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectDataLakeAssociation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTargetAccountId", GoMethod: "ResetTargetAccountId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetAccountIdInput", GoGetter: "TargetAccountIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ConnectDataLakeAssociationConfig)(nil)).Elem(),
	)
}
