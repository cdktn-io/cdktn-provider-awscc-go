...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/groundstationmissionprofile/internal"
...
type GroundstationMissionProfile interface {
	...
	TelemetrySinkConfigArnInput() *string
	// Experimental.
...
func (j *jsiiProxy_GroundstationMissionProfile) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GroundstationMissionProfile) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GroundstationMissionProfile) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GroundstationMissionProfile) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GroundstationMissionProfile) TelemetrySinkConfigArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GroundstationMissionProfile) TelemetrySinkConfigArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"telemetrySinkConfigArnInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_GroundstationMissionProfile) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GroundstationMissionProfile)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GroundstationMissionProfile)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GroundstationMissionProfile)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_GroundstationMissionProfile)SetTelemetrySinkConfigArn(val *string) {
	if err := j.validateSetTelemetrySinkConfigArnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func GroundstationMissionProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GroundstationMissionProfile) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GroundstationMissionProfile) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GroundstationMissionProfile) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GroundstationMissionProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GroundstationMissionProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GroundstationMissionProfile) ResetTelemetrySinkConfigArn() {
	_jsii_.InvokeVoid(
		g,
		"resetTelemetrySinkConfigArn",
		nil, // no parameters
...
func (g *jsiiProxy_GroundstationMissionProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
