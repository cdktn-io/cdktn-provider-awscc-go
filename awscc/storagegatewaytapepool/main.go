...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*StoragegatewayTapePoolTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.storagegatewayTapePool.StoragegatewayTapePoolTagsList",
		reflect.TypeOf((*StoragegatewayTapePoolTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*StoragegatewayTapePoolTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
