...
func (j *jsiiProxy_StoragegatewayTapePool) PoolArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"poolArn",
...
func (j *jsiiProxy_StoragegatewayTapePool) PoolId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"poolId",
...
func (j *jsiiProxy_StoragegatewayTapePool) Tags() StoragegatewayTapePoolTagsList {
	var returns StoragegatewayTapePoolTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/storagegateway_tape_pool awscc_storagegateway_tape_pool} Resource.
...
func (s *jsiiProxy_StoragegatewayTapePool) PutTags(value interface{}) {
