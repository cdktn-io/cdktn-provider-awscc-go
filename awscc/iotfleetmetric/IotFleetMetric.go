...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/iotfleetmetric/internal"
...
func (j *jsiiProxy_IotFleetMetric) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotFleetMetric) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotFleetMetric) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotFleetMetric) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotFleetMetric) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/iot_fleet_metric awscc_iot_fleet_metric} Resource.
...
func (j *jsiiProxy_IotFleetMetric)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotFleetMetric)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotFleetMetric)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IotFleetMetric_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotFleetMetric) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotFleetMetric) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotFleetMetric) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotFleetMetric) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotFleetMetric) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotFleetMetric) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
