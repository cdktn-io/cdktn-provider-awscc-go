...
func (d *jsiiProxy_DataAwsccWafv2LoggingConfigurationLoggingFilterFiltersConditionsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataAwsccWafv2LoggingConfigurationLoggingFilterFiltersConditionsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataAwsccWafv2LoggingConfigurationLoggingFilterFiltersConditionsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
