...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccquicksightdashboard/internal"
...
func (j *jsiiProxy_DataAwsccQuicksightDashboard) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccQuicksightDashboard) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccQuicksightDashboard) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccQuicksightDashboard) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccQuicksightDashboard) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/quicksight_dashboard awscc_quicksight_dashboard} Data Source.
...
func (j *jsiiProxy_DataAwsccQuicksightDashboard)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccQuicksightDashboard)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccQuicksightDashboard)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccQuicksightDashboard_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccQuicksightDashboard) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccQuicksightDashboard) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccQuicksightDashboard) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccQuicksightDashboard) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
