...
func (s *jsiiProxy_SyntheticsCanary) validatePutBrowserConfigsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*SyntheticsCanaryBrowserConfigs:
		value := value.(*[]*SyntheticsCanaryBrowserConfigs)
	...
	case []*SyntheticsCanaryBrowserConfigs:
		value_ := value.([]*SyntheticsCanaryBrowserConfigs)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SyntheticsCanaryBrowserConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SyntheticsCanary) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SyntheticsCanaryTags; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SyntheticsCanary) validatePutVisualReferencesParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*SyntheticsCanaryVisualReferences:
		value := value.(*[]*SyntheticsCanaryVisualReferences)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SyntheticsCanaryVisualReferences:
		value_ := value.([]*SyntheticsCanaryVisualReferences)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SyntheticsCanaryVisualReferences; received %#v (a %T)", value, value)
		}
	}
