...
func (j *jsiiProxy_GameliftScript) NodeJsVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nodeJsVersion",
...
func (j *jsiiProxy_GameliftScript) NodeJsVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nodeJsVersionInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/gamelift_script awscc_gamelift_script} Resource.
...
func (j *jsiiProxy_GameliftScript)SetNodeJsVersion(val *string) {
...
func (g *jsiiProxy_GameliftScript) ResetNodeJsVersion() {
	_jsii_.InvokeVoid(
		g,
		"resetNodeJsVersion",
		nil, // no parameters
