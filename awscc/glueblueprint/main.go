...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueBlueprint)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "arn", GoGetter: "Arn"},
			_jsii_.MemberProperty{JsiiProperty: "blueprintLocation", GoGetter: "BlueprintLocation"},
			_jsii_.MemberProperty{JsiiProperty: "blueprintLocationInput", GoGetter: "BlueprintLocationInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlueBlueprintConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.glueBlueprint.GlueBlueprintTags",
		reflect.TypeOf((*GlueBlueprintTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.glueBlueprint.GlueBlueprintTagsList",
		reflect.TypeOf((*GlueBlueprintTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueBlueprintTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
