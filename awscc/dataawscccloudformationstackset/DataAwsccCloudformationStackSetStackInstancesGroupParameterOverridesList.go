...
func (j *jsiiProxy_DataAwsccCloudformationStackSetStackInstancesGroupParameterOverridesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccCloudformationStackSetStackInstancesGroupParameterOverridesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccCloudformationStackSetStackInstancesGroupParameterOverridesList {
	_init_.Initialize()
...
func NewDataAwsccCloudformationStackSetStackInstancesGroupParameterOverridesList_Override(d DataAwsccCloudformationStackSetStackInstancesGroupParameterOverridesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccCloudformationStackSetStackInstancesGroupParameterOverridesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccCloudformationStackSetStackInstancesGroupParameterOverridesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccCloudformationStackSetStackInstancesGroupParameterOverridesList) Resolve(context cdktn.IResolveContext) interface{} {
