...
func (r *jsiiProxy_RedshiftserverlessNamespace) validatePutSnapshotCopyConfigurationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*RedshiftserverlessNamespaceSnapshotCopyConfigurations; received %#v (a %T)", value, value)
		}
	}
...
func (r *jsiiProxy_RedshiftserverlessNamespace) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*RedshiftserverlessNamespaceTags; received %#v (a %T)", value, value)
		}
	}
