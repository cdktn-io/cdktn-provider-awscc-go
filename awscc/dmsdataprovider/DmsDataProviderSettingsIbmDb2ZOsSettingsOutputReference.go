...
func NewDmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference {
	_init_.Initialize()
...
func NewDmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference_Override(d DmsDataProviderSettingsIbmDb2ZOsSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
