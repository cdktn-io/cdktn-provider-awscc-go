...
func NewDmsDataProviderSettingsMySqlSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DmsDataProviderSettingsMySqlSettingsOutputReference {
	_init_.Initialize()
...
func NewDmsDataProviderSettingsMySqlSettingsOutputReference_Override(d DmsDataProviderSettingsMySqlSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
