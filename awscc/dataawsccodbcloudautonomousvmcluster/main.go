...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccOdbCloudAutonomousVmClusterIamRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccOdbCloudAutonomousVmCluster.DataAwsccOdbCloudAutonomousVmClusterIamRolesList",
		reflect.TypeOf((*DataAwsccOdbCloudAutonomousVmClusterIamRolesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOdbCloudAutonomousVmClusterIamRolesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
