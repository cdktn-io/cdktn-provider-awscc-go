...
func (j *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) BucketOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketOwner",
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) BucketOwnerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketOwnerInput",
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference)SetBucketOwner(val *string) {
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) ResetBucket() {
	_jsii_.InvokeVoid(
		c,
		"resetBucket",
		nil, // no parameters
...
func (c *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) ResetBucketOwner() {
	_jsii_.InvokeVoid(
		c,
		"resetBucketOwner",
		nil, // no parameters
...
func (c *jsiiProxy_CodebuildReportGroupExportConfigS3DestinationOutputReference) ResetEncryptionKey() {
	_jsii_.InvokeVoid(
		c,
		"resetEncryptionKey",
		nil, // no parameters
