...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codebuildReportGroup.CodebuildReportGroup",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codebuildReportGroup.CodebuildReportGroupConfig",
		reflect.TypeOf((*CodebuildReportGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codebuildReportGroup.CodebuildReportGroupExportConfig",
		reflect.TypeOf((*CodebuildReportGroupExportConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codebuildReportGroup.CodebuildReportGroupExportConfigOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "exportConfigTypeInput", GoGetter: "ExportConfigTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codebuildReportGroup.CodebuildReportGroupExportConfigS3Destination",
		reflect.TypeOf((*CodebuildReportGroupExportConfigS3Destination)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codebuildReportGroup.CodebuildReportGroupExportConfigS3DestinationOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codebuildReportGroup.CodebuildReportGroupTags",
		reflect.TypeOf((*CodebuildReportGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codebuildReportGroup.CodebuildReportGroupTagsList",
		reflect.TypeOf((*CodebuildReportGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodebuildReportGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
