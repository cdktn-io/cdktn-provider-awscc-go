...
type CodebuildReportGroupExportConfigOutputReference interface {
	...
	SetExportConfigType(val *string)
	ExportConfigTypeInput() *string
	// Experimental.
	Fqn() *string
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigOutputReference) ExportConfigType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"exportConfigType",
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigOutputReference) ExportConfigTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"exportConfigTypeInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigOutputReference) S3DestinationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"s3DestinationInput",
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigOutputReference)SetExportConfigType(val *string) {
	if err := j.validateSetExportConfigTypeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_CodebuildReportGroupExportConfigOutputReference)SetInternalValue(val interface{}) {
