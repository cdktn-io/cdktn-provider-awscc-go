...
func (j *jsiiProxy_CodebuildReportGroup) ExportConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"exportConfigInput",
...
func (j *jsiiProxy_CodebuildReportGroup) Tags() CodebuildReportGroupTagsList {
	var returns CodebuildReportGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (c *jsiiProxy_CodebuildReportGroup) PutTags(value interface{}) {
...
func (c *jsiiProxy_CodebuildReportGroup) ResetName() {
	_jsii_.InvokeVoid(
		c,
		"resetName",
		nil, // no parameters
