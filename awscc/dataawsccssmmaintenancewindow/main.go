...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsmMaintenanceWindow)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSsmMaintenanceWindowConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccSsmMaintenanceWindow.DataAwsccSsmMaintenanceWindowTags",
		reflect.TypeOf((*DataAwsccSsmMaintenanceWindowTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccSsmMaintenanceWindow.DataAwsccSsmMaintenanceWindowTagsList",
		reflect.TypeOf((*DataAwsccSsmMaintenanceWindowTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsmMaintenanceWindowTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
