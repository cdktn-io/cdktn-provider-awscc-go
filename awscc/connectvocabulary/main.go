...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.connectVocabulary.ConnectVocabulary",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.connectVocabulary.ConnectVocabularyConfig",
		reflect.TypeOf((*ConnectVocabularyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.connectVocabulary.ConnectVocabularyTags",
		reflect.TypeOf((*ConnectVocabularyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.connectVocabulary.ConnectVocabularyTagsList",
		reflect.TypeOf((*ConnectVocabularyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectVocabularyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
