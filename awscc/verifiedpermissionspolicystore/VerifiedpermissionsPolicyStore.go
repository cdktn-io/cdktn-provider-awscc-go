...
type VerifiedpermissionsPolicyStore interface {
	...
	EncryptionSettings() VerifiedpermissionsPolicyStoreEncryptionSettingsOutputReference
	EncryptionSettingsInput() interface{}
	EncryptionState() VerifiedpermissionsPolicyStoreEncryptionStateOutputReference
	// Experimental.
	...
	PutEncryptionSettings(value *VerifiedpermissionsPolicyStoreEncryptionSettings)
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) EncryptionSettings() VerifiedpermissionsPolicyStoreEncryptionSettingsOutputReference {
	var returns VerifiedpermissionsPolicyStoreEncryptionSettingsOutputReference
	_jsii_.Get(
		j,
		"encryptionSettings",
		&returns,
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) EncryptionSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VerifiedpermissionsPolicyStore) EncryptionState() VerifiedpermissionsPolicyStoreEncryptionStateOutputReference {
	var returns VerifiedpermissionsPolicyStoreEncryptionStateOutputReference
	_jsii_.Get(
		j,
		"encryptionState",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/verifiedpermissions_policy_store awscc_verifiedpermissions_policy_store} Resource.
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) PutEncryptionSettings(value *VerifiedpermissionsPolicyStoreEncryptionSettings) {
	if err := v.validatePutEncryptionSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_VerifiedpermissionsPolicyStore) ResetEncryptionSettings() {
	_jsii_.InvokeVoid(
		v,
		"resetEncryptionSettings",
		nil, // no parameters
