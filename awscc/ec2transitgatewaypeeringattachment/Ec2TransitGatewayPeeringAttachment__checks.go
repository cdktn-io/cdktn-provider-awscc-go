...
func (e *jsiiProxy_Ec2TransitGatewayPeeringAttachment) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Ec2TransitGatewayPeeringAttachmentTags; received %#v (a %T)", value, value)
		}
	}
