...
type CleanroomsmlConfiguredModelAlgorithmAssociationPrivacyConfigurationPoliciesTrainedModelsContainerLogs struct {
	...
	LogRedactionConfiguration *CleanroomsmlConfiguredModelAlgorithmAssociationPrivacyConfigurationPoliciesTrainedModelsContainerLogsLogRedactionConfiguration `field:"optional" json:"logRedactionConfiguration" yaml:"logRedactionConfiguration"`
