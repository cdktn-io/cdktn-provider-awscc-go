...
func (j *jsiiProxy_WisdomKnowledgeBase) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WisdomKnowledgeBase) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WisdomKnowledgeBase) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WisdomKnowledgeBase) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WisdomKnowledgeBase) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/wisdom_knowledge_base awscc_wisdom_knowledge_base} Resource.
...
func (j *jsiiProxy_WisdomKnowledgeBase)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WisdomKnowledgeBase)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WisdomKnowledgeBase)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WisdomKnowledgeBase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WisdomKnowledgeBase) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WisdomKnowledgeBase) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WisdomKnowledgeBase) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WisdomKnowledgeBase) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WisdomKnowledgeBase) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WisdomKnowledgeBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
