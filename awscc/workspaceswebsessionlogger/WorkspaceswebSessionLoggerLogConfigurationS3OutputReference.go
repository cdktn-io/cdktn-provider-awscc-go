...
func NewWorkspaceswebSessionLoggerLogConfigurationS3OutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WorkspaceswebSessionLoggerLogConfigurationS3OutputReference {
	_init_.Initialize()

	if err := validateNewWorkspaceswebSessionLoggerLogConfigurationS3OutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewWorkspaceswebSessionLoggerLogConfigurationS3OutputReference_Override(w WorkspaceswebSessionLoggerLogConfigurationS3OutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (w *jsiiProxy_WorkspaceswebSessionLoggerLogConfigurationS3OutputReference) ResetBucket() {
	_jsii_.InvokeVoid(
		w,
		"resetBucket",
		nil, // no parameters
...
func (w *jsiiProxy_WorkspaceswebSessionLoggerLogConfigurationS3OutputReference) ResetFolderStructure() {
	_jsii_.InvokeVoid(
		w,
		"resetFolderStructure",
		nil, // no parameters
...
func (w *jsiiProxy_WorkspaceswebSessionLoggerLogConfigurationS3OutputReference) ResetLogFileFormat() {
	_jsii_.InvokeVoid(
		w,
		"resetLogFileFormat",
		nil, // no parameters
