...
func (j *jsiiProxy_LakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList {
	_init_.Initialize()
...
func NewLakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList_Override(l LakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LakeformationPrincipalPermissionsResourceLfTagPolicyExpressionList) Resolve(context cdktn.IResolveContext) interface{} {
