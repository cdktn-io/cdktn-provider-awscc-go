...
func (j *jsiiProxy_LakeformationPrincipalPermissions) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LakeformationPrincipalPermissions) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LakeformationPrincipalPermissions) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LakeformationPrincipalPermissions) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LakeformationPrincipalPermissions) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LakeformationPrincipalPermissions)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LakeformationPrincipalPermissions)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LakeformationPrincipalPermissions)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LakeformationPrincipalPermissions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LakeformationPrincipalPermissions) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LakeformationPrincipalPermissions) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LakeformationPrincipalPermissions) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LakeformationPrincipalPermissions) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LakeformationPrincipalPermissions) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LakeformationPrincipalPermissions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
