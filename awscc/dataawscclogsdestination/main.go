...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccLogsDestinationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccLogsDestination.DataAwsccLogsDestinationTagsList",
		reflect.TypeOf((*DataAwsccLogsDestinationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLogsDestinationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
