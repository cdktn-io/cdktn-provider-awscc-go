...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/simspaceweaversimulation/internal"
...
func (j *jsiiProxy_SimspaceweaverSimulation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SimspaceweaverSimulation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SimspaceweaverSimulation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SimspaceweaverSimulation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SimspaceweaverSimulation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SimspaceweaverSimulation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SimspaceweaverSimulation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SimspaceweaverSimulation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SimspaceweaverSimulation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SimspaceweaverSimulation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SimspaceweaverSimulation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SimspaceweaverSimulation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SimspaceweaverSimulation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SimspaceweaverSimulation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SimspaceweaverSimulation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
