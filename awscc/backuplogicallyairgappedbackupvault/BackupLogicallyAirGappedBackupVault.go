...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/backuplogicallyairgappedbackupvault/internal"
...
type BackupLogicallyAirGappedBackupVault interface {
	...
	MpaApprovalTeamArnInput() *string
	// The tree node.
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault) EncryptionKeyArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault) MpaApprovalTeamArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mpaApprovalTeamArn",
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault) MpaApprovalTeamArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mpaApprovalTeamArnInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault)SetEncryptionKeyArn(val *string) {
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault)SetMpaApprovalTeamArn(val *string) {
	if err := j.validateSetMpaApprovalTeamArnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_BackupLogicallyAirGappedBackupVault)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BackupLogicallyAirGappedBackupVault_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BackupLogicallyAirGappedBackupVault) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupLogicallyAirGappedBackupVault) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BackupLogicallyAirGappedBackupVault) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BackupLogicallyAirGappedBackupVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BackupLogicallyAirGappedBackupVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BackupLogicallyAirGappedBackupVault) ResetEncryptionKeyArn() {
	_jsii_.InvokeVoid(
		b,
		"resetEncryptionKeyArn",
		nil, // no parameters
...
func (b *jsiiProxy_BackupLogicallyAirGappedBackupVault) ResetMpaApprovalTeamArn() {
	_jsii_.InvokeVoid(
		b,
		"resetMpaApprovalTeamArn",
		nil, // no parameters
...
func (b *jsiiProxy_BackupLogicallyAirGappedBackupVault) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
