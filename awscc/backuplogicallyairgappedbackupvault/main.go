...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "mpaApprovalTeamArnInput", GoGetter: "MpaApprovalTeamArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMpaApprovalTeamArn", GoMethod: "ResetMpaApprovalTeamArn"},
