...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableImdsv1Input", GoGetter: "DisableImdsv1Input"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putRootVolumeConfig", GoMethod: "PutRootVolumeConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDisableImdsv1", GoMethod: "ResetDisableImdsv1"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRootVolumeConfig", GoMethod: "ResetRootVolumeConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetSoftwaresToInstall", GoMethod: "ResetSoftwaresToInstall"},
			_jsii_.MemberMethod{JsiiMethod: "resetSoftwaresToUninstall", GoMethod: "ResetSoftwaresToUninstall"},
			...
			_jsii_.MemberProperty{JsiiProperty: "rootVolumeConfigInput", GoGetter: "RootVolumeConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "softwaresToInstall", GoGetter: "SoftwaresToInstall"},
			_jsii_.MemberProperty{JsiiProperty: "softwaresToInstallInput", GoGetter: "SoftwaresToInstallInput"},
			_jsii_.MemberProperty{JsiiProperty: "softwaresToUninstall", GoGetter: "SoftwaresToUninstall"},
			_jsii_.MemberProperty{JsiiProperty: "softwaresToUninstallInput", GoGetter: "SoftwaresToUninstallInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AppstreamImageBuilderRootVolumeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.appstreamImageBuilder.AppstreamImageBuilderRootVolumeConfigOutputReference",
		reflect.TypeOf((*AppstreamImageBuilderRootVolumeConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
