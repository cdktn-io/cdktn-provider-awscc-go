...
func (j *jsiiProxy_DataAwsccNetworkmanagerSiteToSiteVpnAttachmentTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccNetworkmanagerSiteToSiteVpnAttachmentTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccNetworkmanagerSiteToSiteVpnAttachmentTagsList {
	_init_.Initialize()
...
func NewDataAwsccNetworkmanagerSiteToSiteVpnAttachmentTagsList_Override(d DataAwsccNetworkmanagerSiteToSiteVpnAttachmentTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccNetworkmanagerSiteToSiteVpnAttachmentTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerSiteToSiteVpnAttachmentTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerSiteToSiteVpnAttachmentTagsList) Resolve(context cdktn.IResolveContext) interface{} {
