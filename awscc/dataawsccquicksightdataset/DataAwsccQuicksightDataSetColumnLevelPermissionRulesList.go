...
func (j *jsiiProxy_DataAwsccQuicksightDataSetColumnLevelPermissionRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccQuicksightDataSetColumnLevelPermissionRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccQuicksightDataSetColumnLevelPermissionRulesList {
	_init_.Initialize()
...
func NewDataAwsccQuicksightDataSetColumnLevelPermissionRulesList_Override(d DataAwsccQuicksightDataSetColumnLevelPermissionRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccQuicksightDataSetColumnLevelPermissionRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccQuicksightDataSetColumnLevelPermissionRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccQuicksightDataSetColumnLevelPermissionRulesList) Resolve(context cdktn.IResolveContext) interface{} {
