...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicecatalogLaunchRoleConstraint)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "launchRoleConstraintId", GoGetter: "LaunchRoleConstraintId"},
			_jsii_.MemberProperty{JsiiProperty: "lifecycle", GoGetter: "Lifecycle"},
			_jsii_.MemberProperty{JsiiProperty: "localRoleName", GoGetter: "LocalRoleName"},
			_jsii_.MemberProperty{JsiiProperty: "localRoleNameInput", GoGetter: "LocalRoleNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLocalRoleName", GoMethod: "ResetLocalRoleName"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ServicecatalogLaunchRoleConstraintConfig)(nil)).Elem(),
	)
}
