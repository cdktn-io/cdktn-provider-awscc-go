...
func (j *jsiiProxy_DataAwsccSagemakerEndpointExcludeRetainedVariantPropertiesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccSagemakerEndpointExcludeRetainedVariantPropertiesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccSagemakerEndpointExcludeRetainedVariantPropertiesList {
	_init_.Initialize()
...
func NewDataAwsccSagemakerEndpointExcludeRetainedVariantPropertiesList_Override(d DataAwsccSagemakerEndpointExcludeRetainedVariantPropertiesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccSagemakerEndpointExcludeRetainedVariantPropertiesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccSagemakerEndpointExcludeRetainedVariantPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccSagemakerEndpointExcludeRetainedVariantPropertiesList) Resolve(context cdktn.IResolveContext) interface{} {
