...
type DeadlineQueue interface {
	...
	RoleArnInput() *string
	SchedulingConfiguration() DeadlineQueueSchedulingConfigurationOutputReference
	SchedulingConfigurationInput() interface{}
	...
	PutSchedulingConfiguration(value *DeadlineQueueSchedulingConfiguration)
...
func (j *jsiiProxy_DeadlineQueue) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DeadlineQueue) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DeadlineQueue) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DeadlineQueue) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DeadlineQueue) SchedulingConfiguration() DeadlineQueueSchedulingConfigurationOutputReference {
	var returns DeadlineQueueSchedulingConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DeadlineQueue) SchedulingConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DeadlineQueue) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DeadlineQueue)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DeadlineQueue)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DeadlineQueue)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DeadlineQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DeadlineQueue) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DeadlineQueue) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DeadlineQueue) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DeadlineQueue) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DeadlineQueue) PutSchedulingConfiguration(value *DeadlineQueueSchedulingConfiguration) {
	if err := d.validatePutSchedulingConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
		"putSchedulingConfiguration",
		[]interface{}{value},
	)
}
...
func (d *jsiiProxy_DeadlineQueue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DeadlineQueue) ResetSchedulingConfiguration() {
	_jsii_.InvokeVoid(
		d,
		"resetSchedulingConfiguration",
		nil, // no parameters
...
func (d *jsiiProxy_DeadlineQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
