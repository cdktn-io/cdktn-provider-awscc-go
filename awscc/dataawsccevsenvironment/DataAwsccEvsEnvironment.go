...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccevsenvironment/internal"
...
type DataAwsccEvsEnvironment interface {
	...
	TermsAccepted() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccEvsEnvironment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccEvsEnvironment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccEvsEnvironment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccEvsEnvironment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccEvsEnvironment) TermsAccepted() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccEvsEnvironment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/evs_environment awscc_evs_environment} Data Source.
...
func (j *jsiiProxy_DataAwsccEvsEnvironment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccEvsEnvironment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccEvsEnvironment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccEvsEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccEvsEnvironment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEvsEnvironment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEvsEnvironment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccEvsEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
