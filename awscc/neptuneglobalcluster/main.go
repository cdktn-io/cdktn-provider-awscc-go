...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NeptuneGlobalClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.neptuneGlobalCluster.NeptuneGlobalClusterTagsList",
		reflect.TypeOf((*NeptuneGlobalClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NeptuneGlobalClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
