...
type DataAwsccDatazoneDataSource interface {
	...
	PublishOnImport() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource) PublishOnImport() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccDatazoneDataSource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccDatazoneDataSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccDatazoneDataSource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccDatazoneDataSource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccDatazoneDataSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccDatazoneDataSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
