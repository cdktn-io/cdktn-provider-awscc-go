...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/customerprofilescalculatedattributedefinition/internal"
...
func (j *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CustomerprofilesCalculatedAttributeDefinition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CustomerprofilesCalculatedAttributeDefinition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
