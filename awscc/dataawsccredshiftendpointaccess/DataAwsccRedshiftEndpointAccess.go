...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccredshiftendpointaccess/internal"
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccess) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccess) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccess) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccess) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccess) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/redshift_endpoint_access awscc_redshift_endpoint_access} Data Source.
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccess)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccess)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccess)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccRedshiftEndpointAccess_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccess) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccess) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccess) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccess) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
