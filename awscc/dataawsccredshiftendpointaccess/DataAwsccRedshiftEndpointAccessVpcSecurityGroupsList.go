...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcSecurityGroupsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccRedshiftEndpointAccessVpcSecurityGroupsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccRedshiftEndpointAccessVpcSecurityGroupsList {
	_init_.Initialize()
...
func NewDataAwsccRedshiftEndpointAccessVpcSecurityGroupsList_Override(d DataAwsccRedshiftEndpointAccessVpcSecurityGroupsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcSecurityGroupsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcSecurityGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcSecurityGroupsList) Resolve(context cdktn.IResolveContext) interface{} {
