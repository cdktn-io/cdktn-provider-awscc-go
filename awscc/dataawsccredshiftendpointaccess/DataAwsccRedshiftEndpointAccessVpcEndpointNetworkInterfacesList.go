...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList {
	_init_.Initialize()
...
func NewDataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList_Override(d DataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAccessVpcEndpointNetworkInterfacesList) Resolve(context cdktn.IResolveContext) interface{} {
