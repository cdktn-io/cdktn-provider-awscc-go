...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ec2ipamresourcediscoveryassociation/internal"
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) IsDefault() cdktn.IResolvable {
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2IpamResourceDiscoveryAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2IpamResourceDiscoveryAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2IpamResourceDiscoveryAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
