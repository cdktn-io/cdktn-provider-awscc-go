...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccServicecatalogLaunchTemplateConstraint)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "launchTemplateConstraintId", GoGetter: "LaunchTemplateConstraintId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccServicecatalogLaunchTemplateConstraintConfig)(nil)).Elem(),
	)
}
