...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BedrockagentcorePolicyEngineTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.bedrockagentcorePolicyEngine.BedrockagentcorePolicyEngineTagsList",
		reflect.TypeOf((*BedrockagentcorePolicyEngineTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockagentcorePolicyEngineTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
