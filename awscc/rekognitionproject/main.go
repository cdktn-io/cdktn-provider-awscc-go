...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RekognitionProjectTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.rekognitionProject.RekognitionProjectTagsList",
		reflect.TypeOf((*RekognitionProjectTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RekognitionProjectTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
