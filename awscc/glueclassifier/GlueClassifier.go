...
type GlueClassifier interface {
	...
	GrokClassifierInput() interface{}
	Id() *string
	JsonClassifier() GlueClassifierJsonClassifierOutputReference
	JsonClassifierInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_GlueClassifier) CsvClassifierInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"csvClassifierInput",
...
func (j *jsiiProxy_GlueClassifier) GrokClassifierInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"grokClassifierInput",
...
func (j *jsiiProxy_GlueClassifier) JsonClassifierInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"jsonClassifierInput",
...
func (j *jsiiProxy_GlueClassifier) XmlClassifierInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"xmlClassifierInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/glue_classifier awscc_glue_classifier} Resource.
