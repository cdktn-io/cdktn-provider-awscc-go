...
func (j *jsiiProxy_GlueClassifierGrokClassifierOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GlueClassifierGrokClassifierOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GlueClassifierGrokClassifierOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GlueClassifierGrokClassifierOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_GlueClassifierGrokClassifierOutputReference)SetName(val *string) {
...
func (g *jsiiProxy_GlueClassifierGrokClassifierOutputReference) ResetClassification() {
	_jsii_.InvokeVoid(
		g,
		"resetClassification",
		nil, // no parameters
...
func (g *jsiiProxy_GlueClassifierGrokClassifierOutputReference) ResetGrokPattern() {
	_jsii_.InvokeVoid(
		g,
		"resetGrokPattern",
		nil, // no parameters
...
func (g *jsiiProxy_GlueClassifierGrokClassifierOutputReference) ResetName() {
	_jsii_.InvokeVoid(
		g,
		"resetName",
		nil, // no parameters
