...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudwatchInsightRule)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ruleBodyInput", GoGetter: "RuleBodyInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CloudwatchInsightRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.cloudwatchInsightRule.CloudwatchInsightRuleTags",
		reflect.TypeOf((*CloudwatchInsightRuleTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.cloudwatchInsightRule.CloudwatchInsightRuleTagsList",
		reflect.TypeOf((*CloudwatchInsightRuleTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudwatchInsightRuleTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
