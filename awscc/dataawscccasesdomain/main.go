...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCasesDomain)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCasesDomainConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccCasesDomain.DataAwsccCasesDomainTags",
		reflect.TypeOf((*DataAwsccCasesDomainTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccCasesDomain.DataAwsccCasesDomainTagsList",
		reflect.TypeOf((*DataAwsccCasesDomainTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCasesDomainTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
