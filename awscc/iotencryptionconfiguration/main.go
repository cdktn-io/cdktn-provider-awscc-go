...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotEncryptionConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kmsAccessRoleArnInput", GoGetter: "KmsAccessRoleArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetKmsAccessRoleArn", GoMethod: "ResetKmsAccessRoleArn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IotEncryptionConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.iotEncryptionConfiguration.IotEncryptionConfigurationConfigurationDetails",
		reflect.TypeOf((*IotEncryptionConfigurationConfigurationDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.iotEncryptionConfiguration.IotEncryptionConfigurationConfigurationDetailsOutputReference",
		reflect.TypeOf((*IotEncryptionConfigurationConfigurationDetailsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "configurationStatus", GoGetter: "ConfigurationStatus"},
