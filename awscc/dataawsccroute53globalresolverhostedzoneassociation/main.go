...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53GlobalresolverHostedZoneAssociation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hostedZoneAssociationId", GoGetter: "HostedZoneAssociationId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccRoute53GlobalresolverHostedZoneAssociationConfig)(nil)).Elem(),
	)
}
