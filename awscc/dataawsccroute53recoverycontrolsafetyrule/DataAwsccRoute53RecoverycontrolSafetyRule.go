...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccroute53recoverycontrolsafetyrule/internal"
...
func (j *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccRoute53RecoverycontrolSafetyRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccRoute53RecoverycontrolSafetyRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
