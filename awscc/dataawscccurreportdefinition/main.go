...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCurReportDefinitionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccCurReportDefinition.DataAwsccCurReportDefinitionTagsList",
		reflect.TypeOf((*DataAwsccCurReportDefinitionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCurReportDefinitionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
