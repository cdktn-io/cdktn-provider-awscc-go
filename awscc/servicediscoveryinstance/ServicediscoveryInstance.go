...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/servicediscoveryinstance/internal"
...
func (j *jsiiProxy_ServicediscoveryInstance) InstanceAttributes() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceAttributes",
...
func (j *jsiiProxy_ServicediscoveryInstance) InstanceAttributesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewServicediscoveryInstance(scope constructs.Construct, id *string, config *ServicediscoveryInstanceConfig) ServicediscoveryInstance {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.servicediscoveryInstance.ServicediscoveryInstance",
...
func (j *jsiiProxy_ServicediscoveryInstance)SetInstanceAttributes(val *string) {
...
func (s *jsiiProxy_ServicediscoveryInstance) ResetInstanceId() {
	_jsii_.InvokeVoid(
		s,
		"resetInstanceId",
		nil, // no parameters
