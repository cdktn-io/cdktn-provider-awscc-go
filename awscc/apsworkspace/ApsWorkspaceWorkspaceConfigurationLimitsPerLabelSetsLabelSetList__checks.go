...
func (a *jsiiProxy_ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsLabelSetList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsLabelSetList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewApsWorkspaceWorkspaceConfigurationLimitsPerLabelSetsLabelSetListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
