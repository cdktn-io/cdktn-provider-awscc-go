...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDmsEventSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDmsEventSubscriptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccDmsEventSubscription.DataAwsccDmsEventSubscriptionTags",
		reflect.TypeOf((*DataAwsccDmsEventSubscriptionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccDmsEventSubscription.DataAwsccDmsEventSubscriptionTagsList",
		reflect.TypeOf((*DataAwsccDmsEventSubscriptionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDmsEventSubscriptionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
