...
type DlmLifecyclePolicyPolicyDetailsParametersOutputReference interface {
	...
	ExcludeDataVolumeTags() DlmLifecyclePolicyPolicyDetailsParametersExcludeDataVolumeTagsList
	ExcludeDataVolumeTagsInput() interface{}
	// Experimental.
	Fqn() *string
	...
	PutExcludeDataVolumeTags(value interface{})
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsParametersOutputReference) ExcludeDataVolumeTags() DlmLifecyclePolicyPolicyDetailsParametersExcludeDataVolumeTagsList {
	var returns DlmLifecyclePolicyPolicyDetailsParametersExcludeDataVolumeTagsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsParametersOutputReference) ExcludeDataVolumeTagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsParametersOutputReference)SetInternalValue(val interface{}) {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsParametersOutputReference) PutExcludeDataVolumeTags(value interface{}) {
	if err := d.validatePutExcludeDataVolumeTagsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
		"putExcludeDataVolumeTags",
		[]interface{}{value},
	)
}
