...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference)SetInternalValue(val interface{}) {
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) ResetDescriptionRegex() {
	_jsii_.InvokeVoid(
		d,
		"resetDescriptionRegex",
		nil, // no parameters
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) ResetEventType() {
	_jsii_.InvokeVoid(
		d,
		"resetEventType",
		nil, // no parameters
...
func (d *jsiiProxy_DlmLifecyclePolicyPolicyDetailsEventSourceParametersOutputReference) ResetSnapshotOwner() {
	_jsii_.InvokeVoid(
		d,
		"resetSnapshotOwner",
		nil, // no parameters
