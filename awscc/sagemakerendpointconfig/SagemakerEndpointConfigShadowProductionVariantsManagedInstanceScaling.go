...
type SagemakerEndpointConfigShadowProductionVariantsManagedInstanceScaling struct {
	...
	ScaleInPolicy *SagemakerEndpointConfigShadowProductionVariantsManagedInstanceScalingScaleInPolicy `field:"optional" json:"scaleInPolicy" yaml:"scaleInPolicy"`
