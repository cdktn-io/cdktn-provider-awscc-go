...
type SagemakerEndpointConfigProductionVariantsRoutingConfig struct {
	...
	PrefixAwareRoutingConfig *SagemakerEndpointConfigProductionVariantsRoutingConfigPrefixAwareRoutingConfig `field:"optional" json:"prefixAwareRoutingConfig" yaml:"prefixAwareRoutingConfig"`
