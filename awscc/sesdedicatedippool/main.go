...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SesDedicatedIpPoolTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sesDedicatedIpPool.SesDedicatedIpPoolTagsList",
		reflect.TypeOf((*SesDedicatedIpPoolTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SesDedicatedIpPoolTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SesDedicatedIpPoolTagsOutputReference{}
