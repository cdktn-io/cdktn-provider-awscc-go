...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDirectconnectConnection)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDirectconnectConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccDirectconnectConnection.DataAwsccDirectconnectConnectionTags",
		reflect.TypeOf((*DataAwsccDirectconnectConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccDirectconnectConnection.DataAwsccDirectconnectConnectionTagsList",
		reflect.TypeOf((*DataAwsccDirectconnectConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccDirectconnectConnectionTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDirectconnectConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
