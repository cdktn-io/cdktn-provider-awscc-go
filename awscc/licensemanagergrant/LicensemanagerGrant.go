...
func (j *jsiiProxy_LicensemanagerGrant) Tags() LicensemanagerGrantTagsList {
	var returns LicensemanagerGrantTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_LicensemanagerGrant) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (l *jsiiProxy_LicensemanagerGrant) PutTags(value interface{}) {
...
func (l *jsiiProxy_LicensemanagerGrant) ResetTags() {
	_jsii_.InvokeVoid(
		l,
		"resetTags",
		nil, // no parameters
