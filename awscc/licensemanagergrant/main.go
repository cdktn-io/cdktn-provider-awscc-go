...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LicensemanagerGrantTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.licensemanagerGrant.LicensemanagerGrantTagsList",
		reflect.TypeOf((*LicensemanagerGrantTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LicensemanagerGrantTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_LicensemanagerGrantTagsOutputReference{}
