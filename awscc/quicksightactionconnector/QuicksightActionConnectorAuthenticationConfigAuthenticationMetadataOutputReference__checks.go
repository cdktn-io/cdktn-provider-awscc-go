...
func (j *jsiiProxy_QuicksightActionConnectorAuthenticationConfigAuthenticationMetadataOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *QuicksightActionConnectorAuthenticationConfigAuthenticationMetadata:
		val := val.(*QuicksightActionConnectorAuthenticationConfigAuthenticationMetadata)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case QuicksightActionConnectorAuthenticationConfigAuthenticationMetadata:
		val_ := val.(QuicksightActionConnectorAuthenticationConfigAuthenticationMetadata)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *QuicksightActionConnectorAuthenticationConfigAuthenticationMetadata; received %#v (a %T)", val, val)
		}
	}
