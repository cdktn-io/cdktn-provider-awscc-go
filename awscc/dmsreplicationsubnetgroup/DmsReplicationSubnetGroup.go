...
type DmsReplicationSubnetGroup interface {
	...
	ReplicationSubnetGroupIdentifierInput() *string
	SubnetIds() *[]*string
	...
	ResetReplicationSubnetGroupIdentifier()
	ResetTags()
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) ReplicationSubnetGroupIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) ReplicationSubnetGroupIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"replicationSubnetGroupIdentifierInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_DmsReplicationSubnetGroup) Tags() DmsReplicationSubnetGroupTagsList {
	var returns DmsReplicationSubnetGroupTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_DmsReplicationSubnetGroup)SetReplicationSubnetGroupIdentifier(val *string) {
	if err := j.validateSetReplicationSubnetGroupIdentifierParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) PutTags(value interface{}) {
...
func (d *jsiiProxy_DmsReplicationSubnetGroup) ResetReplicationSubnetGroupIdentifier() {
	_jsii_.InvokeVoid(
		d,
		"resetReplicationSubnetGroupIdentifier",
		nil, // no parameters
