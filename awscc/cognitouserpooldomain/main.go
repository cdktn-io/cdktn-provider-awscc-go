...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CognitoUserPoolDomainRouting)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.cognitoUserPoolDomain.CognitoUserPoolDomainRoutingFailover",
		reflect.TypeOf((*CognitoUserPoolDomainRoutingFailover)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.cognitoUserPoolDomain.CognitoUserPoolDomainRoutingFailoverOutputReference",
		reflect.TypeOf((*CognitoUserPoolDomainRoutingFailoverOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "primaryRoute53HealthCheckId", GoGetter: "PrimaryRoute53HealthCheckId"},
			_jsii_.MemberProperty{JsiiProperty: "primaryRoute53HealthCheckIdInput", GoGetter: "PrimaryRoute53HealthCheckIdInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrimaryRoute53HealthCheckId", GoMethod: "ResetPrimaryRoute53HealthCheckId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSecondaryRegion", GoMethod: "ResetSecondaryRegion"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "secondaryRegion", GoGetter: "SecondaryRegion"},
			_jsii_.MemberProperty{JsiiProperty: "secondaryRegionInput", GoGetter: "SecondaryRegionInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
		func() interface{} {
			j := jsiiProxy_CognitoUserPoolDomainRoutingFailoverOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CognitoUserPoolDomainRoutingOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_CognitoUserPoolDomainRoutingOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
