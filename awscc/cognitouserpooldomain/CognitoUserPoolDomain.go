...
type CognitoUserPoolDomain interface {
	...
	PutRouting(value *CognitoUserPoolDomainRouting)
...
func (j *jsiiProxy_CognitoUserPoolDomain) Routing() CognitoUserPoolDomainRoutingOutputReference {
	var returns CognitoUserPoolDomainRoutingOutputReference
	_jsii_.Get(
		j,
		"routing",
		&returns,
...
func (j *jsiiProxy_CognitoUserPoolDomain) RoutingInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"routingInput",
...
func (c *jsiiProxy_CognitoUserPoolDomain) PutRouting(value *CognitoUserPoolDomainRouting) {
	if err := c.validatePutRoutingParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CognitoUserPoolDomain) ResetRouting() {
	_jsii_.InvokeVoid(
		c,
		"resetRouting",
		nil, // no parameters
