...
func NewOdbCloudAutonomousVmClusterMaintenanceWindowOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference {
	_init_.Initialize()
...
func NewOdbCloudAutonomousVmClusterMaintenanceWindowOutputReference_Override(o OdbCloudAutonomousVmClusterMaintenanceWindowOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
