...
type OdbCloudAutonomousVmCluster interface {
	...
	Hostname() *string
	IamRoles() OdbCloudAutonomousVmClusterIamRolesList
...
func (j *jsiiProxy_OdbCloudAutonomousVmCluster) IamRoles() OdbCloudAutonomousVmClusterIamRolesList {
	var returns OdbCloudAutonomousVmClusterIamRolesList
	_jsii_.Get(
		j,
		"iamRoles",
		&returns,
...
func (j *jsiiProxy_OdbCloudAutonomousVmCluster) IamRolesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"iamRolesInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/odb_cloud_autonomous_vm_cluster awscc_odb_cloud_autonomous_vm_cluster} Resource.
...
func (o *jsiiProxy_OdbCloudAutonomousVmCluster) PutIamRoles(value interface{}) {
...
func (o *jsiiProxy_OdbCloudAutonomousVmCluster) ResetIamRoles() {
	_jsii_.InvokeVoid(
		o,
		"resetIamRoles",
		nil, // no parameters
