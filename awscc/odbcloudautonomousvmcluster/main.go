...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OdbCloudAutonomousVmClusterIamRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.odbCloudAutonomousVmCluster.OdbCloudAutonomousVmClusterIamRolesList",
		reflect.TypeOf((*OdbCloudAutonomousVmClusterIamRolesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OdbCloudAutonomousVmClusterIamRolesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
