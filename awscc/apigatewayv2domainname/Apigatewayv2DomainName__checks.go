...
func (a *jsiiProxy_Apigatewayv2DomainName) validatePutDomainNameConfigurationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Apigatewayv2DomainNameDomainNameConfigurations; received %#v (a %T)", value, value)
		}
	}
