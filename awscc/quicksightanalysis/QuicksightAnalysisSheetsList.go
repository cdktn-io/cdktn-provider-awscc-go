...
func (j *jsiiProxy_QuicksightAnalysisSheetsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightAnalysisSheetsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightAnalysisSheetsList {
	_init_.Initialize()
...
func NewQuicksightAnalysisSheetsList_Override(q QuicksightAnalysisSheetsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightAnalysisSheetsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightAnalysisSheetsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightAnalysisSheetsList) Resolve(context cdktn.IResolveContext) interface{} {
