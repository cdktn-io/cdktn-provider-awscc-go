...
func (e *jsiiProxy_ElasticbeanstalkEnvironment) validatePutOptionSettingsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ElasticbeanstalkEnvironmentOptionSettings; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_ElasticbeanstalkEnvironment) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ElasticbeanstalkEnvironmentTags; received %#v (a %T)", value, value)
		}
	}
