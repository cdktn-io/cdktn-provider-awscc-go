...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "currentVersionEolDate", GoGetter: "CurrentVersionEolDate"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "enableAutoMinorVersionUpgrade", GoGetter: "EnableAutoMinorVersionUpgrade"},
			_jsii_.MemberProperty{JsiiProperty: "enableAutoMinorVersionUpgradeInput", GoGetter: "EnableAutoMinorVersionUpgradeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAppVersion", GoMethod: "ResetAppVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetClientToken", GoMethod: "ResetClientToken"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableAutoMinorVersionUpgrade", GoMethod: "ResetEnableAutoMinorVersionUpgrade"},
