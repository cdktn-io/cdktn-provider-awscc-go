...
func (s *jsiiProxy_SecretsmanagerSecret) validatePutReplicaRegionsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SecretsmanagerSecretReplicaRegions; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SecretsmanagerSecret) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SecretsmanagerSecretTags; received %#v (a %T)", value, value)
		}
	}
