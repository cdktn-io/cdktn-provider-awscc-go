...
func (j *jsiiProxy_FrauddetectorDetectorRulesOutcomesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFrauddetectorDetectorRulesOutcomesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrauddetectorDetectorRulesOutcomesOutputReference {
	_init_.Initialize()
...
func NewFrauddetectorDetectorRulesOutcomesOutputReference_Override(f FrauddetectorDetectorRulesOutcomesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FrauddetectorDetectorRulesOutcomesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FrauddetectorDetectorRulesOutcomesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrauddetectorDetectorRulesOutcomesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FrauddetectorDetectorRulesOutcomesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FrauddetectorDetectorRulesOutcomesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
