...
func (j *jsiiProxy_GuarddutyIpSet) ExpectedBucketOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expectedBucketOwner",
...
func (j *jsiiProxy_GuarddutyIpSet) ExpectedBucketOwnerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GuarddutyIpSet)SetExpectedBucketOwner(val *string) {
...
func (g *jsiiProxy_GuarddutyIpSet) ResetExpectedBucketOwner() {
	_jsii_.InvokeVoid(
		g,
		"resetExpectedBucketOwner",
		nil, // no parameters
