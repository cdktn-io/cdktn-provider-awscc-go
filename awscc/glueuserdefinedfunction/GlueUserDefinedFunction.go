...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/glueuserdefinedfunction/internal"
...
func (j *jsiiProxy_GlueUserDefinedFunction) FunctionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionName",
...
func (j *jsiiProxy_GlueUserDefinedFunction) FunctionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionNameInput",
...
func (j *jsiiProxy_GlueUserDefinedFunction) FunctionType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionType",
...
func (j *jsiiProxy_GlueUserDefinedFunction) FunctionTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionTypeInput",
...
func (j *jsiiProxy_GlueUserDefinedFunction)SetFunctionName(val *string) {
...
func (j *jsiiProxy_GlueUserDefinedFunction)SetFunctionType(val *string) {
...
func (g *jsiiProxy_GlueUserDefinedFunction) ResetClassName() {
	_jsii_.InvokeVoid(
		g,
		"resetClassName",
		nil, // no parameters
...
func (g *jsiiProxy_GlueUserDefinedFunction) ResetFunctionType() {
	_jsii_.InvokeVoid(
		g,
		"resetFunctionType",
		nil, // no parameters
...
func (g *jsiiProxy_GlueUserDefinedFunction) ResetOwnerName() {
	_jsii_.InvokeVoid(
		g,
		"resetOwnerName",
		nil, // no parameters
...
func (g *jsiiProxy_GlueUserDefinedFunction) ResetOwnerType() {
	_jsii_.InvokeVoid(
		g,
		"resetOwnerType",
		nil, // no parameters
