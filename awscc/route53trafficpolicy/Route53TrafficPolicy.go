...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/route53trafficpolicy/internal"
...
func (j *jsiiProxy_Route53TrafficPolicy) TrafficPolicyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"trafficPolicyId",
...
func NewRoute53TrafficPolicy(scope constructs.Construct, id *string, config *Route53TrafficPolicyConfig) Route53TrafficPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.route53TrafficPolicy.Route53TrafficPolicy",
