...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/datasynclocationfsxopenzfs/internal"
...
func (j *jsiiProxy_DatasyncLocationFsxOpenZfs) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatasyncLocationFsxOpenZfs) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatasyncLocationFsxOpenZfs) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatasyncLocationFsxOpenZfs) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatasyncLocationFsxOpenZfs) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DatasyncLocationFsxOpenZfs)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatasyncLocationFsxOpenZfs)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatasyncLocationFsxOpenZfs)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DatasyncLocationFsxOpenZfs_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatasyncLocationFsxOpenZfs) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationFsxOpenZfs) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatasyncLocationFsxOpenZfs) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatasyncLocationFsxOpenZfs) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatasyncLocationFsxOpenZfs) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatasyncLocationFsxOpenZfs) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
