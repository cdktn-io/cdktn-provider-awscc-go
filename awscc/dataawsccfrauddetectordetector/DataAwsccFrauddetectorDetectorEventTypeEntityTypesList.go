...
func (j *jsiiProxy_DataAwsccFrauddetectorDetectorEventTypeEntityTypesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccFrauddetectorDetectorEventTypeEntityTypesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccFrauddetectorDetectorEventTypeEntityTypesList {
	_init_.Initialize()
...
func NewDataAwsccFrauddetectorDetectorEventTypeEntityTypesList_Override(d DataAwsccFrauddetectorDetectorEventTypeEntityTypesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccFrauddetectorDetectorEventTypeEntityTypesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccFrauddetectorDetectorEventTypeEntityTypesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccFrauddetectorDetectorEventTypeEntityTypesList) Resolve(context cdktn.IResolveContext) interface{} {
