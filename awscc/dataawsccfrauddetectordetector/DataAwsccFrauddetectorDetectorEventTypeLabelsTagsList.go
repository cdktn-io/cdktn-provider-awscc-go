...
func (j *jsiiProxy_DataAwsccFrauddetectorDetectorEventTypeLabelsTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccFrauddetectorDetectorEventTypeLabelsTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccFrauddetectorDetectorEventTypeLabelsTagsList {
	_init_.Initialize()
...
func NewDataAwsccFrauddetectorDetectorEventTypeLabelsTagsList_Override(d DataAwsccFrauddetectorDetectorEventTypeLabelsTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccFrauddetectorDetectorEventTypeLabelsTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccFrauddetectorDetectorEventTypeLabelsTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccFrauddetectorDetectorEventTypeLabelsTagsList) Resolve(context cdktn.IResolveContext) interface{} {
