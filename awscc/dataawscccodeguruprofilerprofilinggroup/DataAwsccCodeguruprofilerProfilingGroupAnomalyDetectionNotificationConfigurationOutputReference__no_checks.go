...
func (d *jsiiProxy_DataAwsccCodeguruprofilerProfilingGroupAnomalyDetectionNotificationConfigurationOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (d *jsiiProxy_DataAwsccCodeguruprofilerProfilingGroupAnomalyDetectionNotificationConfigurationOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_DataAwsccCodeguruprofilerProfilingGroupAnomalyDetectionNotificationConfigurationOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}

func validateNewDataAwsccCodeguruprofilerProfilingGroupAnomalyDetectionNotificationConfigurationOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
	return nil
}
