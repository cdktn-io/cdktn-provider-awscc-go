...
type RdsCustomDbEngineVersion interface {
	...
	DatabaseInstallationFilesInput() *[]*string
	...
	ResetDatabaseInstallationFiles()
...
func (j *jsiiProxy_RdsCustomDbEngineVersion) DatabaseInstallationFiles() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RdsCustomDbEngineVersion) DatabaseInstallationFilesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"databaseInstallationFilesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_RdsCustomDbEngineVersion)SetDatabaseInstallationFiles(val *[]*string) {
	if err := j.validateSetDatabaseInstallationFilesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (r *jsiiProxy_RdsCustomDbEngineVersion) ResetDatabaseInstallationFiles() {
	_jsii_.InvokeVoid(
		r,
		"resetDatabaseInstallationFiles",
		nil, // no parameters
