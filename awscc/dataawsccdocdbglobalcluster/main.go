...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDocdbGlobalCluster)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "globalClusterArn", GoGetter: "GlobalClusterArn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDocdbGlobalClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccDocdbGlobalCluster.DataAwsccDocdbGlobalClusterTags",
		reflect.TypeOf((*DataAwsccDocdbGlobalClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccDocdbGlobalCluster.DataAwsccDocdbGlobalClusterTagsList",
		reflect.TypeOf((*DataAwsccDocdbGlobalClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDocdbGlobalClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccDocdbGlobalClusterTagsOutputReference{}
