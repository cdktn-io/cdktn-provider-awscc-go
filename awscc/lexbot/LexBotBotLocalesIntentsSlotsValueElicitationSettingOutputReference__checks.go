...
func (l *jsiiProxy_LexBotBotLocalesIntentsSlotsValueElicitationSettingOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (l *jsiiProxy_LexBotBotLocalesIntentsSlotsValueElicitationSettingOutputReference) validatePutSampleUtterancesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LexBotBotLocalesIntentsSlotsValueElicitationSettingSampleUtterances; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_LexBotBotLocalesIntentsSlotsValueElicitationSettingOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_LexBotBotLocalesIntentsSlotsValueElicitationSettingOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *LexBotBotLocalesIntentsSlotsValueElicitationSetting; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_LexBotBotLocalesIntentsSlotsValueElicitationSettingOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewLexBotBotLocalesIntentsSlotsValueElicitationSettingOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
