...
func (j *jsiiProxy_BedrockSessionTagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*BedrockSessionTags:
		val := val.(*[]*BedrockSessionTags)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*BedrockSessionTags; received %#v (a %T)", val, val)
		}
	}
