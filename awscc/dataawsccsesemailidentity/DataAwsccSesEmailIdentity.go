...
func (j *jsiiProxy_DataAwsccSesEmailIdentity) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccSesEmailIdentity) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccSesEmailIdentity) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccSesEmailIdentity) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccSesEmailIdentity) Tags() DataAwsccSesEmailIdentityTagsList {
	var returns DataAwsccSesEmailIdentityTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_DataAwsccSesEmailIdentity) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ses_email_identity awscc_ses_email_identity} Data Source.
...
func (j *jsiiProxy_DataAwsccSesEmailIdentity)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccSesEmailIdentity)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccSesEmailIdentity)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccSesEmailIdentity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccSesEmailIdentity) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSesEmailIdentity) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSesEmailIdentity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccSesEmailIdentity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
