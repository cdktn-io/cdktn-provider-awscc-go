...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociations)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCleanroomsmlConfiguredModelAlgorithmAssociationsConfig)(nil)).Elem(),
	)
}
