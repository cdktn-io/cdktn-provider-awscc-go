...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) LastModificationErrors() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) RoutingPolicyLabel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingPolicyLabel",
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/networkmanager_connect_attachment awscc_networkmanager_connect_attachment} Data Source.
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccNetworkmanagerConnectAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerConnectAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
