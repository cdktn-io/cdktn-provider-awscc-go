...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSagemakerMlflowApp)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "mlflowAppId", GoGetter: "MlflowAppId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSagemakerMlflowAppConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccSagemakerMlflowApp.DataAwsccSagemakerMlflowAppTags",
		reflect.TypeOf((*DataAwsccSagemakerMlflowAppTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccSagemakerMlflowApp.DataAwsccSagemakerMlflowAppTagsList",
		reflect.TypeOf((*DataAwsccSagemakerMlflowAppTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccSagemakerMlflowAppTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSagemakerMlflowAppTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccSagemakerMlflowAppTagsOutputReference{}
