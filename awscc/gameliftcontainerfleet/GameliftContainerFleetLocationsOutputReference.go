...
type GameliftContainerFleetLocationsOutputReference interface {
	...
	SetPlayerGatewayStatus(val *string)
	PlayerGatewayStatusInput() *string
...
func (j *jsiiProxy_GameliftContainerFleetLocationsOutputReference) PlayerGatewayStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"playerGatewayStatus",
...
func (j *jsiiProxy_GameliftContainerFleetLocationsOutputReference) PlayerGatewayStatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"playerGatewayStatusInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_GameliftContainerFleetLocationsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGameliftContainerFleetLocationsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GameliftContainerFleetLocationsOutputReference {
	_init_.Initialize()
...
func NewGameliftContainerFleetLocationsOutputReference_Override(g GameliftContainerFleetLocationsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GameliftContainerFleetLocationsOutputReference)SetPlayerGatewayStatus(val *string) {
	if err := j.validateSetPlayerGatewayStatusParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_GameliftContainerFleetLocationsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GameliftContainerFleetLocationsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftContainerFleetLocationsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GameliftContainerFleetLocationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftContainerFleetLocationsOutputReference) ResetPlayerGatewayStatus() {
	_jsii_.InvokeVoid(
		g,
		"resetPlayerGatewayStatus",
		nil, // no parameters
...
func (g *jsiiProxy_GameliftContainerFleetLocationsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
