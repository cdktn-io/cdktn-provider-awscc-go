...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ec2route/internal"
...
func (j *jsiiProxy_Ec2Route) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2Route) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2Route) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2Route) OdbNetworkArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"odbNetworkArn",
...
func (j *jsiiProxy_Ec2Route) OdbNetworkArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"odbNetworkArnInput",
...
func (j *jsiiProxy_Ec2Route) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2Route) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2Route)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2Route)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2Route)SetOdbNetworkArn(val *string) {
...
func (j *jsiiProxy_Ec2Route)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2Route_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2Route) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2Route) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2Route) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2Route) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2Route) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2Route) ResetOdbNetworkArn() {
	_jsii_.InvokeVoid(
		e,
		"resetOdbNetworkArn",
		nil, // no parameters
...
func (e *jsiiProxy_Ec2Route) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
