...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "associationDispatchAssumeRoleInput", GoGetter: "AssociationDispatchAssumeRoleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAssociationDispatchAssumeRole", GoMethod: "ResetAssociationDispatchAssumeRole"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SsmAssociationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ssmAssociation.SsmAssociationTagsList",
		reflect.TypeOf((*SsmAssociationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SsmAssociationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
