...
func (j *jsiiProxy_DataAwsccTimestreamTableSchemaCompositePartitionKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccTimestreamTableSchemaCompositePartitionKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccTimestreamTableSchemaCompositePartitionKeyList {
	_init_.Initialize()
...
func NewDataAwsccTimestreamTableSchemaCompositePartitionKeyList_Override(d DataAwsccTimestreamTableSchemaCompositePartitionKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccTimestreamTableSchemaCompositePartitionKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccTimestreamTableSchemaCompositePartitionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccTimestreamTableSchemaCompositePartitionKeyList) Resolve(context cdktn.IResolveContext) interface{} {
