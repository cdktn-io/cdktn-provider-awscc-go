...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNotificationsOrganizationalUnitAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccNotificationsOrganizationalUnitAssociationConfig)(nil)).Elem(),
	)
}
