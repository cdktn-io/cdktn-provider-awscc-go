...
func (j *jsiiProxy_DataAwsccCodegurureviewerRepositoryAssociationTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccCodegurureviewerRepositoryAssociationTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccCodegurureviewerRepositoryAssociationTagsList {
	_init_.Initialize()
...
func NewDataAwsccCodegurureviewerRepositoryAssociationTagsList_Override(d DataAwsccCodegurureviewerRepositoryAssociationTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccCodegurureviewerRepositoryAssociationTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccCodegurureviewerRepositoryAssociationTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccCodegurureviewerRepositoryAssociationTagsList) Resolve(context cdktn.IResolveContext) interface{} {
