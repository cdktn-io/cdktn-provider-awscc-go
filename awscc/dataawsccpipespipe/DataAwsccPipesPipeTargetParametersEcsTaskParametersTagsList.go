...
func (j *jsiiProxy_DataAwsccPipesPipeTargetParametersEcsTaskParametersTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccPipesPipeTargetParametersEcsTaskParametersTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccPipesPipeTargetParametersEcsTaskParametersTagsList {
	_init_.Initialize()
...
func NewDataAwsccPipesPipeTargetParametersEcsTaskParametersTagsList_Override(d DataAwsccPipesPipeTargetParametersEcsTaskParametersTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccPipesPipeTargetParametersEcsTaskParametersTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccPipesPipeTargetParametersEcsTaskParametersTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccPipesPipeTargetParametersEcsTaskParametersTagsList) Resolve(context cdktn.IResolveContext) interface{} {
