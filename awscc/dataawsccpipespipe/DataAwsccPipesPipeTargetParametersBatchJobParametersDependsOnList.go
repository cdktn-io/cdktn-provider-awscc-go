...
func (j *jsiiProxy_DataAwsccPipesPipeTargetParametersBatchJobParametersDependsOnList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccPipesPipeTargetParametersBatchJobParametersDependsOnList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccPipesPipeTargetParametersBatchJobParametersDependsOnList {
	_init_.Initialize()
...
func NewDataAwsccPipesPipeTargetParametersBatchJobParametersDependsOnList_Override(d DataAwsccPipesPipeTargetParametersBatchJobParametersDependsOnList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccPipesPipeTargetParametersBatchJobParametersDependsOnList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccPipesPipeTargetParametersBatchJobParametersDependsOnList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccPipesPipeTargetParametersBatchJobParametersDependsOnList) Resolve(context cdktn.IResolveContext) interface{} {
