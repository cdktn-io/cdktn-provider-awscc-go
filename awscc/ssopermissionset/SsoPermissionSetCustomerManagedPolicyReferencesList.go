...
func (j *jsiiProxy_SsoPermissionSetCustomerManagedPolicyReferencesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSsoPermissionSetCustomerManagedPolicyReferencesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SsoPermissionSetCustomerManagedPolicyReferencesList {
	_init_.Initialize()
...
func NewSsoPermissionSetCustomerManagedPolicyReferencesList_Override(s SsoPermissionSetCustomerManagedPolicyReferencesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SsoPermissionSetCustomerManagedPolicyReferencesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SsoPermissionSetCustomerManagedPolicyReferencesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SsoPermissionSetCustomerManagedPolicyReferencesList) Resolve(context cdktn.IResolveContext) interface{} {
