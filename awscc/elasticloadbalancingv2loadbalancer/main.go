...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableCapacityReservationProvisionStabilizeInput", GoGetter: "EnableCapacityReservationProvisionStabilizeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableCapacityReservationProvisionStabilize", GoMethod: "ResetEnableCapacityReservationProvisionStabilize"},
