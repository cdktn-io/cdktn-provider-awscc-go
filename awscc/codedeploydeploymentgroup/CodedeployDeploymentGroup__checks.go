...
func (c *jsiiProxy_CodedeployDeploymentGroup) validatePutEc2TagFiltersParameters(value interface{}) error {
	...
	case *[]*CodedeployDeploymentGroupEc2TagFilters:
		value := value.(*[]*CodedeployDeploymentGroupEc2TagFilters)
	...
	case []*CodedeployDeploymentGroupEc2TagFilters:
		value_ := value.([]*CodedeployDeploymentGroupEc2TagFilters)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodedeployDeploymentGroupEc2TagFilters; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CodedeployDeploymentGroup) validatePutEcsServicesParameters(value interface{}) error {
	...
	case *[]*CodedeployDeploymentGroupEcsServices:
		value := value.(*[]*CodedeployDeploymentGroupEcsServices)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CodedeployDeploymentGroupEcsServices:
		value_ := value.([]*CodedeployDeploymentGroupEcsServices)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodedeployDeploymentGroupEcsServices; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CodedeployDeploymentGroup) validatePutOnPremisesInstanceTagFiltersParameters(value interface{}) error {
	...
	case *[]*CodedeployDeploymentGroupOnPremisesInstanceTagFilters:
		value := value.(*[]*CodedeployDeploymentGroupOnPremisesInstanceTagFilters)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CodedeployDeploymentGroupOnPremisesInstanceTagFilters:
		value_ := value.([]*CodedeployDeploymentGroupOnPremisesInstanceTagFilters)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodedeployDeploymentGroupOnPremisesInstanceTagFilters; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CodedeployDeploymentGroup) validatePutTagsParameters(value interface{}) error {
	...
	case *[]*CodedeployDeploymentGroupTags:
		value := value.(*[]*CodedeployDeploymentGroupTags)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CodedeployDeploymentGroupTags:
		value_ := value.([]*CodedeployDeploymentGroupTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodedeployDeploymentGroupTags; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CodedeployDeploymentGroup) validatePutTriggerConfigurationsParameters(value interface{}) error {
	...
	case *[]*CodedeployDeploymentGroupTriggerConfigurations:
		value := value.(*[]*CodedeployDeploymentGroupTriggerConfigurations)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CodedeployDeploymentGroupTriggerConfigurations:
		value_ := value.([]*CodedeployDeploymentGroupTriggerConfigurations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodedeployDeploymentGroupTriggerConfigurations; received %#v (a %T)", value, value)
		}
	}
