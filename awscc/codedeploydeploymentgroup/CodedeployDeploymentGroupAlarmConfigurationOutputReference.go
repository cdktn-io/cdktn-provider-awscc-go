...
func (j *jsiiProxy_CodedeployDeploymentGroupAlarmConfigurationOutputReference) Alarms() CodedeployDeploymentGroupAlarmConfigurationAlarmsList {
	var returns CodedeployDeploymentGroupAlarmConfigurationAlarmsList
	_jsii_.Get(
		j,
		"alarms",
		&returns,
...
func (j *jsiiProxy_CodedeployDeploymentGroupAlarmConfigurationOutputReference) AlarmsInput() interface{} {
...
func (j *jsiiProxy_CodedeployDeploymentGroupAlarmConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CodedeployDeploymentGroupAlarmConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (c *jsiiProxy_CodedeployDeploymentGroupAlarmConfigurationOutputReference) PutAlarms(value interface{}) {
	if err := c.validatePutAlarmsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
