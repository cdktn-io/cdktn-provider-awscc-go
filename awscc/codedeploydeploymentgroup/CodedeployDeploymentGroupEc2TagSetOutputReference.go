...
type CodedeployDeploymentGroupEc2TagSetOutputReference interface {
	...
	Ec2TagSetList() CodedeployDeploymentGroupEc2TagSetEc2TagSetListStructList
	Ec2TagSetListInput() interface{}
	// Experimental.
	Fqn() *string
	...
	PutEc2TagSetList(value interface{})
	ResetEc2TagSetList()
...
func (j *jsiiProxy_CodedeployDeploymentGroupEc2TagSetOutputReference) Ec2TagSetList() CodedeployDeploymentGroupEc2TagSetEc2TagSetListStructList {
	var returns CodedeployDeploymentGroupEc2TagSetEc2TagSetListStructList
	_jsii_.Get(
		j,
		"ec2TagSetList",
		&returns,
...
func (j *jsiiProxy_CodedeployDeploymentGroupEc2TagSetOutputReference) Ec2TagSetListInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ec2TagSetListInput",
...
func NewCodedeployDeploymentGroupEc2TagSetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CodedeployDeploymentGroupEc2TagSetOutputReference {
	_init_.Initialize()

	if err := validateNewCodedeployDeploymentGroupEc2TagSetOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewCodedeployDeploymentGroupEc2TagSetOutputReference_Override(c CodedeployDeploymentGroupEc2TagSetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (c *jsiiProxy_CodedeployDeploymentGroupEc2TagSetOutputReference) PutEc2TagSetList(value interface{}) {
	if err := c.validatePutEc2TagSetListParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CodedeployDeploymentGroupEc2TagSetOutputReference) ResetEc2TagSetList() {
	_jsii_.InvokeVoid(
		c,
		"resetEc2TagSetList",
		nil, // no parameters
