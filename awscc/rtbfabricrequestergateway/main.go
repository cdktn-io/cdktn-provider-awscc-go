...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RtbfabricRequesterGateway)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RtbfabricRequesterGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.rtbfabricRequesterGateway.RtbfabricRequesterGatewayTags",
		reflect.TypeOf((*RtbfabricRequesterGatewayTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.rtbfabricRequesterGateway.RtbfabricRequesterGatewayTagsList",
		reflect.TypeOf((*RtbfabricRequesterGatewayTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RtbfabricRequesterGatewayTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
