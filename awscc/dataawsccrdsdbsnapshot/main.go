...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRdsDbSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccRdsDbSnapshot.DataAwsccRdsDbSnapshotConfig",
		reflect.TypeOf((*DataAwsccRdsDbSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccRdsDbSnapshot.DataAwsccRdsDbSnapshotTags",
		reflect.TypeOf((*DataAwsccRdsDbSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccRdsDbSnapshot.DataAwsccRdsDbSnapshotTagsList",
		reflect.TypeOf((*DataAwsccRdsDbSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRdsDbSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
