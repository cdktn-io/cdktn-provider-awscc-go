...
func (i *jsiiProxy_IamSamlProvider) validatePutPrivateKeyListParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*IamSamlProviderPrivateKeyListStruct; received %#v (a %T)", value, value)
		}
	}
...
func (i *jsiiProxy_IamSamlProvider) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*IamSamlProviderTags; received %#v (a %T)", value, value)
		}
	}
