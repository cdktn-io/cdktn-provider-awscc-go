...
func (j *jsiiProxy_DataAwsccBackupFrameworkFrameworkControlsControlInputParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccBackupFrameworkFrameworkControlsControlInputParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccBackupFrameworkFrameworkControlsControlInputParametersList {
	_init_.Initialize()
...
func NewDataAwsccBackupFrameworkFrameworkControlsControlInputParametersList_Override(d DataAwsccBackupFrameworkFrameworkControlsControlInputParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccBackupFrameworkFrameworkControlsControlInputParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccBackupFrameworkFrameworkControlsControlInputParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccBackupFrameworkFrameworkControlsControlInputParametersList) Resolve(context cdktn.IResolveContext) interface{} {
