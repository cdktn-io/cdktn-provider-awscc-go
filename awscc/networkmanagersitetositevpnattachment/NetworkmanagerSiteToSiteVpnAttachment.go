...
func (j *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) LastModificationErrors() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/networkmanager_site_to_site_vpn_attachment awscc_networkmanager_site_to_site_vpn_attachment} Resource.
