...
func (n *jsiiProxy_NetworkmanagerSiteToSiteVpnAttachment) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkmanagerSiteToSiteVpnAttachmentTags; received %#v (a %T)", value, value)
		}
	}
