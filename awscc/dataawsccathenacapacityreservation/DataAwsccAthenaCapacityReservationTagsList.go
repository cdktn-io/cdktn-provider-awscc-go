...
func (j *jsiiProxy_DataAwsccAthenaCapacityReservationTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccAthenaCapacityReservationTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccAthenaCapacityReservationTagsList {
	_init_.Initialize()
...
func NewDataAwsccAthenaCapacityReservationTagsList_Override(d DataAwsccAthenaCapacityReservationTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccAthenaCapacityReservationTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccAthenaCapacityReservationTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccAthenaCapacityReservationTagsList) Resolve(context cdktn.IResolveContext) interface{} {
