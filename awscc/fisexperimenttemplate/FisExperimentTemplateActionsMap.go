...
func (j *jsiiProxy_FisExperimentTemplateActionsMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFisExperimentTemplateActionsMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FisExperimentTemplateActionsMap {
	_init_.Initialize()
...
func NewFisExperimentTemplateActionsMap_Override(f FisExperimentTemplateActionsMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FisExperimentTemplateActionsMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FisExperimentTemplateActionsMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FisExperimentTemplateActionsMap) Resolve(context cdktn.IResolveContext) interface{} {
