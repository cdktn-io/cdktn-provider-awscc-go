...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GuarddutyThreatEntitySet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GuarddutyThreatEntitySetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.guarddutyThreatEntitySet.GuarddutyThreatEntitySetTags",
		reflect.TypeOf((*GuarddutyThreatEntitySetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.guarddutyThreatEntitySet.GuarddutyThreatEntitySetTagsList",
		reflect.TypeOf((*GuarddutyThreatEntitySetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GuarddutyThreatEntitySetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
