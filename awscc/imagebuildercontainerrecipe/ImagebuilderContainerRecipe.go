...
type ImagebuilderContainerRecipe interface {
	...
	LatestVersion() ImagebuilderContainerRecipeLatestVersionOutputReference
	// Experimental.
...
func (j *jsiiProxy_ImagebuilderContainerRecipe) LatestVersion() ImagebuilderContainerRecipeLatestVersionOutputReference {
	var returns ImagebuilderContainerRecipeLatestVersionOutputReference
	_jsii_.Get(
		j,
		"latestVersion",
		&returns,
