...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccMediaconnectFlowVpcInterfaceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccMediaconnectFlowVpcInterface.DataAwsccMediaconnectFlowVpcInterfaceTagsList",
		reflect.TypeOf((*DataAwsccMediaconnectFlowVpcInterfaceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccMediaconnectFlowVpcInterfaceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
