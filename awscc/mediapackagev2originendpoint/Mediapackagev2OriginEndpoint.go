...
type Mediapackagev2OriginEndpoint interface {
	...
	ModifiedAt() *string
	MssManifests() Mediapackagev2OriginEndpointMssManifestsList
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) MssManifests() Mediapackagev2OriginEndpointMssManifestsList {
	var returns Mediapackagev2OriginEndpointMssManifestsList
	_jsii_.Get(
		j,
		"mssManifests",
		&returns,
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) MssManifestsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"mssManifestsInput",
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) MssManifestUrls() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"mssManifestUrls",
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) UriSeparator() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uriSeparator",
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint) UriSeparatorInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uriSeparatorInput",
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Mediapackagev2OriginEndpoint)SetUriSeparator(val *string) {
	if err := j.validateSetUriSeparatorParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func Mediapackagev2OriginEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) PutMssManifests(value interface{}) {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) ResetMssManifests() {
	_jsii_.InvokeVoid(
		m,
		"resetMssManifests",
		nil, // no parameters
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) ResetUriSeparator() {
	_jsii_.InvokeVoid(
		m,
		"resetUriSeparator",
		nil, // no parameters
...
func (m *jsiiProxy_Mediapackagev2OriginEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
