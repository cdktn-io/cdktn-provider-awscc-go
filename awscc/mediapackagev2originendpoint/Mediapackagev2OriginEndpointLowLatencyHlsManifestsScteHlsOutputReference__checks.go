...
func (m *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsScteHlsOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsScteHlsOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsScteHlsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *Mediapackagev2OriginEndpointLowLatencyHlsManifestsScteHls; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsScteHlsOutputReference) validateSetScteInManifestsParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointLowLatencyHlsManifestsScteHlsOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewMediapackagev2OriginEndpointLowLatencyHlsManifestsScteHlsOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
