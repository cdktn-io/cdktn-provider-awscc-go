...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2LocalGatewayVirtualInterfaceGroup)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "localBgpAsnExtendedInput", GoGetter: "LocalBgpAsnExtendedInput"},
			_jsii_.MemberProperty{JsiiProperty: "localBgpAsnInput", GoGetter: "LocalBgpAsnInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "localGatewayVirtualInterfaceGroupArn", GoGetter: "LocalGatewayVirtualInterfaceGroupArn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLocalBgpAsn", GoMethod: "ResetLocalBgpAsn"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocalBgpAsnExtended", GoMethod: "ResetLocalBgpAsnExtended"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2LocalGatewayVirtualInterfaceGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
