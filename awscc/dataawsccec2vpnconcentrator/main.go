...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2VpnConcentrator)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEc2VpnConcentratorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccEc2VpnConcentrator.DataAwsccEc2VpnConcentratorTags",
		reflect.TypeOf((*DataAwsccEc2VpnConcentratorTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccEc2VpnConcentrator.DataAwsccEc2VpnConcentratorTagsList",
		reflect.TypeOf((*DataAwsccEc2VpnConcentratorTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccEc2VpnConcentratorTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2VpnConcentratorTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
