...
func (j *jsiiProxy_XraySamplingRuleTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewXraySamplingRuleTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) XraySamplingRuleTagsList {
	_init_.Initialize()
...
func NewXraySamplingRuleTagsList_Override(x XraySamplingRuleTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_XraySamplingRuleTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (x *jsiiProxy_XraySamplingRuleTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (x *jsiiProxy_XraySamplingRuleTagsList) Resolve(context cdktn.IResolveContext) interface{} {
