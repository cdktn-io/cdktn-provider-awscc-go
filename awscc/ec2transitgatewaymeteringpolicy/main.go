...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2TransitGatewayMeteringPolicyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ec2TransitGatewayMeteringPolicy.Ec2TransitGatewayMeteringPolicyTagsList",
		reflect.TypeOf((*Ec2TransitGatewayMeteringPolicyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2TransitGatewayMeteringPolicyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
