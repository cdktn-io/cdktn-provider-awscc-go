...
func (j *jsiiProxy_SsmguiconnectPreferences) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SsmguiconnectPreferences) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SsmguiconnectPreferences) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SsmguiconnectPreferences) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SsmguiconnectPreferences) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SsmguiconnectPreferences)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SsmguiconnectPreferences)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SsmguiconnectPreferences)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SsmguiconnectPreferences_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SsmguiconnectPreferences) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmguiconnectPreferences) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SsmguiconnectPreferences) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SsmguiconnectPreferences) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SsmguiconnectPreferences) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SsmguiconnectPreferences) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
