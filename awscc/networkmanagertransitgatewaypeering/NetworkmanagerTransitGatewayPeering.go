...
func (j *jsiiProxy_NetworkmanagerTransitGatewayPeering) LastModificationErrors() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/networkmanager_transit_gateway_peering awscc_networkmanager_transit_gateway_peering} Resource.
