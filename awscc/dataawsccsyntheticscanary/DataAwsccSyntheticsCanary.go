...
type DataAwsccSyntheticsCanary interface {
	...
	BrowserConfigs() DataAwsccSyntheticsCanaryBrowserConfigsList
	CanaryId() *string
	// Experimental.
	...
	DeleteLambdaResourcesOnCanaryDeletion() cdktn.IResolvable
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	SetDependsOn(val *[]*string)
	DryRunAndUpdate() cdktn.IResolvable
	...
	StartCanaryAfterCreation() cdktn.IResolvable
	State() *string
	...
	VisualReferences() DataAwsccSyntheticsCanaryVisualReferencesList
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) BrowserConfigs() DataAwsccSyntheticsCanaryBrowserConfigsList {
	var returns DataAwsccSyntheticsCanaryBrowserConfigsList
	_jsii_.Get(
		j,
		"browserConfigs",
		&returns,
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) DeleteLambdaResourcesOnCanaryDeletion() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) DryRunAndUpdate() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"dryRunAndUpdate",
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) StartCanaryAfterCreation() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary) VisualReferences() DataAwsccSyntheticsCanaryVisualReferencesList {
	var returns DataAwsccSyntheticsCanaryVisualReferencesList
	_jsii_.Get(
		j,
		"visualReferences",
		&returns,
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccSyntheticsCanary)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccSyntheticsCanary_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccSyntheticsCanary) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSyntheticsCanary) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSyntheticsCanary) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccSyntheticsCanary) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
