...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SesMailManagerRuleSetRulesActionsBounce)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sesMailManagerRuleSet.SesMailManagerRuleSetRulesActionsBounceOutputReference",
		reflect.TypeOf((*SesMailManagerRuleSetRulesActionsBounceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "actionFailurePolicy", GoGetter: "ActionFailurePolicy"},
			_jsii_.MemberProperty{JsiiProperty: "actionFailurePolicyInput", GoGetter: "ActionFailurePolicyInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetActionFailurePolicy", GoMethod: "ResetActionFailurePolicy"},
			_jsii_.MemberMethod{JsiiMethod: "resetDiagnosticMessage", GoMethod: "ResetDiagnosticMessage"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSender", GoMethod: "ResetSender"},
			_jsii_.MemberMethod{JsiiMethod: "resetSmtpReplyCode", GoMethod: "ResetSmtpReplyCode"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SesMailManagerRuleSetRulesActionsInvokeLambda)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sesMailManagerRuleSet.SesMailManagerRuleSetRulesActionsInvokeLambdaOutputReference",
		reflect.TypeOf((*SesMailManagerRuleSetRulesActionsInvokeLambdaOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "actionFailurePolicy", GoGetter: "ActionFailurePolicy"},
			_jsii_.MemberProperty{JsiiProperty: "actionFailurePolicyInput", GoGetter: "ActionFailurePolicyInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
