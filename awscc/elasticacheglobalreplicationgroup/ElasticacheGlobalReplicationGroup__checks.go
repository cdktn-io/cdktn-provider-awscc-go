...
func (e *jsiiProxy_ElasticacheGlobalReplicationGroup) validatePutMembersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ElasticacheGlobalReplicationGroupMembers; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_ElasticacheGlobalReplicationGroup) validatePutRegionalConfigurationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ElasticacheGlobalReplicationGroupRegionalConfigurations; received %#v (a %T)", value, value)
		}
	}
