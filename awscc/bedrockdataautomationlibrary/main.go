...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockDataAutomationLibrary)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "libraryArn", GoGetter: "LibraryArn"},
			_jsii_.MemberProperty{JsiiProperty: "libraryDescription", GoGetter: "LibraryDescription"},
			_jsii_.MemberProperty{JsiiProperty: "libraryDescriptionInput", GoGetter: "LibraryDescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "libraryName", GoGetter: "LibraryName"},
			_jsii_.MemberProperty{JsiiProperty: "libraryNameInput", GoGetter: "LibraryNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLibraryDescription", GoMethod: "ResetLibraryDescription"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BedrockDataAutomationLibraryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.bedrockDataAutomationLibrary.BedrockDataAutomationLibraryEncryptionConfiguration",
		reflect.TypeOf((*BedrockDataAutomationLibraryEncryptionConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.bedrockDataAutomationLibrary.BedrockDataAutomationLibraryEncryptionConfigurationOutputReference",
		reflect.TypeOf((*BedrockDataAutomationLibraryEncryptionConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BedrockDataAutomationLibraryEntityTypes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.bedrockDataAutomationLibrary.BedrockDataAutomationLibraryEntityTypesList",
		reflect.TypeOf((*BedrockDataAutomationLibraryEntityTypesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockDataAutomationLibraryEntityTypesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "entityMetadata", GoGetter: "EntityMetadata"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BedrockDataAutomationLibraryTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.bedrockDataAutomationLibrary.BedrockDataAutomationLibraryTagsList",
		reflect.TypeOf((*BedrockDataAutomationLibraryTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockDataAutomationLibraryTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
