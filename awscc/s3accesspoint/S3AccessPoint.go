...
func (j *jsiiProxy_S3AccessPoint) Tags() S3AccessPointTagsList {
	var returns S3AccessPointTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_S3AccessPoint) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (s *jsiiProxy_S3AccessPoint) PutTags(value interface{}) {
