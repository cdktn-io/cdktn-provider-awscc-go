...
func (j *jsiiProxy_DataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList {
	_init_.Initialize()
...
func NewDataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList_Override(d DataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccGuarddutyDetectorFeaturesAdditionalConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
