...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/pinpointinapptemplate/internal"
...
func (j *jsiiProxy_PinpointInAppTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PinpointInAppTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PinpointInAppTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PinpointInAppTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PinpointInAppTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_PinpointInAppTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PinpointInAppTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PinpointInAppTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PinpointInAppTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PinpointInAppTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointInAppTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PinpointInAppTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointInAppTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PinpointInAppTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PinpointInAppTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
