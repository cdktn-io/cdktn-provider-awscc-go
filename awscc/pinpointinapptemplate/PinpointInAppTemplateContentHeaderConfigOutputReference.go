...
func (j *jsiiProxy_PinpointInAppTemplateContentHeaderConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPinpointInAppTemplateContentHeaderConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PinpointInAppTemplateContentHeaderConfigOutputReference {
	_init_.Initialize()
...
func NewPinpointInAppTemplateContentHeaderConfigOutputReference_Override(p PinpointInAppTemplateContentHeaderConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PinpointInAppTemplateContentHeaderConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PinpointInAppTemplateContentHeaderConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointInAppTemplateContentHeaderConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PinpointInAppTemplateContentHeaderConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PinpointInAppTemplateContentHeaderConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
