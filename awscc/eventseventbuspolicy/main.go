...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EventsEventBusPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EventsEventBusPolicyCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.eventsEventBusPolicy.EventsEventBusPolicyConditionOutputReference",
		reflect.TypeOf((*EventsEventBusPolicyConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_EventsEventBusPolicyConditionOutputReference{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EventsEventBusPolicyConfig)(nil)).Elem(),
	)
}
