...
type OdbCloudVmCluster interface {
	...
	DbNodes() OdbCloudVmClusterDbNodesList
	DbNodesInput() interface{}
	...
	IamRoles() OdbCloudVmClusterIamRolesList
	IamRolesInput() interface{}
	Id() *string
	...
	PutDbNodes(value interface{})
	PutIamRoles(value interface{})
...
func (j *jsiiProxy_OdbCloudVmCluster) DbNodes() OdbCloudVmClusterDbNodesList {
	var returns OdbCloudVmClusterDbNodesList
	_jsii_.Get(
		j,
		"dbNodes",
		&returns,
...
func (j *jsiiProxy_OdbCloudVmCluster) DbNodesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dbNodesInput",
...
func (j *jsiiProxy_OdbCloudVmCluster) IamRoles() OdbCloudVmClusterIamRolesList {
	var returns OdbCloudVmClusterIamRolesList
	_jsii_.Get(
		j,
		"iamRoles",
		&returns,
...
func (j *jsiiProxy_OdbCloudVmCluster) IamRolesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"iamRolesInput",
...
func (o *jsiiProxy_OdbCloudVmCluster) PutDbNodes(value interface{}) {
	if err := o.validatePutDbNodesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		o,
...
func (o *jsiiProxy_OdbCloudVmCluster) PutIamRoles(value interface{}) {
	if err := o.validatePutIamRolesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		o,
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetDbNodes() {
	_jsii_.InvokeVoid(
		o,
		"resetDbNodes",
		nil, // no parameters
...
func (o *jsiiProxy_OdbCloudVmCluster) ResetIamRoles() {
	_jsii_.InvokeVoid(
		o,
		"resetIamRoles",
		nil, // no parameters
