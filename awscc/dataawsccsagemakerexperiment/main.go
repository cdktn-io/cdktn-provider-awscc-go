...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSagemakerExperiment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSagemakerExperimentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccSagemakerExperiment.DataAwsccSagemakerExperimentTags",
		reflect.TypeOf((*DataAwsccSagemakerExperimentTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccSagemakerExperiment.DataAwsccSagemakerExperimentTagsList",
		reflect.TypeOf((*DataAwsccSagemakerExperimentTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSagemakerExperimentTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccSagemakerExperimentTagsOutputReference{}
