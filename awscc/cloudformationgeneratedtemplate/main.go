...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudformationGeneratedTemplate)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "generatedTemplateId", GoGetter: "GeneratedTemplateId"},
			_jsii_.MemberProperty{JsiiProperty: "generatedTemplateName", GoGetter: "GeneratedTemplateName"},
			_jsii_.MemberProperty{JsiiProperty: "generatedTemplateNameInput", GoGetter: "GeneratedTemplateNameInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "totalWarnings", GoGetter: "TotalWarnings"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CloudformationGeneratedTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.cloudformationGeneratedTemplate.CloudformationGeneratedTemplateProgress",
		reflect.TypeOf((*CloudformationGeneratedTemplateProgress)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.cloudformationGeneratedTemplate.CloudformationGeneratedTemplateProgressOutputReference",
		reflect.TypeOf((*CloudformationGeneratedTemplateProgressOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "resourcesFailed", GoGetter: "ResourcesFailed"},
			_jsii_.MemberProperty{JsiiProperty: "resourcesPending", GoGetter: "ResourcesPending"},
			_jsii_.MemberProperty{JsiiProperty: "resourcesProcessing", GoGetter: "ResourcesProcessing"},
			_jsii_.MemberProperty{JsiiProperty: "resourcesSucceeded", GoGetter: "ResourcesSucceeded"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CloudformationGeneratedTemplateTemplateConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.cloudformationGeneratedTemplate.CloudformationGeneratedTemplateTemplateConfigurationOutputReference",
		reflect.TypeOf((*CloudformationGeneratedTemplateTemplateConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUpdateReplacePolicy", GoMethod: "ResetUpdateReplacePolicy"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "updateReplacePolicy", GoGetter: "UpdateReplacePolicy"},
			_jsii_.MemberProperty{JsiiProperty: "updateReplacePolicyInput", GoGetter: "UpdateReplacePolicyInput"},
		},
		func() interface{} {
