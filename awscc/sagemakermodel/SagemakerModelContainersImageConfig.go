...
type SagemakerModelContainersImageConfig struct {
	...
	RepositoryAuthConfig *SagemakerModelContainersImageConfigRepositoryAuthConfig `field:"optional" json:"repositoryAuthConfig" yaml:"repositoryAuthConfig"`
}
