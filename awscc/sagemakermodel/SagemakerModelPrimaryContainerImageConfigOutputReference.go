...
func (j *jsiiProxy_SagemakerModelPrimaryContainerImageConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerImageConfigOutputReference) RepositoryAuthConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerModelPrimaryContainerImageConfigOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerModelPrimaryContainerImageConfigOutputReference) ResetRepositoryAccessMode() {
	_jsii_.InvokeVoid(
		s,
		"resetRepositoryAccessMode",
		nil, // no parameters
