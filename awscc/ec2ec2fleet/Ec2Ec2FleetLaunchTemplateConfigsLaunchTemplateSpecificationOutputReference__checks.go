...
func (e *jsiiProxy_Ec2Ec2FleetLaunchTemplateConfigsLaunchTemplateSpecificationOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (e *jsiiProxy_Ec2Ec2FleetLaunchTemplateConfigsLaunchTemplateSpecificationOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_Ec2Ec2FleetLaunchTemplateConfigsLaunchTemplateSpecificationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *Ec2Ec2FleetLaunchTemplateConfigsLaunchTemplateSpecification; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Ec2Ec2FleetLaunchTemplateConfigsLaunchTemplateSpecificationOutputReference) validateSetLaunchTemplateSpecificationUserDataParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Ec2Ec2FleetLaunchTemplateConfigsLaunchTemplateSpecificationOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewEc2Ec2FleetLaunchTemplateConfigsLaunchTemplateSpecificationOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
