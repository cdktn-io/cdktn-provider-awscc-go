...
func NewVerifiedpermissionsPolicyDefinitionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VerifiedpermissionsPolicyDefinitionOutputReference {
	_init_.Initialize()
...
func NewVerifiedpermissionsPolicyDefinitionOutputReference_Override(v VerifiedpermissionsPolicyDefinitionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
