...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCertificatemanagerAcmeExternalAccountBindings)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCertificatemanagerAcmeExternalAccountBindingsConfig)(nil)).Elem(),
	)
}
