...
func (j *jsiiProxy_MediapackagePackagingConfigurationDashPackageDashManifestsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMediapackagePackagingConfigurationDashPackageDashManifestsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediapackagePackagingConfigurationDashPackageDashManifestsList {
	_init_.Initialize()
...
func NewMediapackagePackagingConfigurationDashPackageDashManifestsList_Override(m MediapackagePackagingConfigurationDashPackageDashManifestsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MediapackagePackagingConfigurationDashPackageDashManifestsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MediapackagePackagingConfigurationDashPackageDashManifestsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MediapackagePackagingConfigurationDashPackageDashManifestsList) Resolve(context cdktn.IResolveContext) interface{} {
