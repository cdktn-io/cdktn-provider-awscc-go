...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCloudwatchDashboardTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccCloudwatchDashboard.DataAwsccCloudwatchDashboardTagsList",
		reflect.TypeOf((*DataAwsccCloudwatchDashboardTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudwatchDashboardTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
