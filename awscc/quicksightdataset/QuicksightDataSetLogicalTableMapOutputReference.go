...
func NewQuicksightDataSetLogicalTableMapOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) QuicksightDataSetLogicalTableMapOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSetLogicalTableMapOutputReference_Override(q QuicksightDataSetLogicalTableMapOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
