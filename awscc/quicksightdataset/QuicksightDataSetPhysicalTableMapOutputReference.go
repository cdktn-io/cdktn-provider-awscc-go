...
func NewQuicksightDataSetPhysicalTableMapOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) QuicksightDataSetPhysicalTableMapOutputReference {
	_init_.Initialize()
...
func NewQuicksightDataSetPhysicalTableMapOutputReference_Override(q QuicksightDataSetPhysicalTableMapOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
