...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEcsTaskDefinitionVolumesS3FilesVolumeConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEcsTaskDefinitionVolumesS3FilesVolumeConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
