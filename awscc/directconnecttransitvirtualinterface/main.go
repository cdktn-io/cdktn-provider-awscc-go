...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectconnectTransitVirtualInterface)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allocateTransitVirtualInterfaceRoleArnInput", GoGetter: "AllocateTransitVirtualInterfaceRoleArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllocateTransitVirtualInterfaceRoleArn", GoMethod: "ResetAllocateTransitVirtualInterfaceRoleArn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DirectconnectTransitVirtualInterfaceBgpPeers)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.directconnectTransitVirtualInterface.DirectconnectTransitVirtualInterfaceBgpPeersList",
		reflect.TypeOf((*DirectconnectTransitVirtualInterfaceBgpPeersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectconnectTransitVirtualInterfaceBgpPeersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectconnectTransitVirtualInterfaceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
