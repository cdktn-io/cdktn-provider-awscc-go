...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueIdentityCenterConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUserBackgroundSessionsEnabled", GoMethod: "ResetUserBackgroundSessionsEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "userBackgroundSessionsEnabledInput", GoGetter: "UserBackgroundSessionsEnabledInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlueIdentityCenterConfigurationConfig)(nil)).Elem(),
	)
}
