...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference {
	_init_.Initialize()
...
func NewQuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference_Override(q QuicksightRefreshScheduleScheduleScheduleFrequencyOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
