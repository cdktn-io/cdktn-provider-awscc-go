...
type CassandraTable interface {
	...
	WarmThroughput() CassandraTableWarmThroughputOutputReference
	...
	PutWarmThroughput(value *CassandraTableWarmThroughput)
...
func (j *jsiiProxy_CassandraTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CassandraTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CassandraTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CassandraTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CassandraTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CassandraTable) WarmThroughput() CassandraTableWarmThroughputOutputReference {
	var returns CassandraTableWarmThroughputOutputReference
	_jsii_.Get(
		j,
		"warmThroughput",
		&returns,
...
func (j *jsiiProxy_CassandraTable) WarmThroughputInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"warmThroughputInput",
...
func (j *jsiiProxy_CassandraTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CassandraTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CassandraTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CassandraTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CassandraTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CassandraTable) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CassandraTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CassandraTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CassandraTable) PutWarmThroughput(value *CassandraTableWarmThroughput) {
	if err := c.validatePutWarmThroughputParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CassandraTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CassandraTable) ResetWarmThroughput() {
	_jsii_.InvokeVoid(
		c,
		"resetWarmThroughput",
		nil, // no parameters
...
func (c *jsiiProxy_CassandraTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
