...
func (j *jsiiProxy_DataAwsccMediapackagev2OriginEndpointLowLatencyHlsManifestsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccMediapackagev2OriginEndpointLowLatencyHlsManifestsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccMediapackagev2OriginEndpointLowLatencyHlsManifestsList {
	_init_.Initialize()
...
func NewDataAwsccMediapackagev2OriginEndpointLowLatencyHlsManifestsList_Override(d DataAwsccMediapackagev2OriginEndpointLowLatencyHlsManifestsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccMediapackagev2OriginEndpointLowLatencyHlsManifestsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccMediapackagev2OriginEndpointLowLatencyHlsManifestsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccMediapackagev2OriginEndpointLowLatencyHlsManifestsList) Resolve(context cdktn.IResolveContext) interface{} {
