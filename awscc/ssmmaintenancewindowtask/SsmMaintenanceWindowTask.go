...
type SsmMaintenanceWindowTask interface {
	...
	LoggingInfo() SsmMaintenanceWindowTaskLoggingInfoOutputReference
	...
	TaskInvocationParametersInput() interface{}
	TaskParameters() *string
	SetTaskParameters(val *string)
	TaskParametersInput() *string
	TaskType() *string
	...
	PutLoggingInfo(value *SsmMaintenanceWindowTaskLoggingInfo)
...
func (j *jsiiProxy_SsmMaintenanceWindowTask) LoggingInfo() SsmMaintenanceWindowTaskLoggingInfoOutputReference {
	var returns SsmMaintenanceWindowTaskLoggingInfoOutputReference
	_jsii_.Get(
		j,
		"loggingInfo",
		&returns,
...
func (j *jsiiProxy_SsmMaintenanceWindowTask) LoggingInfoInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"loggingInfoInput",
...
func (j *jsiiProxy_SsmMaintenanceWindowTask) TaskInvocationParametersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SsmMaintenanceWindowTask) TaskParameters() *string {
	var returns *string
	_jsii_.Get(
		j,
		"taskParameters",
...
func (j *jsiiProxy_SsmMaintenanceWindowTask) TaskParametersInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"taskParametersInput",
...
func (j *jsiiProxy_SsmMaintenanceWindowTask)SetTaskParameters(val *string) {
...
func (s *jsiiProxy_SsmMaintenanceWindowTask) PutLoggingInfo(value *SsmMaintenanceWindowTaskLoggingInfo) {
	if err := s.validatePutLoggingInfoParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SsmMaintenanceWindowTask) ResetLoggingInfo() {
	_jsii_.InvokeVoid(
		s,
		"resetLoggingInfo",
		nil, // no parameters
...
func (s *jsiiProxy_SsmMaintenanceWindowTask) ResetTaskParameters() {
	_jsii_.InvokeVoid(
		s,
		"resetTaskParameters",
		nil, // no parameters
