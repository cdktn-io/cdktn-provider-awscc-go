...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DocdbGlobalClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.docdbGlobalCluster.DocdbGlobalClusterTagsList",
		reflect.TypeOf((*DocdbGlobalClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DocdbGlobalClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
