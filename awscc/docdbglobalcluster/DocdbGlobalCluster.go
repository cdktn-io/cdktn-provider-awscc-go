...
func (j *jsiiProxy_DocdbGlobalCluster) GlobalClusterArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"globalClusterArn",
...
func (j *jsiiProxy_DocdbGlobalCluster) Tags() DocdbGlobalClusterTagsList {
	var returns DocdbGlobalClusterTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_DocdbGlobalCluster) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (d *jsiiProxy_DocdbGlobalCluster) PutTags(value interface{}) {
...
func (d *jsiiProxy_DocdbGlobalCluster) ResetTags() {
	_jsii_.InvokeVoid(
		d,
		"resetTags",
		nil, // no parameters
