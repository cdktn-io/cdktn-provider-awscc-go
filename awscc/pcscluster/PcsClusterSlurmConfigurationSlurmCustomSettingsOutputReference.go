...
func (j *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference {
	_init_.Initialize()
...
func NewPcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference_Override(p PcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PcsClusterSlurmConfigurationSlurmCustomSettingsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
