...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCloudformationLambdaHookLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccCloudformationLambdaHook.DataAwsccCloudformationLambdaHookLoggingConfigOutputReference",
		reflect.TypeOf((*DataAwsccCloudformationLambdaHookLoggingConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
