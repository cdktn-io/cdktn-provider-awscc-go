...
func (o *jsiiProxy_OmicsWorkflowParameterTemplateMap) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_OmicsWorkflowParameterTemplateMap) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}

func validateNewOmicsWorkflowParameterTemplateMapParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
	return nil
}
