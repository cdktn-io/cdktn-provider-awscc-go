...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/codepipeline_pipeline awscc_codepipeline_pipeline}.
...
func (j *jsiiProxy_CodepipelinePipeline) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_CodepipelinePipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CodepipelinePipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CodepipelinePipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CodepipelinePipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CodepipelinePipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/codepipeline_pipeline awscc_codepipeline_pipeline} Resource.
...
func (j *jsiiProxy_CodepipelinePipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CodepipelinePipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CodepipelinePipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CodepipelinePipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CodepipelinePipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelinePipeline) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CodepipelinePipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CodepipelinePipeline) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CodepipelinePipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CodepipelinePipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
