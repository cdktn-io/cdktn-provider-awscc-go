...
type CodepipelinePipelineStagesOnFailureRetryConfiguration struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/codepipeline_pipeline#retry_mode CodepipelinePipeline#retry_mode}
