...
type CodepipelinePipelineStagesActionsOutputArtifacts struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.96.0/docs/resources/codepipeline_pipeline#files CodepipelinePipeline#files}
