...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCleanroomsPrivacyBudgetTemplateParametersBudgetParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCleanroomsPrivacyBudgetTemplateParametersBudgetParametersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCleanroomsPrivacyBudgetTemplateParametersBudgetParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "autoRefresh", GoGetter: "AutoRefresh"},
