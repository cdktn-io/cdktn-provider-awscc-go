...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ssmmaintenancewindowtarget/internal"
...
func (j *jsiiProxy_SsmMaintenanceWindowTarget) WindowTargetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"windowTargetId",
