...
func (j *jsiiProxy_ConfigOrganizationConformancePack) OrganizationConformancePackArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConfigOrganizationConformancePack) Tags() ConfigOrganizationConformancePackTagsList {
	var returns ConfigOrganizationConformancePackTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ConfigOrganizationConformancePack) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (c *jsiiProxy_ConfigOrganizationConformancePack) PutTags(value interface{}) {
...
func (c *jsiiProxy_ConfigOrganizationConformancePack) ResetTags() {
	_jsii_.InvokeVoid(
		c,
		"resetTags",
		nil, // no parameters
