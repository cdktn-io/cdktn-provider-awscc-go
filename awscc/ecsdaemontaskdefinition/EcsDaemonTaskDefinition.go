...
type EcsDaemonTaskDefinition interface {
	...
	ContainerDefinitions() EcsDaemonTaskDefinitionContainerDefinitionsList
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) ContainerDefinitions() EcsDaemonTaskDefinitionContainerDefinitionsList {
	var returns EcsDaemonTaskDefinitionContainerDefinitionsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) ContainerDefinitionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) DaemonTaskDefinitionArn() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) IpcMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipcMode",
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) IpcModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipcModeInput",
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) PidMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pidMode",
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) PidModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pidModeInput",
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) Tags() EcsDaemonTaskDefinitionTagsList {
	var returns EcsDaemonTaskDefinitionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) Volumes() EcsDaemonTaskDefinitionVolumesList {
	var returns EcsDaemonTaskDefinitionVolumesList
	_jsii_.Get(
		j,
		"volumes",
		&returns,
...
func (j *jsiiProxy_EcsDaemonTaskDefinition) VolumesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"volumesInput",
...
func NewEcsDaemonTaskDefinition(scope constructs.Construct, id *string, config *EcsDaemonTaskDefinitionConfig) EcsDaemonTaskDefinition {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.ecsDaemonTaskDefinition.EcsDaemonTaskDefinition",
...
func (j *jsiiProxy_EcsDaemonTaskDefinition)SetIpcMode(val *string) {
...
func (j *jsiiProxy_EcsDaemonTaskDefinition)SetPidMode(val *string) {
...
func (e *jsiiProxy_EcsDaemonTaskDefinition) PutContainerDefinitions(value interface{}) {
...
func (e *jsiiProxy_EcsDaemonTaskDefinition) PutTags(value interface{}) {
...
func (e *jsiiProxy_EcsDaemonTaskDefinition) PutVolumes(value interface{}) {
...
func (e *jsiiProxy_EcsDaemonTaskDefinition) ResetContainerDefinitions() {
	_jsii_.InvokeVoid(
		e,
		"resetContainerDefinitions",
		nil, // no parameters
...
func (e *jsiiProxy_EcsDaemonTaskDefinition) ResetFamily() {
	_jsii_.InvokeVoid(
		e,
		"resetFamily",
		nil, // no parameters
...
func (e *jsiiProxy_EcsDaemonTaskDefinition) ResetIpcMode() {
	_jsii_.InvokeVoid(
		e,
		"resetIpcMode",
		nil, // no parameters
...
func (e *jsiiProxy_EcsDaemonTaskDefinition) ResetPidMode() {
	_jsii_.InvokeVoid(
		e,
		"resetPidMode",
		nil, // no parameters
...
func (e *jsiiProxy_EcsDaemonTaskDefinition) ResetVolumes() {
	_jsii_.InvokeVoid(
		e,
		"resetVolumes",
		nil, // no parameters
