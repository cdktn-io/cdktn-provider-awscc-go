...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccWorkspaceswebPortal)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccWorkspaceswebPortalConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccWorkspaceswebPortal.DataAwsccWorkspaceswebPortalTags",
		reflect.TypeOf((*DataAwsccWorkspaceswebPortalTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccWorkspaceswebPortal.DataAwsccWorkspaceswebPortalTagsList",
		reflect.TypeOf((*DataAwsccWorkspaceswebPortalTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccWorkspaceswebPortalTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
