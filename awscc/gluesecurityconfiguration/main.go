...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfiguration",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfigurationConfig",
		reflect.TypeOf((*GlueSecurityConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfiguration",
		reflect.TypeOf((*GlueSecurityConfigurationEncryptionConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationCloudwatchEncryption",
		reflect.TypeOf((*GlueSecurityConfigurationEncryptionConfigurationCloudwatchEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationCloudwatchEncryptionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationJobBookmarksEncryption",
		reflect.TypeOf((*GlueSecurityConfigurationEncryptionConfigurationJobBookmarksEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationJobBookmarksEncryptionOutputReference",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putS3Encryptions", GoMethod: "PutS3Encryptions"},
			_jsii_.MemberMethod{JsiiMethod: "resetCloudwatchEncryption", GoMethod: "ResetCloudwatchEncryption"},
			_jsii_.MemberMethod{JsiiMethod: "resetJobBookmarksEncryption", GoMethod: "ResetJobBookmarksEncryption"},
			_jsii_.MemberMethod{JsiiMethod: "resetS3Encryptions", GoMethod: "ResetS3Encryptions"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "s3Encryptions", GoGetter: "S3Encryptions"},
			_jsii_.MemberProperty{JsiiProperty: "s3EncryptionsInput", GoGetter: "S3EncryptionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationS3Encryptions",
		reflect.TypeOf((*GlueSecurityConfigurationEncryptionConfigurationS3Encryptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationS3EncryptionsList",
		reflect.TypeOf((*GlueSecurityConfigurationEncryptionConfigurationS3EncryptionsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueSecurityConfigurationEncryptionConfigurationS3EncryptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
