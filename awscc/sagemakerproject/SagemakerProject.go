...
type SagemakerProject interface {
	...
	TagsInput() interface{}
	TemplateProviderDetails() SagemakerProjectTemplateProviderDetailsList
	TemplateProviderDetailsInput() interface{}
	// Experimental.
	...
	PutTemplateProviderDetails(value interface{})
	...
	ResetServiceCatalogProvisioningDetails()
	ResetTags()
	ResetTemplateProviderDetails()
...
func (j *jsiiProxy_SagemakerProject) TemplateProviderDetails() SagemakerProjectTemplateProviderDetailsList {
	var returns SagemakerProjectTemplateProviderDetailsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerProject) TemplateProviderDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"templateProviderDetailsInput",
		&returns,
	)
	return returns
}
...
func (s *jsiiProxy_SagemakerProject) PutTemplateProviderDetails(value interface{}) {
	if err := s.validatePutTemplateProviderDetailsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
		"putTemplateProviderDetails",
		[]interface{}{value},
	)
}
...
func (s *jsiiProxy_SagemakerProject) ResetServiceCatalogProvisioningDetails() {
	_jsii_.InvokeVoid(
		s,
		"resetServiceCatalogProvisioningDetails",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerProject) ResetTemplateProviderDetails() {
	_jsii_.InvokeVoid(
		s,
		"resetTemplateProviderDetails",
		nil, // no parameters
