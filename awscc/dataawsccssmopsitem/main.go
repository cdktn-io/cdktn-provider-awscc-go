...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsmOpsItem)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "opsItemArn", GoGetter: "OpsItemArn"},
			_jsii_.MemberProperty{JsiiProperty: "opsItemId", GoGetter: "OpsItemId"},
			_jsii_.MemberProperty{JsiiProperty: "opsItemType", GoGetter: "OpsItemType"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSsmOpsItemConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTags",
		reflect.TypeOf((*DataAwsccSsmOpsItemTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccSsmOpsItem.DataAwsccSsmOpsItemTagsList",
		reflect.TypeOf((*DataAwsccSsmOpsItemTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsmOpsItemTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccSsmOpsItemTagsOutputReference{}
