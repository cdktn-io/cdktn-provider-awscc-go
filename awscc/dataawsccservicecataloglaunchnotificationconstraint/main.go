...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccServicecatalogLaunchNotificationConstraint)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "launchNotificationConstraintId", GoGetter: "LaunchNotificationConstraintId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccServicecatalogLaunchNotificationConstraintConfig)(nil)).Elem(),
	)
}
