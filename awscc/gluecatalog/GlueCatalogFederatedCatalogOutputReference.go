...
func NewGlueCatalogFederatedCatalogOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GlueCatalogFederatedCatalogOutputReference {
	_init_.Initialize()

	if err := validateNewGlueCatalogFederatedCatalogOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewGlueCatalogFederatedCatalogOutputReference_Override(g GlueCatalogFederatedCatalogOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
