...
func (j *jsiiProxy_AppstreamStackApplicationSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_AppstreamStackApplicationSettingsOutputReference)SetInternalValue(val interface{}) {
