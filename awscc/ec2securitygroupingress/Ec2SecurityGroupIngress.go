...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ec2securitygroupingress/internal"
...
func (j *jsiiProxy_Ec2SecurityGroupIngress) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2SecurityGroupIngress) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2SecurityGroupIngress) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2SecurityGroupIngress) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2SecurityGroupIngress) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2SecurityGroupIngress)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2SecurityGroupIngress)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2SecurityGroupIngress)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2SecurityGroupIngress_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2SecurityGroupIngress) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2SecurityGroupIngress) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2SecurityGroupIngress) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2SecurityGroupIngress) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2SecurityGroupIngress) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2SecurityGroupIngress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
