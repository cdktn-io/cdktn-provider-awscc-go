...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDirectconnectDirectConnectGateway)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDirectconnectDirectConnectGatewayTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
