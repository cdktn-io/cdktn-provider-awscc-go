...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/lightsailalarm/internal"
...
func (j *jsiiProxy_LightsailAlarm) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LightsailAlarm) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LightsailAlarm) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailAlarm) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LightsailAlarm) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LightsailAlarm)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailAlarm)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailAlarm)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LightsailAlarm_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailAlarm) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailAlarm) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LightsailAlarm) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailAlarm) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailAlarm) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailAlarm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
