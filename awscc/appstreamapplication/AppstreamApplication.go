...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/appstreamapplication/internal"
...
func (j *jsiiProxy_AppstreamApplication) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AppstreamApplication) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AppstreamApplication) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AppstreamApplication) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AppstreamApplication) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AppstreamApplication)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AppstreamApplication)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AppstreamApplication)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AppstreamApplication_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AppstreamApplication) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamApplication) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AppstreamApplication) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AppstreamApplication) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AppstreamApplication) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AppstreamApplication) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
