...
func NewBackupRestoreTestingSelectionProtectedResourceConditionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BackupRestoreTestingSelectionProtectedResourceConditionsOutputReference {
	_init_.Initialize()
...
func NewBackupRestoreTestingSelectionProtectedResourceConditionsOutputReference_Override(b BackupRestoreTestingSelectionProtectedResourceConditionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
