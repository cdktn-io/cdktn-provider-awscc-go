...
type GlueConnection interface {
	...
	ConnectionInput() GlueConnectionConnectionInputOutputReference
	ConnectionInputInput() interface{}
	// Experimental.
	...
	PutConnectionInput(value *GlueConnectionConnectionInput)
...
func (j *jsiiProxy_GlueConnection) ConnectionInput() GlueConnectionConnectionInputOutputReference {
	var returns GlueConnectionConnectionInputOutputReference
	_jsii_.Get(
		j,
		"connectionInput",
		&returns,
...
func (j *jsiiProxy_GlueConnection) ConnectionInputInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connectionInputInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_GlueConnection) Tags() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_GlueConnection) TagsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_GlueConnection)SetTags(val *string) {
...
func (g *jsiiProxy_GlueConnection) PutConnectionInput(value *GlueConnectionConnectionInput) {
	if err := g.validatePutConnectionInputParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
