...
func (j *jsiiProxy_KendraQuerySuggestionsBlockList) SourceS3PathInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sourceS3PathInput",
...
func (j *jsiiProxy_KendraQuerySuggestionsBlockList) Tags() KendraQuerySuggestionsBlockListTagsList {
	var returns KendraQuerySuggestionsBlockListTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_KendraQuerySuggestionsBlockList) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewKendraQuerySuggestionsBlockList(scope constructs.Construct, id *string, config *KendraQuerySuggestionsBlockListConfig) KendraQuerySuggestionsBlockList {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.kendraQuerySuggestionsBlockList.KendraQuerySuggestionsBlockList",
...
func (k *jsiiProxy_KendraQuerySuggestionsBlockList) PutTags(value interface{}) {
