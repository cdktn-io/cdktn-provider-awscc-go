...
type DataAwsccMedialiveSignalMap interface {
	...
	ForceRediscovery() cdktn.IResolvable
	// Experimental.
	...
	ModifiedAt() *string
	MonitorChangesPendingDeployment() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap) ForceRediscovery() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap) MonitorChangesPendingDeployment() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/medialive_signal_map awscc_medialive_signal_map} Data Source.
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccMedialiveSignalMap)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccMedialiveSignalMap_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccMedialiveSignalMap) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccMedialiveSignalMap) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccMedialiveSignalMap) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccMedialiveSignalMap) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
