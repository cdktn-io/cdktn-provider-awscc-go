...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockAutomatedReasoningPolicyVersion)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "definitionHash", GoGetter: "DefinitionHash"},
			...
			_jsii_.MemberProperty{JsiiProperty: "lastUpdatedDefinitionHashInput", GoGetter: "LastUpdatedDefinitionHashInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLastUpdatedDefinitionHash", GoMethod: "ResetLastUpdatedDefinitionHash"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockAutomatedReasoningPolicyVersionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
