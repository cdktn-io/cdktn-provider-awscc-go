...
func (j *jsiiProxy_GlueIntegrationTagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*GlueIntegrationTags; received %#v (a %T)", val, val)
		}
	}
