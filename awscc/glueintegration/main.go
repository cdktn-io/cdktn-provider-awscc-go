...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueIntegration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlueIntegrationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.glueIntegration.GlueIntegrationIntegrationConfig",
		reflect.TypeOf((*GlueIntegrationIntegrationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.glueIntegration.GlueIntegrationIntegrationConfigOutputReference",
		reflect.TypeOf((*GlueIntegrationIntegrationConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "continuousSync", GoGetter: "ContinuousSync"},
			_jsii_.MemberProperty{JsiiProperty: "continuousSyncInput", GoGetter: "ContinuousSyncInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetContinuousSync", GoMethod: "ResetContinuousSync"},
			_jsii_.MemberMethod{JsiiMethod: "resetRefreshInterval", GoMethod: "ResetRefreshInterval"},
			_jsii_.MemberMethod{JsiiMethod: "resetSourceProperties", GoMethod: "ResetSourceProperties"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sourceProperties", GoGetter: "SourceProperties"},
			_jsii_.MemberProperty{JsiiProperty: "sourcePropertiesInput", GoGetter: "SourcePropertiesInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlueIntegrationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.glueIntegration.GlueIntegrationTagsList",
		reflect.TypeOf((*GlueIntegrationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GlueIntegrationTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueIntegrationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
