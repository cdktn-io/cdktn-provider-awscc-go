...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2TransitGatewayPolicyTableTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ec2TransitGatewayPolicyTable.Ec2TransitGatewayPolicyTableTagsList",
		reflect.TypeOf((*Ec2TransitGatewayPolicyTableTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2TransitGatewayPolicyTableTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
