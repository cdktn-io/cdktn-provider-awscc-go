...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ec2subnet/internal"
...
func (j *jsiiProxy_Ec2Subnet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2Subnet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2Subnet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2Subnet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2Subnet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/ec2_subnet awscc_ec2_subnet} Resource.
...
func (j *jsiiProxy_Ec2Subnet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2Subnet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2Subnet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2Subnet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2Subnet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2Subnet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2Subnet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2Subnet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2Subnet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2Subnet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
