...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueIntegrationResourceProperty)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSourceProcessingProperties", GoMethod: "PutSourceProcessingProperties"},
			_jsii_.MemberMethod{JsiiMethod: "putTags", GoMethod: "PutTags"},
			_jsii_.MemberMethod{JsiiMethod: "putTargetProcessingProperties", GoMethod: "PutTargetProcessingProperties"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "registerProviderFeatureUsage", GoMethod: "RegisterProviderFeatureUsage"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSourceProcessingProperties", GoMethod: "ResetSourceProcessingProperties"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTargetProcessingProperties", GoMethod: "ResetTargetProcessingProperties"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourcePropertyArn", GoGetter: "ResourcePropertyArn"},
			_jsii_.MemberProperty{JsiiProperty: "sourceProcessingProperties", GoGetter: "SourceProcessingProperties"},
			_jsii_.MemberProperty{JsiiProperty: "sourceProcessingPropertiesInput", GoGetter: "SourceProcessingPropertiesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetProcessingPropertiesInput", GoGetter: "TargetProcessingPropertiesInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlueIntegrationResourcePropertyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.glueIntegrationResourceProperty.GlueIntegrationResourcePropertySourceProcessingProperties",
		reflect.TypeOf((*GlueIntegrationResourcePropertySourceProcessingProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueIntegrationResourcePropertySourceProcessingPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlueIntegrationResourcePropertyTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.glueIntegrationResourceProperty.GlueIntegrationResourcePropertyTagsList",
		reflect.TypeOf((*GlueIntegrationResourcePropertyTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueIntegrationResourcePropertyTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlueIntegrationResourcePropertyTargetProcessingProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlueIntegrationResourcePropertyTargetProcessingPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_GlueIntegrationResourcePropertyTargetProcessingPropertiesOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
