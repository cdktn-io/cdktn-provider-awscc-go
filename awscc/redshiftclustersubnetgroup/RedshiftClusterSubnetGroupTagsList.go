...
func (j *jsiiProxy_RedshiftClusterSubnetGroupTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewRedshiftClusterSubnetGroupTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) RedshiftClusterSubnetGroupTagsList {
	_init_.Initialize()
...
func NewRedshiftClusterSubnetGroupTagsList_Override(r RedshiftClusterSubnetGroupTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_RedshiftClusterSubnetGroupTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_RedshiftClusterSubnetGroupTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedshiftClusterSubnetGroupTagsList) Resolve(context cdktn.IResolveContext) interface{} {
