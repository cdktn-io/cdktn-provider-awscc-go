...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "internetProtocolInput", GoGetter: "InternetProtocolInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAssociateDefaultSecurityGroup", GoMethod: "ResetAssociateDefaultSecurityGroup"},
			_jsii_.MemberMethod{JsiiMethod: "resetAutoReplicateNewDisks", GoMethod: "ResetAutoReplicateNewDisks"},
			_jsii_.MemberMethod{JsiiMethod: "resetCreatePublicIp", GoMethod: "ResetCreatePublicIp"},
			_jsii_.MemberMethod{JsiiMethod: "resetDataPlaneRouting", GoMethod: "ResetDataPlaneRouting"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultLargeStagingDiskType", GoMethod: "ResetDefaultLargeStagingDiskType"},
			_jsii_.MemberMethod{JsiiMethod: "resetEbsEncryptionKeyArn", GoMethod: "ResetEbsEncryptionKeyArn"},
			_jsii_.MemberMethod{JsiiMethod: "resetInternetProtocol", GoMethod: "ResetInternetProtocol"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetReplicationServerInstanceType", GoMethod: "ResetReplicationServerInstanceType"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetUseDedicatedReplicationServer", GoMethod: "ResetUseDedicatedReplicationServer"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplateConfig",
		reflect.TypeOf((*DrsReplicationConfigurationTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplatePitPolicy",
		reflect.TypeOf((*DrsReplicationConfigurationTemplatePitPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplatePitPolicyList",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplateTags",
		reflect.TypeOf((*DrsReplicationConfigurationTemplateTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplateTagsList",
		reflect.TypeOf((*DrsReplicationConfigurationTemplateTagsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DrsReplicationConfigurationTemplateTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
