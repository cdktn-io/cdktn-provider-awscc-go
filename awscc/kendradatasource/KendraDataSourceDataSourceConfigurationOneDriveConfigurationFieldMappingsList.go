...
func (j *jsiiProxy_KendraDataSourceDataSourceConfigurationOneDriveConfigurationFieldMappingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKendraDataSourceDataSourceConfigurationOneDriveConfigurationFieldMappingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KendraDataSourceDataSourceConfigurationOneDriveConfigurationFieldMappingsList {
	_init_.Initialize()
...
func NewKendraDataSourceDataSourceConfigurationOneDriveConfigurationFieldMappingsList_Override(k KendraDataSourceDataSourceConfigurationOneDriveConfigurationFieldMappingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KendraDataSourceDataSourceConfigurationOneDriveConfigurationFieldMappingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KendraDataSourceDataSourceConfigurationOneDriveConfigurationFieldMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KendraDataSourceDataSourceConfigurationOneDriveConfigurationFieldMappingsList) Resolve(context cdktn.IResolveContext) interface{} {
