...
type DataAwsccCodepipelinePipeline interface {
	...
	RestartExecutionOnUpdate() cdktn.IResolvable
	RoleArn() *string
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline) RestartExecutionOnUpdate() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/codepipeline_pipeline awscc_codepipeline_pipeline} Data Source.
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCodepipelinePipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCodepipelinePipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCodepipelinePipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCodepipelinePipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCodepipelinePipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCodepipelinePipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
