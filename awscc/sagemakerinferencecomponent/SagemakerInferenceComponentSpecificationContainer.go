...
type SagemakerInferenceComponentSpecificationContainer struct {
	...
	ContainerMetricsConfig *SagemakerInferenceComponentSpecificationContainerContainerMetricsConfig `field:"optional" json:"containerMetricsConfig" yaml:"containerMetricsConfig"`
