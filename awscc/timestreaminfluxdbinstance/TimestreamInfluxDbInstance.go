...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/timestreaminfluxdbinstance/internal"
...
type TimestreamInfluxDbInstance interface {
	...
	MaintenanceSchedule() TimestreamInfluxDbInstanceMaintenanceScheduleOutputReference
	...
	PutMaintenanceSchedule(value *TimestreamInfluxDbInstanceMaintenanceSchedule)
...
func (j *jsiiProxy_TimestreamInfluxDbInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_TimestreamInfluxDbInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_TimestreamInfluxDbInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_TimestreamInfluxDbInstance) MaintenanceSchedule() TimestreamInfluxDbInstanceMaintenanceScheduleOutputReference {
	var returns TimestreamInfluxDbInstanceMaintenanceScheduleOutputReference
	_jsii_.Get(
		j,
		"maintenanceSchedule",
		&returns,
...
func (j *jsiiProxy_TimestreamInfluxDbInstance) MaintenanceScheduleInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TimestreamInfluxDbInstance) NextMaintenanceTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nextMaintenanceTime",
...
func (j *jsiiProxy_TimestreamInfluxDbInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_TimestreamInfluxDbInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_TimestreamInfluxDbInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_TimestreamInfluxDbInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_TimestreamInfluxDbInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func TimestreamInfluxDbInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (t *jsiiProxy_TimestreamInfluxDbInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TimestreamInfluxDbInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (t *jsiiProxy_TimestreamInfluxDbInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TimestreamInfluxDbInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TimestreamInfluxDbInstance) PutMaintenanceSchedule(value *TimestreamInfluxDbInstanceMaintenanceSchedule) {
...
func (t *jsiiProxy_TimestreamInfluxDbInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TimestreamInfluxDbInstance) ResetMaintenanceSchedule() {
	_jsii_.InvokeVoid(
		t,
		"resetMaintenanceSchedule",
		nil, // no parameters
...
func (t *jsiiProxy_TimestreamInfluxDbInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
