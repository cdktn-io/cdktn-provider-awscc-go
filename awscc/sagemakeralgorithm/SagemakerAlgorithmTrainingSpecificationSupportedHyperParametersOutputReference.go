...
type SagemakerAlgorithmTrainingSpecificationSupportedHyperParametersOutputReference interface {
	...
	PutRange(value *SagemakerAlgorithmTrainingSpecificationSupportedHyperParametersRange)
	ResetDefaultValue()
	ResetDescription()
	ResetIsRequired()
	ResetIsTunable()
...
func (j *jsiiProxy_SagemakerAlgorithmTrainingSpecificationSupportedHyperParametersOutputReference) Range() SagemakerAlgorithmTrainingSpecificationSupportedHyperParametersRangeOutputReference {
...
func (s *jsiiProxy_SagemakerAlgorithmTrainingSpecificationSupportedHyperParametersOutputReference) PutRange(value *SagemakerAlgorithmTrainingSpecificationSupportedHyperParametersRange) {
...
func (s *jsiiProxy_SagemakerAlgorithmTrainingSpecificationSupportedHyperParametersOutputReference) ResetName() {
	_jsii_.InvokeVoid(
		s,
		"resetName",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerAlgorithmTrainingSpecificationSupportedHyperParametersOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		s,
		"resetType",
		nil, // no parameters
