...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReference {
	_init_.Initialize()
...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReference_Override(e Ec2NetworkInsightsAnalysisForwardPathComponentsInboundHeaderOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
