...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReference {
	_init_.Initialize()
...
func NewEc2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReference_Override(e Ec2NetworkInsightsAnalysisForwardPathComponentsRouteTableRouteOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
