...
func NewEc2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReference {
	_init_.Initialize()
...
func NewEc2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReference_Override(e Ec2NetworkInsightsAnalysisReturnPathComponentsRouteTableRouteOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
