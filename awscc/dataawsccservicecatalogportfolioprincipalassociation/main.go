...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccServicecatalogPortfolioPrincipalAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccServicecatalogPortfolioPrincipalAssociationConfig)(nil)).Elem(),
	)
}
