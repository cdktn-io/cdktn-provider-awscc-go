...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/cognitouserpoolclient/internal"
...
func NewCognitoUserPoolClientRefreshTokenRotationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CognitoUserPoolClientRefreshTokenRotationOutputReference {
	_init_.Initialize()
...
func NewCognitoUserPoolClientRefreshTokenRotationOutputReference_Override(c CognitoUserPoolClientRefreshTokenRotationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
