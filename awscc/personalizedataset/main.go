...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.personalizeDataset.PersonalizeDatasetTags",
		reflect.TypeOf((*PersonalizeDatasetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.personalizeDataset.PersonalizeDatasetTagsList",
		reflect.TypeOf((*PersonalizeDatasetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_PersonalizeDatasetTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PersonalizeDatasetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
