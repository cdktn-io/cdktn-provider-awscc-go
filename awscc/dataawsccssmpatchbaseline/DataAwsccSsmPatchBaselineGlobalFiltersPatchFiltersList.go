...
func (j *jsiiProxy_DataAwsccSsmPatchBaselineGlobalFiltersPatchFiltersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccSsmPatchBaselineGlobalFiltersPatchFiltersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccSsmPatchBaselineGlobalFiltersPatchFiltersList {
	_init_.Initialize()
...
func NewDataAwsccSsmPatchBaselineGlobalFiltersPatchFiltersList_Override(d DataAwsccSsmPatchBaselineGlobalFiltersPatchFiltersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccSsmPatchBaselineGlobalFiltersPatchFiltersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccSsmPatchBaselineGlobalFiltersPatchFiltersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccSsmPatchBaselineGlobalFiltersPatchFiltersList) Resolve(context cdktn.IResolveContext) interface{} {
