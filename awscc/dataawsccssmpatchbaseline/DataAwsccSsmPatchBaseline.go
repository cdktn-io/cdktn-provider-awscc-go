...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccssmpatchbaseline/internal"
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline) ApprovedPatchesEnableNonSecurity() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline) AvailableSecurityUpdatesComplianceStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline) DefaultBaseline() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"defaultBaseline",
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccSsmPatchBaseline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccSsmPatchBaseline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccSsmPatchBaseline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSsmPatchBaseline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSsmPatchBaseline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccSsmPatchBaseline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
