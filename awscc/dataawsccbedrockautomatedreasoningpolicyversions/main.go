...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockAutomatedReasoningPolicyVersions)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccBedrockAutomatedReasoningPolicyVersionsConfig)(nil)).Elem(),
	)
}
