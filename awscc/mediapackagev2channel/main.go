...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "preferredInputInput", GoGetter: "PreferredInputInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetMqcsInputSwitching", GoMethod: "ResetMqcsInputSwitching"},
			_jsii_.MemberMethod{JsiiMethod: "resetPreferredInput", GoMethod: "ResetPreferredInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
