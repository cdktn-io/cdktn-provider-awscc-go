...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccBedrockGuardrailAutomatedReasoningPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccBedrockGuardrail.DataAwsccBedrockGuardrailAutomatedReasoningPolicyConfigOutputReference",
		reflect.TypeOf((*DataAwsccBedrockGuardrailAutomatedReasoningPolicyConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
