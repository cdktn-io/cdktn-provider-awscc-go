...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSesDedicatedIpPoolTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccSesDedicatedIpPool.DataAwsccSesDedicatedIpPoolTagsList",
		reflect.TypeOf((*DataAwsccSesDedicatedIpPoolTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSesDedicatedIpPoolTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
