...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlueIntegration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccGlueIntegrationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccGlueIntegration.DataAwsccGlueIntegrationIntegrationConfig",
		reflect.TypeOf((*DataAwsccGlueIntegrationIntegrationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccGlueIntegration.DataAwsccGlueIntegrationIntegrationConfigOutputReference",
		reflect.TypeOf((*DataAwsccGlueIntegrationIntegrationConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccGlueIntegrationIntegrationConfigOutputReference{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccGlueIntegrationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccGlueIntegration.DataAwsccGlueIntegrationTagsList",
		reflect.TypeOf((*DataAwsccGlueIntegrationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlueIntegrationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
