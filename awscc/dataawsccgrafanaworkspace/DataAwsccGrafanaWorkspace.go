...
type DataAwsccGrafanaWorkspace interface {
	...
	PluginAdminEnabled() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace) PluginAdminEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace) Tags() DataAwsccGrafanaWorkspaceTagsList {
	var returns DataAwsccGrafanaWorkspaceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccGrafanaWorkspace)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccGrafanaWorkspace_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccGrafanaWorkspace) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccGrafanaWorkspace) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccGrafanaWorkspace) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccGrafanaWorkspace) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
