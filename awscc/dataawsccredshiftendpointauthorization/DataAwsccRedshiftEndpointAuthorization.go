...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccredshiftendpointauthorization/internal"
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) AllowedAllVpCs() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) Force() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"force",
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccRedshiftEndpointAuthorization)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccRedshiftEndpointAuthorization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccRedshiftEndpointAuthorization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
