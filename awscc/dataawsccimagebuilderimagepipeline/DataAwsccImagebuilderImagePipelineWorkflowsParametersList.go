...
func (j *jsiiProxy_DataAwsccImagebuilderImagePipelineWorkflowsParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccImagebuilderImagePipelineWorkflowsParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccImagebuilderImagePipelineWorkflowsParametersList {
	_init_.Initialize()
...
func NewDataAwsccImagebuilderImagePipelineWorkflowsParametersList_Override(d DataAwsccImagebuilderImagePipelineWorkflowsParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccImagebuilderImagePipelineWorkflowsParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccImagebuilderImagePipelineWorkflowsParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccImagebuilderImagePipelineWorkflowsParametersList) Resolve(context cdktn.IResolveContext) interface{} {
