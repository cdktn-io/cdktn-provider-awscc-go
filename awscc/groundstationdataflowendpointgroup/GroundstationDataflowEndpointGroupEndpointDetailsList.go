...
func (j *jsiiProxy_GroundstationDataflowEndpointGroupEndpointDetailsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGroundstationDataflowEndpointGroupEndpointDetailsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GroundstationDataflowEndpointGroupEndpointDetailsList {
	_init_.Initialize()
...
func NewGroundstationDataflowEndpointGroupEndpointDetailsList_Override(g GroundstationDataflowEndpointGroupEndpointDetailsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroupEndpointDetailsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GroundstationDataflowEndpointGroupEndpointDetailsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GroundstationDataflowEndpointGroupEndpointDetailsList) Resolve(context cdktn.IResolveContext) interface{} {
