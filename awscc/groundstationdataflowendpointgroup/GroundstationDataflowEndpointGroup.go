...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/groundstationdataflowendpointgroup/internal"
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GroundstationDataflowEndpointGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GroundstationDataflowEndpointGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GroundstationDataflowEndpointGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GroundstationDataflowEndpointGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GroundstationDataflowEndpointGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GroundstationDataflowEndpointGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GroundstationDataflowEndpointGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GroundstationDataflowEndpointGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
