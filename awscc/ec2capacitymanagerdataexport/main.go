...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2CapacityManagerDataExport)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "capacityManagerDataExportId", GoGetter: "CapacityManagerDataExportId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetS3BucketPrefix", GoMethod: "ResetS3BucketPrefix"},
			...
			_jsii_.MemberProperty{JsiiProperty: "s3BucketPrefixInput", GoGetter: "S3BucketPrefixInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2CapacityManagerDataExportConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.ec2CapacityManagerDataExport.Ec2CapacityManagerDataExportTags",
		reflect.TypeOf((*Ec2CapacityManagerDataExportTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ec2CapacityManagerDataExport.Ec2CapacityManagerDataExportTagsList",
		reflect.TypeOf((*Ec2CapacityManagerDataExportTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2CapacityManagerDataExportTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
