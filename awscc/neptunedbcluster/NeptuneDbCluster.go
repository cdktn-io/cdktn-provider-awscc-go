...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/neptunedbcluster/internal"
...
func (j *jsiiProxy_NeptuneDbCluster) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NeptuneDbCluster) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NeptuneDbCluster) GlobalClusterIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NeptuneDbCluster) GlobalClusterIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NeptuneDbCluster) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NeptuneDbCluster) NetworkType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkType",
...
func (j *jsiiProxy_NeptuneDbCluster) NetworkTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkTypeInput",
...
func (j *jsiiProxy_NeptuneDbCluster) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NeptuneDbCluster) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/neptune_db_cluster awscc_neptune_db_cluster} Resource.
...
func (j *jsiiProxy_NeptuneDbCluster)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NeptuneDbCluster)SetGlobalClusterIdentifier(val *string) {
...
func (j *jsiiProxy_NeptuneDbCluster)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NeptuneDbCluster)SetNetworkType(val *string) {
...
func (j *jsiiProxy_NeptuneDbCluster)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NeptuneDbCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NeptuneDbCluster) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneDbCluster) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NeptuneDbCluster) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NeptuneDbCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NeptuneDbCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NeptuneDbCluster) ResetGlobalClusterIdentifier() {
	_jsii_.InvokeVoid(
		n,
		"resetGlobalClusterIdentifier",
		nil, // no parameters
...
func (n *jsiiProxy_NeptuneDbCluster) ResetNetworkType() {
	_jsii_.InvokeVoid(
		n,
		"resetNetworkType",
		nil, // no parameters
...
func (n *jsiiProxy_NeptuneDbCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
