...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableRecord)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableRecordConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccConnectDataTableRecord.DataAwsccConnectDataTableRecordDataTableRecord",
		reflect.TypeOf((*DataAwsccConnectDataTableRecordDataTableRecord)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccConnectDataTableRecord.DataAwsccConnectDataTableRecordDataTableRecordOutputReference",
		reflect.TypeOf((*DataAwsccConnectDataTableRecordDataTableRecordOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "primaryValues", GoGetter: "PrimaryValues"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableRecordDataTableRecordPrimaryValues)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccConnectDataTableRecord.DataAwsccConnectDataTableRecordDataTableRecordPrimaryValuesList",
		reflect.TypeOf((*DataAwsccConnectDataTableRecordDataTableRecordPrimaryValuesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableRecordDataTableRecordPrimaryValuesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableRecordDataTableRecordValues)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccConnectDataTableRecord.DataAwsccConnectDataTableRecordDataTableRecordValuesList",
		reflect.TypeOf((*DataAwsccConnectDataTableRecordDataTableRecordValuesList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableRecordDataTableRecordValuesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attributeId", GoGetter: "AttributeId"},
			_jsii_.MemberProperty{JsiiProperty: "attributeValue", GoGetter: "AttributeValue"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
