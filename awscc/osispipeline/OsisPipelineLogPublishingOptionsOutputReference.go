...
func NewOsisPipelineLogPublishingOptionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) OsisPipelineLogPublishingOptionsOutputReference {
	_init_.Initialize()
...
func NewOsisPipelineLogPublishingOptionsOutputReference_Override(o OsisPipelineLogPublishingOptionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
