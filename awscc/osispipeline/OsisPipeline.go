...
type OsisPipeline interface {
	...
	ResourcePolicy() OsisPipelineResourcePolicyOutputReference
	...
	PutResourcePolicy(value *OsisPipelineResourcePolicy)
...
func (j *jsiiProxy_OsisPipeline) ResourcePolicy() OsisPipelineResourcePolicyOutputReference {
	var returns OsisPipelineResourcePolicyOutputReference
	_jsii_.Get(
		j,
		"resourcePolicy",
		&returns,
...
func (j *jsiiProxy_OsisPipeline) ResourcePolicyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"resourcePolicyInput",
...
func (o *jsiiProxy_OsisPipeline) PutResourcePolicy(value *OsisPipelineResourcePolicy) {
	if err := o.validatePutResourcePolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		o,
...
func (o *jsiiProxy_OsisPipeline) ResetResourcePolicy() {
	_jsii_.InvokeVoid(
		o,
		"resetResourcePolicy",
		nil, // no parameters
