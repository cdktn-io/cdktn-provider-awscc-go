...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccNetworkfirewallFirewallAvailabilityZoneMappings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccNetworkfirewallFirewall.DataAwsccNetworkfirewallFirewallAvailabilityZoneMappingsList",
		reflect.TypeOf((*DataAwsccNetworkfirewallFirewallAvailabilityZoneMappingsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNetworkfirewallFirewallAvailabilityZoneMappingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccNetworkfirewallFirewallAvailabilityZoneMappingsOutputReference{}
