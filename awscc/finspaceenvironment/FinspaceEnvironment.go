...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/finspaceenvironment/internal"
...
func (j *jsiiProxy_FinspaceEnvironment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FinspaceEnvironment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FinspaceEnvironment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FinspaceEnvironment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FinspaceEnvironment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/finspace_environment awscc_finspace_environment} Resource.
...
func (j *jsiiProxy_FinspaceEnvironment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FinspaceEnvironment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FinspaceEnvironment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FinspaceEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FinspaceEnvironment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceEnvironment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FinspaceEnvironment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceEnvironment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FinspaceEnvironment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FinspaceEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
