...
func (j *jsiiProxy_FinspaceEnvironmentFederationParametersAttributeMapOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFinspaceEnvironmentFederationParametersAttributeMapOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FinspaceEnvironmentFederationParametersAttributeMapOutputReference {
	_init_.Initialize()
...
func NewFinspaceEnvironmentFederationParametersAttributeMapOutputReference_Override(f FinspaceEnvironmentFederationParametersAttributeMapOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FinspaceEnvironmentFederationParametersAttributeMapOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FinspaceEnvironmentFederationParametersAttributeMapOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceEnvironmentFederationParametersAttributeMapOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FinspaceEnvironmentFederationParametersAttributeMapOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FinspaceEnvironmentFederationParametersAttributeMapOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
