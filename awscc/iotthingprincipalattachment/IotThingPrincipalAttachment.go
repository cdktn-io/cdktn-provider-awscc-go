...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/iotthingprincipalattachment/internal"
...
func (j *jsiiProxy_IotThingPrincipalAttachment) ThingName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingName",
...
func (j *jsiiProxy_IotThingPrincipalAttachment) ThingNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"thingNameInput",
...
func NewIotThingPrincipalAttachment(scope constructs.Construct, id *string, config *IotThingPrincipalAttachmentConfig) IotThingPrincipalAttachment {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.iotThingPrincipalAttachment.IotThingPrincipalAttachment",
...
func (j *jsiiProxy_IotThingPrincipalAttachment)SetThingName(val *string) {
