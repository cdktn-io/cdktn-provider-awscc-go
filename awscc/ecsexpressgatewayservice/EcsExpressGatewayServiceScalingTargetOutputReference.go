...
func NewEcsExpressGatewayServiceScalingTargetOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) EcsExpressGatewayServiceScalingTargetOutputReference {
	_init_.Initialize()

	if err := validateNewEcsExpressGatewayServiceScalingTargetOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEcsExpressGatewayServiceScalingTargetOutputReference_Override(e EcsExpressGatewayServiceScalingTargetOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
