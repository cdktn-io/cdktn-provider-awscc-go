...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectPeerConfigurationBgpConfigurationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccNetworkmanagerConnectPeerConfigurationBgpConfigurationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccNetworkmanagerConnectPeerConfigurationBgpConfigurationsList {
	_init_.Initialize()
...
func NewDataAwsccNetworkmanagerConnectPeerConfigurationBgpConfigurationsList_Override(d DataAwsccNetworkmanagerConnectPeerConfigurationBgpConfigurationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccNetworkmanagerConnectPeerConfigurationBgpConfigurationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerConnectPeerConfigurationBgpConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerConnectPeerConfigurationBgpConfigurationsList) Resolve(context cdktn.IResolveContext) interface{} {
