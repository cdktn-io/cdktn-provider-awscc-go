...
type EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference interface {
	...
	SetNormalizationVersion(val *string)
	NormalizationVersionInput() *string
...
func (j *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference) NormalizationVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference) NormalizationVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"normalizationVersionInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference {
	_init_.Initialize()
...
func NewEntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference_Override(e EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference)SetNormalizationVersion(val *string) {
	if err := j.validateSetNormalizationVersionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference) ResetNormalizationVersion() {
	_jsii_.InvokeVoid(
		e,
		"resetNormalizationVersion",
		nil, // no parameters
...
func (e *jsiiProxy_EntityresolutionIdMappingWorkflowIdMappingTechniquesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
