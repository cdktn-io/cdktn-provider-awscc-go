...
func (j *jsiiProxy_OmicsWorkflowVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_OmicsWorkflowVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_OmicsWorkflowVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_OmicsWorkflowVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_OmicsWorkflowVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/omics_workflow_version awscc_omics_workflow_version} Resource.
...
func (j *jsiiProxy_OmicsWorkflowVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_OmicsWorkflowVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_OmicsWorkflowVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func OmicsWorkflowVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (o *jsiiProxy_OmicsWorkflowVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OmicsWorkflowVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (o *jsiiProxy_OmicsWorkflowVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (o *jsiiProxy_OmicsWorkflowVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OmicsWorkflowVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OmicsWorkflowVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
