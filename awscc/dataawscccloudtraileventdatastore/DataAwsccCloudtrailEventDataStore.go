...
type DataAwsccCloudtrailEventDataStore interface {
	...
	FederationEnabled() cdktn.IResolvable
	...
	SetId(val *string)
	IdInput() *string
	IngestionEnabled() cdktn.IResolvable
	...
	MaxEventSize() *string
	MultiRegionEnabled() cdktn.IResolvable
	Name() *string
	// The tree node.
	Node() constructs.Node
	OrganizationEnabled() cdktn.IResolvable
	// Experimental.
	...
	TerminationProtectionEnabled() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) FederationEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) IngestionEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"ingestionEnabled",
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) MultiRegionEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"multiRegionEnabled",
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) OrganizationEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"organizationEnabled",
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) TerminationProtectionEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cloudtrail_event_data_store awscc_cloudtrail_event_data_store} Data Source.
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCloudtrailEventDataStore)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCloudtrailEventDataStore_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCloudtrailEventDataStore) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCloudtrailEventDataStore) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCloudtrailEventDataStore) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCloudtrailEventDataStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
