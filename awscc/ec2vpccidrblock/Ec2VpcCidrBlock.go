...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ec2vpccidrblock/internal"
...
func (j *jsiiProxy_Ec2VpcCidrBlock) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2VpcCidrBlock) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2VpcCidrBlock) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2VpcCidrBlock) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2VpcCidrBlock) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2VpcCidrBlock)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2VpcCidrBlock)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2VpcCidrBlock)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2VpcCidrBlock_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2VpcCidrBlock) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2VpcCidrBlock) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2VpcCidrBlock) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2VpcCidrBlock) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2VpcCidrBlock) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2VpcCidrBlock) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
