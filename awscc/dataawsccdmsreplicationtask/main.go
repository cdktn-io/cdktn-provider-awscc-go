...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDmsReplicationTask)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccDmsReplicationTask.DataAwsccDmsReplicationTaskConfig",
		reflect.TypeOf((*DataAwsccDmsReplicationTaskConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccDmsReplicationTask.DataAwsccDmsReplicationTaskTags",
		reflect.TypeOf((*DataAwsccDmsReplicationTaskTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccDmsReplicationTask.DataAwsccDmsReplicationTaskTagsList",
		reflect.TypeOf((*DataAwsccDmsReplicationTaskTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDmsReplicationTaskTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
