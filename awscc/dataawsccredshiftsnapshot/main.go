...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRedshiftSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "encryptedWithHsm", GoGetter: "EncryptedWithHsm"},
			_jsii_.MemberProperty{JsiiProperty: "engineFullVersion", GoGetter: "EngineFullVersion"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccRedshiftSnapshot.DataAwsccRedshiftSnapshotConfig",
		reflect.TypeOf((*DataAwsccRedshiftSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccRedshiftSnapshot.DataAwsccRedshiftSnapshotTags",
		reflect.TypeOf((*DataAwsccRedshiftSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccRedshiftSnapshot.DataAwsccRedshiftSnapshotTagsList",
		reflect.TypeOf((*DataAwsccRedshiftSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRedshiftSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
