...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccChimeAppInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccChimeAppInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccChimeAppInstance.DataAwsccChimeAppInstanceTags",
		reflect.TypeOf((*DataAwsccChimeAppInstanceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccChimeAppInstance.DataAwsccChimeAppInstanceTagsList",
		reflect.TypeOf((*DataAwsccChimeAppInstanceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccChimeAppInstanceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
