...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/elasticloadbalancingv2_trust_store_revocation awscc_elasticloadbalancingv2_trust_store_revocation} Resource.
...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Elasticloadbalancingv2TrustStoreRevocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
