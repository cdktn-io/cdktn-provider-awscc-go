...
func (e *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocationTrustStoreRevocationsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_Elasticloadbalancingv2TrustStoreRevocationTrustStoreRevocationsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewElasticloadbalancingv2TrustStoreRevocationTrustStoreRevocationsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
