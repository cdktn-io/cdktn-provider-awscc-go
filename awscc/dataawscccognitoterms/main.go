...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCognitoTerms)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "termsId", GoGetter: "TermsId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCognitoTermsConfig)(nil)).Elem(),
	)
}
