...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccRekognitionProjectTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccRekognitionProject.DataAwsccRekognitionProjectTagsList",
		reflect.TypeOf((*DataAwsccRekognitionProjectTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccRekognitionProjectTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRekognitionProjectTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
