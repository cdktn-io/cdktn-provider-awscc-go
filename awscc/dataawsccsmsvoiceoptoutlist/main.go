...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSmsvoiceOptOutList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSmsvoiceOptOutListConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccSmsvoiceOptOutList.DataAwsccSmsvoiceOptOutListTags",
		reflect.TypeOf((*DataAwsccSmsvoiceOptOutListTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccSmsvoiceOptOutList.DataAwsccSmsvoiceOptOutListTagsList",
		reflect.TypeOf((*DataAwsccSmsvoiceOptOutListTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSmsvoiceOptOutListTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccSmsvoiceOptOutListTagsOutputReference{}
