...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccLakeformationPrincipalPermissions.DataAwsccLakeformationPrincipalPermissionsResourceCatalog",
		reflect.TypeOf((*DataAwsccLakeformationPrincipalPermissionsResourceCatalog)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLakeformationPrincipalPermissionsResourceCatalogOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
