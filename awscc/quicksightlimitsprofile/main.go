...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*QuicksightLimitsProfile)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.quicksightLimitsProfile.QuicksightLimitsProfileConfig",
		reflect.TypeOf((*QuicksightLimitsProfileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.quicksightLimitsProfile.QuicksightLimitsProfileResourceLimits",
		reflect.TypeOf((*QuicksightLimitsProfileResourceLimits)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.quicksightLimitsProfile.QuicksightLimitsProfileResourceLimitsMap",
		reflect.TypeOf((*QuicksightLimitsProfileResourceLimitsMap)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*QuicksightLimitsProfileResourceLimitsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
