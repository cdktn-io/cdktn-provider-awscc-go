...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/nimblestudiostudio/internal"
...
func (j *jsiiProxy_NimblestudioStudio) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_NimblestudioStudio) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_NimblestudioStudio) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NimblestudioStudio) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_NimblestudioStudio) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NimblestudioStudio)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_NimblestudioStudio)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_NimblestudioStudio)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func NimblestudioStudio_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NimblestudioStudio) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NimblestudioStudio) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (n *jsiiProxy_NimblestudioStudio) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NimblestudioStudio) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NimblestudioStudio) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NimblestudioStudio) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
