...
func (j *jsiiProxy_DatazoneDataSource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatazoneDataSource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatazoneDataSource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatazoneDataSource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatazoneDataSource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DatazoneDataSource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatazoneDataSource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatazoneDataSource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DatazoneDataSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatazoneDataSource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatazoneDataSource) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatazoneDataSource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatazoneDataSource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatazoneDataSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatazoneDataSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
