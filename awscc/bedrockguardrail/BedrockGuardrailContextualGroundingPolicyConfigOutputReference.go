...
func NewBedrockGuardrailContextualGroundingPolicyConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BedrockGuardrailContextualGroundingPolicyConfigOutputReference {
	_init_.Initialize()
...
func NewBedrockGuardrailContextualGroundingPolicyConfigOutputReference_Override(b BedrockGuardrailContextualGroundingPolicyConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
