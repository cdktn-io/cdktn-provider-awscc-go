...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "automatedReasoningPolicyConfigInput", GoGetter: "AutomatedReasoningPolicyConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAutomatedReasoningPolicyConfig", GoMethod: "PutAutomatedReasoningPolicyConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutomatedReasoningPolicyConfig", GoMethod: "ResetAutomatedReasoningPolicyConfig"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BedrockGuardrailAutomatedReasoningPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.bedrockGuardrail.BedrockGuardrailAutomatedReasoningPolicyConfigOutputReference",
		reflect.TypeOf((*BedrockGuardrailAutomatedReasoningPolicyConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
