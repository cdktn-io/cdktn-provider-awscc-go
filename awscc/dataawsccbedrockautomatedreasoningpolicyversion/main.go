...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockAutomatedReasoningPolicyVersion)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccBedrockAutomatedReasoningPolicyVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccBedrockAutomatedReasoningPolicyVersion.DataAwsccBedrockAutomatedReasoningPolicyVersionTags",
		reflect.TypeOf((*DataAwsccBedrockAutomatedReasoningPolicyVersionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockAutomatedReasoningPolicyVersionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockAutomatedReasoningPolicyVersionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
