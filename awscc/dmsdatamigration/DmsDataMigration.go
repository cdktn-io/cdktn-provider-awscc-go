...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dmsdatamigration/internal"
...
func (j *jsiiProxy_DmsDataMigration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DmsDataMigration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DmsDataMigration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DmsDataMigration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DmsDataMigration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DmsDataMigration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DmsDataMigration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DmsDataMigration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DmsDataMigration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DmsDataMigration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsDataMigration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DmsDataMigration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DmsDataMigration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DmsDataMigration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DmsDataMigration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
