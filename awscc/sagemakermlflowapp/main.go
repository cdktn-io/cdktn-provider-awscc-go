...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SagemakerMlflowAppTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sagemakerMlflowApp.SagemakerMlflowAppTagsList",
		reflect.TypeOf((*SagemakerMlflowAppTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerMlflowAppTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
