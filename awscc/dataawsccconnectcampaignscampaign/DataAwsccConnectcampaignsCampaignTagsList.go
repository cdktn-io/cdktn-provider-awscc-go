...
func (j *jsiiProxy_DataAwsccConnectcampaignsCampaignTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccConnectcampaignsCampaignTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccConnectcampaignsCampaignTagsList {
	_init_.Initialize()
...
func NewDataAwsccConnectcampaignsCampaignTagsList_Override(d DataAwsccConnectcampaignsCampaignTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccConnectcampaignsCampaignTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccConnectcampaignsCampaignTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccConnectcampaignsCampaignTagsList) Resolve(context cdktn.IResolveContext) interface{} {
