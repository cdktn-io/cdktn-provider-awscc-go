...
func (g *jsiiProxy_GlobalacceleratorEndpointGroup) validatePutEndpointConfigurationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GlobalacceleratorEndpointGroupEndpointConfigurations; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GlobalacceleratorEndpointGroup) validatePutPortOverridesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GlobalacceleratorEndpointGroupPortOverrides; received %#v (a %T)", value, value)
		}
	}
