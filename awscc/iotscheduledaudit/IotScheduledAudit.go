...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/iotscheduledaudit/internal"
...
func (j *jsiiProxy_IotScheduledAudit) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotScheduledAudit) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotScheduledAudit) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotScheduledAudit) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotScheduledAudit) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IotScheduledAudit)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotScheduledAudit)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotScheduledAudit)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IotScheduledAudit_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotScheduledAudit) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotScheduledAudit) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotScheduledAudit) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotScheduledAudit) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotScheduledAudit) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotScheduledAudit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
