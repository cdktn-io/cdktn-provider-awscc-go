...
func (e *jsiiProxy_EmrserverlessApplication) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EmrserverlessApplicationTags; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EmrserverlessApplication) validatePutWorkerTypeSpecificationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *map[string]*EmrserverlessApplicationWorkerTypeSpecifications; received %#v (a %T)", value, value)
		}
	}
