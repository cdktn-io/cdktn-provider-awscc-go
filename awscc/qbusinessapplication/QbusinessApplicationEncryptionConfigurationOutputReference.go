...
func NewQbusinessApplicationEncryptionConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) QbusinessApplicationEncryptionConfigurationOutputReference {
	_init_.Initialize()
...
func NewQbusinessApplicationEncryptionConfigurationOutputReference_Override(q QbusinessApplicationEncryptionConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
