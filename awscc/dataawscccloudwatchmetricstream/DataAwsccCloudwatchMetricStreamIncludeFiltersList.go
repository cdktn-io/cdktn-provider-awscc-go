...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStreamIncludeFiltersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccCloudwatchMetricStreamIncludeFiltersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccCloudwatchMetricStreamIncludeFiltersList {
	_init_.Initialize()
...
func NewDataAwsccCloudwatchMetricStreamIncludeFiltersList_Override(d DataAwsccCloudwatchMetricStreamIncludeFiltersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStreamIncludeFiltersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStreamIncludeFiltersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStreamIncludeFiltersList) Resolve(context cdktn.IResolveContext) interface{} {
