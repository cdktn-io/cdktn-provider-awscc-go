...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStreamStatisticsConfigurationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccCloudwatchMetricStreamStatisticsConfigurationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccCloudwatchMetricStreamStatisticsConfigurationsList {
	_init_.Initialize()
...
func NewDataAwsccCloudwatchMetricStreamStatisticsConfigurationsList_Override(d DataAwsccCloudwatchMetricStreamStatisticsConfigurationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStreamStatisticsConfigurationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStreamStatisticsConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStreamStatisticsConfigurationsList) Resolve(context cdktn.IResolveContext) interface{} {
