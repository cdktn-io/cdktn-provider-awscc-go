...
type DataAwsccCloudwatchMetricStream interface {
	...
	IncludeLinkedAccountsMetrics() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream) IncludeLinkedAccountsMetrics() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCloudwatchMetricStream)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCloudwatchMetricStream_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStream) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStream) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStream) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCloudwatchMetricStream) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
