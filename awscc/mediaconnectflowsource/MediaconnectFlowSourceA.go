...
func (j *jsiiProxy_MediaconnectFlowSourceA) Tags() MediaconnectFlowSourceTagsAList {
	var returns MediaconnectFlowSourceTagsAList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/mediaconnect_flow_source awscc_mediaconnect_flow_source} Resource.
