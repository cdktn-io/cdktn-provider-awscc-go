...
func (j *jsiiProxy_DataAwsccApigatewayUsagePlanApiStagesThrottleMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccApigatewayUsagePlanApiStagesThrottleMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataAwsccApigatewayUsagePlanApiStagesThrottleMap {
	_init_.Initialize()
...
func NewDataAwsccApigatewayUsagePlanApiStagesThrottleMap_Override(d DataAwsccApigatewayUsagePlanApiStagesThrottleMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccApigatewayUsagePlanApiStagesThrottleMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccApigatewayUsagePlanApiStagesThrottleMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccApigatewayUsagePlanApiStagesThrottleMap) Resolve(context cdktn.IResolveContext) interface{} {
