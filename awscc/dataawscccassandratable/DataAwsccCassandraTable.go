...
type DataAwsccCassandraTable interface {
	...
	ClientSideTimestampsEnabled() cdktn.IResolvable
	...
	WarmThroughput() DataAwsccCassandraTableWarmThroughputOutputReference
	// Experimental.
...
func (j *jsiiProxy_DataAwsccCassandraTable) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCassandraTable) ClientSideTimestampsEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccCassandraTable) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCassandraTable) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCassandraTable) PointInTimeRecoveryEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCassandraTable) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCassandraTable) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccCassandraTable) WarmThroughput() DataAwsccCassandraTableWarmThroughputOutputReference {
	var returns DataAwsccCassandraTableWarmThroughputOutputReference
	_jsii_.Get(
		j,
		"warmThroughput",
		&returns,
...
func (j *jsiiProxy_DataAwsccCassandraTable)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCassandraTable)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCassandraTable)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCassandraTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCassandraTable) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCassandraTable) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCassandraTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCassandraTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
