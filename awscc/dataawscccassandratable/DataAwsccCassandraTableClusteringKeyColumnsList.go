...
func (j *jsiiProxy_DataAwsccCassandraTableClusteringKeyColumnsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccCassandraTableClusteringKeyColumnsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccCassandraTableClusteringKeyColumnsList {
	_init_.Initialize()
...
func NewDataAwsccCassandraTableClusteringKeyColumnsList_Override(d DataAwsccCassandraTableClusteringKeyColumnsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccCassandraTableClusteringKeyColumnsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccCassandraTableClusteringKeyColumnsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccCassandraTableClusteringKeyColumnsList) Resolve(context cdktn.IResolveContext) interface{} {
