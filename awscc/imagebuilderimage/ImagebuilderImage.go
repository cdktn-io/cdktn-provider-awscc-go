...
type ImagebuilderImage interface {
	...
	DeletionSettings() ImagebuilderImageDeletionSettingsOutputReference
	DeletionSettingsInput() interface{}
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	Id() *string
	ImageId() *string
	ImagePipelineExecutionSettings() ImagebuilderImageImagePipelineExecutionSettingsOutputReference
	ImagePipelineExecutionSettingsInput() interface{}
	...
	LatestVersion() ImagebuilderImageLatestVersionOutputReference
	// Experimental.
	...
	PutDeletionSettings(value *ImagebuilderImageDeletionSettings)
	PutImagePipelineExecutionSettings(value *ImagebuilderImageImagePipelineExecutionSettings)
	...
	ResetExecutionRole()
	ResetImagePipelineExecutionSettings()
	ResetImageRecipeArn()
...
func (j *jsiiProxy_ImagebuilderImage) DeletionSettings() ImagebuilderImageDeletionSettingsOutputReference {
	var returns ImagebuilderImageDeletionSettingsOutputReference
	_jsii_.Get(
		j,
		"deletionSettings",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImage) DeletionSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deletionSettingsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_ImagebuilderImage) ImagePipelineExecutionSettings() ImagebuilderImageImagePipelineExecutionSettingsOutputReference {
	var returns ImagebuilderImageImagePipelineExecutionSettingsOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImage) ImagePipelineExecutionSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"imagePipelineExecutionSettingsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_ImagebuilderImage) LatestVersion() ImagebuilderImageLatestVersionOutputReference {
	var returns ImagebuilderImageLatestVersionOutputReference
	_jsii_.Get(
		j,
		"latestVersion",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImage) LoggingConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (i *jsiiProxy_ImagebuilderImage) PutDeletionSettings(value *ImagebuilderImageDeletionSettings) {
	if err := i.validatePutDeletionSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_ImagebuilderImage) PutImagePipelineExecutionSettings(value *ImagebuilderImageImagePipelineExecutionSettings) {
	if err := i.validatePutImagePipelineExecutionSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
		"putImagePipelineExecutionSettings",
		[]interface{}{value},
	)
}
...
func (i *jsiiProxy_ImagebuilderImage) ResetDeletionSettings() {
	_jsii_.InvokeVoid(
		i,
		"resetDeletionSettings",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImage) ResetImagePipelineExecutionSettings() {
	_jsii_.InvokeVoid(
		i,
		"resetImagePipelineExecutionSettings",
		nil, // no parameters
