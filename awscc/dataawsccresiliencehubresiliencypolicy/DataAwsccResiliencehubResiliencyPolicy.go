...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccresiliencehubresiliencypolicy/internal"
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) Tags() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/resiliencehub_resiliency_policy awscc_resiliencehub_resiliency_policy} Data Source.
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccResiliencehubResiliencyPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccResiliencehubResiliencyPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
