...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/supportappslackchannelconfiguration/internal"
...
func (j *jsiiProxy_SupportappSlackChannelConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SupportappSlackChannelConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SupportappSlackChannelConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SupportappSlackChannelConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SupportappSlackChannelConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SupportappSlackChannelConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SupportappSlackChannelConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SupportappSlackChannelConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SupportappSlackChannelConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SupportappSlackChannelConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SupportappSlackChannelConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SupportappSlackChannelConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SupportappSlackChannelConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SupportappSlackChannelConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SupportappSlackChannelConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
