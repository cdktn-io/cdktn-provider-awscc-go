...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptunegraphGraphSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "graphSnapshotId", GoGetter: "GraphSnapshotId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccNeptunegraphGraphSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccNeptunegraphGraphSnapshot.DataAwsccNeptunegraphGraphSnapshotTags",
		reflect.TypeOf((*DataAwsccNeptunegraphGraphSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccNeptunegraphGraphSnapshot.DataAwsccNeptunegraphGraphSnapshotTagsList",
		reflect.TypeOf((*DataAwsccNeptunegraphGraphSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccNeptunegraphGraphSnapshotTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptunegraphGraphSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
