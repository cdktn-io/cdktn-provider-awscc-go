...
func (c *jsiiProxy_ConnectSecurityProfile) validatePutAllowedAccessControlTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ConnectSecurityProfileAllowedAccessControlTags; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ConnectSecurityProfile) validatePutAllowedFlowModulesParameters(value interface{}) error {
	...
	case *[]*ConnectSecurityProfileAllowedFlowModules:
		value := value.(*[]*ConnectSecurityProfileAllowedFlowModules)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ConnectSecurityProfileAllowedFlowModules:
		value_ := value.([]*ConnectSecurityProfileAllowedFlowModules)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ConnectSecurityProfileAllowedFlowModules; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ConnectSecurityProfile) validatePutApplicationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ConnectSecurityProfileApplications; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ConnectSecurityProfile) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ConnectSecurityProfileTags; received %#v (a %T)", value, value)
		}
	}
