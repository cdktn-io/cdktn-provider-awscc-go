...
func (j *jsiiProxy_SagemakerCodeRepository) CodeRepositoryArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"codeRepositoryArn",
...
func (j *jsiiProxy_SagemakerCodeRepository) GitConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"gitConfigInput",
...
func (j *jsiiProxy_SagemakerCodeRepository) Tags() SagemakerCodeRepositoryTagsList {
	var returns SagemakerCodeRepositoryTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (s *jsiiProxy_SagemakerCodeRepository) PutTags(value interface{}) {
...
func (s *jsiiProxy_SagemakerCodeRepository) ResetCodeRepositoryName() {
	_jsii_.InvokeVoid(
		s,
		"resetCodeRepositoryName",
		nil, // no parameters
