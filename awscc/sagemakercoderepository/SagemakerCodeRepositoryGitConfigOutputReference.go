...
func (j *jsiiProxy_SagemakerCodeRepositoryGitConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SagemakerCodeRepositoryGitConfigOutputReference)SetInternalValue(val interface{}) {
