...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sagemakerCodeRepository.SagemakerCodeRepository",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCodeRepositoryName", GoMethod: "ResetCodeRepositoryName"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.sagemakerCodeRepository.SagemakerCodeRepositoryConfig",
		reflect.TypeOf((*SagemakerCodeRepositoryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.sagemakerCodeRepository.SagemakerCodeRepositoryGitConfig",
		reflect.TypeOf((*SagemakerCodeRepositoryGitConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sagemakerCodeRepository.SagemakerCodeRepositoryGitConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.sagemakerCodeRepository.SagemakerCodeRepositoryTags",
		reflect.TypeOf((*SagemakerCodeRepositoryTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sagemakerCodeRepository.SagemakerCodeRepositoryTagsList",
		reflect.TypeOf((*SagemakerCodeRepositoryTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerCodeRepositoryTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
