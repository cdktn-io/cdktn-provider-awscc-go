...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsClusterSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.rdsClusterSnapshot.RdsClusterSnapshotConfig",
		reflect.TypeOf((*RdsClusterSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.rdsClusterSnapshot.RdsClusterSnapshotTags",
		reflect.TypeOf((*RdsClusterSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.rdsClusterSnapshot.RdsClusterSnapshotTagsList",
		reflect.TypeOf((*RdsClusterSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsClusterSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
