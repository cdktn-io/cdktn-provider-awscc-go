...
type DatazonePolicyGrant interface {
	...
	PutDetail(value *DatazonePolicyGrantDetail)
	PutPrincipal(value *DatazonePolicyGrantPrincipal)
...
func (j *jsiiProxy_DatazonePolicyGrant) Detail() DatazonePolicyGrantDetailOutputReference {
...
func (j *jsiiProxy_DatazonePolicyGrant) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DatazonePolicyGrant) Principal() DatazonePolicyGrantPrincipalOutputReference {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/datazone_policy_grant awscc_datazone_policy_grant} Resource.
...
func (d *jsiiProxy_DatazonePolicyGrant) PutDetail(value *DatazonePolicyGrantDetail) {
...
func (d *jsiiProxy_DatazonePolicyGrant) PutPrincipal(value *DatazonePolicyGrantPrincipal) {
