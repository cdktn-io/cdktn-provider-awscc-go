...
type DatazonePolicyGrantPrincipalUserOutputReference interface {
	...
	SetAllUsersGrantFilter(val *string)
	AllUsersGrantFilterInput() *string
...
func (j *jsiiProxy_DatazonePolicyGrantPrincipalUserOutputReference) AllUsersGrantFilter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"allUsersGrantFilter",
...
func (j *jsiiProxy_DatazonePolicyGrantPrincipalUserOutputReference) AllUsersGrantFilterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDatazonePolicyGrantPrincipalUserOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DatazonePolicyGrantPrincipalUserOutputReference {
	_init_.Initialize()

	if err := validateNewDatazonePolicyGrantPrincipalUserOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewDatazonePolicyGrantPrincipalUserOutputReference_Override(d DatazonePolicyGrantPrincipalUserOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DatazonePolicyGrantPrincipalUserOutputReference)SetAllUsersGrantFilter(val *string) {
	if err := j.validateSetAllUsersGrantFilterParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
