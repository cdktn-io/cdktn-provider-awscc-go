...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDirectoryserviceSimpleAdTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccDirectoryserviceSimpleAd.DataAwsccDirectoryserviceSimpleAdTagsList",
		reflect.TypeOf((*DataAwsccDirectoryserviceSimpleAdTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccDirectoryserviceSimpleAdTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDirectoryserviceSimpleAdTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
