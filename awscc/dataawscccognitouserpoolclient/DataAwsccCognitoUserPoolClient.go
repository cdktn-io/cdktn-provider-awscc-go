...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscccognitouserpoolclient/internal"
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) AllowedOAuthFlowsUserPoolClient() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) EnablePropagateAdditionalUserContextData() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) EnableTokenRevocation() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) GenerateSecret() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"generateSecret",
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCognitoUserPoolClient)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCognitoUserPoolClient_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCognitoUserPoolClient) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCognitoUserPoolClient) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCognitoUserPoolClient) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCognitoUserPoolClient) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
