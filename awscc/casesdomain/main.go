...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CasesDomain)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CasesDomainConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.casesDomain.CasesDomainTags",
		reflect.TypeOf((*CasesDomainTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.casesDomain.CasesDomainTagsList",
		reflect.TypeOf((*CasesDomainTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CasesDomainTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
