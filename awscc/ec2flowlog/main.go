...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putTagFieldSpecifications", GoMethod: "PutTagFieldSpecifications"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTagFieldSpecifications", GoMethod: "ResetTagFieldSpecifications"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tagFieldSpecificationsInput", GoGetter: "TagFieldSpecificationsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2FlowLogTagFieldSpecifications)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ec2FlowLog.Ec2FlowLogTagFieldSpecificationsList",
		reflect.TypeOf((*Ec2FlowLogTagFieldSpecificationsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2FlowLogTagFieldSpecificationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_Ec2FlowLogTagFieldSpecificationsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
