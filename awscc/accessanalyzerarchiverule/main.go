...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.accessanalyzerArchiveRule.AccessanalyzerArchiveRuleConfig",
		reflect.TypeOf((*AccessanalyzerArchiveRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.accessanalyzerArchiveRule.AccessanalyzerArchiveRuleFilter",
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AccessanalyzerArchiveRuleFilterMap)(nil)).Elem(),
		[]_jsii_.Member{
