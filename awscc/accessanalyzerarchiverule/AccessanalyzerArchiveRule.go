...
func (j *jsiiProxy_AccessanalyzerArchiveRule) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_AccessanalyzerArchiveRule) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_AccessanalyzerArchiveRule) Filter() AccessanalyzerArchiveRuleFilterMap {
	var returns AccessanalyzerArchiveRuleFilterMap
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_AccessanalyzerArchiveRule) UpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedAt",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/accessanalyzer_archive_rule awscc_accessanalyzer_archive_rule} Resource.
func NewAccessanalyzerArchiveRule(scope constructs.Construct, id *string, config *AccessanalyzerArchiveRuleConfig) AccessanalyzerArchiveRule {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.accessanalyzerArchiveRule.AccessanalyzerArchiveRule",
