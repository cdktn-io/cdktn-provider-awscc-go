...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/cognitoidentitypoolprincipaltag/internal"
...
func (j *jsiiProxy_CognitoIdentityPoolPrincipalTag) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoIdentityPoolPrincipalTag) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoIdentityPoolPrincipalTag) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoIdentityPoolPrincipalTag) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoIdentityPoolPrincipalTag) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CognitoIdentityPoolPrincipalTag)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoIdentityPoolPrincipalTag)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoIdentityPoolPrincipalTag)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CognitoIdentityPoolPrincipalTag_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoIdentityPoolPrincipalTag) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
