...
type DataAwsccEc2Ec2Fleet interface {
	...
	ReplaceUnhealthyInstances() cdktn.IResolvable
	ReservedCapacityOptions() DataAwsccEc2Ec2FleetReservedCapacityOptionsOutputReference
	...
	TerminateInstancesWithExpiration() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet) ReplaceUnhealthyInstances() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet) ReservedCapacityOptions() DataAwsccEc2Ec2FleetReservedCapacityOptionsOutputReference {
	var returns DataAwsccEc2Ec2FleetReservedCapacityOptionsOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet) TerminateInstancesWithExpiration() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_ec2_fleet awscc_ec2_ec2_fleet} Data Source.
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccEc2Ec2Fleet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccEc2Ec2Fleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccEc2Ec2Fleet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2Ec2Fleet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2Ec2Fleet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccEc2Ec2Fleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
