...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference) Gid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gid",
...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference) GidInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gidInput",
...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference) SecondaryGids() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"secondaryGids",
...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference) SecondaryGidsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"secondaryGidsInput",
...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference) UidInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uidInput",
...
func NewS3FilesAccessPointPosixUserOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) S3FilesAccessPointPosixUserOutputReference {
	_init_.Initialize()

	if err := validateNewS3FilesAccessPointPosixUserOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewS3FilesAccessPointPosixUserOutputReference_Override(s S3FilesAccessPointPosixUserOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference)SetGid(val *string) {
...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference)SetSecondaryGids(val *[]*string) {
...
func (j *jsiiProxy_S3FilesAccessPointPosixUserOutputReference)SetUid(val *string) {
...
func (s *jsiiProxy_S3FilesAccessPointPosixUserOutputReference) ResetGid() {
	_jsii_.InvokeVoid(
		s,
		"resetGid",
		nil, // no parameters
...
func (s *jsiiProxy_S3FilesAccessPointPosixUserOutputReference) ResetUid() {
	_jsii_.InvokeVoid(
		s,
		"resetUid",
		nil, // no parameters
