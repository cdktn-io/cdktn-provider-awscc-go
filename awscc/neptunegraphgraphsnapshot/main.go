...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NeptunegraphGraphSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NeptunegraphGraphSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.neptunegraphGraphSnapshot.NeptunegraphGraphSnapshotTags",
		reflect.TypeOf((*NeptunegraphGraphSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.neptunegraphGraphSnapshot.NeptunegraphGraphSnapshotTagsList",
		reflect.TypeOf((*NeptunegraphGraphSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NeptunegraphGraphSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
