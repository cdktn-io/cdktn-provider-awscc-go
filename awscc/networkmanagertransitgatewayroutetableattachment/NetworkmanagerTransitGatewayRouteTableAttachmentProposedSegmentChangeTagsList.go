...
func (j *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTagsList {
	_init_.Initialize()
...
func NewNetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTagsList_Override(n NetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkmanagerTransitGatewayRouteTableAttachmentProposedSegmentChangeTagsList) Resolve(context cdktn.IResolveContext) interface{} {
