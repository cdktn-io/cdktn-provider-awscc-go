...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53GlobalresolverFirewallDomainLists)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccRoute53GlobalresolverFirewallDomainListsConfig)(nil)).Elem(),
	)
}
