...
func (e *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsForwardConfigOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (e *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsForwardConfigOutputReference) validatePutTargetGroupsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Elasticloadbalancingv2ListenerRuleActionsForwardConfigTargetGroups; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsForwardConfigOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsForwardConfigOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *Elasticloadbalancingv2ListenerRuleActionsForwardConfig; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Elasticloadbalancingv2ListenerRuleActionsForwardConfigOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewElasticloadbalancingv2ListenerRuleActionsForwardConfigOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
