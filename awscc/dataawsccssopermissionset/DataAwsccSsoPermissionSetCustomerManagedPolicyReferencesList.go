...
func (j *jsiiProxy_DataAwsccSsoPermissionSetCustomerManagedPolicyReferencesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccSsoPermissionSetCustomerManagedPolicyReferencesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccSsoPermissionSetCustomerManagedPolicyReferencesList {
	_init_.Initialize()
...
func NewDataAwsccSsoPermissionSetCustomerManagedPolicyReferencesList_Override(d DataAwsccSsoPermissionSetCustomerManagedPolicyReferencesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccSsoPermissionSetCustomerManagedPolicyReferencesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccSsoPermissionSetCustomerManagedPolicyReferencesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccSsoPermissionSetCustomerManagedPolicyReferencesList) Resolve(context cdktn.IResolveContext) interface{} {
