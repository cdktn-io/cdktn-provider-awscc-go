...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/cognitouserpooluser/internal"
...
func (j *jsiiProxy_CognitoUserPoolUser) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CognitoUserPoolUser) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CognitoUserPoolUser) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitoUserPoolUser) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CognitoUserPoolUser) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CognitoUserPoolUser)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitoUserPoolUser)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitoUserPoolUser)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CognitoUserPoolUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitoUserPoolUser) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolUser) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CognitoUserPoolUser) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoUserPoolUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CognitoUserPoolUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CognitoUserPoolUser) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
