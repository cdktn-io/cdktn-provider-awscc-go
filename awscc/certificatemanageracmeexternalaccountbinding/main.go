...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CertificatemanagerAcmeExternalAccountBinding)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "acmeEndpointArn", GoGetter: "AcmeEndpointArn"},
			_jsii_.MemberProperty{JsiiProperty: "acmeEndpointArnInput", GoGetter: "AcmeEndpointArnInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CertificatemanagerAcmeExternalAccountBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.certificatemanagerAcmeExternalAccountBinding.CertificatemanagerAcmeExternalAccountBindingExpiration",
		reflect.TypeOf((*CertificatemanagerAcmeExternalAccountBindingExpiration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CertificatemanagerAcmeExternalAccountBindingExpirationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CertificatemanagerAcmeExternalAccountBindingTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.certificatemanagerAcmeExternalAccountBinding.CertificatemanagerAcmeExternalAccountBindingTagsList",
		reflect.TypeOf((*CertificatemanagerAcmeExternalAccountBindingTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CertificatemanagerAcmeExternalAccountBindingTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_CertificatemanagerAcmeExternalAccountBindingTagsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
