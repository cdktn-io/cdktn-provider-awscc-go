...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LightsailDiskSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "diskSnapshotNameInput", GoGetter: "DiskSnapshotNameInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LightsailDiskSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.lightsailDiskSnapshot.LightsailDiskSnapshotLocation",
		reflect.TypeOf((*LightsailDiskSnapshotLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.lightsailDiskSnapshot.LightsailDiskSnapshotLocationOutputReference",
		reflect.TypeOf((*LightsailDiskSnapshotLocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LightsailDiskSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.lightsailDiskSnapshot.LightsailDiskSnapshotTagsList",
		reflect.TypeOf((*LightsailDiskSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LightsailDiskSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
