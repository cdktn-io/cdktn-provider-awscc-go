...
func (j *jsiiProxy_SagemakerWorkforceCognitoConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewSagemakerWorkforceCognitoConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerWorkforceCognitoConfigOutputReference {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.sagemakerWorkforce.SagemakerWorkforceCognitoConfigOutputReference",
...
func (j *jsiiProxy_SagemakerWorkforceCognitoConfigOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_SagemakerWorkforceCognitoConfigOutputReference) ResetClientId() {
	_jsii_.InvokeVoid(
		s,
		"resetClientId",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerWorkforceCognitoConfigOutputReference) ResetUserPool() {
	_jsii_.InvokeVoid(
		s,
		"resetUserPool",
		nil, // no parameters
