...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccec2capacityreservation/internal"
...
type DataAwsccEc2CapacityReservation interface {
	...
	EndDate() *string
	EndDateType() *string
	EphemeralStorage() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation) EbsOptimized() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation) EphemeralStorage() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"ephemeralStorage",
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_capacity_reservation awscc_ec2_capacity_reservation} Data Source.
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccEc2CapacityReservation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccEc2CapacityReservation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccEc2CapacityReservation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2CapacityReservation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2CapacityReservation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccEc2CapacityReservation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
