...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ec2securitygroupegress/internal"
...
func (j *jsiiProxy_Ec2SecurityGroupEgress) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2SecurityGroupEgress) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2SecurityGroupEgress) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2SecurityGroupEgress) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2SecurityGroupEgress) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_security_group_egress awscc_ec2_security_group_egress} Resource.
...
func (j *jsiiProxy_Ec2SecurityGroupEgress)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2SecurityGroupEgress)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2SecurityGroupEgress)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2SecurityGroupEgress_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2SecurityGroupEgress) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2SecurityGroupEgress) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2SecurityGroupEgress) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2SecurityGroupEgress) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2SecurityGroupEgress) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2SecurityGroupEgress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
