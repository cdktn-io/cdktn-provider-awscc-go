...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerContext)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "contextNameInput", GoGetter: "ContextNameInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SagemakerContextConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.sagemakerContext.SagemakerContextSource",
		reflect.TypeOf((*SagemakerContextSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sagemakerContext.SagemakerContextSourceOutputReference",
		reflect.TypeOf((*SagemakerContextSourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SagemakerContextTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sagemakerContext.SagemakerContextTagsList",
		reflect.TypeOf((*SagemakerContextTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerContextTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
