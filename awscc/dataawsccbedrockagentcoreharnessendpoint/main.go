...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreHarnessEndpoint)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreHarnessEndpointTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
