...
func (j *jsiiProxy_SagemakerInferenceExperiment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SagemakerInferenceExperiment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SagemakerInferenceExperiment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SagemakerInferenceExperiment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SagemakerInferenceExperiment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SagemakerInferenceExperiment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SagemakerInferenceExperiment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SagemakerInferenceExperiment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SagemakerInferenceExperiment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SagemakerInferenceExperiment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerInferenceExperiment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SagemakerInferenceExperiment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SagemakerInferenceExperiment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SagemakerInferenceExperiment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SagemakerInferenceExperiment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
