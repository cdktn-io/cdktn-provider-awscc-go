...
type BillingconductorCustomLineItem interface {
	...
	PresentationDetails() BillingconductorCustomLineItemPresentationDetailsOutputReference
	PresentationDetailsInput() interface{}
	ProductCode() *string
	// Experimental.
	...
	PutPresentationDetails(value *BillingconductorCustomLineItemPresentationDetails)
...
func (j *jsiiProxy_BillingconductorCustomLineItem) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BillingconductorCustomLineItem) ComputationRule() *string {
	var returns *string
	_jsii_.Get(
		j,
		"computationRule",
...
func (j *jsiiProxy_BillingconductorCustomLineItem) ComputationRuleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"computationRuleInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_BillingconductorCustomLineItem) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BillingconductorCustomLineItem) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BillingconductorCustomLineItem) PresentationDetails() BillingconductorCustomLineItemPresentationDetailsOutputReference {
	var returns BillingconductorCustomLineItemPresentationDetailsOutputReference
	_jsii_.Get(
		j,
		"presentationDetails",
		&returns,
...
func (j *jsiiProxy_BillingconductorCustomLineItem) PresentationDetailsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"presentationDetailsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_BillingconductorCustomLineItem) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BillingconductorCustomLineItem) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BillingconductorCustomLineItem)SetComputationRule(val *string) {
	if err := j.validateSetComputationRuleParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_BillingconductorCustomLineItem)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BillingconductorCustomLineItem)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BillingconductorCustomLineItem)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BillingconductorCustomLineItem_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BillingconductorCustomLineItem) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BillingconductorCustomLineItem) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BillingconductorCustomLineItem) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BillingconductorCustomLineItem) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BillingconductorCustomLineItem) PutPresentationDetails(value *BillingconductorCustomLineItemPresentationDetails) {
	if err := b.validatePutPresentationDetailsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
		"putPresentationDetails",
		[]interface{}{value},
	)
}
...
func (b *jsiiProxy_BillingconductorCustomLineItem) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BillingconductorCustomLineItem) ResetComputationRule() {
	_jsii_.InvokeVoid(
		b,
		"resetComputationRule",
		nil, // no parameters
...
func (b *jsiiProxy_BillingconductorCustomLineItem) ResetPresentationDetails() {
	_jsii_.InvokeVoid(
		b,
		"resetPresentationDetails",
		nil, // no parameters
...
func (b *jsiiProxy_BillingconductorCustomLineItem) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
