...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlueUserDefinedFunction)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccGlueUserDefinedFunctionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccGlueUserDefinedFunction.DataAwsccGlueUserDefinedFunctionResourceUris",
		reflect.TypeOf((*DataAwsccGlueUserDefinedFunctionResourceUris)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccGlueUserDefinedFunction.DataAwsccGlueUserDefinedFunctionResourceUrisList",
		reflect.TypeOf((*DataAwsccGlueUserDefinedFunctionResourceUrisList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlueUserDefinedFunctionResourceUrisOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
