...
type SagemakerSpaceSpaceSettingsOutputReference interface {
	...
	RemoteAccess() *string
	SetRemoteAccess(val *string)
	RemoteAccessInput() *string
	SpaceManagedResources() *string
	SetSpaceManagedResources(val *string)
	SpaceManagedResourcesInput() *string
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsOutputReference) RemoteAccess() *string {
	var returns *string
	_jsii_.Get(
		j,
		"remoteAccess",
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsOutputReference) RemoteAccessInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"remoteAccessInput",
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsOutputReference) SpaceManagedResources() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsOutputReference) SpaceManagedResourcesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"spaceManagedResourcesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsOutputReference)SetRemoteAccess(val *string) {
...
func (j *jsiiProxy_SagemakerSpaceSpaceSettingsOutputReference)SetSpaceManagedResources(val *string) {
	if err := j.validateSetSpaceManagedResourcesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsOutputReference) ResetRemoteAccess() {
	_jsii_.InvokeVoid(
		s,
		"resetRemoteAccess",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerSpaceSpaceSettingsOutputReference) ResetSpaceManagedResources() {
	_jsii_.InvokeVoid(
		s,
		"resetSpaceManagedResources",
		nil, // no parameters
