...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SsmOpsItem)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SsmOpsItemConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.ssmOpsItem.SsmOpsItemTags",
		reflect.TypeOf((*SsmOpsItemTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ssmOpsItem.SsmOpsItemTagsList",
		reflect.TypeOf((*SsmOpsItemTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SsmOpsItemTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
