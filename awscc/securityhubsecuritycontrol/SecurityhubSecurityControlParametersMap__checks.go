...
func (j *jsiiProxy_SecurityhubSecurityControlParametersMap) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *map[string]*SecurityhubSecurityControlParameters; received %#v (a %T)", val, val)
		}
	}
