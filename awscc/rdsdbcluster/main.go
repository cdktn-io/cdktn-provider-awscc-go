...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSourceDbClusterResourceId", GoMethod: "ResetSourceDbClusterResourceId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceDbClusterResourceIdInput", GoGetter: "SourceDbClusterResourceIdInput"},
