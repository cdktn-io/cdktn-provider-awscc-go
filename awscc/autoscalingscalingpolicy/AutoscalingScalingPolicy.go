...
func (j *jsiiProxy_AutoscalingScalingPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutoscalingScalingPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutoscalingScalingPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutoscalingScalingPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutoscalingScalingPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AutoscalingScalingPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutoscalingScalingPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutoscalingScalingPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AutoscalingScalingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AutoscalingScalingPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingScalingPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutoscalingScalingPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingScalingPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutoscalingScalingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutoscalingScalingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
