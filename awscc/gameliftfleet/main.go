...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "playerGatewayConfigurationInput", GoGetter: "PlayerGatewayConfigurationInput"},
			_jsii_.MemberProperty{JsiiProperty: "playerGatewayMode", GoGetter: "PlayerGatewayMode"},
			_jsii_.MemberProperty{JsiiProperty: "playerGatewayModeInput", GoGetter: "PlayerGatewayModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putPlayerGatewayConfiguration", GoMethod: "PutPlayerGatewayConfiguration"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPlayerGatewayConfiguration", GoMethod: "ResetPlayerGatewayConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resetPlayerGatewayMode", GoMethod: "ResetPlayerGatewayMode"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GameliftFleetLocationsLocationCapacityManagedCapacityConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.gameliftFleet.GameliftFleetLocationsLocationCapacityManagedCapacityConfigurationOutputReference",
		reflect.TypeOf((*GameliftFleetLocationsLocationCapacityManagedCapacityConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetScaleInAfterInactivityMinutes", GoMethod: "ResetScaleInAfterInactivityMinutes"},
			_jsii_.MemberMethod{JsiiMethod: "resetZeroCapacityStrategy", GoMethod: "ResetZeroCapacityStrategy"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "scaleInAfterInactivityMinutes", GoGetter: "ScaleInAfterInactivityMinutes"},
			_jsii_.MemberProperty{JsiiProperty: "scaleInAfterInactivityMinutesInput", GoGetter: "ScaleInAfterInactivityMinutesInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "zeroCapacityStrategy", GoGetter: "ZeroCapacityStrategy"},
			_jsii_.MemberProperty{JsiiProperty: "zeroCapacityStrategyInput", GoGetter: "ZeroCapacityStrategyInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "managedCapacityConfiguration", GoGetter: "ManagedCapacityConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "managedCapacityConfigurationInput", GoGetter: "ManagedCapacityConfigurationInput"},
			_jsii_.MemberProperty{JsiiProperty: "maxSize", GoGetter: "MaxSize"},
			_jsii_.MemberProperty{JsiiProperty: "maxSizeInput", GoGetter: "MaxSizeInput"},
			_jsii_.MemberProperty{JsiiProperty: "minSize", GoGetter: "MinSize"},
			_jsii_.MemberProperty{JsiiProperty: "minSizeInput", GoGetter: "MinSizeInput"},
			_jsii_.MemberMethod{JsiiMethod: "putManagedCapacityConfiguration", GoMethod: "PutManagedCapacityConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resetDesiredEc2Instances", GoMethod: "ResetDesiredEc2Instances"},
			_jsii_.MemberMethod{JsiiMethod: "resetManagedCapacityConfiguration", GoMethod: "ResetManagedCapacityConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaxSize", GoMethod: "ResetMaxSize"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinSize", GoMethod: "ResetMinSize"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "playerGatewayStatus", GoGetter: "PlayerGatewayStatus"},
			_jsii_.MemberProperty{JsiiProperty: "playerGatewayStatusInput", GoGetter: "PlayerGatewayStatusInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPlayerGatewayStatus", GoMethod: "ResetPlayerGatewayStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GameliftFleetPlayerGatewayConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.gameliftFleet.GameliftFleetPlayerGatewayConfigurationOutputReference",
		reflect.TypeOf((*GameliftFleetPlayerGatewayConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "gameServerIpProtocolSupported", GoGetter: "GameServerIpProtocolSupported"},
			_jsii_.MemberProperty{JsiiProperty: "gameServerIpProtocolSupportedInput", GoGetter: "GameServerIpProtocolSupportedInput"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getListAttribute", GoMethod: "GetListAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetGameServerIpProtocolSupported", GoMethod: "ResetGameServerIpProtocolSupported"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		...
		func() interface{} {
			j := jsiiProxy_GameliftFleetPlayerGatewayConfigurationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
