...
type GameliftFleet interface {
	...
	PlayerGatewayConfiguration() GameliftFleetPlayerGatewayConfigurationOutputReference
	PlayerGatewayConfigurationInput() interface{}
	...
	PutPlayerGatewayConfiguration(value *GameliftFleetPlayerGatewayConfiguration)
	...
	ResetPeerVpcId()
	ResetPlayerGatewayConfiguration()
...
func (j *jsiiProxy_GameliftFleet) PlayerGatewayConfiguration() GameliftFleetPlayerGatewayConfigurationOutputReference {
	var returns GameliftFleetPlayerGatewayConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GameliftFleet) PlayerGatewayConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"playerGatewayConfigurationInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_GameliftFleet) PlayerGatewayMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"playerGatewayMode",
...
func (j *jsiiProxy_GameliftFleet) PlayerGatewayModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GameliftFleet)SetPlayerGatewayMode(val *string) {
...
func (g *jsiiProxy_GameliftFleet) PutPlayerGatewayConfiguration(value *GameliftFleetPlayerGatewayConfiguration) {
	if err := g.validatePutPlayerGatewayConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
		"putPlayerGatewayConfiguration",
		[]interface{}{value},
	)
}
...
func (g *jsiiProxy_GameliftFleet) ResetPlayerGatewayConfiguration() {
	_jsii_.InvokeVoid(
		g,
		"resetPlayerGatewayConfiguration",
		nil, // no parameters
...
func (g *jsiiProxy_GameliftFleet) ResetPlayerGatewayMode() {
	_jsii_.InvokeVoid(
		g,
		"resetPlayerGatewayMode",
		nil, // no parameters
