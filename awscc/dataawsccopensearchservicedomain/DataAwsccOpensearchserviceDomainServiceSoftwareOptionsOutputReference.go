...
type DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference interface {
	...
	NewVersion() *string
	OptionalDeployment() cdktn.IResolvable
	// Experimental.
	...
	UpdateAvailable() cdktn.IResolvable
	UpdateStatus() *string
	// Experimental.
	ComputeFqn() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference) Cancellable() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference) OptionalDeployment() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"optionalDeployment",
...
func (j *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference) UpdateAvailable() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"updateAvailable",
...
func NewDataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference {
	_init_.Initialize()
...
func NewDataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference_Override(d DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccOpensearchserviceDomainServiceSoftwareOptionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
