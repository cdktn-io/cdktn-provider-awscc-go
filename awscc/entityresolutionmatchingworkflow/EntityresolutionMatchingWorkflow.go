...
func (j *jsiiProxy_EntityresolutionMatchingWorkflow) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EntityresolutionMatchingWorkflow) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EntityresolutionMatchingWorkflow) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EntityresolutionMatchingWorkflow) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EntityresolutionMatchingWorkflow) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/entityresolution_matching_workflow awscc_entityresolution_matching_workflow} Resource.
...
func (j *jsiiProxy_EntityresolutionMatchingWorkflow)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EntityresolutionMatchingWorkflow)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EntityresolutionMatchingWorkflow)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EntityresolutionMatchingWorkflow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EntityresolutionMatchingWorkflow) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EntityresolutionMatchingWorkflow) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EntityresolutionMatchingWorkflow) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EntityresolutionMatchingWorkflow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EntityresolutionMatchingWorkflow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EntityresolutionMatchingWorkflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
