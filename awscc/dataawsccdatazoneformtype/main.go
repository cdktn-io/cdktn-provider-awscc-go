...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDatazoneFormType)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "formTypeIdentifier", GoGetter: "FormTypeIdentifier"},
			...
			_jsii_.MemberProperty{JsiiProperty: "owningProjectId", GoGetter: "OwningProjectId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDatazoneFormTypeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccDatazoneFormType.DataAwsccDatazoneFormTypeModel",
		reflect.TypeOf((*DataAwsccDatazoneFormTypeModel)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccDatazoneFormType.DataAwsccDatazoneFormTypeModelOutputReference",
		reflect.TypeOf((*DataAwsccDatazoneFormTypeModelOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
