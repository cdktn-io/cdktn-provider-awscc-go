...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ConnectQuickConnectQuickConnectConfigFlowConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.connectQuickConnect.ConnectQuickConnectQuickConnectConfigFlowConfigOutputReference",
		reflect.TypeOf((*ConnectQuickConnectQuickConnectConfigFlowConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "flowConfigInput", GoGetter: "FlowConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putFlowConfig", GoMethod: "PutFlowConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFlowConfig", GoMethod: "ResetFlowConfig"},
