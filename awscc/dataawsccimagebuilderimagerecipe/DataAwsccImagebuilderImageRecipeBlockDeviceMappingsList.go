...
func (j *jsiiProxy_DataAwsccImagebuilderImageRecipeBlockDeviceMappingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccImagebuilderImageRecipeBlockDeviceMappingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccImagebuilderImageRecipeBlockDeviceMappingsList {
	_init_.Initialize()
...
func NewDataAwsccImagebuilderImageRecipeBlockDeviceMappingsList_Override(d DataAwsccImagebuilderImageRecipeBlockDeviceMappingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccImagebuilderImageRecipeBlockDeviceMappingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccImagebuilderImageRecipeBlockDeviceMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccImagebuilderImageRecipeBlockDeviceMappingsList) Resolve(context cdktn.IResolveContext) interface{} {
