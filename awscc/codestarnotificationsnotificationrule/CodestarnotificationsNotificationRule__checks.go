...
func (c *jsiiProxy_CodestarnotificationsNotificationRule) validatePutTargetsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodestarnotificationsNotificationRuleTargets; received %#v (a %T)", value, value)
		}
	}
