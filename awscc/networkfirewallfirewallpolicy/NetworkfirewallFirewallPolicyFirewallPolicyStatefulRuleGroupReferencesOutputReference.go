...
type NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference interface {
	...
	SetDeepThreatInspection(val interface{})
	DeepThreatInspectionInput() interface{}
	// Experimental.
	Fqn() *string
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference) DeepThreatInspection() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference) DeepThreatInspectionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference {
	_init_.Initialize()
...
func NewNetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference_Override(n NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference)SetDeepThreatInspection(val interface{}) {
...
func (j *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference) ResetDeepThreatInspection() {
	_jsii_.InvokeVoid(
		n,
		"resetDeepThreatInspection",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkfirewallFirewallPolicyFirewallPolicyStatefulRuleGroupReferencesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
