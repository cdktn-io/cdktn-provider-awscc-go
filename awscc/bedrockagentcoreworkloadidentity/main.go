...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BedrockagentcoreWorkloadIdentityTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.bedrockagentcoreWorkloadIdentity.BedrockagentcoreWorkloadIdentityTagsList",
		reflect.TypeOf((*BedrockagentcoreWorkloadIdentityTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BedrockagentcoreWorkloadIdentityTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
