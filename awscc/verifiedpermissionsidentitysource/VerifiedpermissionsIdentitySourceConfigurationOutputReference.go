...
func NewVerifiedpermissionsIdentitySourceConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) VerifiedpermissionsIdentitySourceConfigurationOutputReference {
	_init_.Initialize()
...
func NewVerifiedpermissionsIdentitySourceConfigurationOutputReference_Override(v VerifiedpermissionsIdentitySourceConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
