...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense) Tags() DataAwsccLicensemanagerLicenseTagsList {
	var returns DataAwsccLicensemanagerLicenseTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccLicensemanagerLicense)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccLicensemanagerLicense_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccLicensemanagerLicense) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLicensemanagerLicense) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLicensemanagerLicense) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccLicensemanagerLicense) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
