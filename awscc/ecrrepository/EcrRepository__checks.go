...
func (e *jsiiProxy_EcrRepository) validatePutImageTagMutabilityExclusionFiltersParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*EcrRepositoryImageTagMutabilityExclusionFilters:
		value := value.(*[]*EcrRepositoryImageTagMutabilityExclusionFilters)
	...
	case []*EcrRepositoryImageTagMutabilityExclusionFilters:
		value_ := value.([]*EcrRepositoryImageTagMutabilityExclusionFilters)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcrRepositoryImageTagMutabilityExclusionFilters; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EcrRepository) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcrRepositoryTags; received %#v (a %T)", value, value)
		}
	}
