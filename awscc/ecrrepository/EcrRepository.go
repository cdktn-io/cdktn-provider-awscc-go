...
type EcrRepository interface {
	...
	ImageTagMutabilityExclusionFilters() EcrRepositoryImageTagMutabilityExclusionFiltersList
...
func (j *jsiiProxy_EcrRepository) ImageTagMutabilityExclusionFilters() EcrRepositoryImageTagMutabilityExclusionFiltersList {
	var returns EcrRepositoryImageTagMutabilityExclusionFiltersList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcrRepository) ImageTagMutabilityExclusionFiltersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (e *jsiiProxy_EcrRepository) PutImageTagMutabilityExclusionFilters(value interface{}) {
...
func (e *jsiiProxy_EcrRepository) ResetImageTagMutabilityExclusionFilters() {
	_jsii_.InvokeVoid(
		e,
		"resetImageTagMutabilityExclusionFilters",
		nil, // no parameters
