...
func (j *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (a *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) ResetDestinationArn() {
	_jsii_.InvokeVoid(
		a,
		"resetDestinationArn",
		nil, // no parameters
...
func (a *jsiiProxy_Apigatewayv2StageAccessLogSettingsOutputReference) ResetFormat() {
	_jsii_.InvokeVoid(
		a,
		"resetFormat",
		nil, // no parameters
