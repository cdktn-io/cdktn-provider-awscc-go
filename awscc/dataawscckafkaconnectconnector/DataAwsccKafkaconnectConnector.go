...
type DataAwsccKafkaconnectConnector interface {
	...
	ConnectorArn() *string
	ConnectorConfiguration() cdktn.StringMap
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector) ConnectorConfiguration() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector) NetworkType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkType",
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccKafkaconnectConnector)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccKafkaconnectConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccKafkaconnectConnector) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccKafkaconnectConnector) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccKafkaconnectConnector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccKafkaconnectConnector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
