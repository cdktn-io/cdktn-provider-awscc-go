...
func (j *jsiiProxy_LambdaUrlCorsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaUrlCorsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaUrlCorsOutputReference {
	_init_.Initialize()
...
func NewLambdaUrlCorsOutputReference_Override(l LambdaUrlCorsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaUrlCorsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaUrlCorsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaUrlCorsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaUrlCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaUrlCorsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
