...
func (j *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) DependsOnInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOnInput",
...
func (j *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference)SetDependsOn(val *[]*string) {
...
func (c *jsiiProxy_CloudformationStackSetAutoDeploymentOutputReference) ResetDependsOn() {
	_jsii_.InvokeVoid(
		c,
		"resetDependsOn",
		nil, // no parameters
