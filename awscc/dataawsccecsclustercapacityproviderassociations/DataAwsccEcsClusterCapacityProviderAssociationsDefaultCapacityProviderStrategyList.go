...
func (j *jsiiProxy_DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList {
	_init_.Initialize()
...
func NewDataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList_Override(d DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccEcsClusterCapacityProviderAssociationsDefaultCapacityProviderStrategyList) Resolve(context cdktn.IResolveContext) interface{} {
