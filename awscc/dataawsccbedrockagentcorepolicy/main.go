...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcorePolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcorePolicyDefinitionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcorePolicyDefinitionPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccBedrockagentcorePolicy.DataAwsccBedrockagentcorePolicyDefinitionPolicyOutputReference",
		reflect.TypeOf((*DataAwsccBedrockagentcorePolicyDefinitionPolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
