...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/lightsailloadbalancertlscertificate/internal"
...
func (j *jsiiProxy_LightsailLoadBalancerTlsCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LightsailLoadBalancerTlsCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LightsailLoadBalancerTlsCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LightsailLoadBalancerTlsCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LightsailLoadBalancerTlsCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LightsailLoadBalancerTlsCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LightsailLoadBalancerTlsCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LightsailLoadBalancerTlsCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LightsailLoadBalancerTlsCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LightsailLoadBalancerTlsCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailLoadBalancerTlsCertificate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LightsailLoadBalancerTlsCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LightsailLoadBalancerTlsCertificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LightsailLoadBalancerTlsCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LightsailLoadBalancerTlsCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
