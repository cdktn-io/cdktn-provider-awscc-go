...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Route53GlobalresolverAccessSource)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Route53GlobalresolverAccessSourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.route53GlobalresolverAccessSource.Route53GlobalresolverAccessSourceTags",
		reflect.TypeOf((*Route53GlobalresolverAccessSourceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.route53GlobalresolverAccessSource.Route53GlobalresolverAccessSourceTagsList",
		reflect.TypeOf((*Route53GlobalresolverAccessSourceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Route53GlobalresolverAccessSourceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
