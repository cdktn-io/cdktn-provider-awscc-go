...
func (j *jsiiProxy_ConnectWorkspaceTagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*ConnectWorkspaceTags:
		val := val.(*[]*ConnectWorkspaceTags)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*ConnectWorkspaceTags; received %#v (a %T)", val, val)
		}
	}
