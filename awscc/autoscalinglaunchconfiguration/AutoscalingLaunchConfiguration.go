...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/autoscalinglaunchconfiguration/internal"
...
func (j *jsiiProxy_AutoscalingLaunchConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AutoscalingLaunchConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AutoscalingLaunchConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AutoscalingLaunchConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AutoscalingLaunchConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_AutoscalingLaunchConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AutoscalingLaunchConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AutoscalingLaunchConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AutoscalingLaunchConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AutoscalingLaunchConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingLaunchConfiguration) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AutoscalingLaunchConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AutoscalingLaunchConfiguration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AutoscalingLaunchConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AutoscalingLaunchConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
