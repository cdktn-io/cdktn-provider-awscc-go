...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*MediaconnectFlowVpcInterfaceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.mediaconnectFlowVpcInterface.MediaconnectFlowVpcInterfaceTagsList",
		reflect.TypeOf((*MediaconnectFlowVpcInterfaceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MediaconnectFlowVpcInterfaceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
