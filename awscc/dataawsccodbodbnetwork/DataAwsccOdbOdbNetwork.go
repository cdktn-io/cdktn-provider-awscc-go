...
type DataAwsccOdbOdbNetwork interface {
	...
	DeleteAssociatedResources() cdktn.IResolvable
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	...
	ManagedServices() DataAwsccOdbOdbNetworkManagedServicesOutputReference
	// The tree node.
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) CrossRegionS3RestoreSources() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) CustomDomainName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customDomainName",
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) DeleteAssociatedResources() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) Ec2PlacementGroupIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) KmsAccess() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsAccess",
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) KmsPolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsPolicyDocument",
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) ManagedServices() DataAwsccOdbOdbNetworkManagedServicesOutputReference {
	var returns DataAwsccOdbOdbNetworkManagedServicesOutputReference
	_jsii_.Get(
		j,
		"managedServices",
		&returns,
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) S3Access() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3Access",
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) S3PolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3PolicyDocument",
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) StsAccess() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stsAccess",
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) StsPolicyDocument() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stsPolicyDocument",
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork) ZeroEtlAccess() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zeroEtlAccess",
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccOdbOdbNetwork)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccOdbOdbNetwork_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccOdbOdbNetwork) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccOdbOdbNetwork) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccOdbOdbNetwork) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccOdbOdbNetwork) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
