...
func (j *jsiiProxy_MediatailorVodSourceTagsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMediatailorVodSourceTagsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MediatailorVodSourceTagsOutputReference {
	_init_.Initialize()
...
func NewMediatailorVodSourceTagsOutputReference_Override(m MediatailorVodSourceTagsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MediatailorVodSourceTagsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MediatailorVodSourceTagsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MediatailorVodSourceTagsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_MediatailorVodSourceTagsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MediatailorVodSourceTagsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
