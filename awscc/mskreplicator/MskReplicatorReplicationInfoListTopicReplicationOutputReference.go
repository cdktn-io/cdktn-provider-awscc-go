...
func NewMskReplicatorReplicationInfoListTopicReplicationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MskReplicatorReplicationInfoListTopicReplicationOutputReference {
	_init_.Initialize()
...
func NewMskReplicatorReplicationInfoListTopicReplicationOutputReference_Override(m MskReplicatorReplicationInfoListTopicReplicationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
