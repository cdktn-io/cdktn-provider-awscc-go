...
func (j *jsiiProxy_MskReplicatorLogDeliveryReplicatorLogDeliveryCloudwatchLogsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_MskReplicatorLogDeliveryReplicatorLogDeliveryCloudwatchLogsOutputReference)SetInternalValue(val interface{}) {
...
func (m *jsiiProxy_MskReplicatorLogDeliveryReplicatorLogDeliveryCloudwatchLogsOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		m,
		"resetEnabled",
		nil, // no parameters
