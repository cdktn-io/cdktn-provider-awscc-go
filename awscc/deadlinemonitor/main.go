...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "identityCenterRegionInput", GoGetter: "IdentityCenterRegionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIdentityCenterRegion", GoMethod: "ResetIdentityCenterRegion"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DeadlineMonitorTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.deadlineMonitor.DeadlineMonitorTagsList",
		reflect.TypeOf((*DeadlineMonitorTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DeadlineMonitorTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
