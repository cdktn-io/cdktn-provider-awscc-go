...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/stepfunctionsactivity/internal"
...
func (j *jsiiProxy_StepfunctionsActivity) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StepfunctionsActivity) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StepfunctionsActivity) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StepfunctionsActivity) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StepfunctionsActivity) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_StepfunctionsActivity)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StepfunctionsActivity)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StepfunctionsActivity)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StepfunctionsActivity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StepfunctionsActivity) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StepfunctionsActivity) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StepfunctionsActivity) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StepfunctionsActivity) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StepfunctionsActivity) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StepfunctionsActivity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
