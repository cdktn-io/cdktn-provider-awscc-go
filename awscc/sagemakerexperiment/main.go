...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerExperiment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SagemakerExperimentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.sagemakerExperiment.SagemakerExperimentTags",
		reflect.TypeOf((*SagemakerExperimentTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.sagemakerExperiment.SagemakerExperimentTagsList",
		reflect.TypeOf((*SagemakerExperimentTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SagemakerExperimentTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
