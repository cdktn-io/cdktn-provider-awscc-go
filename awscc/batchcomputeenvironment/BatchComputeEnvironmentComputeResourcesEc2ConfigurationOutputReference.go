...
type BatchComputeEnvironmentComputeResourcesEc2ConfigurationOutputReference interface {
	...
	SetBatchImageStatus(val *string)
	BatchImageStatusInput() *string
...
func (j *jsiiProxy_BatchComputeEnvironmentComputeResourcesEc2ConfigurationOutputReference) BatchImageStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"batchImageStatus",
...
func (j *jsiiProxy_BatchComputeEnvironmentComputeResourcesEc2ConfigurationOutputReference) BatchImageStatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"batchImageStatusInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_BatchComputeEnvironmentComputeResourcesEc2ConfigurationOutputReference)SetBatchImageStatus(val *string) {
	if err := j.validateSetBatchImageStatusParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (b *jsiiProxy_BatchComputeEnvironmentComputeResourcesEc2ConfigurationOutputReference) ResetBatchImageStatus() {
	_jsii_.InvokeVoid(
		b,
		"resetBatchImageStatus",
		nil, // no parameters
