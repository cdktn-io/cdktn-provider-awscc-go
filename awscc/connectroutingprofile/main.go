...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "manualAssignmentQueueConfigsInput", GoGetter: "ManualAssignmentQueueConfigsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putManualAssignmentQueueConfigs", GoMethod: "PutManualAssignmentQueueConfigs"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetManualAssignmentQueueConfigs", GoMethod: "ResetManualAssignmentQueueConfigs"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ConnectRoutingProfileManualAssignmentQueueConfigs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.connectRoutingProfile.ConnectRoutingProfileManualAssignmentQueueConfigsList",
		reflect.TypeOf((*ConnectRoutingProfileManualAssignmentQueueConfigsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectRoutingProfileManualAssignmentQueueConfigsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ConnectRoutingProfileManualAssignmentQueueConfigsQueueReference)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectRoutingProfileManualAssignmentQueueConfigsQueueReferenceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
