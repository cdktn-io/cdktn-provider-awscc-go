...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateAuthority)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateAuthority)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateAuthority)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccAcmpcaCertificateAuthority_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccAcmpcaCertificateAuthority) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
