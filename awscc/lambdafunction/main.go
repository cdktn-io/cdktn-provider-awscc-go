...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publishToLatestPublishedInput", GoGetter: "PublishToLatestPublishedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPublishToLatestPublished", GoMethod: "ResetPublishToLatestPublished"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLambdaManagedInstancesCapacityProviderConfig", GoMethod: "ResetLambdaManagedInstancesCapacityProviderConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetS3ObjectStorageMode", GoMethod: "ResetS3ObjectStorageMode"},
			...
			_jsii_.MemberProperty{JsiiProperty: "s3ObjectStorageModeInput", GoGetter: "S3ObjectStorageModeInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LambdaFunctionFunctionScalingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.lambdaFunction.LambdaFunctionFunctionScalingConfigOutputReference",
		reflect.TypeOf((*LambdaFunctionFunctionScalingConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetTenantIsolationMode", GoMethod: "ResetTenantIsolationMode"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
