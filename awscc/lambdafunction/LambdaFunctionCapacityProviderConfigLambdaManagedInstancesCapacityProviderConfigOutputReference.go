...
func (j *jsiiProxy_LambdaFunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LambdaFunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfigOutputReference)SetInternalValue(val interface{}) {
...
func (l *jsiiProxy_LambdaFunctionCapacityProviderConfigLambdaManagedInstancesCapacityProviderConfigOutputReference) ResetCapacityProviderArn() {
	_jsii_.InvokeVoid(
		l,
		"resetCapacityProviderArn",
		nil, // no parameters
