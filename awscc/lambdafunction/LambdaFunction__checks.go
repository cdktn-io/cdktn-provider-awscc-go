...
func (l *jsiiProxy_LambdaFunction) validatePutFileSystemConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LambdaFunctionFileSystemConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_LambdaFunction) validatePutFunctionScalingConfigParameters(value *LambdaFunctionFunctionScalingConfig) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (l *jsiiProxy_LambdaFunction) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LambdaFunctionTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_LambdaFunction) validateSetPublishToLatestPublishedParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
