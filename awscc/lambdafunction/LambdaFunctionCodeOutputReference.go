...
type LambdaFunctionCodeOutputReference interface {
	...
	SetS3ObjectStorageMode(val *string)
	S3ObjectStorageModeInput() *string
...
func (j *jsiiProxy_LambdaFunctionCodeOutputReference) S3ObjectStorageMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3ObjectStorageMode",
...
func (j *jsiiProxy_LambdaFunctionCodeOutputReference) S3ObjectStorageModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3ObjectStorageModeInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_LambdaFunctionCodeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaFunctionCodeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaFunctionCodeOutputReference {
	_init_.Initialize()
...
func NewLambdaFunctionCodeOutputReference_Override(l LambdaFunctionCodeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaFunctionCodeOutputReference)SetS3ObjectStorageMode(val *string) {
	if err := j.validateSetS3ObjectStorageModeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_LambdaFunctionCodeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaFunctionCodeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionCodeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaFunctionCodeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaFunctionCodeOutputReference) ResetS3ObjectStorageMode() {
	_jsii_.InvokeVoid(
		l,
		"resetS3ObjectStorageMode",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaFunctionCodeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
