...
type DataAwsccSsmAssociation interface {
	...
	Parameters() cdktn.StringListMap
	// Experimental.
...
func (j *jsiiProxy_DataAwsccSsmAssociation) ApplyOnlyAtCronInterval() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccSsmAssociation) AssociationDispatchAssumeRole() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccSsmAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccSsmAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccSsmAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccSsmAssociation) Parameters() cdktn.StringListMap {
...
func (j *jsiiProxy_DataAwsccSsmAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccSsmAssociation) Tags() DataAwsccSsmAssociationTagsList {
	var returns DataAwsccSsmAssociationTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_DataAwsccSsmAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccSsmAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccSsmAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccSsmAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccSsmAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccSsmAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSsmAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSsmAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccSsmAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
