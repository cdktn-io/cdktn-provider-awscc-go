...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryCode",
		reflect.TypeOf((*CodecommitRepositoryCode)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryCodeOutputReference",
		reflect.TypeOf((*CodecommitRepositoryCodeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryCodeS3",
		reflect.TypeOf((*CodecommitRepositoryCodeS3)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryCodeS3OutputReference",
		reflect.TypeOf((*CodecommitRepositoryCodeS3OutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryConfig",
		reflect.TypeOf((*CodecommitRepositoryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryTags",
		reflect.TypeOf((*CodecommitRepositoryTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryTagsList",
		reflect.TypeOf((*CodecommitRepositoryTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodecommitRepositoryTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryTriggers",
		reflect.TypeOf((*CodecommitRepositoryTriggers)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepositoryTriggersList",
		reflect.TypeOf((*CodecommitRepositoryTriggersList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodecommitRepositoryTriggersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
