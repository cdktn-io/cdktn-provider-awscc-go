...
type CodecommitRepository interface {
	...
	PutCode(value *CodecommitRepositoryCode)
...
func (j *jsiiProxy_CodecommitRepository) Code() CodecommitRepositoryCodeOutputReference {
	var returns CodecommitRepositoryCodeOutputReference
	_jsii_.Get(
		j,
		"code",
		&returns,
...
func (j *jsiiProxy_CodecommitRepository) CodeInput() interface{} {
...
func (j *jsiiProxy_CodecommitRepository) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CodecommitRepository) RepositoryDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodecommitRepository) RepositoryDescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodecommitRepository) Tags() CodecommitRepositoryTagsList {
	var returns CodecommitRepositoryTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CodecommitRepository) Triggers() CodecommitRepositoryTriggersList {
	var returns CodecommitRepositoryTriggersList
	_jsii_.Get(
		j,
		"triggers",
		&returns,
...
func (j *jsiiProxy_CodecommitRepository) TriggersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"triggersInput",
...
func NewCodecommitRepository(scope constructs.Construct, id *string, config *CodecommitRepositoryConfig) CodecommitRepository {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.codecommitRepository.CodecommitRepository",
...
func (j *jsiiProxy_CodecommitRepository)SetRepositoryDescription(val *string) {
...
func (c *jsiiProxy_CodecommitRepository) PutCode(value *CodecommitRepositoryCode) {
	if err := c.validatePutCodeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_CodecommitRepository) PutTags(value interface{}) {
...
func (c *jsiiProxy_CodecommitRepository) PutTriggers(value interface{}) {
...
func (c *jsiiProxy_CodecommitRepository) ResetCode() {
	_jsii_.InvokeVoid(
		c,
		"resetCode",
		nil, // no parameters
...
func (c *jsiiProxy_CodecommitRepository) ResetRepositoryDescription() {
	_jsii_.InvokeVoid(
		c,
		"resetRepositoryDescription",
		nil, // no parameters
...
func (c *jsiiProxy_CodecommitRepository) ResetTriggers() {
	_jsii_.InvokeVoid(
		c,
		"resetTriggers",
		nil, // no parameters
