...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/glueworkflow/internal"
...
type GlueWorkflow interface {
	...
	SetDefaultRunProperties(val *string)
	DefaultRunPropertiesInput() *string
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_GlueWorkflow) DefaultRunProperties() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueWorkflow) DefaultRunPropertiesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueWorkflow) Tags() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_GlueWorkflow) TagsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_GlueWorkflow)SetDefaultRunProperties(val *string) {
...
func (j *jsiiProxy_GlueWorkflow)SetTags(val *string) {
