...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.rdsDbSnapshot.RdsDbSnapshotConfig",
		reflect.TypeOf((*RdsDbSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.rdsDbSnapshot.RdsDbSnapshotTags",
		reflect.TypeOf((*RdsDbSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.rdsDbSnapshot.RdsDbSnapshotTagsList",
		reflect.TypeOf((*RdsDbSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RdsDbSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
