...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*TranscribeVocabularyFilterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.transcribeVocabularyFilter.TranscribeVocabularyFilterTagsList",
		reflect.TypeOf((*TranscribeVocabularyFilterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TranscribeVocabularyFilterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
