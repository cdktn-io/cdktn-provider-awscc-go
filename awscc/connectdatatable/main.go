...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectDataTable)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "valueLockLevelInput", GoGetter: "ValueLockLevelInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ConnectDataTableConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.connectDataTable.ConnectDataTableLockVersion",
		reflect.TypeOf((*ConnectDataTableLockVersion)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.connectDataTable.ConnectDataTableLockVersionOutputReference",
		reflect.TypeOf((*ConnectDataTableLockVersionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ConnectDataTableTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.connectDataTable.ConnectDataTableTagsList",
		reflect.TypeOf((*ConnectDataTableTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectDataTableTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
