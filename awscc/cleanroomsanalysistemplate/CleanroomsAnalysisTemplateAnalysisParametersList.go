...
func (j *jsiiProxy_CleanroomsAnalysisTemplateAnalysisParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCleanroomsAnalysisTemplateAnalysisParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CleanroomsAnalysisTemplateAnalysisParametersList {
	_init_.Initialize()
...
func NewCleanroomsAnalysisTemplateAnalysisParametersList_Override(c CleanroomsAnalysisTemplateAnalysisParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CleanroomsAnalysisTemplateAnalysisParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CleanroomsAnalysisTemplateAnalysisParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CleanroomsAnalysisTemplateAnalysisParametersList) Resolve(context cdktn.IResolveContext) interface{} {
