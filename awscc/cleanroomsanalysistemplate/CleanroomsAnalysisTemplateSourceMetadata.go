...
type CleanroomsAnalysisTemplateSourceMetadata struct {
	...
	Artifacts *CleanroomsAnalysisTemplateSourceMetadataArtifacts `field:"optional" json:"artifacts" yaml:"artifacts"`
}
