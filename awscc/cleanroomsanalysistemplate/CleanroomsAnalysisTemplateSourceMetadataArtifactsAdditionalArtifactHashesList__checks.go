...
func (c *jsiiProxy_CleanroomsAnalysisTemplateSourceMetadataArtifactsAdditionalArtifactHashesList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_CleanroomsAnalysisTemplateSourceMetadataArtifactsAdditionalArtifactHashesList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewCleanroomsAnalysisTemplateSourceMetadataArtifactsAdditionalArtifactHashesListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
