...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccServicecatalogPortfolio)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "portfolioName", GoGetter: "PortfolioName"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccServicecatalogPortfolioConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccServicecatalogPortfolio.DataAwsccServicecatalogPortfolioTags",
		reflect.TypeOf((*DataAwsccServicecatalogPortfolioTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccServicecatalogPortfolio.DataAwsccServicecatalogPortfolioTagsList",
		reflect.TypeOf((*DataAwsccServicecatalogPortfolioTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccServicecatalogPortfolioTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccServicecatalogPortfolioTagsOutputReference{}
