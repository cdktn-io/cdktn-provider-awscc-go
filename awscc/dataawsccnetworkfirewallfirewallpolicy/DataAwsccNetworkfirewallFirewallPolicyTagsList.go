...
func (j *jsiiProxy_DataAwsccNetworkfirewallFirewallPolicyTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccNetworkfirewallFirewallPolicyTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccNetworkfirewallFirewallPolicyTagsList {
	_init_.Initialize()
...
func NewDataAwsccNetworkfirewallFirewallPolicyTagsList_Override(d DataAwsccNetworkfirewallFirewallPolicyTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccNetworkfirewallFirewallPolicyTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccNetworkfirewallFirewallPolicyTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccNetworkfirewallFirewallPolicyTagsList) Resolve(context cdktn.IResolveContext) interface{} {
