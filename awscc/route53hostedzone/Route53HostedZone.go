...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/route53hostedzone/internal"
...
type Route53HostedZone interface {
	...
	HostedZoneFeatures() Route53HostedZoneHostedZoneFeaturesOutputReference
	HostedZoneFeaturesInput() interface{}
	HostedZoneId() *string
	...
	PutHostedZoneFeatures(value *Route53HostedZoneHostedZoneFeatures)
...
func (j *jsiiProxy_Route53HostedZone) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53HostedZone) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53HostedZone) HostedZoneFeatures() Route53HostedZoneHostedZoneFeaturesOutputReference {
	var returns Route53HostedZoneHostedZoneFeaturesOutputReference
	_jsii_.Get(
		j,
		"hostedZoneFeatures",
		&returns,
...
func (j *jsiiProxy_Route53HostedZone) HostedZoneFeaturesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"hostedZoneFeaturesInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_Route53HostedZone) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53HostedZone) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53HostedZone) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Route53HostedZone)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53HostedZone)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53HostedZone)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53HostedZone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53HostedZone) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53HostedZone) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53HostedZone) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53HostedZone) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53HostedZone) PutHostedZoneFeatures(value *Route53HostedZoneHostedZoneFeatures) {
	if err := r.validatePutHostedZoneFeaturesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
		"putHostedZoneFeatures",
		[]interface{}{value},
	)
}
...
func (r *jsiiProxy_Route53HostedZone) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53HostedZone) ResetHostedZoneFeatures() {
	_jsii_.InvokeVoid(
		r,
		"resetHostedZoneFeatures",
		nil, // no parameters
...
func (r *jsiiProxy_Route53HostedZone) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
