...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RedshiftSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.redshiftSnapshot.RedshiftSnapshotConfig",
		reflect.TypeOf((*RedshiftSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.redshiftSnapshot.RedshiftSnapshotTags",
		reflect.TypeOf((*RedshiftSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.redshiftSnapshot.RedshiftSnapshotTagsList",
		reflect.TypeOf((*RedshiftSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RedshiftSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
