...
type WisdomMessageTemplate interface {
	...
	MessageTemplateAttachments() WisdomMessageTemplateMessageTemplateAttachmentsList
	MessageTemplateAttachmentsInput() interface{}
	...
	PutMessageTemplateAttachments(value interface{})
	...
	ResetLanguage()
	ResetMessageTemplateAttachments()
...
func (j *jsiiProxy_WisdomMessageTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_WisdomMessageTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_WisdomMessageTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_WisdomMessageTemplate) MessageTemplateAttachments() WisdomMessageTemplateMessageTemplateAttachmentsList {
	var returns WisdomMessageTemplateMessageTemplateAttachmentsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WisdomMessageTemplate) MessageTemplateAttachmentsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"messageTemplateAttachmentsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_WisdomMessageTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_WisdomMessageTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_WisdomMessageTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_WisdomMessageTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_WisdomMessageTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func WisdomMessageTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_WisdomMessageTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WisdomMessageTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_WisdomMessageTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_WisdomMessageTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WisdomMessageTemplate) PutMessageTemplateAttachments(value interface{}) {
	if err := w.validatePutMessageTemplateAttachmentsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
		"putMessageTemplateAttachments",
		[]interface{}{value},
	)
}
...
func (w *jsiiProxy_WisdomMessageTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WisdomMessageTemplate) ResetMessageTemplateAttachments() {
	_jsii_.InvokeVoid(
		w,
		"resetMessageTemplateAttachments",
		nil, // no parameters
...
func (w *jsiiProxy_WisdomMessageTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
