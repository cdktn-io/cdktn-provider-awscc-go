...
func (s *jsiiProxy_SecurityhubAutomationRuleV2CriteriaOcsfFindingCriteriaOutputReference) validatePutCompositeFiltersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SecurityhubAutomationRuleV2CriteriaOcsfFindingCriteriaCompositeFilters; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SecurityhubAutomationRuleV2CriteriaOcsfFindingCriteriaOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *SecurityhubAutomationRuleV2CriteriaOcsfFindingCriteria; received %#v (a %T)", val, val)
		}
	}
