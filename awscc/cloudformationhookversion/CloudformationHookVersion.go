...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/cloudformationhookversion/internal"
...
func (j *jsiiProxy_CloudformationHookVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudformationHookVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudformationHookVersion) IsDefaultVersion() cdktn.IResolvable {
...
func (j *jsiiProxy_CloudformationHookVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudformationHookVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudformationHookVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/cloudformation_hook_version awscc_cloudformation_hook_version} Resource.
...
func (j *jsiiProxy_CloudformationHookVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudformationHookVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudformationHookVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudformationHookVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudformationHookVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationHookVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudformationHookVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationHookVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudformationHookVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudformationHookVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
