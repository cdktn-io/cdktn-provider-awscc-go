...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/lookoutmetricsalert/internal"
...
func (j *jsiiProxy_LookoutmetricsAlert) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LookoutmetricsAlert) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LookoutmetricsAlert) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LookoutmetricsAlert) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LookoutmetricsAlert) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LookoutmetricsAlert)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LookoutmetricsAlert)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LookoutmetricsAlert)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LookoutmetricsAlert_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LookoutmetricsAlert) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LookoutmetricsAlert) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LookoutmetricsAlert) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LookoutmetricsAlert) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LookoutmetricsAlert) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LookoutmetricsAlert) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
