...
type ImagebuilderComponent interface {
	...
	LatestVersion() ImagebuilderComponentLatestVersionOutputReference
	// Experimental.
...
func (j *jsiiProxy_ImagebuilderComponent) LatestVersion() ImagebuilderComponentLatestVersionOutputReference {
	var returns ImagebuilderComponentLatestVersionOutputReference
	_jsii_.Get(
		j,
		"latestVersion",
		&returns,
