...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ConnectIntegrationAssociationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.connectIntegrationAssociation.ConnectIntegrationAssociationTagsList",
		reflect.TypeOf((*ConnectIntegrationAssociationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConnectIntegrationAssociationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_ConnectIntegrationAssociationTagsOutputReference{}
