...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/networkfirewallloggingconfiguration/internal"
...
func (j *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList {
	_init_.Initialize()
...
func NewNetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList_Override(n NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkfirewallLoggingConfigurationLoggingConfigurationLogDestinationConfigsList) Resolve(context cdktn.IResolveContext) interface{} {
