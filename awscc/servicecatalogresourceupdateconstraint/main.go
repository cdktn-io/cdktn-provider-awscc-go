...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicecatalogResourceUpdateConstraint)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "resourceUpdateConstraintId", GoGetter: "ResourceUpdateConstraintId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tagUpdateOnProvisionedProductInput", GoGetter: "TagUpdateOnProvisionedProductInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ServicecatalogResourceUpdateConstraintConfig)(nil)).Elem(),
	)
}
