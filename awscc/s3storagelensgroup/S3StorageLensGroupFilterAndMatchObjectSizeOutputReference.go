...
func (j *jsiiProxy_S3StorageLensGroupFilterAndMatchObjectSizeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewS3StorageLensGroupFilterAndMatchObjectSizeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) S3StorageLensGroupFilterAndMatchObjectSizeOutputReference {
	_init_.Initialize()
...
func NewS3StorageLensGroupFilterAndMatchObjectSizeOutputReference_Override(s S3StorageLensGroupFilterAndMatchObjectSizeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_S3StorageLensGroupFilterAndMatchObjectSizeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_S3StorageLensGroupFilterAndMatchObjectSizeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3StorageLensGroupFilterAndMatchObjectSizeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_S3StorageLensGroupFilterAndMatchObjectSizeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3StorageLensGroupFilterAndMatchObjectSizeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
