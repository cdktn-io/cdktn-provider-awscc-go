...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CognitoUserPoolReplica)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUserPoolTagsAtCreate", GoMethod: "ResetUserPoolTagsAtCreate"},
			...
			_jsii_.MemberProperty{JsiiProperty: "userPoolTagsAtCreateInput", GoGetter: "UserPoolTagsAtCreateInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CognitoUserPoolReplicaConfig)(nil)).Elem(),
	)
}
