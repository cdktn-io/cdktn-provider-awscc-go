...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSmsvoiceSenderId)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSmsvoiceSenderIdConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccSmsvoiceSenderId.DataAwsccSmsvoiceSenderIdTags",
		reflect.TypeOf((*DataAwsccSmsvoiceSenderIdTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccSmsvoiceSenderId.DataAwsccSmsvoiceSenderIdTagsList",
		reflect.TypeOf((*DataAwsccSmsvoiceSenderIdTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSmsvoiceSenderIdTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccSmsvoiceSenderIdTagsOutputReference{}
