...
func (j *jsiiProxy_MacieFindingsFilterFindingCriteriaCriterionMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMacieFindingsFilterFindingCriteriaCriterionMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MacieFindingsFilterFindingCriteriaCriterionMap {
	_init_.Initialize()
...
func NewMacieFindingsFilterFindingCriteriaCriterionMap_Override(m MacieFindingsFilterFindingCriteriaCriterionMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_MacieFindingsFilterFindingCriteriaCriterionMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MacieFindingsFilterFindingCriteriaCriterionMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MacieFindingsFilterFindingCriteriaCriterionMap) Resolve(context cdktn.IResolveContext) interface{} {
