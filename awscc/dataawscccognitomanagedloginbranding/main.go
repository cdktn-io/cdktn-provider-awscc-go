...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCognitoManagedLoginBranding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCognitoManagedLoginBrandingAssets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccCognitoManagedLoginBranding.DataAwsccCognitoManagedLoginBrandingAssetsList",
		reflect.TypeOf((*DataAwsccCognitoManagedLoginBrandingAssetsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCognitoManagedLoginBrandingAssetsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCognitoManagedLoginBrandingConfig)(nil)).Elem(),
	)
}
