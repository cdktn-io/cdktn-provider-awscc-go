...
func (j *jsiiProxy_ServicediscoveryServiceHealthCheckCustomConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ServicediscoveryServiceHealthCheckCustomConfigOutputReference)SetInternalValue(val interface{}) {
