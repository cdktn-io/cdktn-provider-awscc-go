...
func (s *jsiiProxy_ServicediscoveryServiceDnsConfigDnsRecordsOutputReference) ResetTtl() {
	_jsii_.InvokeVoid(
		s,
		"resetTtl",
		nil, // no parameters
...
func (s *jsiiProxy_ServicediscoveryServiceDnsConfigDnsRecordsOutputReference) ResetType() {
	_jsii_.InvokeVoid(
		s,
		"resetType",
		nil, // no parameters
