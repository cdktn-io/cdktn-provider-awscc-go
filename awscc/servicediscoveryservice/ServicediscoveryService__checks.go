...
func (s *jsiiProxy_ServicediscoveryService) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*ServicediscoveryServiceTags:
		value := value.(*[]*ServicediscoveryServiceTags)
	...
	case []*ServicediscoveryServiceTags:
		value_ := value.([]*ServicediscoveryServiceTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ServicediscoveryServiceTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ServicediscoveryService) validateSetServiceAttributesParameters(val *map[string]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
