...
func (j *jsiiProxy_ServicediscoveryServiceDnsConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ServicediscoveryServiceDnsConfigOutputReference)SetInternalValue(val interface{}) {
...
func (s *jsiiProxy_ServicediscoveryServiceDnsConfigOutputReference) ResetDnsRecords() {
	_jsii_.InvokeVoid(
		s,
		"resetDnsRecords",
		nil, // no parameters
...
func (s *jsiiProxy_ServicediscoveryServiceDnsConfigOutputReference) ResetNamespaceId() {
	_jsii_.InvokeVoid(
		s,
		"resetNamespaceId",
		nil, // no parameters
