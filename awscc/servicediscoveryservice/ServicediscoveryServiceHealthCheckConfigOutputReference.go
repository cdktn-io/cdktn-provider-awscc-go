...
func (j *jsiiProxy_ServicediscoveryServiceHealthCheckConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ServicediscoveryServiceHealthCheckConfigOutputReference)SetInternalValue(val interface{}) {
