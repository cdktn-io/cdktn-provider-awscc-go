...
type ServicediscoveryService interface {
	...
	HealthCheckCustomConfigInput() interface{}
	Id() *string
	// Experimental.
	...
	SetServiceAttributes(val *map[string]*string)
	ServiceAttributesInput() *map[string]*string
	ServiceId() *string
...
func (j *jsiiProxy_ServicediscoveryService) DnsConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"dnsConfigInput",
...
func (j *jsiiProxy_ServicediscoveryService) HealthCheckConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServicediscoveryService) HealthCheckCustomConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServicediscoveryService) ServiceAttributes() *map[string]*string {
...
func (j *jsiiProxy_ServicediscoveryService) ServiceAttributesInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"serviceAttributesInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_ServicediscoveryService) ServiceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceId",
...
func (j *jsiiProxy_ServicediscoveryService) Tags() ServicediscoveryServiceTagsList {
	var returns ServicediscoveryServiceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ServicediscoveryService)SetServiceAttributes(val *map[string]*string) {
...
func (s *jsiiProxy_ServicediscoveryService) PutTags(value interface{}) {
...
func (s *jsiiProxy_ServicediscoveryService) ResetName() {
	_jsii_.InvokeVoid(
		s,
		"resetName",
		nil, // no parameters
...
func (s *jsiiProxy_ServicediscoveryService) ResetServiceAttributes() {
	_jsii_.InvokeVoid(
		s,
		"resetServiceAttributes",
		nil, // no parameters
