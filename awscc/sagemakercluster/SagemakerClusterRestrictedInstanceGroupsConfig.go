...
type SagemakerClusterRestrictedInstanceGroupsConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/sagemaker_cluster#shared_environment_config SagemakerCluster#shared_environment_config}
