...
type SagemakerClusterInstanceGroupsAutoPatchConfigPatchSchedule struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/sagemaker_cluster#next_patch_date SagemakerCluster#next_patch_date}
