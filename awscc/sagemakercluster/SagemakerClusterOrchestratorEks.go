...
type SagemakerClusterOrchestratorEks struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/sagemaker_cluster#cluster_arn SagemakerCluster#cluster_arn}
