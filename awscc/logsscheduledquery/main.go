...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsScheduledQuery)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lastExecutionStatus", GoGetter: "LastExecutionStatus"},
			_jsii_.MemberProperty{JsiiProperty: "lastTriggeredTime", GoGetter: "LastTriggeredTime"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scheduledQueryArn", GoGetter: "ScheduledQueryArn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LogsScheduledQueryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.logsScheduledQuery.LogsScheduledQueryDestinationConfiguration",
		reflect.TypeOf((*LogsScheduledQueryDestinationConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.logsScheduledQuery.LogsScheduledQueryDestinationConfigurationOutputReference",
		reflect.TypeOf((*LogsScheduledQueryDestinationConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LogsScheduledQueryDestinationConfigurationS3Configuration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.logsScheduledQuery.LogsScheduledQueryDestinationConfigurationS3ConfigurationOutputReference",
		reflect.TypeOf((*LogsScheduledQueryDestinationConfigurationS3ConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "destinationIdentifier", GoGetter: "DestinationIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "destinationIdentifierInput", GoGetter: "DestinationIdentifierInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetDestinationIdentifier", GoMethod: "ResetDestinationIdentifier"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LogsScheduledQueryTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.logsScheduledQuery.LogsScheduledQueryTagsList",
		reflect.TypeOf((*LogsScheduledQueryTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsScheduledQueryTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
