...
type S3StorageLensStorageLensConfigurationExpandedPrefixesDataExportS3BucketDestination struct {
	...
	Encryption *S3StorageLensStorageLensConfigurationExpandedPrefixesDataExportS3BucketDestinationEncryption `field:"optional" json:"encryption" yaml:"encryption"`
