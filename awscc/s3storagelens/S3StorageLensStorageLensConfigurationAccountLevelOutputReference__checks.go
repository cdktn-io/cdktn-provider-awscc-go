...
func (s *jsiiProxy_S3StorageLensStorageLensConfigurationAccountLevelOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (s *jsiiProxy_S3StorageLensStorageLensConfigurationAccountLevelOutputReference) validatePutAdvancedPerformanceMetricsParameters(value *S3StorageLensStorageLensConfigurationAccountLevelAdvancedPerformanceMetrics) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (s *jsiiProxy_S3StorageLensStorageLensConfigurationAccountLevelOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_S3StorageLensStorageLensConfigurationAccountLevelOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *S3StorageLensStorageLensConfigurationAccountLevel; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_S3StorageLensStorageLensConfigurationAccountLevelOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewS3StorageLensStorageLensConfigurationAccountLevelOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
