...
func (j *jsiiProxy_S3StorageLens) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_S3StorageLens) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_S3StorageLens) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_S3StorageLens) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_S3StorageLens) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_S3StorageLens)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_S3StorageLens)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_S3StorageLens)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func S3StorageLens_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_S3StorageLens) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3StorageLens) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_S3StorageLens) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_S3StorageLens) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_S3StorageLens) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_S3StorageLens) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
