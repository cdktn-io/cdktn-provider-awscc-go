...
func NewAppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference {
	_init_.Initialize()
...
func NewAppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference_Override(a AppsyncChannelNamespaceHandlerConfigsOnSubscribeIntegrationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
