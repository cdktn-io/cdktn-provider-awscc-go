...
func (j *jsiiProxy_IdentitystoreUserNameOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewIdentitystoreUserNameOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) IdentitystoreUserNameOutputReference {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.identitystoreUser.IdentitystoreUserNameOutputReference",
...
func (j *jsiiProxy_IdentitystoreUserNameOutputReference)SetInternalValue(val interface{}) {
...
func (i *jsiiProxy_IdentitystoreUserNameOutputReference) ResetFamilyName() {
	_jsii_.InvokeVoid(
		i,
		"resetFamilyName",
		nil, // no parameters
...
func (i *jsiiProxy_IdentitystoreUserNameOutputReference) ResetGivenName() {
	_jsii_.InvokeVoid(
		i,
		"resetGivenName",
		nil, // no parameters
