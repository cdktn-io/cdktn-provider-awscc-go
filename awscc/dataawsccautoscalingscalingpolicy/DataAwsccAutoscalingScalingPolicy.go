...
func (j *jsiiProxy_DataAwsccAutoscalingScalingPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccAutoscalingScalingPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccAutoscalingScalingPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccAutoscalingScalingPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccAutoscalingScalingPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/autoscaling_scaling_policy awscc_autoscaling_scaling_policy} Data Source.
...
func (j *jsiiProxy_DataAwsccAutoscalingScalingPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccAutoscalingScalingPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccAutoscalingScalingPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccAutoscalingScalingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccAutoscalingScalingPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccAutoscalingScalingPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccAutoscalingScalingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccAutoscalingScalingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
