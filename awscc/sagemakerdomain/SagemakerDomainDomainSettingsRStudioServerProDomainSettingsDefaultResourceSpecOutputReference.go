...
func (j *jsiiProxy_SagemakerDomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpecOutputReference) TrainingPlanArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"trainingPlanArn",
...
func (j *jsiiProxy_SagemakerDomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpecOutputReference) TrainingPlanArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpecOutputReference)SetTrainingPlanArn(val *string) {
...
func (s *jsiiProxy_SagemakerDomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpecOutputReference) ResetTrainingPlanArn() {
	_jsii_.InvokeVoid(
		s,
		"resetTrainingPlanArn",
		nil, // no parameters
