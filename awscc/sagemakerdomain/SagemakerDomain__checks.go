...
func (s *jsiiProxy_SagemakerDomain) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SagemakerDomainTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SagemakerDomain) validateSetHomeEfsFileSystemCreationParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
