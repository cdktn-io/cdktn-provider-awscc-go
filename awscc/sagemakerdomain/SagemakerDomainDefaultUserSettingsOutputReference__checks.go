...
func (s *jsiiProxy_SagemakerDomainDefaultUserSettingsOutputReference) validatePutCustomFileSystemConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SagemakerDomainDefaultUserSettingsCustomFileSystemConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SagemakerDomainDefaultUserSettingsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *SagemakerDomainDefaultUserSettings; received %#v (a %T)", val, val)
		}
	}
