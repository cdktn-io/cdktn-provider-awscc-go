...
type SagemakerDomain interface {
	...
	HomeEfsFileSystemCreationInput() *string
	...
	ResetDomainSettings()
	ResetHomeEfsFileSystemCreation()
	ResetKmsKeyId()
...
func (j *jsiiProxy_SagemakerDomain) HomeEfsFileSystemCreation() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SagemakerDomain) HomeEfsFileSystemCreationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"homeEfsFileSystemCreationInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_SagemakerDomain)SetHomeEfsFileSystemCreation(val *string) {
	if err := j.validateSetHomeEfsFileSystemCreationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (s *jsiiProxy_SagemakerDomain) ResetHomeEfsFileSystemCreation() {
	_jsii_.InvokeVoid(
		s,
		"resetHomeEfsFileSystemCreation",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerDomain) ResetSubnetIds() {
	_jsii_.InvokeVoid(
		s,
		"resetSubnetIds",
		nil, // no parameters
...
func (s *jsiiProxy_SagemakerDomain) ResetVpcId() {
	_jsii_.InvokeVoid(
		s,
		"resetVpcId",
		nil, // no parameters
