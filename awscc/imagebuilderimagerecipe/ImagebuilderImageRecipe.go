...
type ImagebuilderImageRecipe interface {
	...
	Id() *string
	LatestVersion() ImagebuilderImageRecipeLatestVersionOutputReference
	// Experimental.
...
func (j *jsiiProxy_ImagebuilderImageRecipe) AmiWatermarks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"amiWatermarks",
...
func (j *jsiiProxy_ImagebuilderImageRecipe) AmiWatermarksInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"amiWatermarksInput",
...
func (j *jsiiProxy_ImagebuilderImageRecipe) LatestVersion() ImagebuilderImageRecipeLatestVersionOutputReference {
	var returns ImagebuilderImageRecipeLatestVersionOutputReference
	_jsii_.Get(
		j,
		"latestVersion",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImageRecipe)SetAmiWatermarks(val *[]*string) {
	if err := j.validateSetAmiWatermarksParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (i *jsiiProxy_ImagebuilderImageRecipe) ResetAmiWatermarks() {
	_jsii_.InvokeVoid(
		i,
		"resetAmiWatermarks",
		nil, // no parameters
...
func (i *jsiiProxy_ImagebuilderImageRecipe) ResetComponents() {
	_jsii_.InvokeVoid(
		i,
		"resetComponents",
		nil, // no parameters
