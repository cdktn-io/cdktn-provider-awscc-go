...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "amiWatermarksInput", GoGetter: "AmiWatermarksInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAmiWatermarks", GoMethod: "ResetAmiWatermarks"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ImagebuilderImageRecipeLatestVersion)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.imagebuilderImageRecipe.ImagebuilderImageRecipeLatestVersionOutputReference",
		reflect.TypeOf((*ImagebuilderImageRecipeLatestVersionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "arn", GoGetter: "Arn"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
