...
func NewWorkspaceswebUserSettingsToolbarConfigurationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) WorkspaceswebUserSettingsToolbarConfigurationOutputReference {
	_init_.Initialize()
...
func NewWorkspaceswebUserSettingsToolbarConfigurationOutputReference_Override(w WorkspaceswebUserSettingsToolbarConfigurationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
