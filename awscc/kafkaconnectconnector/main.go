...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "maxAutoscalingTaskCount", GoGetter: "MaxAutoscalingTaskCount"},
			_jsii_.MemberProperty{JsiiProperty: "maxAutoscalingTaskCountInput", GoGetter: "MaxAutoscalingTaskCountInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaxAutoscalingTaskCount", GoMethod: "ResetMaxAutoscalingTaskCount"},
