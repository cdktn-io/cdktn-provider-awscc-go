...
func (j *jsiiProxy_KafkaconnectConnectorCapacityOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKafkaconnectConnectorCapacityOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) KafkaconnectConnectorCapacityOutputReference {
	_init_.Initialize()
...
func NewKafkaconnectConnectorCapacityOutputReference_Override(k KafkaconnectConnectorCapacityOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KafkaconnectConnectorCapacityOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KafkaconnectConnectorCapacityOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KafkaconnectConnectorCapacityOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (k *jsiiProxy_KafkaconnectConnectorCapacityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (k *jsiiProxy_KafkaconnectConnectorCapacityOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
