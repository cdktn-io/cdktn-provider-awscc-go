...
func (j *jsiiProxy_HealthlakeFhirDatastoreTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewHealthlakeFhirDatastoreTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HealthlakeFhirDatastoreTagsList {
	_init_.Initialize()
...
func NewHealthlakeFhirDatastoreTagsList_Override(h HealthlakeFhirDatastoreTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_HealthlakeFhirDatastoreTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (h *jsiiProxy_HealthlakeFhirDatastoreTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HealthlakeFhirDatastoreTagsList) Resolve(context cdktn.IResolveContext) interface{} {
