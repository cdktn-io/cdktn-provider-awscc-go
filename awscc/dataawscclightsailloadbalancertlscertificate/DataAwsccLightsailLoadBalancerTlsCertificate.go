...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscclightsailloadbalancertlscertificate/internal"
...
type DataAwsccLightsailLoadBalancerTlsCertificate interface {
	...
	HttpsRedirectionEnabled() cdktn.IResolvable
	Id() *string
	SetId(val *string)
	IdInput() *string
	IsAttached() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) HttpsRedirectionEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) IsAttached() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"isAttached",
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccLightsailLoadBalancerTlsCertificate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccLightsailLoadBalancerTlsCertificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
