...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccConnectContactFlowModuleExternalInvocationConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccConnectContactFlowModuleExternalInvocationConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
