...
type ConnectQueue interface {
	...
	AdditionalEmailAddresses() ConnectQueueAdditionalEmailAddressesList
	AdditionalEmailAddressesInput() interface{}
	// Experimental.
	...
	PutAdditionalEmailAddresses(value interface{})
...
func (j *jsiiProxy_ConnectQueue) AdditionalEmailAddresses() ConnectQueueAdditionalEmailAddressesList {
	var returns ConnectQueueAdditionalEmailAddressesList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConnectQueue) AdditionalEmailAddressesInput() interface{} {
...
func (j *jsiiProxy_ConnectQueue) LastModifiedRegion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastModifiedRegion",
...
func (j *jsiiProxy_ConnectQueue) LastModifiedTime() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"lastModifiedTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/connect_queue awscc_connect_queue} Resource.
...
func (c *jsiiProxy_ConnectQueue) PutAdditionalEmailAddresses(value interface{}) {
	if err := c.validatePutAdditionalEmailAddressesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putAdditionalEmailAddresses",
		[]interface{}{value},
	)
}
...
func (c *jsiiProxy_ConnectQueue) ResetAdditionalEmailAddresses() {
	_jsii_.InvokeVoid(
		c,
		"resetAdditionalEmailAddresses",
		nil, // no parameters
