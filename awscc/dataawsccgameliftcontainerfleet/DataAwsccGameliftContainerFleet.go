...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet) PlayerGatewayMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"playerGatewayMode",
...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/gamelift_container_fleet awscc_gamelift_container_fleet} Data Source.
...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccGameliftContainerFleet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccGameliftContainerFleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccGameliftContainerFleet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccGameliftContainerFleet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccGameliftContainerFleet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccGameliftContainerFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
