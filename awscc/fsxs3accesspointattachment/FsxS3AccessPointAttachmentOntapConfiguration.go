...
type FsxS3AccessPointAttachmentOntapConfiguration struct {
	...
	FileSystemIdentity *FsxS3AccessPointAttachmentOntapConfigurationFileSystemIdentity `field:"optional" json:"fileSystemIdentity" yaml:"fileSystemIdentity"`
