...
func NewFsxS3AccessPointAttachmentS3AccessPointOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FsxS3AccessPointAttachmentS3AccessPointOutputReference {
	_init_.Initialize()
...
func NewFsxS3AccessPointAttachmentS3AccessPointOutputReference_Override(f FsxS3AccessPointAttachmentS3AccessPointOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
