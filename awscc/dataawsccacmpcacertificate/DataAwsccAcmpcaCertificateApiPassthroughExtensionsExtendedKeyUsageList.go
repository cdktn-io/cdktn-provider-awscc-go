...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList {
	_init_.Initialize()
...
func NewDataAwsccAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList_Override(d DataAwsccAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList) Resolve(context cdktn.IResolveContext) interface{} {
