...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/lambdaeventinvokeconfig/internal"
...
func (j *jsiiProxy_LambdaEventInvokeConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_LambdaEventInvokeConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_LambdaEventInvokeConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_LambdaEventInvokeConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_LambdaEventInvokeConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_LambdaEventInvokeConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_LambdaEventInvokeConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_LambdaEventInvokeConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func LambdaEventInvokeConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (l *jsiiProxy_LambdaEventInvokeConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventInvokeConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (l *jsiiProxy_LambdaEventInvokeConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaEventInvokeConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LambdaEventInvokeConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (l *jsiiProxy_LambdaEventInvokeConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
