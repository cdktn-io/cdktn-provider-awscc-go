...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudwatchInsightRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccCloudwatchInsightRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccCloudwatchInsightRule.DataAwsccCloudwatchInsightRuleTags",
		reflect.TypeOf((*DataAwsccCloudwatchInsightRuleTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccCloudwatchInsightRule.DataAwsccCloudwatchInsightRuleTagsList",
		reflect.TypeOf((*DataAwsccCloudwatchInsightRuleTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudwatchInsightRuleTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
