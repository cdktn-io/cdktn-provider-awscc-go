...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DmsEventSubscriptionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dmsEventSubscription.DmsEventSubscriptionTagsList",
		reflect.TypeOf((*DmsEventSubscriptionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DmsEventSubscriptionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
