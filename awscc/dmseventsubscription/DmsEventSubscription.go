...
func (j *jsiiProxy_DmsEventSubscription) SubscriptionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriptionName",
...
func (j *jsiiProxy_DmsEventSubscription) SubscriptionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DmsEventSubscription) Tags() DmsEventSubscriptionTagsList {
	var returns DmsEventSubscriptionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_DmsEventSubscription)SetSubscriptionName(val *string) {
...
func (d *jsiiProxy_DmsEventSubscription) PutTags(value interface{}) {
...
func (d *jsiiProxy_DmsEventSubscription) ResetEventCategories() {
	_jsii_.InvokeVoid(
		d,
		"resetEventCategories",
		nil, // no parameters
...
func (d *jsiiProxy_DmsEventSubscription) ResetSubscriptionName() {
	_jsii_.InvokeVoid(
		d,
		"resetSubscriptionName",
		nil, // no parameters
