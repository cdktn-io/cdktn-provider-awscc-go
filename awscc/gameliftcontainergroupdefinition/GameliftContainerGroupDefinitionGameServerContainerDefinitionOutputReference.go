...
type GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference interface {
	...
	LinuxCapabilities() GameliftContainerGroupDefinitionGameServerContainerDefinitionLinuxCapabilitiesOutputReference
	...
	PutLinuxCapabilities(value *GameliftContainerGroupDefinitionGameServerContainerDefinitionLinuxCapabilities)
...
func (j *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) LinuxCapabilities() GameliftContainerGroupDefinitionGameServerContainerDefinitionLinuxCapabilitiesOutputReference {
	var returns GameliftContainerGroupDefinitionGameServerContainerDefinitionLinuxCapabilitiesOutputReference
	_jsii_.Get(
		j,
		"linuxCapabilities",
		&returns,
...
func (j *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) LinuxCapabilitiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference {
	_init_.Initialize()
...
func NewGameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference_Override(g GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) PutLinuxCapabilities(value *GameliftContainerGroupDefinitionGameServerContainerDefinitionLinuxCapabilities) {
...
func (g *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) ResetLinuxCapabilities() {
	_jsii_.InvokeVoid(
		g,
		"resetLinuxCapabilities",
		nil, // no parameters
...
func (g *jsiiProxy_GameliftContainerGroupDefinitionGameServerContainerDefinitionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
