...
func (r *jsiiProxy_Route53RecoveryreadinessRecoveryGroup) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*Route53RecoveryreadinessRecoveryGroupTags; received %#v (a %T)", value, value)
		}
	}
