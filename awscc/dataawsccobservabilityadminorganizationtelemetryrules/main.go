...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccObservabilityadminOrganizationTelemetryRules)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccObservabilityadminOrganizationTelemetryRulesConfig)(nil)).Elem(),
	)
}
