...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccDeadlineMonitorTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccDeadlineMonitor.DataAwsccDeadlineMonitorTagsList",
		reflect.TypeOf((*DataAwsccDeadlineMonitorTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccDeadlineMonitorTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
