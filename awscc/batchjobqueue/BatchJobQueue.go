...
type BatchJobQueue interface {
	...
	ServiceEnvironmentOrder() BatchJobQueueServiceEnvironmentOrderList
	ServiceEnvironmentOrderInput() interface{}
	State() *string
	SetState(val *string)
	StateInput() *string
	...
	PutServiceEnvironmentOrder(value interface{})
...
func (j *jsiiProxy_BatchJobQueue) JobQueueType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobQueueType",
...
func (j *jsiiProxy_BatchJobQueue) JobQueueTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"jobQueueTypeInput",
...
func (j *jsiiProxy_BatchJobQueue) ServiceEnvironmentOrder() BatchJobQueueServiceEnvironmentOrderList {
	var returns BatchJobQueueServiceEnvironmentOrderList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BatchJobQueue) ServiceEnvironmentOrderInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"serviceEnvironmentOrderInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_BatchJobQueue)SetJobQueueType(val *string) {
	if err := j.validateSetJobQueueTypeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (b *jsiiProxy_BatchJobQueue) PutServiceEnvironmentOrder(value interface{}) {
	if err := b.validatePutServiceEnvironmentOrderParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
		"putServiceEnvironmentOrder",
		[]interface{}{value},
	)
}
...
func (b *jsiiProxy_BatchJobQueue) ResetJobQueueType() {
	_jsii_.InvokeVoid(
		b,
		"resetJobQueueType",
		nil, // no parameters
...
func (b *jsiiProxy_BatchJobQueue) ResetServiceEnvironmentOrder() {
	_jsii_.InvokeVoid(
		b,
		"resetServiceEnvironmentOrder",
		nil, // no parameters
