...
func (j *jsiiProxy_DataAwsccSecurityhubInsightFiltersRecommendationTextList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccSecurityhubInsightFiltersRecommendationTextList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccSecurityhubInsightFiltersRecommendationTextList {
	_init_.Initialize()
...
func NewDataAwsccSecurityhubInsightFiltersRecommendationTextList_Override(d DataAwsccSecurityhubInsightFiltersRecommendationTextList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccSecurityhubInsightFiltersRecommendationTextList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccSecurityhubInsightFiltersRecommendationTextList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccSecurityhubInsightFiltersRecommendationTextList) Resolve(context cdktn.IResolveContext) interface{} {
