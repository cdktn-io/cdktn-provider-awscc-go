...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/datazonesubscriptiontarget/internal"
...
func (j *jsiiProxy_DatazoneSubscriptionTarget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DatazoneSubscriptionTarget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DatazoneSubscriptionTarget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DatazoneSubscriptionTarget) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DatazoneSubscriptionTarget) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DatazoneSubscriptionTarget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DatazoneSubscriptionTarget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DatazoneSubscriptionTarget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DatazoneSubscriptionTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DatazoneSubscriptionTarget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatazoneSubscriptionTarget) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (d *jsiiProxy_DatazoneSubscriptionTarget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DatazoneSubscriptionTarget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DatazoneSubscriptionTarget) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DatazoneSubscriptionTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
