...
func (b *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validatePutAdvancedBackupSettingsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BackupBackupPlanBackupPlanAdvancedBackupSettings; received %#v (a %T)", value, value)
		}
	}
...
func (b *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validatePutBackupPlanRuleParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BackupBackupPlanBackupPlanBackupPlanRule; received %#v (a %T)", value, value)
		}
	}
...
func (b *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validatePutScanSettingsParameters(value interface{}) error {
	...
	case *[]*BackupBackupPlanBackupPlanScanSettings:
		value := value.(*[]*BackupBackupPlanBackupPlanScanSettings)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*BackupBackupPlanBackupPlanScanSettings:
		value_ := value.([]*BackupBackupPlanBackupPlanScanSettings)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BackupBackupPlanBackupPlanScanSettings; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_BackupBackupPlanBackupPlanOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *BackupBackupPlanBackupPlan; received %#v (a %T)", val, val)
		}
	}
