...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putLifecycle", GoMethod: "PutLifecycle"},
			_jsii_.MemberMethod{JsiiMethod: "putScanActions", GoMethod: "PutScanActions"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetScanActions", GoMethod: "ResetScanActions"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scanActions", GoGetter: "ScanActions"},
			_jsii_.MemberProperty{JsiiProperty: "scanActionsInput", GoGetter: "ScanActionsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BackupBackupPlanBackupPlanBackupPlanRuleScanActions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.backupBackupPlan.BackupBackupPlanBackupPlanBackupPlanRuleScanActionsList",
		reflect.TypeOf((*BackupBackupPlanBackupPlanBackupPlanRuleScanActionsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BackupBackupPlanBackupPlanBackupPlanRuleScanActionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMalwareScanner", GoMethod: "ResetMalwareScanner"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putScanSettings", GoMethod: "PutScanSettings"},
			_jsii_.MemberMethod{JsiiMethod: "resetAdvancedBackupSettings", GoMethod: "ResetAdvancedBackupSettings"},
			_jsii_.MemberMethod{JsiiMethod: "resetScanSettings", GoMethod: "ResetScanSettings"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "scanSettings", GoGetter: "ScanSettings"},
			_jsii_.MemberProperty{JsiiProperty: "scanSettingsInput", GoGetter: "ScanSettingsInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BackupBackupPlanBackupPlanScanSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.backupBackupPlan.BackupBackupPlanBackupPlanScanSettingsList",
		reflect.TypeOf((*BackupBackupPlanBackupPlanScanSettingsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
		...
		func() interface{} {
			j := jsiiProxy_BackupBackupPlanBackupPlanScanSettingsList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BackupBackupPlanBackupPlanScanSettingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMalwareScanner", GoMethod: "ResetMalwareScanner"},
			_jsii_.MemberMethod{JsiiMethod: "resetResourceTypes", GoMethod: "ResetResourceTypes"},
			_jsii_.MemberMethod{JsiiMethod: "resetScannerRoleArn", GoMethod: "ResetScannerRoleArn"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "resourceTypes", GoGetter: "ResourceTypes"},
			_jsii_.MemberProperty{JsiiProperty: "resourceTypesInput", GoGetter: "ResourceTypesInput"},
