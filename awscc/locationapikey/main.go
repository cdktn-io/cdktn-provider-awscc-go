...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LocationApiKeyRestrictionsAllowAndroidApps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.locationApiKey.LocationApiKeyRestrictionsAllowAndroidAppsList",
		reflect.TypeOf((*LocationApiKeyRestrictionsAllowAndroidAppsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LocationApiKeyRestrictionsAllowAndroidAppsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "certificateFingerprint", GoGetter: "CertificateFingerprint"},
			_jsii_.MemberProperty{JsiiProperty: "certificateFingerprintInput", GoGetter: "CertificateFingerprintInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCertificateFingerprint", GoMethod: "ResetCertificateFingerprint"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LocationApiKeyRestrictionsAllowAppleApps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.locationApiKey.LocationApiKeyRestrictionsAllowAppleAppsList",
		reflect.TypeOf((*LocationApiKeyRestrictionsAllowAppleAppsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LocationApiKeyRestrictionsAllowAppleAppsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowAndroidApps", GoGetter: "AllowAndroidApps"},
			_jsii_.MemberProperty{JsiiProperty: "allowAndroidAppsInput", GoGetter: "AllowAndroidAppsInput"},
			_jsii_.MemberProperty{JsiiProperty: "allowAppleApps", GoGetter: "AllowAppleApps"},
			_jsii_.MemberProperty{JsiiProperty: "allowAppleAppsInput", GoGetter: "AllowAppleAppsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putAllowAndroidApps", GoMethod: "PutAllowAndroidApps"},
			_jsii_.MemberMethod{JsiiMethod: "putAllowAppleApps", GoMethod: "PutAllowAppleApps"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowAndroidApps", GoMethod: "ResetAllowAndroidApps"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowAppleApps", GoMethod: "ResetAllowAppleApps"},
