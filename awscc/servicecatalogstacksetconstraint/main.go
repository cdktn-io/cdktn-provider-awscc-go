...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicecatalogStackSetConstraint)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "accountListInput", GoGetter: "AccountListInput"},
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "adminRole", GoGetter: "AdminRole"},
			_jsii_.MemberProperty{JsiiProperty: "adminRoleInput", GoGetter: "AdminRoleInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "stackInstanceControlInput", GoGetter: "StackInstanceControlInput"},
			_jsii_.MemberProperty{JsiiProperty: "stackSetConstraintId", GoGetter: "StackSetConstraintId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ServicecatalogStackSetConstraintConfig)(nil)).Elem(),
	)
}
