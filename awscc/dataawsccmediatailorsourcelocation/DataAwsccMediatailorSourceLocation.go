...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccmediatailorsourcelocation/internal"
...
func (j *jsiiProxy_DataAwsccMediatailorSourceLocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccMediatailorSourceLocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccMediatailorSourceLocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccMediatailorSourceLocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccMediatailorSourceLocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/mediatailor_source_location awscc_mediatailor_source_location} Data Source.
...
func (j *jsiiProxy_DataAwsccMediatailorSourceLocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccMediatailorSourceLocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccMediatailorSourceLocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccMediatailorSourceLocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccMediatailorSourceLocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccMediatailorSourceLocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccMediatailorSourceLocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccMediatailorSourceLocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
