...
func (f *jsiiProxy_FmsPolicy) validatePutResourceTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*FmsPolicyResourceTags; received %#v (a %T)", value, value)
		}
	}
...
func (f *jsiiProxy_FmsPolicy) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*FmsPolicyTags; received %#v (a %T)", value, value)
		}
	}
