...
func (j *jsiiProxy_SchedulerScheduleTargetEcsParametersOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_SchedulerScheduleTargetEcsParametersOutputReference) NetworkConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SchedulerScheduleTargetEcsParametersOutputReference) Tags() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_SchedulerScheduleTargetEcsParametersOutputReference) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_SchedulerScheduleTargetEcsParametersOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SchedulerScheduleTargetEcsParametersOutputReference)SetTags(val interface{}) {
...
func (s *jsiiProxy_SchedulerScheduleTargetEcsParametersOutputReference) ResetTaskDefinitionArn() {
	_jsii_.InvokeVoid(
		s,
		"resetTaskDefinitionArn",
		nil, // no parameters
