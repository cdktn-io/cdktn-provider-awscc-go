...
func (j *jsiiProxy_SchedulerScheduleFlexibleTimeWindowOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *SchedulerScheduleFlexibleTimeWindow:
		val := val.(*SchedulerScheduleFlexibleTimeWindow)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SchedulerScheduleFlexibleTimeWindow:
		val_ := val.(SchedulerScheduleFlexibleTimeWindow)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *SchedulerScheduleFlexibleTimeWindow; received %#v (a %T)", val, val)
		}
	}
