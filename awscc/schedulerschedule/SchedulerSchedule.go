...
type SchedulerSchedule interface {
	...
	FlexibleTimeWindowInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_SchedulerSchedule) FlexibleTimeWindowInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SchedulerSchedule) TargetInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targetInput",
