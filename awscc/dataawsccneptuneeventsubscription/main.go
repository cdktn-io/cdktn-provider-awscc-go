...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptuneEventSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccNeptuneEventSubscriptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccNeptuneEventSubscription.DataAwsccNeptuneEventSubscriptionTags",
		reflect.TypeOf((*DataAwsccNeptuneEventSubscriptionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccNeptuneEventSubscription.DataAwsccNeptuneEventSubscriptionTagsList",
		reflect.TypeOf((*DataAwsccNeptuneEventSubscriptionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptuneEventSubscriptionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
