...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccEc2TransitGatewayTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccEc2TransitGatewayTagsList {
	_init_.Initialize()
...
func NewDataAwsccEc2TransitGatewayTagsList_Override(d DataAwsccEc2TransitGatewayTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccEc2TransitGatewayTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccEc2TransitGatewayTagsList) Resolve(context cdktn.IResolveContext) interface{} {
