...
func NewEksCapabilityConfigurationArgoCdAwsIdcOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) EksCapabilityConfigurationArgoCdAwsIdcOutputReference {
	_init_.Initialize()

	if err := validateNewEksCapabilityConfigurationArgoCdAwsIdcOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewEksCapabilityConfigurationArgoCdAwsIdcOutputReference_Override(e EksCapabilityConfigurationArgoCdAwsIdcOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (e *jsiiProxy_EksCapabilityConfigurationArgoCdAwsIdcOutputReference) ResetIdcInstanceArn() {
	_jsii_.InvokeVoid(
		e,
		"resetIdcInstanceArn",
		nil, // no parameters
