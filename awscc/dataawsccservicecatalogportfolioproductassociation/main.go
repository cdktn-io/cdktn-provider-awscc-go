...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccServicecatalogPortfolioProductAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccServicecatalogPortfolioProductAssociationConfig)(nil)).Elem(),
	)
}
