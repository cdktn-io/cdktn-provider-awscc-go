...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNovaactWorkflowDefinition)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccNovaactWorkflowDefinitionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccNovaactWorkflowDefinition.DataAwsccNovaactWorkflowDefinitionExportConfig",
		reflect.TypeOf((*DataAwsccNovaactWorkflowDefinitionExportConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccNovaactWorkflowDefinition.DataAwsccNovaactWorkflowDefinitionExportConfigOutputReference",
		reflect.TypeOf((*DataAwsccNovaactWorkflowDefinitionExportConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
