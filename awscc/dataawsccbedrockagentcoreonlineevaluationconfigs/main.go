...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreOnlineEvaluationConfigs)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreOnlineEvaluationConfigsConfig)(nil)).Elem(),
	)
}
