...
type MemorydbSnapshot interface {
	...
	ClusterConfiguration() MemorydbSnapshotClusterConfigurationOutputReference
	ClusterName() *string
...
func (j *jsiiProxy_MemorydbSnapshot) ClusterConfiguration() MemorydbSnapshotClusterConfigurationOutputReference {
...
func (j *jsiiProxy_MemorydbSnapshot) DataTiering() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataTiering",
...
func (j *jsiiProxy_MemorydbSnapshot) KmsKeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyId",
...
func (j *jsiiProxy_MemorydbSnapshot) KmsKeyIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyIdInput",
...
func (j *jsiiProxy_MemorydbSnapshot) SnapshotName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"snapshotName",
...
func (j *jsiiProxy_MemorydbSnapshot) SnapshotNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"snapshotNameInput",
...
func (j *jsiiProxy_MemorydbSnapshot) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
func (j *jsiiProxy_MemorydbSnapshot) Tags() MemorydbSnapshotTagsList {
	var returns MemorydbSnapshotTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_MemorydbSnapshot) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewMemorydbSnapshot(scope constructs.Construct, id *string, config *MemorydbSnapshotConfig) MemorydbSnapshot {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.memorydbSnapshot.MemorydbSnapshot",
...
func (j *jsiiProxy_MemorydbSnapshot)SetKmsKeyId(val *string) {
...
func (j *jsiiProxy_MemorydbSnapshot)SetSnapshotName(val *string) {
...
func (m *jsiiProxy_MemorydbSnapshot) PutTags(value interface{}) {
...
func (m *jsiiProxy_MemorydbSnapshot) ResetKmsKeyId() {
	_jsii_.InvokeVoid(
		m,
		"resetKmsKeyId",
		nil, // no parameters
