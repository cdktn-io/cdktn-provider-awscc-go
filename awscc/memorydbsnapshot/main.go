...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.memorydbSnapshot.MemorydbSnapshotClusterConfiguration",
		reflect.TypeOf((*MemorydbSnapshotClusterConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.memorydbSnapshot.MemorydbSnapshotClusterConfigurationOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.memorydbSnapshot.MemorydbSnapshotConfig",
		reflect.TypeOf((*MemorydbSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.memorydbSnapshot.MemorydbSnapshotTags",
		reflect.TypeOf((*MemorydbSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.memorydbSnapshot.MemorydbSnapshotTagsList",
		reflect.TypeOf((*MemorydbSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.memorydbSnapshot.MemorydbSnapshotTagsOutputReference",
		reflect.TypeOf((*MemorydbSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_MemorydbSnapshotTagsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
