...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOdbOdbPeeringConnection)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccOdbOdbPeeringConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnection.DataAwsccOdbOdbPeeringConnectionTags",
		reflect.TypeOf((*DataAwsccOdbOdbPeeringConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccOdbOdbPeeringConnection.DataAwsccOdbOdbPeeringConnectionTagsList",
		reflect.TypeOf((*DataAwsccOdbOdbPeeringConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccOdbOdbPeeringConnectionTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOdbOdbPeeringConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
