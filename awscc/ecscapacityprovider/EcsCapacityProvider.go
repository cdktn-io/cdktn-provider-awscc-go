...
func (j *jsiiProxy_EcsCapacityProvider) ClusterName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterName",
...
func (j *jsiiProxy_EcsCapacityProvider) ClusterNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterNameInput",
...
func (j *jsiiProxy_EcsCapacityProvider) ManagedInstancesProviderInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsCapacityProvider)SetClusterName(val *string) {
...
func (e *jsiiProxy_EcsCapacityProvider) ResetClusterName() {
	_jsii_.InvokeVoid(
		e,
		"resetClusterName",
		nil, // no parameters
