...
func (e *jsiiProxy_EcsCapacityProvider) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsCapacityProviderTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_EcsCapacityProvider) validateSetClusterNameParameters(val *string) error {
	if val == nil {
