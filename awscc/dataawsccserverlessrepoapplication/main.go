...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccServerlessrepoApplication)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isVerifiedAuthor", GoGetter: "IsVerifiedAuthor"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccServerlessrepoApplication.DataAwsccServerlessrepoApplicationConfig",
		reflect.TypeOf((*DataAwsccServerlessrepoApplicationConfig)(nil)).Elem(),
	)
}
