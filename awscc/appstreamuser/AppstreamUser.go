...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/appstreamuser/internal"
...
func (j *jsiiProxy_AppstreamUser) MessageAction() *string {
	var returns *string
	_jsii_.Get(
		j,
		"messageAction",
...
func (j *jsiiProxy_AppstreamUser) MessageActionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"messageActionInput",
...
func NewAppstreamUser(scope constructs.Construct, id *string, config *AppstreamUserConfig) AppstreamUser {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.appstreamUser.AppstreamUser",
...
func (j *jsiiProxy_AppstreamUser)SetMessageAction(val *string) {
...
func (a *jsiiProxy_AppstreamUser) ResetMessageAction() {
	_jsii_.InvokeVoid(
		a,
		"resetMessageAction",
		nil, // no parameters
