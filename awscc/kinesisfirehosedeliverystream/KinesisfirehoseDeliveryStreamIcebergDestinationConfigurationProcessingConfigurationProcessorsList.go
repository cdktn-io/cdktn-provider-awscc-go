...
func (j *jsiiProxy_KinesisfirehoseDeliveryStreamIcebergDestinationConfigurationProcessingConfigurationProcessorsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewKinesisfirehoseDeliveryStreamIcebergDestinationConfigurationProcessingConfigurationProcessorsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KinesisfirehoseDeliveryStreamIcebergDestinationConfigurationProcessingConfigurationProcessorsList {
	_init_.Initialize()
...
func NewKinesisfirehoseDeliveryStreamIcebergDestinationConfigurationProcessingConfigurationProcessorsList_Override(k KinesisfirehoseDeliveryStreamIcebergDestinationConfigurationProcessingConfigurationProcessorsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_KinesisfirehoseDeliveryStreamIcebergDestinationConfigurationProcessingConfigurationProcessorsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (k *jsiiProxy_KinesisfirehoseDeliveryStreamIcebergDestinationConfigurationProcessingConfigurationProcessorsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KinesisfirehoseDeliveryStreamIcebergDestinationConfigurationProcessingConfigurationProcessorsList) Resolve(context cdktn.IResolveContext) interface{} {
