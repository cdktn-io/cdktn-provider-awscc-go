...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccnetworkmanagertransitgatewayroutetableattachment/internal"
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) LastModificationErrors() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) RoutingPolicyLabel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routingPolicyLabel",
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccNetworkmanagerTransitGatewayRouteTableAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
