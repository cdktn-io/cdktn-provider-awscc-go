...
func (j *jsiiProxy_DataAwsccHealthlakeFhirDatastore) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccHealthlakeFhirDatastore) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccHealthlakeFhirDatastore) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccHealthlakeFhirDatastore) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccHealthlakeFhirDatastore) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/healthlake_fhir_datastore awscc_healthlake_fhir_datastore} Data Source.
...
func (j *jsiiProxy_DataAwsccHealthlakeFhirDatastore)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccHealthlakeFhirDatastore)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccHealthlakeFhirDatastore)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccHealthlakeFhirDatastore_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccHealthlakeFhirDatastore) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccHealthlakeFhirDatastore) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccHealthlakeFhirDatastore) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccHealthlakeFhirDatastore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
