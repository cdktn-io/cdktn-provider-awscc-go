...
func (j *jsiiProxy_DataAwsccMediatailorVodSourceHttpPackageConfigurationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccMediatailorVodSourceHttpPackageConfigurationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccMediatailorVodSourceHttpPackageConfigurationsList {
	_init_.Initialize()
...
func NewDataAwsccMediatailorVodSourceHttpPackageConfigurationsList_Override(d DataAwsccMediatailorVodSourceHttpPackageConfigurationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccMediatailorVodSourceHttpPackageConfigurationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccMediatailorVodSourceHttpPackageConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccMediatailorVodSourceHttpPackageConfigurationsList) Resolve(context cdktn.IResolveContext) interface{} {
