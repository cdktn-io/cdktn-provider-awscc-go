...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccInspectorv2CodeSecurityScanConfigurations)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccInspectorv2CodeSecurityScanConfigurationsConfig)(nil)).Elem(),
	)
}
