...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccConnectDataTable)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccConnectDataTable.DataAwsccConnectDataTableLockVersion",
		reflect.TypeOf((*DataAwsccConnectDataTableLockVersion)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccConnectDataTable.DataAwsccConnectDataTableLockVersionOutputReference",
		reflect.TypeOf((*DataAwsccConnectDataTableLockVersionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccConnectDataTableLockVersionOutputReference{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccConnectDataTable.DataAwsccConnectDataTableTagsList",
		reflect.TypeOf((*DataAwsccConnectDataTableTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccConnectDataTableTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccConnectDataTableTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
