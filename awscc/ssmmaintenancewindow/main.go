...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SsmMaintenanceWindowTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ssmMaintenanceWindow.SsmMaintenanceWindowTagsList",
		reflect.TypeOf((*SsmMaintenanceWindowTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SsmMaintenanceWindowTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SsmMaintenanceWindowTagsOutputReference{}
