...
func (j *jsiiProxy_SsmMaintenanceWindow) Tags() SsmMaintenanceWindowTagsList {
	var returns SsmMaintenanceWindowTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_SsmMaintenanceWindow) WindowId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"windowId",
...
func (s *jsiiProxy_SsmMaintenanceWindow) PutTags(value interface{}) {
