...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/route53resolverresolverqueryloggingconfigassociation/internal"
...
func (j *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/route53resolver_resolver_query_logging_config_association awscc_route53resolver_resolver_query_logging_config_association} Resource.
...
func (j *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Route53ResolverResolverQueryLoggingConfigAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_Route53ResolverResolverQueryLoggingConfigAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
