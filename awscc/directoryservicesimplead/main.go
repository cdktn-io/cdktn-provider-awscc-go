...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DirectoryserviceSimpleAdTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.directoryserviceSimpleAd.DirectoryserviceSimpleAdTagsList",
		reflect.TypeOf((*DirectoryserviceSimpleAdTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectoryserviceSimpleAdTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
