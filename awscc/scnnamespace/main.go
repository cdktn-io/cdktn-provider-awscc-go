...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ScnNamespace)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ScnNamespaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.scnNamespace.ScnNamespaceTags",
		reflect.TypeOf((*ScnNamespaceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.scnNamespace.ScnNamespaceTagsList",
		reflect.TypeOf((*ScnNamespaceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ScnNamespaceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
