...
func (j *jsiiProxy_ApplicationautoscalingScalableTarget) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ApplicationautoscalingScalableTarget) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ApplicationautoscalingScalableTarget) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApplicationautoscalingScalableTarget) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ApplicationautoscalingScalableTarget)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ApplicationautoscalingScalableTarget)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ApplicationautoscalingScalableTarget)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ApplicationautoscalingScalableTarget_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApplicationautoscalingScalableTarget) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationautoscalingScalableTarget) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_ApplicationautoscalingScalableTarget) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationautoscalingScalableTarget) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApplicationautoscalingScalableTarget) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
