...
type DataAwsccGameliftFleet interface {
	...
	PeerVpcId() *string
	PlayerGatewayConfiguration() DataAwsccGameliftFleetPlayerGatewayConfigurationOutputReference
...
func (j *jsiiProxy_DataAwsccGameliftFleet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccGameliftFleet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccGameliftFleet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccGameliftFleet) PlayerGatewayConfiguration() DataAwsccGameliftFleetPlayerGatewayConfigurationOutputReference {
	var returns DataAwsccGameliftFleetPlayerGatewayConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccGameliftFleet) PlayerGatewayMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"playerGatewayMode",
...
func (j *jsiiProxy_DataAwsccGameliftFleet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccGameliftFleet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccGameliftFleet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccGameliftFleet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccGameliftFleet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccGameliftFleet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccGameliftFleet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccGameliftFleet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccGameliftFleet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccGameliftFleet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
