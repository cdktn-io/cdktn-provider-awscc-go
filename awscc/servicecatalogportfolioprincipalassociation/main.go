...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicecatalogPortfolioPrincipalAssociation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPortfolioId", GoMethod: "ResetPortfolioId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrincipalArn", GoMethod: "ResetPrincipalArn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ServicecatalogPortfolioPrincipalAssociationConfig)(nil)).Elem(),
	)
}
