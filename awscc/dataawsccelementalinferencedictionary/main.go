...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccElementalinferenceDictionary)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dictionaryId", GoGetter: "DictionaryId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccElementalinferenceDictionaryConfig)(nil)).Elem(),
	)
}
