...
type DataAwsccOsisPipeline interface {
	...
	ResourcePolicy() DataAwsccOsisPipelineResourcePolicyOutputReference
...
func (j *jsiiProxy_DataAwsccOsisPipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccOsisPipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccOsisPipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccOsisPipeline) PipelineRoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pipelineRoleArn",
...
func (j *jsiiProxy_DataAwsccOsisPipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccOsisPipeline) ResourcePolicy() DataAwsccOsisPipelineResourcePolicyOutputReference {
	var returns DataAwsccOsisPipelineResourcePolicyOutputReference
	_jsii_.Get(
		j,
		"resourcePolicy",
		&returns,
...
func (j *jsiiProxy_DataAwsccOsisPipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccOsisPipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccOsisPipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccOsisPipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccOsisPipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccOsisPipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccOsisPipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccOsisPipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccOsisPipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
