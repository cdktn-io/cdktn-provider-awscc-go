...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecurityhubConnector)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enablementStatus", GoGetter: "EnablementStatus"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putProviderName", GoMethod: "PutProviderName"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SecurityhubConnectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.securityhubConnector.SecurityhubConnectorIssues",
		reflect.TypeOf((*SecurityhubConnectorIssues)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.securityhubConnector.SecurityhubConnectorIssuesList",
		reflect.TypeOf((*SecurityhubConnectorIssuesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecurityhubConnectorIssuesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SecurityhubConnectorProviderName)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.securityhubConnector.SecurityhubConnectorProviderNameAzure",
		reflect.TypeOf((*SecurityhubConnectorProviderNameAzure)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.securityhubConnector.SecurityhubConnectorProviderNameAzureOutputReference",
		reflect.TypeOf((*SecurityhubConnectorProviderNameAzureOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "awsConfigConnectorArn", GoGetter: "AwsConfigConnectorArn"},
			_jsii_.MemberProperty{JsiiProperty: "awsConfigConnectorArnInput", GoGetter: "AwsConfigConnectorArnInput"},
			_jsii_.MemberProperty{JsiiProperty: "azureRegions", GoGetter: "AzureRegions"},
			_jsii_.MemberProperty{JsiiProperty: "azureRegionsInput", GoGetter: "AzureRegionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SecurityhubConnectorProviderNameAzureScopeConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.securityhubConnector.SecurityhubConnectorProviderNameAzureScopeConfigurationOutputReference",
		reflect.TypeOf((*SecurityhubConnectorProviderNameAzureScopeConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetScopeValues", GoMethod: "ResetScopeValues"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scopeValues", GoGetter: "ScopeValues"},
			_jsii_.MemberProperty{JsiiProperty: "scopeValuesInput", GoGetter: "ScopeValuesInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecurityhubConnectorProviderNameOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SecurityhubConnectorProviderNameOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
