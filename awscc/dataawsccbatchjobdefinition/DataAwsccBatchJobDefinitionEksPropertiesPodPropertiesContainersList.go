...
func (j *jsiiProxy_DataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList {
	_init_.Initialize()
...
func NewDataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList_Override(d DataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccBatchJobDefinitionEksPropertiesPodPropertiesContainersList) Resolve(context cdktn.IResolveContext) interface{} {
