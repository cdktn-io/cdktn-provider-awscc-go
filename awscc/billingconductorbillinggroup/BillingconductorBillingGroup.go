...
func (j *jsiiProxy_BillingconductorBillingGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BillingconductorBillingGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BillingconductorBillingGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BillingconductorBillingGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BillingconductorBillingGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/billingconductor_billing_group awscc_billingconductor_billing_group} Resource.
...
func (j *jsiiProxy_BillingconductorBillingGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BillingconductorBillingGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BillingconductorBillingGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BillingconductorBillingGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BillingconductorBillingGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BillingconductorBillingGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BillingconductorBillingGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BillingconductorBillingGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BillingconductorBillingGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BillingconductorBillingGroup) ResetPrimaryAccountId() {
	_jsii_.InvokeVoid(
		b,
		"resetPrimaryAccountId",
		nil, // no parameters
...
func (b *jsiiProxy_BillingconductorBillingGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
