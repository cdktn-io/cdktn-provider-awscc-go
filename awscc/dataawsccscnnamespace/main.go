...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccScnNamespace)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccScnNamespaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccScnNamespace.DataAwsccScnNamespaceTags",
		reflect.TypeOf((*DataAwsccScnNamespaceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccScnNamespace.DataAwsccScnNamespaceTagsList",
		reflect.TypeOf((*DataAwsccScnNamespaceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccScnNamespaceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
