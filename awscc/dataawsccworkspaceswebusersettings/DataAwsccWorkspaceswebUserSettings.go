...
type DataAwsccWorkspaceswebUserSettings interface {
	...
	BrandingConfiguration() DataAwsccWorkspaceswebUserSettingsBrandingConfigurationOutputReference
	// Experimental.
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings) AdditionalEncryptionContext() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings) BrandingConfiguration() DataAwsccWorkspaceswebUserSettingsBrandingConfigurationOutputReference {
	var returns DataAwsccWorkspaceswebUserSettingsBrandingConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings) WebAuthnAllowed() *string {
	var returns *string
	_jsii_.Get(
		j,
		"webAuthnAllowed",
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccWorkspaceswebUserSettings)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccWorkspaceswebUserSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccWorkspaceswebUserSettings) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccWorkspaceswebUserSettings) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccWorkspaceswebUserSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccWorkspaceswebUserSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
