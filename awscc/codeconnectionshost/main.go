...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codeconnectionsHost.CodeconnectionsHostConfig",
		reflect.TypeOf((*CodeconnectionsHostConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codeconnectionsHost.CodeconnectionsHostTags",
		reflect.TypeOf((*CodeconnectionsHostTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.codeconnectionsHost.CodeconnectionsHostTagsList",
		reflect.TypeOf((*CodeconnectionsHostTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CodeconnectionsHostTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.codeconnectionsHost.CodeconnectionsHostVpcConfiguration",
