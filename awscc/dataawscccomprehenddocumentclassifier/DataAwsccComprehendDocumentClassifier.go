...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscccomprehenddocumentclassifier/internal"
...
func (j *jsiiProxy_DataAwsccComprehendDocumentClassifier) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccComprehendDocumentClassifier) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccComprehendDocumentClassifier) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccComprehendDocumentClassifier) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccComprehendDocumentClassifier) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/data-sources/comprehend_document_classifier awscc_comprehend_document_classifier} Data Source.
...
func (j *jsiiProxy_DataAwsccComprehendDocumentClassifier)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccComprehendDocumentClassifier)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccComprehendDocumentClassifier)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccComprehendDocumentClassifier_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccComprehendDocumentClassifier) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccComprehendDocumentClassifier) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccComprehendDocumentClassifier) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccComprehendDocumentClassifier) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
