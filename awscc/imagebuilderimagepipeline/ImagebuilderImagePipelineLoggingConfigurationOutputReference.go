...
func (j *jsiiProxy_ImagebuilderImagePipelineLoggingConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ImagebuilderImagePipelineLoggingConfigurationOutputReference)SetInternalValue(val interface{}) {
