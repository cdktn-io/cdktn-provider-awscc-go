...
type ImagebuilderImagePipeline interface {
	...
	SetImageTags(val *map[string]*string)
	ImageTagsInput() *map[string]*string
...
func (j *jsiiProxy_ImagebuilderImagePipeline) DeploymentId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deploymentId",
...
func (j *jsiiProxy_ImagebuilderImagePipeline) ImageTags() *map[string]*string {
...
func (j *jsiiProxy_ImagebuilderImagePipeline) ImageTagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"imageTagsInput",
...
func (j *jsiiProxy_ImagebuilderImagePipeline) LoggingConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ImagebuilderImagePipeline)SetImageTags(val *map[string]*string) {
...
func (i *jsiiProxy_ImagebuilderImagePipeline) ResetImageTags() {
	_jsii_.InvokeVoid(
		i,
		"resetImageTags",
		nil, // no parameters
