...
type ImagebuilderImagePipelineScheduleOutputReference interface {
	cdktn.ComplexObject
	AutoDisablePolicy() ImagebuilderImagePipelineScheduleAutoDisablePolicyOutputReference
	AutoDisablePolicyInput() interface{}
	...
	PutAutoDisablePolicy(value *ImagebuilderImagePipelineScheduleAutoDisablePolicy)
	ResetAutoDisablePolicy()
...
func (j *jsiiProxy_ImagebuilderImagePipelineScheduleOutputReference) AutoDisablePolicy() ImagebuilderImagePipelineScheduleAutoDisablePolicyOutputReference {
	var returns ImagebuilderImagePipelineScheduleAutoDisablePolicyOutputReference
	_jsii_.Get(
		j,
		"autoDisablePolicy",
		&returns,
...
func (j *jsiiProxy_ImagebuilderImagePipelineScheduleOutputReference) AutoDisablePolicyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"autoDisablePolicyInput",
		&returns,
	)
	return returns
}
...
func (i *jsiiProxy_ImagebuilderImagePipelineScheduleOutputReference) PutAutoDisablePolicy(value *ImagebuilderImagePipelineScheduleAutoDisablePolicy) {
	if err := i.validatePutAutoDisablePolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
		"putAutoDisablePolicy",
		[]interface{}{value},
	)
}

func (i *jsiiProxy_ImagebuilderImagePipelineScheduleOutputReference) ResetAutoDisablePolicy() {
	_jsii_.InvokeVoid(
		i,
		"resetAutoDisablePolicy",
		nil, // no parameters
