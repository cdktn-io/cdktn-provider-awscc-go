...
func (r *jsiiProxy_RedshiftserverlessWorkgroup) validatePutConfigParametersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*RedshiftserverlessWorkgroupConfigParameters; received %#v (a %T)", value, value)
		}
	}
...
func (r *jsiiProxy_RedshiftserverlessWorkgroup) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*RedshiftserverlessWorkgroupTags; received %#v (a %T)", value, value)
		}
	}
