...
type LambdaEventSourceMapping interface {
	...
	LoggingConfig() LambdaEventSourceMappingLoggingConfigOutputReference
	...
	PutLoggingConfig(value *LambdaEventSourceMappingLoggingConfig)
...
func (j *jsiiProxy_LambdaEventSourceMapping) LoggingConfig() LambdaEventSourceMappingLoggingConfigOutputReference {
	var returns LambdaEventSourceMappingLoggingConfigOutputReference
	_jsii_.Get(
		j,
		"loggingConfig",
		&returns,
...
func (j *jsiiProxy_LambdaEventSourceMapping) LoggingConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"loggingConfigInput",
...
func (l *jsiiProxy_LambdaEventSourceMapping) PutLoggingConfig(value *LambdaEventSourceMappingLoggingConfig) {
...
func (l *jsiiProxy_LambdaEventSourceMapping) ResetLoggingConfig() {
	_jsii_.InvokeVoid(
		l,
		"resetLoggingConfig",
		nil, // no parameters
