...
func (l *jsiiProxy_LambdaEventSourceMapping) validatePutLoggingConfigParameters(value *LambdaEventSourceMappingLoggingConfig) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (l *jsiiProxy_LambdaEventSourceMapping) validatePutSourceAccessConfigurationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LambdaEventSourceMappingSourceAccessConfigurations; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_LambdaEventSourceMapping) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LambdaEventSourceMappingTags; received %#v (a %T)", value, value)
		}
	}
