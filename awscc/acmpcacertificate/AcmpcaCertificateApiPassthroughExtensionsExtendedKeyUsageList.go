...
func (j *jsiiProxy_AcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList {
	_init_.Initialize()
...
func NewAcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList_Override(a AcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AcmpcaCertificateApiPassthroughExtensionsExtendedKeyUsageList) Resolve(context cdktn.IResolveContext) interface{} {
