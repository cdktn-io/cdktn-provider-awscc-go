...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/batchschedulingpolicy/internal"
...
type BatchSchedulingPolicy interface {
	...
	QuotaSharePolicy() BatchSchedulingPolicyQuotaSharePolicyOutputReference
	QuotaSharePolicyInput() interface{}
	// Experimental.
	...
	PutQuotaSharePolicy(value *BatchSchedulingPolicyQuotaSharePolicy)
...
func (j *jsiiProxy_BatchSchedulingPolicy) QuotaSharePolicy() BatchSchedulingPolicyQuotaSharePolicyOutputReference {
	var returns BatchSchedulingPolicyQuotaSharePolicyOutputReference
	_jsii_.Get(
		j,
		"quotaSharePolicy",
		&returns,
...
func (j *jsiiProxy_BatchSchedulingPolicy) QuotaSharePolicyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"quotaSharePolicyInput",
		&returns,
	)
	return returns
}
...
func (b *jsiiProxy_BatchSchedulingPolicy) PutQuotaSharePolicy(value *BatchSchedulingPolicyQuotaSharePolicy) {
	if err := b.validatePutQuotaSharePolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BatchSchedulingPolicy) ResetQuotaSharePolicy() {
	_jsii_.InvokeVoid(
		b,
		"resetQuotaSharePolicy",
		nil, // no parameters
