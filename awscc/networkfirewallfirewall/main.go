...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "availabilityZoneMappingsInput", GoGetter: "AvailabilityZoneMappingsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAvailabilityZoneMappings", GoMethod: "PutAvailabilityZoneMappings"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAvailabilityZoneMappings", GoMethod: "ResetAvailabilityZoneMappings"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkfirewallFirewallAvailabilityZoneMappings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.networkfirewallFirewall.NetworkfirewallFirewallAvailabilityZoneMappingsList",
		reflect.TypeOf((*NetworkfirewallFirewallAvailabilityZoneMappingsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkfirewallFirewallAvailabilityZoneMappingsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
