...
type NetworkfirewallFirewall interface {
	...
	AvailabilityZoneMappings() NetworkfirewallFirewallAvailabilityZoneMappingsList
	AvailabilityZoneMappingsInput() interface{}
	// Experimental.
	...
	PutAvailabilityZoneMappings(value interface{})
...
func (j *jsiiProxy_NetworkfirewallFirewall) AvailabilityZoneMappings() NetworkfirewallFirewallAvailabilityZoneMappingsList {
	var returns NetworkfirewallFirewallAvailabilityZoneMappingsList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkfirewallFirewall) AvailabilityZoneMappingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"availabilityZoneMappingsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_NetworkfirewallFirewall) TransitGatewayAttachmentId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (n *jsiiProxy_NetworkfirewallFirewall) PutAvailabilityZoneMappings(value interface{}) {
	if err := n.validatePutAvailabilityZoneMappingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
		"putAvailabilityZoneMappings",
		[]interface{}{value},
	)
}
...
func (n *jsiiProxy_NetworkfirewallFirewall) ResetAvailabilityZoneMappings() {
	_jsii_.InvokeVoid(
		n,
		"resetAvailabilityZoneMappings",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkfirewallFirewall) ResetSubnetMappings() {
	_jsii_.InvokeVoid(
		n,
		"resetSubnetMappings",
		nil, // no parameters
