...
func (n *jsiiProxy_NetworkfirewallFirewall) validatePutAvailabilityZoneMappingsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*NetworkfirewallFirewallAvailabilityZoneMappings:
		value := value.(*[]*NetworkfirewallFirewallAvailabilityZoneMappings)
	...
	case []*NetworkfirewallFirewallAvailabilityZoneMappings:
		value_ := value.([]*NetworkfirewallFirewallAvailabilityZoneMappings)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkfirewallFirewallAvailabilityZoneMappings; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NetworkfirewallFirewall) validatePutSubnetMappingsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkfirewallFirewallSubnetMappings; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NetworkfirewallFirewall) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkfirewallFirewallTags; received %#v (a %T)", value, value)
		}
	}
