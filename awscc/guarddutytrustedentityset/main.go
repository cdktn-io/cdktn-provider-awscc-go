...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GuarddutyTrustedEntitySet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GuarddutyTrustedEntitySetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.guarddutyTrustedEntitySet.GuarddutyTrustedEntitySetTags",
		reflect.TypeOf((*GuarddutyTrustedEntitySetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.guarddutyTrustedEntitySet.GuarddutyTrustedEntitySetTagsList",
		reflect.TypeOf((*GuarddutyTrustedEntitySetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GuarddutyTrustedEntitySetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
