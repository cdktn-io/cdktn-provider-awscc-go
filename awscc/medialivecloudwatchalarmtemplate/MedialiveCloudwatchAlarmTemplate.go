...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/medialivecloudwatchalarmtemplate/internal"
...
func (j *jsiiProxy_MedialiveCloudwatchAlarmTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MedialiveCloudwatchAlarmTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MedialiveCloudwatchAlarmTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MedialiveCloudwatchAlarmTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MedialiveCloudwatchAlarmTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MedialiveCloudwatchAlarmTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MedialiveCloudwatchAlarmTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MedialiveCloudwatchAlarmTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MedialiveCloudwatchAlarmTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MedialiveCloudwatchAlarmTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MedialiveCloudwatchAlarmTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MedialiveCloudwatchAlarmTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MedialiveCloudwatchAlarmTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MedialiveCloudwatchAlarmTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MedialiveCloudwatchAlarmTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
