...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ec2gatewayroutetableassociation/internal"
...
func (j *jsiiProxy_Ec2GatewayRouteTableAssociation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2GatewayRouteTableAssociation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2GatewayRouteTableAssociation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2GatewayRouteTableAssociation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2GatewayRouteTableAssociation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/ec2_gateway_route_table_association awscc_ec2_gateway_route_table_association} Resource.
...
func (j *jsiiProxy_Ec2GatewayRouteTableAssociation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2GatewayRouteTableAssociation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2GatewayRouteTableAssociation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2GatewayRouteTableAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2GatewayRouteTableAssociation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2GatewayRouteTableAssociation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2GatewayRouteTableAssociation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2GatewayRouteTableAssociation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2GatewayRouteTableAssociation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2GatewayRouteTableAssociation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
