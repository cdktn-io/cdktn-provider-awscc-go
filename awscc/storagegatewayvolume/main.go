...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*StoragegatewayVolume)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.storagegatewayVolume.StoragegatewayVolumeConfig",
		reflect.TypeOf((*StoragegatewayVolumeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.storagegatewayVolume.StoragegatewayVolumeTags",
		reflect.TypeOf((*StoragegatewayVolumeTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.storagegatewayVolume.StoragegatewayVolumeTagsList",
		reflect.TypeOf((*StoragegatewayVolumeTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*StoragegatewayVolumeTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
