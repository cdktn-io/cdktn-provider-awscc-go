...
func (c *jsiiProxy_Connectcampaignsv2CampaignChannelSubtypeConfigSmsOutboundModeOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (c *jsiiProxy_Connectcampaignsv2CampaignChannelSubtypeConfigSmsOutboundModeOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_Connectcampaignsv2CampaignChannelSubtypeConfigSmsOutboundModeOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *Connectcampaignsv2CampaignChannelSubtypeConfigSmsOutboundMode; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_Connectcampaignsv2CampaignChannelSubtypeConfigSmsOutboundModeOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewConnectcampaignsv2CampaignChannelSubtypeConfigSmsOutboundModeOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
