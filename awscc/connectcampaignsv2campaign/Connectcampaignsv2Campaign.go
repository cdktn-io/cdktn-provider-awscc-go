...
type Connectcampaignsv2Campaign interface {
	...
	EntryLimitsConfig() Connectcampaignsv2CampaignEntryLimitsConfigOutputReference
	EntryLimitsConfigInput() interface{}
	// Experimental.
	...
	PutEntryLimitsConfig(value *Connectcampaignsv2CampaignEntryLimitsConfig)
...
func (j *jsiiProxy_Connectcampaignsv2Campaign) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Connectcampaignsv2Campaign) EntryLimitsConfig() Connectcampaignsv2CampaignEntryLimitsConfigOutputReference {
	var returns Connectcampaignsv2CampaignEntryLimitsConfigOutputReference
	_jsii_.Get(
		j,
		"entryLimitsConfig",
		&returns,
...
func (j *jsiiProxy_Connectcampaignsv2Campaign) EntryLimitsConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"entryLimitsConfigInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_Connectcampaignsv2Campaign) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Connectcampaignsv2Campaign) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Connectcampaignsv2Campaign) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Connectcampaignsv2Campaign) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Connectcampaignsv2Campaign) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_Connectcampaignsv2Campaign) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_Connectcampaignsv2Campaign)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Connectcampaignsv2Campaign)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Connectcampaignsv2Campaign)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_Connectcampaignsv2Campaign)SetType(val *string) {
...
func Connectcampaignsv2Campaign_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) PutEntryLimitsConfig(value *Connectcampaignsv2CampaignEntryLimitsConfig) {
	if err := c.validatePutEntryLimitsConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putEntryLimitsConfig",
		[]interface{}{value},
	)
}
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) ResetChannelSubtypeConfig() {
	_jsii_.InvokeVoid(
		c,
		"resetChannelSubtypeConfig",
		nil, // no parameters
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) ResetEntryLimitsConfig() {
	_jsii_.InvokeVoid(
		c,
		"resetEntryLimitsConfig",
		nil, // no parameters
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) ResetType() {
	_jsii_.InvokeVoid(
		c,
		"resetType",
		nil, // no parameters
...
func (c *jsiiProxy_Connectcampaignsv2Campaign) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
