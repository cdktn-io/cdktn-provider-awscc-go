...
func (c *jsiiProxy_CodepipelineWebhook) validatePutFiltersParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*CodepipelineWebhookFilters:
		value := value.(*[]*CodepipelineWebhookFilters)
	...
	case []*CodepipelineWebhookFilters:
		value_ := value.([]*CodepipelineWebhookFilters)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodepipelineWebhookFilters; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CodepipelineWebhook) validatePutTagsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*CodepipelineWebhookTags:
		value := value.(*[]*CodepipelineWebhookTags)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*CodepipelineWebhookTags:
		value_ := value.([]*CodepipelineWebhookTags)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CodepipelineWebhookTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_CodepipelineWebhook) validateSetRegisterWithThirdPartyParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_CodepipelineWebhook) validateSetTargetPipelineVersionParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
