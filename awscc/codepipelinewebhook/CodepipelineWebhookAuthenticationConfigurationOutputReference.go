...
func (j *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CodepipelineWebhookAuthenticationConfigurationOutputReference)SetInternalValue(val interface{}) {
