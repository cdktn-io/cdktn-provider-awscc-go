...
type CodepipelineWebhook interface {
	...
	RegisterWithThirdPartyInput() interface{}
	...
	TargetPipelineVersionInput() *float64
	// Experimental.
	...
	ResetRegisterWithThirdParty()
	ResetTags()
	ResetTargetPipelineVersion()
...
func (j *jsiiProxy_CodepipelineWebhook) AuthenticationConfigurationInput() interface{} {
...
func (j *jsiiProxy_CodepipelineWebhook) Filters() CodepipelineWebhookFiltersList {
	var returns CodepipelineWebhookFiltersList
	_jsii_.Get(
		j,
		"filters",
		&returns,
...
func (j *jsiiProxy_CodepipelineWebhook) FiltersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filtersInput",
...
func (j *jsiiProxy_CodepipelineWebhook) RegisterWithThirdParty() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodepipelineWebhook) RegisterWithThirdPartyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"registerWithThirdPartyInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_CodepipelineWebhook) Tags() CodepipelineWebhookTagsList {
	var returns CodepipelineWebhookTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CodepipelineWebhook) TargetPipelineVersion() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CodepipelineWebhook) TargetPipelineVersionInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"targetPipelineVersionInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_CodepipelineWebhook) WebhookId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"webhookId",
...
func (j *jsiiProxy_CodepipelineWebhook)SetRegisterWithThirdParty(val interface{}) {
...
func (j *jsiiProxy_CodepipelineWebhook)SetTargetPipelineVersion(val *float64) {
...
func (c *jsiiProxy_CodepipelineWebhook) PutFilters(value interface{}) {
...
func (c *jsiiProxy_CodepipelineWebhook) PutTags(value interface{}) {
...
func (c *jsiiProxy_CodepipelineWebhook) ResetName() {
	_jsii_.InvokeVoid(
		c,
		"resetName",
		nil, // no parameters
...
func (c *jsiiProxy_CodepipelineWebhook) ResetRegisterWithThirdParty() {
	_jsii_.InvokeVoid(
		c,
		"resetRegisterWithThirdParty",
		nil, // no parameters
...
func (c *jsiiProxy_CodepipelineWebhook) ResetTargetPipelineVersion() {
	_jsii_.InvokeVoid(
		c,
		"resetTargetPipelineVersion",
		nil, // no parameters
