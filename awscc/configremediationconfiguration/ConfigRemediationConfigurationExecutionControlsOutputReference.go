...
func (j *jsiiProxy_ConfigRemediationConfigurationExecutionControlsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_ConfigRemediationConfigurationExecutionControlsOutputReference) SsmControlsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ssmControlsInput",
...
func (j *jsiiProxy_ConfigRemediationConfigurationExecutionControlsOutputReference)SetInternalValue(val interface{}) {
