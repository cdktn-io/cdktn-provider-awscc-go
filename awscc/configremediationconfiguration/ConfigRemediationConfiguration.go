...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/configremediationconfiguration/internal"
...
type ConfigRemediationConfiguration interface {
	...
	ExecutionControlsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_ConfigRemediationConfiguration) ExecutionControlsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConfigRemediationConfiguration) Parameters() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameters",
...
func (j *jsiiProxy_ConfigRemediationConfiguration) ParametersInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parametersInput",
...
func (j *jsiiProxy_ConfigRemediationConfiguration)SetParameters(val *string) {
...
func (c *jsiiProxy_ConfigRemediationConfiguration) ResetParameters() {
	_jsii_.InvokeVoid(
		c,
		"resetParameters",
		nil, // no parameters
