...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlueBlueprint)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccGlueBlueprintConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccGlueBlueprint.DataAwsccGlueBlueprintTags",
		reflect.TypeOf((*DataAwsccGlueBlueprintTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccGlueBlueprint.DataAwsccGlueBlueprintTagsList",
		reflect.TypeOf((*DataAwsccGlueBlueprintTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGlueBlueprintTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
