...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*S3ExpressAccessPointTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.s3ExpressAccessPoint.S3ExpressAccessPointTagsList",
		reflect.TypeOf((*S3ExpressAccessPointTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_S3ExpressAccessPointTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*S3ExpressAccessPointTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
