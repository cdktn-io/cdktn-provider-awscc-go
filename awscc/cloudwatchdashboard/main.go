...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CloudwatchDashboardTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.cloudwatchDashboard.CloudwatchDashboardTagsList",
		reflect.TypeOf((*CloudwatchDashboardTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudwatchDashboardTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
