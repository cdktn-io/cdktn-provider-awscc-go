...
type MediaconnectRouterInputTransitEncryptionEncryptionKeyConfiguration struct {
	...
	SecretsManager *MediaconnectRouterInputTransitEncryptionEncryptionKeyConfigurationSecretsManager `field:"optional" json:"secretsManager" yaml:"secretsManager"`
}
