...
type MediaconnectRouterInputConfigurationFailoverProtocolConfigurationsSrtCaller struct {
	...
	DecryptionConfiguration *MediaconnectRouterInputConfigurationFailoverProtocolConfigurationsSrtCallerDecryptionConfiguration `field:"optional" json:"decryptionConfiguration" yaml:"decryptionConfiguration"`
