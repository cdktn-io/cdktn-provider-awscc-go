...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "publicIpDnsHostnameTypeSpecificationInput", GoGetter: "PublicIpDnsHostnameTypeSpecificationInput"},
			_jsii_.MemberProperty{JsiiProperty: "publicIpDnsNameOptions", GoGetter: "PublicIpDnsNameOptions"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPublicIpDnsHostnameTypeSpecification", GoMethod: "ResetPublicIpDnsHostnameTypeSpecification"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2NetworkInterfacePublicIpDnsNameOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ec2NetworkInterface.Ec2NetworkInterfacePublicIpDnsNameOptionsOutputReference",
		reflect.TypeOf((*Ec2NetworkInterfacePublicIpDnsNameOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "dnsHostnameType", GoGetter: "DnsHostnameType"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "publicDualStackDnsName", GoGetter: "PublicDualStackDnsName"},
			_jsii_.MemberProperty{JsiiProperty: "publicIpv4DnsName", GoGetter: "PublicIpv4DnsName"},
			_jsii_.MemberProperty{JsiiProperty: "publicIpv6DnsName", GoGetter: "PublicIpv6DnsName"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		...
		func() interface{} {
			j := jsiiProxy_Ec2NetworkInterfacePublicIpDnsNameOptionsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
