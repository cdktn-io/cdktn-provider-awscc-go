...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectconnectDirectConnectGateway)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "directConnectGatewayNameInput", GoGetter: "DirectConnectGatewayNameInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DirectconnectDirectConnectGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.directconnectDirectConnectGateway.DirectconnectDirectConnectGatewayTags",
		reflect.TypeOf((*DirectconnectDirectConnectGatewayTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.directconnectDirectConnectGateway.DirectconnectDirectConnectGatewayTagsList",
		reflect.TypeOf((*DirectconnectDirectConnectGatewayTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DirectconnectDirectConnectGatewayTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
