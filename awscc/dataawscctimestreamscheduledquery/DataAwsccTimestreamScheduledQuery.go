...
func (j *jsiiProxy_DataAwsccTimestreamScheduledQuery) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccTimestreamScheduledQuery) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccTimestreamScheduledQuery) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccTimestreamScheduledQuery) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccTimestreamScheduledQuery) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccTimestreamScheduledQuery)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccTimestreamScheduledQuery)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccTimestreamScheduledQuery)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccTimestreamScheduledQuery_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccTimestreamScheduledQuery) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccTimestreamScheduledQuery) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccTimestreamScheduledQuery) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccTimestreamScheduledQuery) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
