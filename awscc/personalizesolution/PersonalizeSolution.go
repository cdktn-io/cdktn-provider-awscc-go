...
func (j *jsiiProxy_PersonalizeSolution) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PersonalizeSolution) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PersonalizeSolution) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PersonalizeSolution) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PersonalizeSolution)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PersonalizeSolution)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PersonalizeSolution)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PersonalizeSolution_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PersonalizeSolution) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PersonalizeSolution) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PersonalizeSolution) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PersonalizeSolution) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PersonalizeSolution) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
