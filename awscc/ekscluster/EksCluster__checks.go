...
func (e *jsiiProxy_EksCluster) validatePutEncryptionConfigParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EksClusterEncryptionConfig; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EksCluster) validatePutRollbackConfigParameters(value *EksClusterRollbackConfig) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (e *jsiiProxy_EksCluster) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EksClusterTags; received %#v (a %T)", value, value)
		}
	}
