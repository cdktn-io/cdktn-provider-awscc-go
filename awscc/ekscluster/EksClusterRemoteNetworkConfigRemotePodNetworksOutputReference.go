...
func NewEksClusterRemoteNetworkConfigRemotePodNetworksOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EksClusterRemoteNetworkConfigRemotePodNetworksOutputReference {
	_init_.Initialize()
...
func NewEksClusterRemoteNetworkConfigRemotePodNetworksOutputReference_Override(e EksClusterRemoteNetworkConfigRemotePodNetworksOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
