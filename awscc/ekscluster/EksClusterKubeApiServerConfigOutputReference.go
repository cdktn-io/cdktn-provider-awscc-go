...
type EksClusterKubeApiServerConfigOutputReference interface {
	...
	ServiceNodePortRangeInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_EksClusterKubeApiServerConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EksClusterKubeApiServerConfigOutputReference) ServiceNodePortRangeInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EksClusterKubeApiServerConfigOutputReference)SetInternalValue(val interface{}) {
