...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool) AllowClassicFlow() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool) AllowUnauthenticatedIdentities() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/cognito_identity_pool awscc_cognito_identity_pool} Data Source.
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCognitoIdentityPool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCognitoIdentityPool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCognitoIdentityPool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCognitoIdentityPool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCognitoIdentityPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCognitoIdentityPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
