...
type GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutputReference interface {
	...
	ConnectionPasswordEncryptionInput() interface{}
	...
	ResetConnectionPasswordEncryption()
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutputReference) ConnectionPasswordEncryptionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutputReference) EncryptionAtRestInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutputReference) ResetConnectionPasswordEncryption() {
	_jsii_.InvokeVoid(
		g,
		"resetConnectionPasswordEncryption",
		nil, // no parameters
...
func (g *jsiiProxy_GlueDataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutputReference) ResetEncryptionAtRest() {
	_jsii_.InvokeVoid(
		g,
		"resetEncryptionAtRest",
		nil, // no parameters
