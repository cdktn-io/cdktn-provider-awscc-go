...
type GlueDataCatalogEncryptionSettings interface {
	...
	DataCatalogEncryptionSettingsInput() interface{}
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
...
func (j *jsiiProxy_GlueDataCatalogEncryptionSettings) DataCatalogEncryptionSettingsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/glue_data_catalog_encryption_settings awscc_glue_data_catalog_encryption_settings} Resource.
