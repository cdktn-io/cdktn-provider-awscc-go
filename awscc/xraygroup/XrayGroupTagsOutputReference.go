...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/xraygroup/internal"
...
func (j *jsiiProxy_XrayGroupTagsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewXrayGroupTagsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) XrayGroupTagsOutputReference {
	_init_.Initialize()
...
func NewXrayGroupTagsOutputReference_Override(x XrayGroupTagsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_XrayGroupTagsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (x *jsiiProxy_XrayGroupTagsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (x *jsiiProxy_XrayGroupTagsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (x *jsiiProxy_XrayGroupTagsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (x *jsiiProxy_XrayGroupTagsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
