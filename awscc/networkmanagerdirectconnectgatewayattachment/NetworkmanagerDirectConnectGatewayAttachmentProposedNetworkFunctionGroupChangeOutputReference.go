...
type NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChange
	SetInternalValue(val *NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChange)
...
func (j *jsiiProxy_NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference) InternalValue() *NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChange {
	var returns *NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChange
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference {
	_init_.Initialize()
...
func NewNetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference_Override(n NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference)SetInternalValue(val *NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChange) {
...
func (j *jsiiProxy_NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (n *jsiiProxy_NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (n *jsiiProxy_NetworkmanagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChangeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
