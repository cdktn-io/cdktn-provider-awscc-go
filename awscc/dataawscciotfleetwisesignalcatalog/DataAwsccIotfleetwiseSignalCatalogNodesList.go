...
func (j *jsiiProxy_DataAwsccIotfleetwiseSignalCatalogNodesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccIotfleetwiseSignalCatalogNodesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccIotfleetwiseSignalCatalogNodesList {
	_init_.Initialize()
...
func NewDataAwsccIotfleetwiseSignalCatalogNodesList_Override(d DataAwsccIotfleetwiseSignalCatalogNodesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccIotfleetwiseSignalCatalogNodesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccIotfleetwiseSignalCatalogNodesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccIotfleetwiseSignalCatalogNodesList) Resolve(context cdktn.IResolveContext) interface{} {
