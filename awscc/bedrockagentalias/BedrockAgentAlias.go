...
func (j *jsiiProxy_BedrockAgentAlias) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BedrockAgentAlias) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BedrockAgentAlias) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BedrockAgentAlias) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BedrockAgentAlias) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BedrockAgentAlias)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BedrockAgentAlias)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BedrockAgentAlias)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BedrockAgentAlias_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockAgentAlias) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockAgentAlias) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BedrockAgentAlias) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockAgentAlias) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BedrockAgentAlias) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BedrockAgentAlias) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
