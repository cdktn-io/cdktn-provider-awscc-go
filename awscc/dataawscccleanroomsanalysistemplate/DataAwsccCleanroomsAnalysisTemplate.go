...
type DataAwsccCleanroomsAnalysisTemplate interface {
	...
	Description() *string
	ErrorMessageConfiguration() DataAwsccCleanroomsAnalysisTemplateErrorMessageConfigurationOutputReference
	// Experimental.
	...
	SyntheticDataParameters() DataAwsccCleanroomsAnalysisTemplateSyntheticDataParametersOutputReference
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) ErrorMessageConfiguration() DataAwsccCleanroomsAnalysisTemplateErrorMessageConfigurationOutputReference {
	var returns DataAwsccCleanroomsAnalysisTemplateErrorMessageConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) SyntheticDataParameters() DataAwsccCleanroomsAnalysisTemplateSyntheticDataParametersOutputReference {
	var returns DataAwsccCleanroomsAnalysisTemplateSyntheticDataParametersOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCleanroomsAnalysisTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCleanroomsAnalysisTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
