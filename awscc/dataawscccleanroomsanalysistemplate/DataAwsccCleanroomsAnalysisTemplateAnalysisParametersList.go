...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplateAnalysisParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccCleanroomsAnalysisTemplateAnalysisParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccCleanroomsAnalysisTemplateAnalysisParametersList {
	_init_.Initialize()
...
func NewDataAwsccCleanroomsAnalysisTemplateAnalysisParametersList_Override(d DataAwsccCleanroomsAnalysisTemplateAnalysisParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccCleanroomsAnalysisTemplateAnalysisParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccCleanroomsAnalysisTemplateAnalysisParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccCleanroomsAnalysisTemplateAnalysisParametersList) Resolve(context cdktn.IResolveContext) interface{} {
