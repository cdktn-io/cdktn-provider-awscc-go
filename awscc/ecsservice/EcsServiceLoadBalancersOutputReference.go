...
type EcsServiceLoadBalancersOutputReference interface {
	cdktn.ComplexObject
	AdvancedConfiguration() EcsServiceLoadBalancersAdvancedConfigurationOutputReference
	...
	PutAdvancedConfiguration(value *EcsServiceLoadBalancersAdvancedConfiguration)
...
func (j *jsiiProxy_EcsServiceLoadBalancersOutputReference) AdvancedConfiguration() EcsServiceLoadBalancersAdvancedConfigurationOutputReference {
	var returns EcsServiceLoadBalancersAdvancedConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsServiceLoadBalancersOutputReference) AdvancedConfigurationInput() interface{} {
...
func (j *jsiiProxy_EcsServiceLoadBalancersOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewEcsServiceLoadBalancersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EcsServiceLoadBalancersOutputReference {
	_init_.Initialize()
...
func NewEcsServiceLoadBalancersOutputReference_Override(e EcsServiceLoadBalancersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_EcsServiceLoadBalancersOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (e *jsiiProxy_EcsServiceLoadBalancersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsServiceLoadBalancersOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (e *jsiiProxy_EcsServiceLoadBalancersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EcsServiceLoadBalancersOutputReference) PutAdvancedConfiguration(value *EcsServiceLoadBalancersAdvancedConfiguration) {
...
func (e *jsiiProxy_EcsServiceLoadBalancersOutputReference) ResetAdvancedConfiguration() {
	_jsii_.InvokeVoid(
		e,
		"resetAdvancedConfiguration",
		nil, // no parameters
...
func (e *jsiiProxy_EcsServiceLoadBalancersOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
