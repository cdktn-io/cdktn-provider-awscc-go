...
type EcsServiceServiceConnectConfigurationServicesClientAliasesTestTrafficRulesHeader struct {
	...
	Value *EcsServiceServiceConnectConfigurationServicesClientAliasesTestTrafficRulesHeaderValue `field:"optional" json:"value" yaml:"value"`
}
