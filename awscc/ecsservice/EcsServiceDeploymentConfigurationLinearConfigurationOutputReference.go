...
type EcsServiceDeploymentConfigurationLinearConfigurationOutputReference interface {
	...
	SetStepBakeTimeInMinutes(val *float64)
	StepBakeTimeInMinutesInput() *float64
	StepPercent() *float64
...
func (j *jsiiProxy_EcsServiceDeploymentConfigurationLinearConfigurationOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_EcsServiceDeploymentConfigurationLinearConfigurationOutputReference) StepBakeTimeInMinutes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsServiceDeploymentConfigurationLinearConfigurationOutputReference) StepBakeTimeInMinutesInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_EcsServiceDeploymentConfigurationLinearConfigurationOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_EcsServiceDeploymentConfigurationLinearConfigurationOutputReference)SetStepBakeTimeInMinutes(val *float64) {
