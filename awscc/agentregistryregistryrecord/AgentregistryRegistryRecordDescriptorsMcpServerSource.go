...
type AgentregistryRegistryRecordDescriptorsMcpServerSource struct {
	...
	FromUrl *AgentregistryRegistryRecordDescriptorsMcpServerSourceFromUrl `field:"optional" json:"fromUrl" yaml:"fromUrl"`
}
