...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53GlobalresolverGlobalResolver)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53GlobalresolverGlobalResolverTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
