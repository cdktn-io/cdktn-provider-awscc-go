...
func (j *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsDataSetSchemaColumnSchemaListStructList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightTemplateVersionDataSetConfigurationsDataSetSchemaColumnSchemaListStructList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightTemplateVersionDataSetConfigurationsDataSetSchemaColumnSchemaListStructList {
	_init_.Initialize()
...
func NewQuicksightTemplateVersionDataSetConfigurationsDataSetSchemaColumnSchemaListStructList_Override(q QuicksightTemplateVersionDataSetConfigurationsDataSetSchemaColumnSchemaListStructList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsDataSetSchemaColumnSchemaListStructList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsDataSetSchemaColumnSchemaListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsDataSetSchemaColumnSchemaListStructList) Resolve(context cdktn.IResolveContext) interface{} {
