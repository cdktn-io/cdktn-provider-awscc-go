...
func (j *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList {
	_init_.Initialize()
...
func NewQuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList_Override(q QuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightTemplateVersionDataSetConfigurationsColumnGroupSchemaListStructList) Resolve(context cdktn.IResolveContext) interface{} {
