...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccWellarchitectedReviewTemplate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccWellarchitectedReviewTemplateTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccWellarchitectedReviewTemplateTagsOutputReference{}
