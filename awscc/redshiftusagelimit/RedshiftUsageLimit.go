...
func (j *jsiiProxy_RedshiftUsageLimit) Tags() RedshiftUsageLimitTagsList {
	var returns RedshiftUsageLimitTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_RedshiftUsageLimit) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_RedshiftUsageLimit) UsageLimitId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"usageLimitId",
...
func (r *jsiiProxy_RedshiftUsageLimit) PutTags(value interface{}) {
