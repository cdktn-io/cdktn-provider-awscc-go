...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicecatalogTagOptionAssociation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTagOptionId", GoMethod: "ResetTagOptionId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ServicecatalogTagOptionAssociationConfig)(nil)).Elem(),
	)
}
