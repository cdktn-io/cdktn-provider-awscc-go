...
func (j *jsiiProxy_DmsEndpointTagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*DmsEndpointTags:
		val := val.(*[]*DmsEndpointTags)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*DmsEndpointTags; received %#v (a %T)", val, val)
		}
	}
