...
func (j *jsiiProxy_DmsEndpointKafkaSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DmsEndpointKafkaSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (d *jsiiProxy_DmsEndpointKafkaSettingsOutputReference) ResetBroker() {
	_jsii_.InvokeVoid(
		d,
		"resetBroker",
		nil, // no parameters
