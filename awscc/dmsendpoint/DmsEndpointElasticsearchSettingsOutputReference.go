...
func (j *jsiiProxy_DmsEndpointElasticsearchSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DmsEndpointElasticsearchSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (d *jsiiProxy_DmsEndpointElasticsearchSettingsOutputReference) ResetEndpointUri() {
	_jsii_.InvokeVoid(
		d,
		"resetEndpointUri",
		nil, // no parameters
...
func (d *jsiiProxy_DmsEndpointElasticsearchSettingsOutputReference) ResetServiceAccessRoleArn() {
	_jsii_.InvokeVoid(
		d,
		"resetServiceAccessRoleArn",
		nil, // no parameters
