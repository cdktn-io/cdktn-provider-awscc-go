...
func (j *jsiiProxy_DmsEndpointRedisSettingsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DmsEndpointRedisSettingsOutputReference)SetInternalValue(val interface{}) {
...
func (d *jsiiProxy_DmsEndpointRedisSettingsOutputReference) ResetAuthType() {
	_jsii_.InvokeVoid(
		d,
		"resetAuthType",
		nil, // no parameters
...
func (d *jsiiProxy_DmsEndpointRedisSettingsOutputReference) ResetPort() {
	_jsii_.InvokeVoid(
		d,
		"resetPort",
		nil, // no parameters
...
func (d *jsiiProxy_DmsEndpointRedisSettingsOutputReference) ResetServerName() {
	_jsii_.InvokeVoid(
		d,
		"resetServerName",
		nil, // no parameters
