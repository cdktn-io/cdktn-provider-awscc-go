...
func (a *jsiiProxy_Apigatewayv2RoutingRuleConditionsMatchHeadersAnyOfList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_Apigatewayv2RoutingRuleConditionsMatchHeadersAnyOfList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewApigatewayv2RoutingRuleConditionsMatchHeadersAnyOfListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
