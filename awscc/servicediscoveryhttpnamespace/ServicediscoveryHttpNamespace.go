...
func (j *jsiiProxy_ServicediscoveryHttpNamespace) HttpNamespaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"httpNamespaceId",
...
func (j *jsiiProxy_ServicediscoveryHttpNamespace) Tags() ServicediscoveryHttpNamespaceTagsList {
	var returns ServicediscoveryHttpNamespaceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (s *jsiiProxy_ServicediscoveryHttpNamespace) PutTags(value interface{}) {
