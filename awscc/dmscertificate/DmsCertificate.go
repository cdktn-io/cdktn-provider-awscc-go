...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dmscertificate/internal"
...
func (j *jsiiProxy_DmsCertificate) CertificateIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DmsCertificate) CertificateIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DmsCertificate)SetCertificateIdentifier(val *string) {
...
func (d *jsiiProxy_DmsCertificate) ResetCertificateIdentifier() {
	_jsii_.InvokeVoid(
		d,
		"resetCertificateIdentifier",
		nil, // no parameters
