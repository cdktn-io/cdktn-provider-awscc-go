...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "imageTagMutabilityExclusionFiltersInput", GoGetter: "ImageTagMutabilityExclusionFiltersInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putImageTagMutabilityExclusionFilters", GoMethod: "PutImageTagMutabilityExclusionFilters"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetImageTagMutabilityExclusionFilters", GoMethod: "ResetImageTagMutabilityExclusionFilters"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EcrRepositoryCreationTemplateImageTagMutabilityExclusionFilters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ecrRepositoryCreationTemplate.EcrRepositoryCreationTemplateImageTagMutabilityExclusionFiltersList",
		reflect.TypeOf((*EcrRepositoryCreationTemplateImageTagMutabilityExclusionFiltersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EcrRepositoryCreationTemplateImageTagMutabilityExclusionFiltersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "imageTagMutabilityExclusionFilterType", GoGetter: "ImageTagMutabilityExclusionFilterType"},
			_jsii_.MemberProperty{JsiiProperty: "imageTagMutabilityExclusionFilterTypeInput", GoGetter: "ImageTagMutabilityExclusionFilterTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "imageTagMutabilityExclusionFilterValue", GoGetter: "ImageTagMutabilityExclusionFilterValue"},
			_jsii_.MemberProperty{JsiiProperty: "imageTagMutabilityExclusionFilterValueInput", GoGetter: "ImageTagMutabilityExclusionFilterValueInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetImageTagMutabilityExclusionFilterType", GoMethod: "ResetImageTagMutabilityExclusionFilterType"},
			_jsii_.MemberMethod{JsiiMethod: "resetImageTagMutabilityExclusionFilterValue", GoMethod: "ResetImageTagMutabilityExclusionFilterValue"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
