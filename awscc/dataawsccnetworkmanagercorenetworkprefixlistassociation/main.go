...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNetworkmanagerCoreNetworkPrefixListAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccNetworkmanagerCoreNetworkPrefixListAssociationConfig)(nil)).Elem(),
	)
}
