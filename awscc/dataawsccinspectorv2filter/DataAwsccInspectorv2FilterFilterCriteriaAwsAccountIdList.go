...
func (j *jsiiProxy_DataAwsccInspectorv2FilterFilterCriteriaAwsAccountIdList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccInspectorv2FilterFilterCriteriaAwsAccountIdList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccInspectorv2FilterFilterCriteriaAwsAccountIdList {
	_init_.Initialize()
...
func NewDataAwsccInspectorv2FilterFilterCriteriaAwsAccountIdList_Override(d DataAwsccInspectorv2FilterFilterCriteriaAwsAccountIdList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccInspectorv2FilterFilterCriteriaAwsAccountIdList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccInspectorv2FilterFilterCriteriaAwsAccountIdList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccInspectorv2FilterFilterCriteriaAwsAccountIdList) Resolve(context cdktn.IResolveContext) interface{} {
