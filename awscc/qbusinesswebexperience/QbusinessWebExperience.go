...
func (j *jsiiProxy_QbusinessWebExperience) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_QbusinessWebExperience) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_QbusinessWebExperience) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_QbusinessWebExperience) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_QbusinessWebExperience) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_QbusinessWebExperience)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_QbusinessWebExperience)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_QbusinessWebExperience)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func QbusinessWebExperience_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (q *jsiiProxy_QbusinessWebExperience) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QbusinessWebExperience) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (q *jsiiProxy_QbusinessWebExperience) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QbusinessWebExperience) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (q *jsiiProxy_QbusinessWebExperience) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (q *jsiiProxy_QbusinessWebExperience) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
