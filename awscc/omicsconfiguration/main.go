...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OmicsConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putRunConfigurations", GoMethod: "PutRunConfigurations"},
			...
			_jsii_.MemberProperty{JsiiProperty: "runConfigurationsInput", GoGetter: "RunConfigurationsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OmicsConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.omicsConfiguration.OmicsConfigurationRunConfigurations",
		reflect.TypeOf((*OmicsConfigurationRunConfigurations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.omicsConfiguration.OmicsConfigurationRunConfigurationsOutputReference",
		reflect.TypeOf((*OmicsConfigurationRunConfigurationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OmicsConfigurationRunConfigurationsVpcConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.omicsConfiguration.OmicsConfigurationRunConfigurationsVpcConfigOutputReference",
		reflect.TypeOf((*OmicsConfigurationRunConfigurationsVpcConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
