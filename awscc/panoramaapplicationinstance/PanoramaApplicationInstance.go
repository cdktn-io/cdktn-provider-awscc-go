...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/panoramaapplicationinstance/internal"
...
func (j *jsiiProxy_PanoramaApplicationInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PanoramaApplicationInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PanoramaApplicationInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PanoramaApplicationInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PanoramaApplicationInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_PanoramaApplicationInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PanoramaApplicationInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PanoramaApplicationInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PanoramaApplicationInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PanoramaApplicationInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PanoramaApplicationInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PanoramaApplicationInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PanoramaApplicationInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PanoramaApplicationInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PanoramaApplicationInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
