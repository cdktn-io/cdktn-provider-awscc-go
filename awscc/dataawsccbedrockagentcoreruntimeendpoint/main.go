...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreRuntimeEndpoint)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "runtimeEndpointId", GoGetter: "RuntimeEndpointId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreRuntimeEndpointConfig)(nil)).Elem(),
	)
}
