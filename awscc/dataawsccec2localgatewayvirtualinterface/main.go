...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2LocalGatewayVirtualInterface)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2LocalGatewayVirtualInterfaceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
