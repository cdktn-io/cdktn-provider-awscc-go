...
func (p *jsiiProxy_PcsComputeNodeGroupSlurmConfigurationSlurmCustomSettingsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_PcsComputeNodeGroupSlurmConfigurationSlurmCustomSettingsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewPcsComputeNodeGroupSlurmConfigurationSlurmCustomSettingsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
