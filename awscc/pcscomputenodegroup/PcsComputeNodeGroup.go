...
type PcsComputeNodeGroup interface {
	...
	NodeLifecycleActions() PcsComputeNodeGroupNodeLifecycleActionsOutputReference
	NodeLifecycleActionsInput() interface{}
	// Experimental.
	...
	PutNodeLifecycleActions(value *PcsComputeNodeGroupNodeLifecycleActions)
...
func (j *jsiiProxy_PcsComputeNodeGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_PcsComputeNodeGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_PcsComputeNodeGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PcsComputeNodeGroup) NodeLifecycleActions() PcsComputeNodeGroupNodeLifecycleActionsOutputReference {
	var returns PcsComputeNodeGroupNodeLifecycleActionsOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PcsComputeNodeGroup) NodeLifecycleActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"nodeLifecycleActionsInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_PcsComputeNodeGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_PcsComputeNodeGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/pcs_compute_node_group awscc_pcs_compute_node_group} Resource.
...
func (j *jsiiProxy_PcsComputeNodeGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_PcsComputeNodeGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_PcsComputeNodeGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func PcsComputeNodeGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_PcsComputeNodeGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PcsComputeNodeGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_PcsComputeNodeGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PcsComputeNodeGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_PcsComputeNodeGroup) PutNodeLifecycleActions(value *PcsComputeNodeGroupNodeLifecycleActions) {
	if err := p.validatePutNodeLifecycleActionsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		p,
		"putNodeLifecycleActions",
		[]interface{}{value},
	)
}
...
func (p *jsiiProxy_PcsComputeNodeGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_PcsComputeNodeGroup) ResetNodeLifecycleActions() {
	_jsii_.InvokeVoid(
		p,
		"resetNodeLifecycleActions",
		nil, // no parameters
...
func (p *jsiiProxy_PcsComputeNodeGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
