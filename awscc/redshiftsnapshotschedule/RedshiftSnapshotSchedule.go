...
type RedshiftSnapshotSchedule interface {
	...
	ScheduleDefinitionsInput() *[]*string
	ScheduleDescription() *string
	SetScheduleDescription(val *string)
	ScheduleDescriptionInput() *string
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) AssociatedClusterCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) ScheduleDefinitions() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"scheduleDefinitions",
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) ScheduleDefinitionsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"scheduleDefinitionsInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_RedshiftSnapshotSchedule) ScheduleDescription() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scheduleDescription",
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) ScheduleDescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) ScheduleIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scheduleIdentifier",
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) ScheduleIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_RedshiftSnapshotSchedule) Tags() RedshiftSnapshotScheduleTagsList {
	var returns RedshiftSnapshotScheduleTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_RedshiftSnapshotSchedule)SetScheduleDefinitions(val *[]*string) {
...
func (j *jsiiProxy_RedshiftSnapshotSchedule)SetScheduleDescription(val *string) {
	if err := j.validateSetScheduleDescriptionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_RedshiftSnapshotSchedule)SetScheduleIdentifier(val *string) {
...
func (r *jsiiProxy_RedshiftSnapshotSchedule) PutTags(value interface{}) {
...
func (r *jsiiProxy_RedshiftSnapshotSchedule) ResetScheduleDescription() {
	_jsii_.InvokeVoid(
		r,
		"resetScheduleDescription",
		nil, // no parameters
