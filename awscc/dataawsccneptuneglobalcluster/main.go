...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptuneGlobalCluster)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccNeptuneGlobalClusterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccNeptuneGlobalCluster.DataAwsccNeptuneGlobalClusterTags",
		reflect.TypeOf((*DataAwsccNeptuneGlobalClusterTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccNeptuneGlobalCluster.DataAwsccNeptuneGlobalClusterTagsList",
		reflect.TypeOf((*DataAwsccNeptuneGlobalClusterTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccNeptuneGlobalClusterTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
