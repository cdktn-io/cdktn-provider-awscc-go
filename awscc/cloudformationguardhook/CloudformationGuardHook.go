...
func (j *jsiiProxy_CloudformationGuardHook) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_CloudformationGuardHook) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_CloudformationGuardHook) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CloudformationGuardHook) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_CloudformationGuardHook) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_CloudformationGuardHook)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CloudformationGuardHook)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CloudformationGuardHook)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CloudformationGuardHook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudformationGuardHook) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationGuardHook) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (c *jsiiProxy_CloudformationGuardHook) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CloudformationGuardHook) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudformationGuardHook) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudformationGuardHook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
