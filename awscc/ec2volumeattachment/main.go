...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ebsCardIndexInput", GoGetter: "EbsCardIndexInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEbsCardIndex", GoMethod: "ResetEbsCardIndex"},
