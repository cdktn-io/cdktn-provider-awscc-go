...
func NewBedrockagentcoreHarnessModelBedrockModelConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BedrockagentcoreHarnessModelBedrockModelConfigOutputReference {
	_init_.Initialize()

	if err := validateNewBedrockagentcoreHarnessModelBedrockModelConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBedrockagentcoreHarnessModelBedrockModelConfigOutputReference_Override(b BedrockagentcoreHarnessModelBedrockModelConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockagentcoreHarnessModelBedrockModelConfigOutputReference) ResetModelId() {
	_jsii_.InvokeVoid(
		b,
		"resetModelId",
		nil, // no parameters
