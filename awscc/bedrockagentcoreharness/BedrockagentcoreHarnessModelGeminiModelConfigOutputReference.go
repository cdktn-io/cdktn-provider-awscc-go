...
func NewBedrockagentcoreHarnessModelGeminiModelConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) BedrockagentcoreHarnessModelGeminiModelConfigOutputReference {
	_init_.Initialize()

	if err := validateNewBedrockagentcoreHarnessModelGeminiModelConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewBedrockagentcoreHarnessModelGeminiModelConfigOutputReference_Override(b BedrockagentcoreHarnessModelGeminiModelConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockagentcoreHarnessModelGeminiModelConfigOutputReference) ResetApiKeyArn() {
	_jsii_.InvokeVoid(
		b,
		"resetApiKeyArn",
		nil, // no parameters
...
func (b *jsiiProxy_BedrockagentcoreHarnessModelGeminiModelConfigOutputReference) ResetModelId() {
	_jsii_.InvokeVoid(
		b,
		"resetModelId",
		nil, // no parameters
