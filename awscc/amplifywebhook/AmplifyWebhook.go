...
func (j *jsiiProxy_AmplifyWebhook) Tags() AmplifyWebhookTagsList {
	var returns AmplifyWebhookTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_AmplifyWebhook) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_AmplifyWebhook) WebhookId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"webhookId",
...
func (j *jsiiProxy_AmplifyWebhook) WebhookUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"webhookUrl",
...
func (a *jsiiProxy_AmplifyWebhook) PutTags(value interface{}) {
...
func (a *jsiiProxy_AmplifyWebhook) ResetAppId() {
	_jsii_.InvokeVoid(
		a,
		"resetAppId",
		nil, // no parameters
...
func (a *jsiiProxy_AmplifyWebhook) ResetTags() {
	_jsii_.InvokeVoid(
		a,
		"resetTags",
		nil, // no parameters
