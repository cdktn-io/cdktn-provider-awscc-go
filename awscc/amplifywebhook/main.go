...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.amplifyWebhook.AmplifyWebhook",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.amplifyWebhook.AmplifyWebhookConfig",
		reflect.TypeOf((*AmplifyWebhookConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.amplifyWebhook.AmplifyWebhookTags",
		reflect.TypeOf((*AmplifyWebhookTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.amplifyWebhook.AmplifyWebhookTagsList",
		reflect.TypeOf((*AmplifyWebhookTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_AmplifyWebhookTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AmplifyWebhookTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
