...
func (j *jsiiProxy_DataAwsccEvidentlyLaunchScheduledSplitsConfigSegmentOverridesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccEvidentlyLaunchScheduledSplitsConfigSegmentOverridesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccEvidentlyLaunchScheduledSplitsConfigSegmentOverridesList {
	_init_.Initialize()
...
func NewDataAwsccEvidentlyLaunchScheduledSplitsConfigSegmentOverridesList_Override(d DataAwsccEvidentlyLaunchScheduledSplitsConfigSegmentOverridesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccEvidentlyLaunchScheduledSplitsConfigSegmentOverridesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccEvidentlyLaunchScheduledSplitsConfigSegmentOverridesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccEvidentlyLaunchScheduledSplitsConfigSegmentOverridesList) Resolve(context cdktn.IResolveContext) interface{} {
