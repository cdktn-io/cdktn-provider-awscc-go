...
func (j *jsiiProxy_DataAwsccEvidentlyLaunchMetricMonitorsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccEvidentlyLaunchMetricMonitorsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccEvidentlyLaunchMetricMonitorsList {
	_init_.Initialize()
...
func NewDataAwsccEvidentlyLaunchMetricMonitorsList_Override(d DataAwsccEvidentlyLaunchMetricMonitorsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccEvidentlyLaunchMetricMonitorsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccEvidentlyLaunchMetricMonitorsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccEvidentlyLaunchMetricMonitorsList) Resolve(context cdktn.IResolveContext) interface{} {
