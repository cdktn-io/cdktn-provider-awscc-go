...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGuarddutyThreatEntitySet)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "threatEntitySetId", GoGetter: "ThreatEntitySetId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccGuarddutyThreatEntitySetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccGuarddutyThreatEntitySet.DataAwsccGuarddutyThreatEntitySetTags",
		reflect.TypeOf((*DataAwsccGuarddutyThreatEntitySetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccGuarddutyThreatEntitySet.DataAwsccGuarddutyThreatEntitySetTagsList",
		reflect.TypeOf((*DataAwsccGuarddutyThreatEntitySetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGuarddutyThreatEntitySetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
