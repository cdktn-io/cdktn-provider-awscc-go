...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataIntegrationArn", GoGetter: "DataIntegrationArn"},
			_jsii_.MemberProperty{JsiiProperty: "dataIntegrationId", GoGetter: "DataIntegrationId"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionInput", GoGetter: "DescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "fileConfiguration", GoGetter: "FileConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "fileConfigurationInput", GoGetter: "FileConfigurationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "objectConfigurationInput", GoGetter: "ObjectConfigurationInput"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putFileConfiguration", GoMethod: "PutFileConfiguration"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFileConfiguration", GoMethod: "ResetFileConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resetObjectConfiguration", GoMethod: "ResetObjectConfiguration"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AppintegrationsDataIntegrationFileConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.appintegrationsDataIntegration.AppintegrationsDataIntegrationFileConfigurationOutputReference",
		reflect.TypeOf((*AppintegrationsDataIntegrationFileConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "foldersInput", GoGetter: "FoldersInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFolders", GoMethod: "ResetFolders"},
		...
		func() interface{} {
			j := jsiiProxy_AppintegrationsDataIntegrationFileConfigurationOutputReference{}
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AppintegrationsDataIntegrationTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.appintegrationsDataIntegration.AppintegrationsDataIntegrationTagsList",
		reflect.TypeOf((*AppintegrationsDataIntegrationTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AppintegrationsDataIntegrationTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
