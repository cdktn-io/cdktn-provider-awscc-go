...
func (j *jsiiProxy_BatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference {
	_init_.Initialize()
...
func NewBatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference_Override(b BatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (b *jsiiProxy_BatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BatchJobDefinitionEcsPropertiesTaskPropertiesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
