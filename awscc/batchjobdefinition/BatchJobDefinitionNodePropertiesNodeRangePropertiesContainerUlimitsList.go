...
func (j *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerUlimitsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionNodePropertiesNodeRangePropertiesContainerUlimitsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerUlimitsList {
	_init_.Initialize()
...
func NewBatchJobDefinitionNodePropertiesNodeRangePropertiesContainerUlimitsList_Override(b BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerUlimitsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerUlimitsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerUlimitsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerUlimitsList) Resolve(context cdktn.IResolveContext) interface{} {
