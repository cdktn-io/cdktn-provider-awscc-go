...
func (b *jsiiProxy_BatchJobDefinitionEcsPropertiesTaskPropertiesContainersLinuxParametersDevicesList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_BatchJobDefinitionEcsPropertiesTaskPropertiesContainersLinuxParametersDevicesList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewBatchJobDefinitionEcsPropertiesTaskPropertiesContainersLinuxParametersDevicesListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
