...
func (j *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLogConfigurationSecretOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLogConfigurationSecretOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLogConfigurationSecretOptionsList {
	_init_.Initialize()
...
func NewBatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLogConfigurationSecretOptionsList_Override(b BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLogConfigurationSecretOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLogConfigurationSecretOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLogConfigurationSecretOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchJobDefinitionNodePropertiesNodeRangePropertiesContainerLogConfigurationSecretOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
