...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccec2securitygroupingress/internal"
...
func (j *jsiiProxy_DataAwsccEc2SecurityGroupIngress) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccEc2SecurityGroupIngress) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccEc2SecurityGroupIngress) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccEc2SecurityGroupIngress) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccEc2SecurityGroupIngress) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/ec2_security_group_ingress awscc_ec2_security_group_ingress} Data Source.
...
func (j *jsiiProxy_DataAwsccEc2SecurityGroupIngress)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccEc2SecurityGroupIngress)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccEc2SecurityGroupIngress)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccEc2SecurityGroupIngress_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccEc2SecurityGroupIngress) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2SecurityGroupIngress) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2SecurityGroupIngress) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccEc2SecurityGroupIngress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
