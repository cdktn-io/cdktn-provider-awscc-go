...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ChimeAppInstance)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ChimeAppInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.chimeAppInstance.ChimeAppInstanceTags",
		reflect.TypeOf((*ChimeAppInstanceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.chimeAppInstance.ChimeAppInstanceTagsList",
		reflect.TypeOf((*ChimeAppInstanceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ChimeAppInstanceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
