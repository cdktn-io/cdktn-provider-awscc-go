...
type KinesisStream interface {
	...
	WarmThroughputObject() KinesisStreamWarmThroughputObjectOutputReference
...
func (j *jsiiProxy_KinesisStream) WarmThroughputObject() KinesisStreamWarmThroughputObjectOutputReference {
	var returns KinesisStreamWarmThroughputObjectOutputReference
	_jsii_.Get(
		j,
