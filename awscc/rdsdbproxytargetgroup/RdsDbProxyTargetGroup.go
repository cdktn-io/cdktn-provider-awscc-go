...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/rdsdbproxytargetgroup/internal"
...
func (j *jsiiProxy_RdsDbProxyTargetGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RdsDbProxyTargetGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RdsDbProxyTargetGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RdsDbProxyTargetGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RdsDbProxyTargetGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_RdsDbProxyTargetGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RdsDbProxyTargetGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RdsDbProxyTargetGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RdsDbProxyTargetGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RdsDbProxyTargetGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RdsDbProxyTargetGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RdsDbProxyTargetGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RdsDbProxyTargetGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RdsDbProxyTargetGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
