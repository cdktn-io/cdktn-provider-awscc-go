...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/route53delegationset/internal"
...
func (j *jsiiProxy_Route53DelegationSet) CallerReference() *string {
	var returns *string
	_jsii_.Get(
		j,
		"callerReference",
...
func (j *jsiiProxy_Route53DelegationSet) DelegationSetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delegationSetId",
...
func NewRoute53DelegationSet(scope constructs.Construct, id *string, config *Route53DelegationSetConfig) Route53DelegationSet {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.route53DelegationSet.Route53DelegationSet",
