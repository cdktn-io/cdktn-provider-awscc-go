...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/iotfleetwisesignalcatalog/internal"
...
func (j *jsiiProxy_IotfleetwiseSignalCatalog) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IotfleetwiseSignalCatalog) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IotfleetwiseSignalCatalog) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IotfleetwiseSignalCatalog) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IotfleetwiseSignalCatalog) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IotfleetwiseSignalCatalog)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IotfleetwiseSignalCatalog)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IotfleetwiseSignalCatalog)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IotfleetwiseSignalCatalog_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IotfleetwiseSignalCatalog) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
