...
func (w *jsiiProxy_WorkspacesinstancesWorkspaceInstanceManagedInstanceOutputReference) validatePutBlockDeviceMappingsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*WorkspacesinstancesWorkspaceInstanceManagedInstanceBlockDeviceMappings; received %#v (a %T)", value, value)
		}
	}
...
func (w *jsiiProxy_WorkspacesinstancesWorkspaceInstanceManagedInstanceOutputReference) validatePutLicenseSpecificationsParameters(value interface{}) error {
	...
	case *[]*WorkspacesinstancesWorkspaceInstanceManagedInstanceLicenseSpecifications:
		value := value.(*[]*WorkspacesinstancesWorkspaceInstanceManagedInstanceLicenseSpecifications)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*WorkspacesinstancesWorkspaceInstanceManagedInstanceLicenseSpecifications:
		value_ := value.([]*WorkspacesinstancesWorkspaceInstanceManagedInstanceLicenseSpecifications)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*WorkspacesinstancesWorkspaceInstanceManagedInstanceLicenseSpecifications; received %#v (a %T)", value, value)
		}
	}
...
func (w *jsiiProxy_WorkspacesinstancesWorkspaceInstanceManagedInstanceOutputReference) validatePutNetworkInterfacesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*WorkspacesinstancesWorkspaceInstanceManagedInstanceNetworkInterfaces; received %#v (a %T)", value, value)
		}
	}
...
func (w *jsiiProxy_WorkspacesinstancesWorkspaceInstanceManagedInstanceOutputReference) validatePutTagSpecificationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*WorkspacesinstancesWorkspaceInstanceManagedInstanceTagSpecifications; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_WorkspacesinstancesWorkspaceInstanceManagedInstanceOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *WorkspacesinstancesWorkspaceInstanceManagedInstance; received %#v (a %T)", val, val)
		}
	}
