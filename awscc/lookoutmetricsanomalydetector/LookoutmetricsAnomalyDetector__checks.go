...
func (l *jsiiProxy_LookoutmetricsAnomalyDetector) validatePutMetricSetListParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*LookoutmetricsAnomalyDetectorMetricSetListStruct; received %#v (a %T)", value, value)
		}
	}
