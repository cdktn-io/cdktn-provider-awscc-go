...
type CloudfrontFunction interface {
	...
	Stage() *string
	Tags() CloudfrontFunctionTagsList
	TagsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_CloudfrontFunction) Tags() CloudfrontFunctionTagsList {
	var returns CloudfrontFunctionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CloudfrontFunction) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (c *jsiiProxy_CloudfrontFunction) PutTags(value interface{}) {
