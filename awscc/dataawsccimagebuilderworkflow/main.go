...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccImagebuilderWorkflowLatestVersion)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccImagebuilderWorkflow.DataAwsccImagebuilderWorkflowLatestVersionOutputReference",
		reflect.TypeOf((*DataAwsccImagebuilderWorkflowLatestVersionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "arn", GoGetter: "Arn"},
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccImagebuilderWorkflowLatestVersionOutputReference{}
