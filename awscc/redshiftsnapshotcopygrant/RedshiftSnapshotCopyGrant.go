...
func (j *jsiiProxy_RedshiftSnapshotCopyGrant) Tags() RedshiftSnapshotCopyGrantTagsList {
	var returns RedshiftSnapshotCopyGrantTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (r *jsiiProxy_RedshiftSnapshotCopyGrant) PutTags(value interface{}) {
