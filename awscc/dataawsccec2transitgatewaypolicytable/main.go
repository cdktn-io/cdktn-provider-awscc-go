...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayPolicyTable)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccEc2TransitGatewayPolicyTableTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayPolicyTableTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
