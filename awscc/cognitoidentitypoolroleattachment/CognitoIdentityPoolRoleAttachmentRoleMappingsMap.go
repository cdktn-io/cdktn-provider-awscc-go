...
func (j *jsiiProxy_CognitoIdentityPoolRoleAttachmentRoleMappingsMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCognitoIdentityPoolRoleAttachmentRoleMappingsMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CognitoIdentityPoolRoleAttachmentRoleMappingsMap {
	_init_.Initialize()
...
func NewCognitoIdentityPoolRoleAttachmentRoleMappingsMap_Override(c CognitoIdentityPoolRoleAttachmentRoleMappingsMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CognitoIdentityPoolRoleAttachmentRoleMappingsMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CognitoIdentityPoolRoleAttachmentRoleMappingsMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CognitoIdentityPoolRoleAttachmentRoleMappingsMap) Resolve(context cdktn.IResolveContext) interface{} {
