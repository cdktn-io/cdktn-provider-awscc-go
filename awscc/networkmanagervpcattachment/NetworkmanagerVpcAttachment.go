...
func (j *jsiiProxy_NetworkmanagerVpcAttachment) LastModificationErrors() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/networkmanager_vpc_attachment awscc_networkmanager_vpc_attachment} Resource.
