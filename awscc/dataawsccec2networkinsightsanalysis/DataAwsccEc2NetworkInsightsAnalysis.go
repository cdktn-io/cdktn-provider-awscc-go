...
type DataAwsccEc2NetworkInsightsAnalysis interface {
	...
	NetworkPathFound() cdktn.IResolvable
	// The tree node.
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) NetworkPathFound() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccEc2NetworkInsightsAnalysis_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccEc2NetworkInsightsAnalysis) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
