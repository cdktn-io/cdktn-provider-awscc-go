...
func (c *jsiiProxy_CeAnomalySubscription) validatePutResourceTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CeAnomalySubscriptionResourceTags; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_CeAnomalySubscription) validatePutSubscribersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*CeAnomalySubscriptionSubscribers; received %#v (a %T)", value, value)
		}
	}
