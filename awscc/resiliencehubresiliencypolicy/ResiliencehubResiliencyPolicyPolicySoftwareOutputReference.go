...
func NewResiliencehubResiliencyPolicyPolicySoftwareOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) ResiliencehubResiliencyPolicyPolicySoftwareOutputReference {
	_init_.Initialize()
...
func NewResiliencehubResiliencyPolicyPolicySoftwareOutputReference_Override(r ResiliencehubResiliencyPolicyPolicySoftwareOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
