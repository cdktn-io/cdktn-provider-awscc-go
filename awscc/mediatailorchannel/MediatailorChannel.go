...
func (j *jsiiProxy_MediatailorChannel) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MediatailorChannel) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MediatailorChannel) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MediatailorChannel) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MediatailorChannel) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_MediatailorChannel)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MediatailorChannel)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MediatailorChannel)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MediatailorChannel_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MediatailorChannel) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MediatailorChannel) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MediatailorChannel) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MediatailorChannel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MediatailorChannel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MediatailorChannel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
