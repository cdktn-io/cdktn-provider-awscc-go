...
func (s *jsiiProxy_SagemakerUserProfileUserSettingsOutputReference) validatePutCustomFileSystemConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SagemakerUserProfileUserSettingsCustomFileSystemConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SagemakerUserProfileUserSettingsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *SagemakerUserProfileUserSettings; received %#v (a %T)", val, val)
		}
	}
