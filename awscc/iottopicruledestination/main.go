...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "influxDbPropertiesInput", GoGetter: "InfluxDbPropertiesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putInfluxDbProperties", GoMethod: "PutInfluxDbProperties"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInfluxDbProperties", GoMethod: "ResetInfluxDbProperties"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.iotTopicRuleDestination.IotTopicRuleDestinationInfluxDbProperties",
		reflect.TypeOf((*IotTopicRuleDestinationInfluxDbProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.iotTopicRuleDestination.IotTopicRuleDestinationInfluxDbPropertiesOutputReference",
		reflect.TypeOf((*IotTopicRuleDestinationInfluxDbPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "influxDbVersionInput", GoGetter: "InfluxDbVersionInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetEndpoint", GoMethod: "ResetEndpoint"},
			_jsii_.MemberMethod{JsiiMethod: "resetInfluxDbVersion", GoMethod: "ResetInfluxDbVersion"},
