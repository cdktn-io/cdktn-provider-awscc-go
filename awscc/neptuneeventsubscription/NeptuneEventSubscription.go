...
func (j *jsiiProxy_NeptuneEventSubscription) SubscriptionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriptionName",
...
func (j *jsiiProxy_NeptuneEventSubscription) SubscriptionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NeptuneEventSubscription) Tags() NeptuneEventSubscriptionTagsList {
	var returns NeptuneEventSubscriptionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_NeptuneEventSubscription)SetSubscriptionName(val *string) {
...
func (n *jsiiProxy_NeptuneEventSubscription) PutTags(value interface{}) {
...
func (n *jsiiProxy_NeptuneEventSubscription) ResetSubscriptionName() {
	_jsii_.InvokeVoid(
		n,
		"resetSubscriptionName",
		nil, // no parameters
