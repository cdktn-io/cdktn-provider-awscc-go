...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NeptuneEventSubscriptionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.neptuneEventSubscription.NeptuneEventSubscriptionTagsList",
		reflect.TypeOf((*NeptuneEventSubscriptionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NeptuneEventSubscriptionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
