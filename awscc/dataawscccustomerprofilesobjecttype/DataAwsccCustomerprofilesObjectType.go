...
type DataAwsccCustomerprofilesObjectType interface {
	...
	AllowProfileCreation() cdktn.IResolvable
	// Experimental.
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType) AllowProfileCreation() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType) SourcePriority() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"sourcePriority",
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/customerprofiles_object_type awscc_customerprofiles_object_type} Data Source.
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCustomerprofilesObjectType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCustomerprofilesObjectType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCustomerprofilesObjectType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCustomerprofilesObjectType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCustomerprofilesObjectType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCustomerprofilesObjectType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
