...
func (j *jsiiProxy_Greengrassv2DeploymentComponentsMap) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGreengrassv2DeploymentComponentsMap(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) Greengrassv2DeploymentComponentsMap {
	_init_.Initialize()
...
func NewGreengrassv2DeploymentComponentsMap_Override(g Greengrassv2DeploymentComponentsMap, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_Greengrassv2DeploymentComponentsMap)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_Greengrassv2DeploymentComponentsMap) InterpolationForAttribute(property *string) cdktn.IResolvable {
...
func (g *jsiiProxy_Greengrassv2DeploymentComponentsMap) Resolve(context cdktn.IResolveContext) interface{} {
