...
type DataAwsccInternetmonitorMonitor interface {
	...
	SetId(val *string)
	IdInput() *string
	IncludeLinkedAccounts() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor) IncludeLinkedAccounts() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/internetmonitor_monitor awscc_internetmonitor_monitor} Data Source.
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccInternetmonitorMonitor)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccInternetmonitorMonitor_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccInternetmonitorMonitor) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccInternetmonitorMonitor) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccInternetmonitorMonitor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccInternetmonitorMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
