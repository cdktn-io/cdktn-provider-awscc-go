...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccOpensearchserverlessSecurityConfigIamFederationOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccOpensearchserverlessSecurityConfigIamFederationOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
