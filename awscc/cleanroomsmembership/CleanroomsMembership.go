...
func (j *jsiiProxy_CleanroomsMembership) IsMetricsEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isMetricsEnabled",
...
func (j *jsiiProxy_CleanroomsMembership) IsMetricsEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CleanroomsMembership)SetIsMetricsEnabled(val interface{}) {
...
func (c *jsiiProxy_CleanroomsMembership) ResetIsMetricsEnabled() {
	_jsii_.InvokeVoid(
		c,
		"resetIsMetricsEnabled",
		nil, // no parameters
