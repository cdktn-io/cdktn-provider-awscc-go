...
func (j *jsiiProxy_DataAwsccElasticbeanstalkEnvironmentOptionSettingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccElasticbeanstalkEnvironmentOptionSettingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccElasticbeanstalkEnvironmentOptionSettingsList {
	_init_.Initialize()
...
func NewDataAwsccElasticbeanstalkEnvironmentOptionSettingsList_Override(d DataAwsccElasticbeanstalkEnvironmentOptionSettingsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccElasticbeanstalkEnvironmentOptionSettingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccElasticbeanstalkEnvironmentOptionSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccElasticbeanstalkEnvironmentOptionSettingsList) Resolve(context cdktn.IResolveContext) interface{} {
