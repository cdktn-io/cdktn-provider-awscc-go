...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccIotLoggingEventConfigurations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccIotLogging.DataAwsccIotLoggingEventConfigurationsList",
		reflect.TypeOf((*DataAwsccIotLoggingEventConfigurationsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccIotLoggingEventConfigurationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccIotLoggingEventConfigurationsOutputReference{}
