...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TrafficMirrorSession)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEc2TrafficMirrorSessionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccEc2TrafficMirrorSession.DataAwsccEc2TrafficMirrorSessionTags",
		reflect.TypeOf((*DataAwsccEc2TrafficMirrorSessionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccEc2TrafficMirrorSession.DataAwsccEc2TrafficMirrorSessionTagsList",
		reflect.TypeOf((*DataAwsccEc2TrafficMirrorSessionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TrafficMirrorSessionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
