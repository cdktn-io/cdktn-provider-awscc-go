...
func (e *jsiiProxy_EvidentlyFeature) validatePutEntityOverridesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EvidentlyFeatureEntityOverrides; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EvidentlyFeature) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EvidentlyFeatureTags; received %#v (a %T)", value, value)
		}
	}
