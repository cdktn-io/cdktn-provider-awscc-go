...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/daxparametergroup/internal"
...
type DaxParameterGroup interface {
	...
	SetParameterNameValues(val *string)
	ParameterNameValuesInput() *string
	// Experimental.
...
func (j *jsiiProxy_DaxParameterGroup) ParameterGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterGroupName",
...
func (j *jsiiProxy_DaxParameterGroup) ParameterGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DaxParameterGroup) ParameterNameValues() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterNameValues",
...
func (j *jsiiProxy_DaxParameterGroup) ParameterNameValuesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parameterNameValuesInput",
		&returns,
	)
	return returns
}
...
func NewDaxParameterGroup(scope constructs.Construct, id *string, config *DaxParameterGroupConfig) DaxParameterGroup {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.daxParameterGroup.DaxParameterGroup",
...
func (j *jsiiProxy_DaxParameterGroup)SetParameterGroupName(val *string) {
...
func (j *jsiiProxy_DaxParameterGroup)SetParameterNameValues(val *string) {
...
func (d *jsiiProxy_DaxParameterGroup) ResetParameterGroupName() {
	_jsii_.InvokeVoid(
		d,
		"resetParameterGroupName",
		nil, // no parameters
...
func (d *jsiiProxy_DaxParameterGroup) ResetParameterNameValues() {
	_jsii_.InvokeVoid(
		d,
		"resetParameterNameValues",
		nil, // no parameters
