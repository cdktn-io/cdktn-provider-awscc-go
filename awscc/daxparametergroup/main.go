...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parameterNameValuesInput", GoGetter: "ParameterNameValuesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetParameterNameValues", GoMethod: "ResetParameterNameValues"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.daxParameterGroup.DaxParameterGroupConfig",
