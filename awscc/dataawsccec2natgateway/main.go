...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEc2NatGatewayAvailabilityZoneAddresses)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccEc2NatGateway.DataAwsccEc2NatGatewayAvailabilityZoneAddressesList",
		reflect.TypeOf((*DataAwsccEc2NatGatewayAvailabilityZoneAddressesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2NatGatewayAvailabilityZoneAddressesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
