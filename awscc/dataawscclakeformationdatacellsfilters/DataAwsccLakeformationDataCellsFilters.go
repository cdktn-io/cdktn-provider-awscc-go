...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscclakeformationdatacellsfilters/internal"
...
func (j *jsiiProxy_DataAwsccLakeformationDataCellsFilters) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccLakeformationDataCellsFilters) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccLakeformationDataCellsFilters) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccLakeformationDataCellsFilters) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccLakeformationDataCellsFilters) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccLakeformationDataCellsFilters)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccLakeformationDataCellsFilters)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccLakeformationDataCellsFilters)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccLakeformationDataCellsFilters_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccLakeformationDataCellsFilters) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLakeformationDataCellsFilters) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLakeformationDataCellsFilters) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccLakeformationDataCellsFilters) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
