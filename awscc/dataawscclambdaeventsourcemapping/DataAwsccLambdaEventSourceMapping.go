...
type DataAwsccLambdaEventSourceMapping interface {
	...
	BatchSize() *float64
	BisectBatchOnFunctionError() cdktn.IResolvable
	// Experimental.
	...
	LoggingConfig() DataAwsccLambdaEventSourceMappingLoggingConfigOutputReference
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping) BisectBatchOnFunctionError() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping) Enabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping) LoggingConfig() DataAwsccLambdaEventSourceMappingLoggingConfigOutputReference {
	var returns DataAwsccLambdaEventSourceMappingLoggingConfigOutputReference
	_jsii_.Get(
		j,
		"loggingConfig",
		&returns,
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMapping)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccLambdaEventSourceMapping_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccLambdaEventSourceMapping) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLambdaEventSourceMapping) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLambdaEventSourceMapping) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccLambdaEventSourceMapping) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
