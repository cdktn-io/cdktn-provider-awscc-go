...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList {
	_init_.Initialize()
...
func NewDataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList_Override(d DataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccLambdaEventSourceMappingSourceAccessConfigurationsList) Resolve(context cdktn.IResolveContext) interface{} {
