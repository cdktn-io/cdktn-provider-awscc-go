...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2LocalGatewayVirtualInterface)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "localGatewayVirtualInterfaceId", GoGetter: "LocalGatewayVirtualInterfaceId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "outpostLagIdInput", GoGetter: "OutpostLagIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "peerBgpAsnExtendedInput", GoGetter: "PeerBgpAsnExtendedInput"},
			_jsii_.MemberProperty{JsiiProperty: "peerBgpAsnInput", GoGetter: "PeerBgpAsnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPeerBgpAsn", GoMethod: "ResetPeerBgpAsn"},
			_jsii_.MemberMethod{JsiiMethod: "resetPeerBgpAsnExtended", GoMethod: "ResetPeerBgpAsnExtended"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2LocalGatewayVirtualInterfaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.ec2LocalGatewayVirtualInterface.Ec2LocalGatewayVirtualInterfaceTags",
		reflect.TypeOf((*Ec2LocalGatewayVirtualInterfaceTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ec2LocalGatewayVirtualInterface.Ec2LocalGatewayVirtualInterfaceTagsList",
		reflect.TypeOf((*Ec2LocalGatewayVirtualInterfaceTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2LocalGatewayVirtualInterfaceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
