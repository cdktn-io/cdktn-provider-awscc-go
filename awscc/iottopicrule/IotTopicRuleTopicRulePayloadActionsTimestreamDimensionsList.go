...
func (j *jsiiProxy_IotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList {
	_init_.Initialize()
...
func NewIotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList_Override(i IotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IotTopicRuleTopicRulePayloadActionsTimestreamDimensionsList) Resolve(context cdktn.IResolveContext) interface{} {
