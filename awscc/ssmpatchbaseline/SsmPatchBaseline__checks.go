...
func (s *jsiiProxy_SsmPatchBaseline) validatePutSourcesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SsmPatchBaselineSources; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SsmPatchBaseline) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SsmPatchBaselineTags; received %#v (a %T)", value, value)
		}
	}
