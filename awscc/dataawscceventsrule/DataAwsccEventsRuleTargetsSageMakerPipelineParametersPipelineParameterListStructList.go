...
func (j *jsiiProxy_DataAwsccEventsRuleTargetsSageMakerPipelineParametersPipelineParameterListStructList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccEventsRuleTargetsSageMakerPipelineParametersPipelineParameterListStructList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccEventsRuleTargetsSageMakerPipelineParametersPipelineParameterListStructList {
	_init_.Initialize()
...
func NewDataAwsccEventsRuleTargetsSageMakerPipelineParametersPipelineParameterListStructList_Override(d DataAwsccEventsRuleTargetsSageMakerPipelineParametersPipelineParameterListStructList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccEventsRuleTargetsSageMakerPipelineParametersPipelineParameterListStructList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccEventsRuleTargetsSageMakerPipelineParametersPipelineParameterListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccEventsRuleTargetsSageMakerPipelineParametersPipelineParameterListStructList) Resolve(context cdktn.IResolveContext) interface{} {
