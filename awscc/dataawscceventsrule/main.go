...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEventsRuleTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccEventsRule.DataAwsccEventsRuleTagsList",
		reflect.TypeOf((*DataAwsccEventsRuleTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEventsRuleTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
