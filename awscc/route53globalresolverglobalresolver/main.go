...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Route53GlobalresolverGlobalResolver)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "observabilityRegionInput", GoGetter: "ObservabilityRegionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetObservabilityRegion", GoMethod: "ResetObservabilityRegion"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Route53GlobalresolverGlobalResolverTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
