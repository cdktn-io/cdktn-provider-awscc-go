...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscclightsailinstance/internal"
...
func (j *jsiiProxy_DataAwsccLightsailInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccLightsailInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccLightsailInstance) IsStaticIp() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccLightsailInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccLightsailInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccLightsailInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/lightsail_instance awscc_lightsail_instance} Data Source.
...
func (j *jsiiProxy_DataAwsccLightsailInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccLightsailInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccLightsailInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccLightsailInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccLightsailInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLightsailInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLightsailInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccLightsailInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
