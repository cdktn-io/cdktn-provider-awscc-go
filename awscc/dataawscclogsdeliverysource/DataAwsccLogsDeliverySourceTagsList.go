...
func (j *jsiiProxy_DataAwsccLogsDeliverySourceTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccLogsDeliverySourceTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccLogsDeliverySourceTagsList {
	_init_.Initialize()
...
func NewDataAwsccLogsDeliverySourceTagsList_Override(d DataAwsccLogsDeliverySourceTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccLogsDeliverySourceTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccLogsDeliverySourceTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccLogsDeliverySourceTagsList) Resolve(context cdktn.IResolveContext) interface{} {
