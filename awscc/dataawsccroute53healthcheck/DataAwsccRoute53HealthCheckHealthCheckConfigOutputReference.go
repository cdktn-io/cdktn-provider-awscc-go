...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccroute53healthcheck/internal"
...
type DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference interface {
	...
	Inverted() cdktn.IResolvable
	IpAddress() *string
	MeasureLatency() cdktn.IResolvable
	Port() *float64
	Regions() *[]*string
...
func (j *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference) EnableSni() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference) Inverted() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"inverted",
...
func (j *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference) MeasureLatency() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"measureLatency",
...
func (j *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccRoute53HealthCheckHealthCheckConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference {
	_init_.Initialize()
...
func NewDataAwsccRoute53HealthCheckHealthCheckConfigOutputReference_Override(d DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccRoute53HealthCheckHealthCheckConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
