...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/bedrockintelligentpromptrouter/internal"
...
func (j *jsiiProxy_BedrockIntelligentPromptRouter) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BedrockIntelligentPromptRouter) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BedrockIntelligentPromptRouter) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BedrockIntelligentPromptRouter) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BedrockIntelligentPromptRouter) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BedrockIntelligentPromptRouter)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BedrockIntelligentPromptRouter)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BedrockIntelligentPromptRouter)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BedrockIntelligentPromptRouter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BedrockIntelligentPromptRouter) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockIntelligentPromptRouter) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BedrockIntelligentPromptRouter) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BedrockIntelligentPromptRouter) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BedrockIntelligentPromptRouter) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BedrockIntelligentPromptRouter) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
