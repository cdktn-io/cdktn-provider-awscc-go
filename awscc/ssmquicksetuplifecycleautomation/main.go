...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SsmquicksetupLifecycleAutomation)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "automationDocumentInput", GoGetter: "AutomationDocumentInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SsmquicksetupLifecycleAutomationConfig)(nil)).Elem(),
	)
}
