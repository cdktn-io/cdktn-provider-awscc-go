...
func (j *jsiiProxy_DataAwsccAppsyncDataSource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccAppsyncDataSource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccAppsyncDataSource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccAppsyncDataSource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccAppsyncDataSource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/appsync_data_source awscc_appsync_data_source} Data Source.
...
func (j *jsiiProxy_DataAwsccAppsyncDataSource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccAppsyncDataSource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccAppsyncDataSource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccAppsyncDataSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccAppsyncDataSource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccAppsyncDataSource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccAppsyncDataSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccAppsyncDataSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
