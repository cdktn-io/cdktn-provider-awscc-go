...
func NewPaymentcryptographyKeyKeyAttributesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PaymentcryptographyKeyKeyAttributesOutputReference {
	_init_.Initialize()
...
func NewPaymentcryptographyKeyKeyAttributesOutputReference_Override(p PaymentcryptographyKeyKeyAttributesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
