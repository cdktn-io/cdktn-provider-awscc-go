...
func NewPaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference {
	_init_.Initialize()
...
func NewPaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference_Override(p PaymentcryptographyKeyKeyAttributesKeyModesOfUseOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
