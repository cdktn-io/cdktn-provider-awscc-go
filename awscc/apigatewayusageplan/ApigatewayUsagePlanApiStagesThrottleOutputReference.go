...
func NewApigatewayUsagePlanApiStagesThrottleOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) ApigatewayUsagePlanApiStagesThrottleOutputReference {
	_init_.Initialize()
...
func NewApigatewayUsagePlanApiStagesThrottleOutputReference_Override(a ApigatewayUsagePlanApiStagesThrottleOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
