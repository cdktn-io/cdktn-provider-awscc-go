...
func NewMedialiveMultiplexprogramMultiplexProgramSettingsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) MedialiveMultiplexprogramMultiplexProgramSettingsOutputReference {
	_init_.Initialize()
...
func NewMedialiveMultiplexprogramMultiplexProgramSettingsOutputReference_Override(m MedialiveMultiplexprogramMultiplexProgramSettingsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
