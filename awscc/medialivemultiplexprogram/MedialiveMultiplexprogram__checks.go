...
func (m *jsiiProxy_MedialiveMultiplexprogram) validatePutPipelineDetailsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*MedialiveMultiplexprogramPipelineDetails; received %#v (a %T)", value, value)
		}
	}
