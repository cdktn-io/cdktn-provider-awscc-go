...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreOAuth2CredentialProviders)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreOAuth2CredentialProvidersConfig)(nil)).Elem(),
	)
}
