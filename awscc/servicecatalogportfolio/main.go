...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ServicecatalogPortfolioTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.servicecatalogPortfolio.ServicecatalogPortfolioTagsList",
		reflect.TypeOf((*ServicecatalogPortfolioTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicecatalogPortfolioTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
