...
func (j *jsiiProxy_DataAwsccAccessanalyzerAnalyzerArchiveRulesFilterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccAccessanalyzerAnalyzerArchiveRulesFilterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccAccessanalyzerAnalyzerArchiveRulesFilterList {
	_init_.Initialize()
...
func NewDataAwsccAccessanalyzerAnalyzerArchiveRulesFilterList_Override(d DataAwsccAccessanalyzerAnalyzerArchiveRulesFilterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccAccessanalyzerAnalyzerArchiveRulesFilterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccAccessanalyzerAnalyzerArchiveRulesFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccAccessanalyzerAnalyzerArchiveRulesFilterList) Resolve(context cdktn.IResolveContext) interface{} {
