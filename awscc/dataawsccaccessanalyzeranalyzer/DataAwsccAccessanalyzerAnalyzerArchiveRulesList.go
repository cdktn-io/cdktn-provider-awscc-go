...
func (j *jsiiProxy_DataAwsccAccessanalyzerAnalyzerArchiveRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccAccessanalyzerAnalyzerArchiveRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccAccessanalyzerAnalyzerArchiveRulesList {
	_init_.Initialize()
...
func NewDataAwsccAccessanalyzerAnalyzerArchiveRulesList_Override(d DataAwsccAccessanalyzerAnalyzerArchiveRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccAccessanalyzerAnalyzerArchiveRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccAccessanalyzerAnalyzerArchiveRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccAccessanalyzerAnalyzerArchiveRulesList) Resolve(context cdktn.IResolveContext) interface{} {
