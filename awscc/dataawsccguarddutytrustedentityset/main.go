...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGuarddutyTrustedEntitySet)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "trustedEntitySetId", GoGetter: "TrustedEntitySetId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccGuarddutyTrustedEntitySetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccGuarddutyTrustedEntitySet.DataAwsccGuarddutyTrustedEntitySetTags",
		reflect.TypeOf((*DataAwsccGuarddutyTrustedEntitySetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccGuarddutyTrustedEntitySet.DataAwsccGuarddutyTrustedEntitySetTagsList",
		reflect.TypeOf((*DataAwsccGuarddutyTrustedEntitySetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccGuarddutyTrustedEntitySetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
