...
func (n *jsiiProxy_NetworkfirewallRuleGroup) validatePutSummaryConfigurationParameters(value *NetworkfirewallRuleGroupSummaryConfiguration) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (n *jsiiProxy_NetworkfirewallRuleGroup) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NetworkfirewallRuleGroupTags; received %#v (a %T)", value, value)
		}
	}
