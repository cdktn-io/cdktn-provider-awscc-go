...
func NewNetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) NetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference {
	_init_.Initialize()
...
func NewNetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference_Override(n NetworkfirewallRuleGroupRuleGroupRuleVariablesIpSetsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
