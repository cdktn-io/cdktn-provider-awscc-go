...
type NetworkfirewallRuleGroup interface {
	...
	SummaryConfiguration() NetworkfirewallRuleGroupSummaryConfigurationOutputReference
	SummaryConfigurationInput() interface{}
	...
	PutSummaryConfiguration(value *NetworkfirewallRuleGroupSummaryConfiguration)
...
func (j *jsiiProxy_NetworkfirewallRuleGroup) SummaryConfiguration() NetworkfirewallRuleGroupSummaryConfigurationOutputReference {
	var returns NetworkfirewallRuleGroupSummaryConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkfirewallRuleGroup) SummaryConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"summaryConfigurationInput",
		&returns,
	)
	return returns
}
...
func (n *jsiiProxy_NetworkfirewallRuleGroup) PutSummaryConfiguration(value *NetworkfirewallRuleGroupSummaryConfiguration) {
	if err := n.validatePutSummaryConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
		"putSummaryConfiguration",
		[]interface{}{value},
	)
}
...
func (n *jsiiProxy_NetworkfirewallRuleGroup) ResetSummaryConfiguration() {
	_jsii_.InvokeVoid(
		n,
		"resetSummaryConfiguration",
		nil, // no parameters
