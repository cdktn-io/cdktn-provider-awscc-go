...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccappsyncresolver/internal"
...
func (j *jsiiProxy_DataAwsccAppsyncResolver) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccAppsyncResolver) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccAppsyncResolver) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccAppsyncResolver) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccAppsyncResolver) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/data-sources/appsync_resolver awscc_appsync_resolver} Data Source.
...
func (j *jsiiProxy_DataAwsccAppsyncResolver)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccAppsyncResolver)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccAppsyncResolver)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccAppsyncResolver_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccAppsyncResolver) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccAppsyncResolver) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccAppsyncResolver) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccAppsyncResolver) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
