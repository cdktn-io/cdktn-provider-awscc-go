...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/servicecatalogportfolioshare/internal"
...
func (j *jsiiProxy_ServicecatalogPortfolioShare) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_ServicecatalogPortfolioShare) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.102.0/docs/resources/servicecatalog_portfolio_share awscc_servicecatalog_portfolio_share} Resource.
...
func (j *jsiiProxy_ServicecatalogPortfolioShare)SetAccountId(val *string) {
