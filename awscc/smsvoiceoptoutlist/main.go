...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SmsvoiceOptOutList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SmsvoiceOptOutListConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.smsvoiceOptOutList.SmsvoiceOptOutListTags",
		reflect.TypeOf((*SmsvoiceOptOutListTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.smsvoiceOptOutList.SmsvoiceOptOutListTagsList",
		reflect.TypeOf((*SmsvoiceOptOutListTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SmsvoiceOptOutListTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
