...
type Mediapackagev2OriginEndpointPolicy interface {
	...
	CdnAuthConfiguration() Mediapackagev2OriginEndpointPolicyCdnAuthConfigurationOutputReference
	CdnAuthConfigurationInput() interface{}
	...
	PutCdnAuthConfiguration(value *Mediapackagev2OriginEndpointPolicyCdnAuthConfiguration)
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy) CdnAuthConfiguration() Mediapackagev2OriginEndpointPolicyCdnAuthConfigurationOutputReference {
	var returns Mediapackagev2OriginEndpointPolicyCdnAuthConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy) CdnAuthConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"cdnAuthConfigurationInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Mediapackagev2OriginEndpointPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Mediapackagev2OriginEndpointPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointPolicy) PutCdnAuthConfiguration(value *Mediapackagev2OriginEndpointPolicyCdnAuthConfiguration) {
	if err := m.validatePutCdnAuthConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
		"putCdnAuthConfiguration",
		[]interface{}{value},
	)
}

func (m *jsiiProxy_Mediapackagev2OriginEndpointPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointPolicy) ResetCdnAuthConfiguration() {
	_jsii_.InvokeVoid(
		m,
		"resetCdnAuthConfiguration",
		nil, // no parameters
...
func (m *jsiiProxy_Mediapackagev2OriginEndpointPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
