...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudformationChangeSet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetConfig",
		reflect.TypeOf((*DataAwsccCloudformationChangeSetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetTags",
		reflect.TypeOf((*DataAwsccCloudformationChangeSetTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccCloudformationChangeSet.DataAwsccCloudformationChangeSetTagsList",
		reflect.TypeOf((*DataAwsccCloudformationChangeSetTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccCloudformationChangeSetTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
