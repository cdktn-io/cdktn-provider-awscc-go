...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/appsyncapikey/internal"
...
func (j *jsiiProxy_AppsyncApiKey) ApiKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiKey",
...
func (j *jsiiProxy_AppsyncApiKey) Arn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"arn",
...
func (j *jsiiProxy_AppsyncApiKey) Expires() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"expires",
...
func (j *jsiiProxy_AppsyncApiKey) ExpiresInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"expiresInput",
...
func NewAppsyncApiKey(scope constructs.Construct, id *string, config *AppsyncApiKeyConfig) AppsyncApiKey {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.appsyncApiKey.AppsyncApiKey",
...
func (j *jsiiProxy_AppsyncApiKey)SetExpires(val *float64) {
