...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEventsEventBusPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEventsEventBusPolicyCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccEventsEventBusPolicy.DataAwsccEventsEventBusPolicyConditionOutputReference",
		reflect.TypeOf((*DataAwsccEventsEventBusPolicyConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEventsEventBusPolicyConfig)(nil)).Elem(),
	)
}
