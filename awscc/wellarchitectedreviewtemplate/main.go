...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WellarchitectedReviewTemplate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WellarchitectedReviewTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.wellarchitectedReviewTemplate.WellarchitectedReviewTemplateTags",
		reflect.TypeOf((*WellarchitectedReviewTemplateTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.wellarchitectedReviewTemplate.WellarchitectedReviewTemplateTagsList",
		reflect.TypeOf((*WellarchitectedReviewTemplateTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WellarchitectedReviewTemplateTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
