...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccApplicationsignalsGroupingConfigurations)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccApplicationsignalsGroupingConfigurationsConfig)(nil)).Elem(),
	)
}
