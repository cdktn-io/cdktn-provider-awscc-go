...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreWorkloadIdentity)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccBedrockagentcoreWorkloadIdentityTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
