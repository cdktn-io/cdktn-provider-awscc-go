...
func (j *jsiiProxy_GrafanaWorkspace) Tags() GrafanaWorkspaceTagsList {
	var returns GrafanaWorkspaceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_GrafanaWorkspace) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (g *jsiiProxy_GrafanaWorkspace) PutTags(value interface{}) {
