...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscclogsloganomalydetector/internal"
...
func (j *jsiiProxy_DataAwsccLogsLogAnomalyDetector) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccLogsLogAnomalyDetector) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccLogsLogAnomalyDetector) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccLogsLogAnomalyDetector) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccLogsLogAnomalyDetector) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/data-sources/logs_log_anomaly_detector awscc_logs_log_anomaly_detector} Data Source.
...
func (j *jsiiProxy_DataAwsccLogsLogAnomalyDetector)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccLogsLogAnomalyDetector)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccLogsLogAnomalyDetector)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccLogsLogAnomalyDetector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccLogsLogAnomalyDetector) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLogsLogAnomalyDetector) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLogsLogAnomalyDetector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccLogsLogAnomalyDetector) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
