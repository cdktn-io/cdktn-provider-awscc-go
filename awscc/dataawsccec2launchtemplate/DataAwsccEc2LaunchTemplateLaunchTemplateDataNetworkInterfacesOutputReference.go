...
type DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference interface {
	cdktn.ComplexObject
	AssociateCarrierIpAddress() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) AssociateCarrierIpAddress() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) AssociatePublicIpAddress() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) DeleteOnTermination() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"deleteOnTermination",
...
func (j *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) PrimaryIpv6() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"primaryIpv6",
...
func (j *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference {
	_init_.Initialize()
...
func NewDataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference_Override(d DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2LaunchTemplateLaunchTemplateDataNetworkInterfacesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
