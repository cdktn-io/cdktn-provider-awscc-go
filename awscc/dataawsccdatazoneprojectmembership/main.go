...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "memberIdentifier", GoGetter: "MemberIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "memberIdentifierType", GoGetter: "MemberIdentifierType"},
