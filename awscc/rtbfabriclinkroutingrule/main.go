...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RtbfabricLinkRoutingRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RtbfabricLinkRoutingRuleConditions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.rtbfabricLinkRoutingRule.RtbfabricLinkRoutingRuleConditionsOutputReference",
		reflect.TypeOf((*RtbfabricLinkRoutingRuleConditionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hostHeaderWildcard", GoGetter: "HostHeaderWildcard"},
			_jsii_.MemberProperty{JsiiProperty: "hostHeaderWildcardInput", GoGetter: "HostHeaderWildcardInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putQueryStringEquals", GoMethod: "PutQueryStringEquals"},
			_jsii_.MemberProperty{JsiiProperty: "queryStringEquals", GoGetter: "QueryStringEquals"},
			_jsii_.MemberProperty{JsiiProperty: "queryStringEqualsInput", GoGetter: "QueryStringEqualsInput"},
			_jsii_.MemberProperty{JsiiProperty: "queryStringExists", GoGetter: "QueryStringExists"},
			_jsii_.MemberProperty{JsiiProperty: "queryStringExistsInput", GoGetter: "QueryStringExistsInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetHostHeader", GoMethod: "ResetHostHeader"},
			_jsii_.MemberMethod{JsiiMethod: "resetHostHeaderWildcard", GoMethod: "ResetHostHeaderWildcard"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQueryStringEquals", GoMethod: "ResetQueryStringEquals"},
			_jsii_.MemberMethod{JsiiMethod: "resetQueryStringExists", GoMethod: "ResetQueryStringExists"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RtbfabricLinkRoutingRuleConditionsQueryStringEquals)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.rtbfabricLinkRoutingRule.RtbfabricLinkRoutingRuleConditionsQueryStringEqualsOutputReference",
		reflect.TypeOf((*RtbfabricLinkRoutingRuleConditionsQueryStringEqualsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RtbfabricLinkRoutingRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.rtbfabricLinkRoutingRule.RtbfabricLinkRoutingRuleTags",
		reflect.TypeOf((*RtbfabricLinkRoutingRuleTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.rtbfabricLinkRoutingRule.RtbfabricLinkRoutingRuleTagsList",
		reflect.TypeOf((*RtbfabricLinkRoutingRuleTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RtbfabricLinkRoutingRuleTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_RtbfabricLinkRoutingRuleTagsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
