...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccLicensemanagerGrantTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccLicensemanagerGrant.DataAwsccLicensemanagerGrantTagsList",
		reflect.TypeOf((*DataAwsccLicensemanagerGrantTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLicensemanagerGrantTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
