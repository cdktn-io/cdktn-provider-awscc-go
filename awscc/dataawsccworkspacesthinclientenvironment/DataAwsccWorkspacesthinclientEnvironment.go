...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccworkspacesthinclientenvironment/internal"
...
func (j *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccWorkspacesthinclientEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccWorkspacesthinclientEnvironment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
