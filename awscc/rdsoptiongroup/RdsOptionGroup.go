...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/rdsoptiongroup/internal"
...
func (j *jsiiProxy_RdsOptionGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_RdsOptionGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_RdsOptionGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RdsOptionGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_RdsOptionGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.101.0/docs/resources/rds_option_group awscc_rds_option_group} Resource.
...
func (j *jsiiProxy_RdsOptionGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RdsOptionGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RdsOptionGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func RdsOptionGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_RdsOptionGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RdsOptionGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (r *jsiiProxy_RdsOptionGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (r *jsiiProxy_RdsOptionGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_RdsOptionGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (r *jsiiProxy_RdsOptionGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
