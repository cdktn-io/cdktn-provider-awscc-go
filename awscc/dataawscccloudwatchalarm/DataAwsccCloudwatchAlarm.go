...
type DataAwsccCloudwatchAlarm interface {
	...
	EvaluationCriteria() DataAwsccCloudwatchAlarmEvaluationCriteriaOutputReference
	EvaluationInterval() *float64
	EvaluationPeriods() *float64
	EvaluationWindow() DataAwsccCloudwatchAlarmEvaluationWindowOutputReference
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) ActionsEnabled() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) EvaluationCriteria() DataAwsccCloudwatchAlarmEvaluationCriteriaOutputReference {
	var returns DataAwsccCloudwatchAlarmEvaluationCriteriaOutputReference
	_jsii_.Get(
		j,
		"evaluationCriteria",
		&returns,
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) EvaluationInterval() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"evaluationInterval",
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) EvaluationWindow() DataAwsccCloudwatchAlarmEvaluationWindowOutputReference {
	var returns DataAwsccCloudwatchAlarmEvaluationWindowOutputReference
	_jsii_.Get(
		j,
		"evaluationWindow",
		&returns,
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccCloudwatchAlarm)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccCloudwatchAlarm_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccCloudwatchAlarm) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCloudwatchAlarm) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccCloudwatchAlarm) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccCloudwatchAlarm) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
