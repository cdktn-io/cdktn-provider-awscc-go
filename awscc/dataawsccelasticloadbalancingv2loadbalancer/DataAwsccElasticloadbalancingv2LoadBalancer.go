...
type DataAwsccElasticloadbalancingv2LoadBalancer interface {
	...
	DnsName() *string
	EnableCapacityReservationProvisionStabilize() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) EnableCapacityReservationProvisionStabilize() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/elasticloadbalancingv2_load_balancer awscc_elasticloadbalancingv2_load_balancer} Data Source.
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccElasticloadbalancingv2LoadBalancer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccElasticloadbalancingv2LoadBalancer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
