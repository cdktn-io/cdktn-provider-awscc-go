...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLightsailDiskSnapshot)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "diskSnapshotArn", GoGetter: "DiskSnapshotArn"},
			_jsii_.MemberProperty{JsiiProperty: "diskSnapshotName", GoGetter: "DiskSnapshotName"},
			_jsii_.MemberProperty{JsiiProperty: "forEach", GoGetter: "ForEach"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "friendlyUniqueId", GoGetter: "FriendlyUniqueId"},
			_jsii_.MemberProperty{JsiiProperty: "fromDiskName", GoGetter: "FromDiskName"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccLightsailDiskSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccLightsailDiskSnapshot.DataAwsccLightsailDiskSnapshotLocation",
		reflect.TypeOf((*DataAwsccLightsailDiskSnapshotLocation)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccLightsailDiskSnapshot.DataAwsccLightsailDiskSnapshotLocationOutputReference",
		reflect.TypeOf((*DataAwsccLightsailDiskSnapshotLocationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccLightsailDiskSnapshotTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccLightsailDiskSnapshot.DataAwsccLightsailDiskSnapshotTagsList",
		reflect.TypeOf((*DataAwsccLightsailDiskSnapshotTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLightsailDiskSnapshotTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
