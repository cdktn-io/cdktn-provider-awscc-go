...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/budgetsbudgetsaction/internal"
...
func (j *jsiiProxy_BudgetsBudgetsAction) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_BudgetsBudgetsAction) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_BudgetsBudgetsAction) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BudgetsBudgetsAction) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_BudgetsBudgetsAction) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_BudgetsBudgetsAction)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_BudgetsBudgetsAction)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_BudgetsBudgetsAction)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func BudgetsBudgetsAction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BudgetsBudgetsAction) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetsAction) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (b *jsiiProxy_BudgetsBudgetsAction) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (b *jsiiProxy_BudgetsBudgetsAction) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (b *jsiiProxy_BudgetsBudgetsAction) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (b *jsiiProxy_BudgetsBudgetsAction) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
