...
func (j *jsiiProxy_BudgetsBudgetsActionResourceTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewBudgetsBudgetsActionResourceTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BudgetsBudgetsActionResourceTagsList {
	_init_.Initialize()
...
func NewBudgetsBudgetsActionResourceTagsList_Override(b BudgetsBudgetsActionResourceTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BudgetsBudgetsActionResourceTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (b *jsiiProxy_BudgetsBudgetsActionResourceTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BudgetsBudgetsActionResourceTagsList) Resolve(context cdktn.IResolveContext) interface{} {
