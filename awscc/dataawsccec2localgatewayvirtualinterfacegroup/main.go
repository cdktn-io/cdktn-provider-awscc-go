...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2LocalGatewayVirtualInterfaceGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2LocalGatewayVirtualInterfaceGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
