...
func (j *jsiiProxy_CurReportDefinition) Tags() CurReportDefinitionTagsList {
	var returns CurReportDefinitionTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_CurReportDefinition) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (c *jsiiProxy_CurReportDefinition) PutTags(value interface{}) {
