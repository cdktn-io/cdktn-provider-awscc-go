...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CurReportDefinitionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.curReportDefinition.CurReportDefinitionTagsList",
		reflect.TypeOf((*CurReportDefinitionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_CurReportDefinitionTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CurReportDefinitionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
