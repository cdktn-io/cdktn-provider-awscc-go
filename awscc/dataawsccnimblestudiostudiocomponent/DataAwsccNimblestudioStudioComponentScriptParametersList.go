...
func (j *jsiiProxy_DataAwsccNimblestudioStudioComponentScriptParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccNimblestudioStudioComponentScriptParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccNimblestudioStudioComponentScriptParametersList {
	_init_.Initialize()
...
func NewDataAwsccNimblestudioStudioComponentScriptParametersList_Override(d DataAwsccNimblestudioStudioComponentScriptParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccNimblestudioStudioComponentScriptParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccNimblestudioStudioComponentScriptParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccNimblestudioStudioComponentScriptParametersList) Resolve(context cdktn.IResolveContext) interface{} {
