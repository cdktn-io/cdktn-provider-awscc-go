...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccObservabilityadminOrganizationCentralizationRules)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccObservabilityadminOrganizationCentralizationRulesConfig)(nil)).Elem(),
	)
}
