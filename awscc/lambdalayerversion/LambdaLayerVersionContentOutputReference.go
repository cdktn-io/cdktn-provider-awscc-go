...
func (j *jsiiProxy_LambdaLayerVersionContentOutputReference) S3ObjectStorageMode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3ObjectStorageMode",
...
func (j *jsiiProxy_LambdaLayerVersionContentOutputReference) S3ObjectStorageModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LambdaLayerVersionContentOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLambdaLayerVersionContentOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) LambdaLayerVersionContentOutputReference {
	_init_.Initialize()
...
func NewLambdaLayerVersionContentOutputReference_Override(l LambdaLayerVersionContentOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_LambdaLayerVersionContentOutputReference)SetS3ObjectStorageMode(val *string) {
...
func (j *jsiiProxy_LambdaLayerVersionContentOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LambdaLayerVersionContentOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaLayerVersionContentOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (l *jsiiProxy_LambdaLayerVersionContentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (l *jsiiProxy_LambdaLayerVersionContentOutputReference) ResetS3ObjectStorageMode() {
	_jsii_.InvokeVoid(
		l,
		"resetS3ObjectStorageMode",
		nil, // no parameters
...
func (l *jsiiProxy_LambdaLayerVersionContentOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
