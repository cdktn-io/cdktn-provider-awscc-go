...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*InterconnectConnection)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "attachPointInput", GoGetter: "AttachPointInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "billingTier", GoGetter: "BillingTier"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAttachPoint", GoMethod: "PutAttachPoint"},
			_jsii_.MemberMethod{JsiiMethod: "putRemoteAccount", GoMethod: "PutRemoteAccount"},
			_jsii_.MemberMethod{JsiiMethod: "putTags", GoMethod: "PutTags"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "registerProviderFeatureUsage", GoMethod: "RegisterProviderFeatureUsage"},
			_jsii_.MemberProperty{JsiiProperty: "remoteAccount", GoGetter: "RemoteAccount"},
			_jsii_.MemberProperty{JsiiProperty: "remoteAccountInput", GoGetter: "RemoteAccountInput"},
			_jsii_.MemberProperty{JsiiProperty: "remoteOwnerAccount", GoGetter: "RemoteOwnerAccount"},
			_jsii_.MemberProperty{JsiiProperty: "remoteOwnerAccountInput", GoGetter: "RemoteOwnerAccountInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRemoteAccount", GoMethod: "ResetRemoteAccount"},
			_jsii_.MemberMethod{JsiiMethod: "resetRemoteOwnerAccount", GoMethod: "ResetRemoteOwnerAccount"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberProperty{JsiiProperty: "sharedId", GoGetter: "SharedId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*InterconnectConnectionAttachPoint)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.interconnectConnection.InterconnectConnectionAttachPointOutputReference",
		reflect.TypeOf((*InterconnectConnectionAttachPointOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "arn", GoGetter: "Arn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "directConnectGateway", GoGetter: "DirectConnectGateway"},
			_jsii_.MemberProperty{JsiiProperty: "directConnectGatewayInput", GoGetter: "DirectConnectGatewayInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDirectConnectGateway", GoMethod: "ResetDirectConnectGateway"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*InterconnectConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.interconnectConnection.InterconnectConnectionProviderName",
		reflect.TypeOf((*InterconnectConnectionProviderName)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.interconnectConnection.InterconnectConnectionProviderNameOutputReference",
		reflect.TypeOf((*InterconnectConnectionProviderNameOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "cloudServiceProvider", GoGetter: "CloudServiceProvider"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lastMileProvider", GoGetter: "LastMileProvider"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*InterconnectConnectionRemoteAccount)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.interconnectConnection.InterconnectConnectionRemoteAccountOutputReference",
		reflect.TypeOf((*InterconnectConnectionRemoteAccountOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*InterconnectConnectionTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.interconnectConnection.InterconnectConnectionTagsList",
		reflect.TypeOf((*InterconnectConnectionTagsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_InterconnectConnectionTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*InterconnectConnectionTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
