...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayPolicyTableEntry)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayPolicyTableEntryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.dataAwsccEc2TransitGatewayPolicyTableEntry.DataAwsccEc2TransitGatewayPolicyTableEntryPolicyRule",
		reflect.TypeOf((*DataAwsccEc2TransitGatewayPolicyTableEntryPolicyRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccEc2TransitGatewayPolicyTableEntryPolicyRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
