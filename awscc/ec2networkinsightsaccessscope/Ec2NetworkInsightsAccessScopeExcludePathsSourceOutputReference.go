...
func NewEc2NetworkInsightsAccessScopeExcludePathsSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference {
	_init_.Initialize()
...
func NewEc2NetworkInsightsAccessScopeExcludePathsSourceOutputReference_Override(e Ec2NetworkInsightsAccessScopeExcludePathsSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
