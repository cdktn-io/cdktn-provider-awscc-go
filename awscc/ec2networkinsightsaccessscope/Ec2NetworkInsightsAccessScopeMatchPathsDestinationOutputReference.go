...
func NewEc2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference {
	_init_.Initialize()
...
func NewEc2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference_Override(e Ec2NetworkInsightsAccessScopeMatchPathsDestinationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
