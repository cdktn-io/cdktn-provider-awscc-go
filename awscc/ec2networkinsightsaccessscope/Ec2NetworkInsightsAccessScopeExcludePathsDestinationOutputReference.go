...
func NewEc2NetworkInsightsAccessScopeExcludePathsDestinationOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) Ec2NetworkInsightsAccessScopeExcludePathsDestinationOutputReference {
	_init_.Initialize()
...
func NewEc2NetworkInsightsAccessScopeExcludePathsDestinationOutputReference_Override(e Ec2NetworkInsightsAccessScopeExcludePathsDestinationOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
