...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawscclocationapikeys/internal"
...
func (j *jsiiProxy_DataAwsccLocationApiKeys) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccLocationApiKeys) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccLocationApiKeys) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccLocationApiKeys) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccLocationApiKeys) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccLocationApiKeys)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccLocationApiKeys)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccLocationApiKeys)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccLocationApiKeys_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccLocationApiKeys) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLocationApiKeys) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccLocationApiKeys) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccLocationApiKeys) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
