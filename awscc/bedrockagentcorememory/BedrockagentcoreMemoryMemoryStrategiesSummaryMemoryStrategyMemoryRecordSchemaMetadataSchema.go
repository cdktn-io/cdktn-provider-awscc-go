...
type BedrockagentcoreMemoryMemoryStrategiesSummaryMemoryStrategyMemoryRecordSchemaMetadataSchema struct {
	...
	ExtractionConfig *BedrockagentcoreMemoryMemoryStrategiesSummaryMemoryStrategyMemoryRecordSchemaMetadataSchemaExtractionConfig `field:"optional" json:"extractionConfig" yaml:"extractionConfig"`
