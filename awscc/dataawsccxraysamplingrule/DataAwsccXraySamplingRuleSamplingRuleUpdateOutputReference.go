...
type DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference interface {
	...
	RuleArn() *string
	RuleName() *string
	SamplingRateBoost() DataAwsccXraySamplingRuleSamplingRuleUpdateSamplingRateBoostOutputReference
	ServiceName() *string
	ServiceType() *string
	// Experimental.
...
func (j *jsiiProxy_DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference) Attributes() cdktn.StringMap {
...
func (j *jsiiProxy_DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference) SamplingRateBoost() DataAwsccXraySamplingRuleSamplingRuleUpdateSamplingRateBoostOutputReference {
	var returns DataAwsccXraySamplingRuleSamplingRuleUpdateSamplingRateBoostOutputReference
	_jsii_.Get(
		j,
		"samplingRateBoost",
		&returns,
...
func (j *jsiiProxy_DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference {
	_init_.Initialize()
...
func NewDataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference_Override(d DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccXraySamplingRuleSamplingRuleUpdateOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
