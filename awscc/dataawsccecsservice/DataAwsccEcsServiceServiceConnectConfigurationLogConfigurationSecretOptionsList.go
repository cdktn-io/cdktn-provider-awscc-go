...
func (j *jsiiProxy_DataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList {
	_init_.Initialize()
...
func NewDataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList_Override(d DataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAwsccEcsServiceServiceConnectConfigurationLogConfigurationSecretOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
