...
func (e *jsiiProxy_EksAddon) validatePutPodIdentityAssociationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EksAddonPodIdentityAssociations; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EksAddon) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EksAddonTags; received %#v (a %T)", value, value)
		}
	}
