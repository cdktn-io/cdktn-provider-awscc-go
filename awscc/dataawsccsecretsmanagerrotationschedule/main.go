...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationScheduleExternalSecretRotationMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationScheduleExternalSecretRotationMetadataList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSecretsmanagerRotationScheduleExternalSecretRotationMetadataOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
