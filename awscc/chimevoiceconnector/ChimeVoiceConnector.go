...
func (j *jsiiProxy_ChimeVoiceConnector) CreatedTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdTimestamp",
...
func (j *jsiiProxy_ChimeVoiceConnector) NetworkType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkType",
...
func (j *jsiiProxy_ChimeVoiceConnector) NetworkTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkTypeInput",
...
func (j *jsiiProxy_ChimeVoiceConnector) Tags() ChimeVoiceConnectorTagsList {
	var returns ChimeVoiceConnectorTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_ChimeVoiceConnector) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_ChimeVoiceConnector) UpdatedTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedTimestamp",
...
func (j *jsiiProxy_ChimeVoiceConnector) VoiceConnectorArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"voiceConnectorArn",
...
func (j *jsiiProxy_ChimeVoiceConnector) VoiceConnectorId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"voiceConnectorId",
...
func NewChimeVoiceConnector(scope constructs.Construct, id *string, config *ChimeVoiceConnectorConfig) ChimeVoiceConnector {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.chimeVoiceConnector.ChimeVoiceConnector",
...
func (j *jsiiProxy_ChimeVoiceConnector)SetNetworkType(val *string) {
...
func (c *jsiiProxy_ChimeVoiceConnector) PutTags(value interface{}) {
...
func (c *jsiiProxy_ChimeVoiceConnector) ResetNetworkType() {
	_jsii_.InvokeVoid(
		c,
		"resetNetworkType",
		nil, // no parameters
