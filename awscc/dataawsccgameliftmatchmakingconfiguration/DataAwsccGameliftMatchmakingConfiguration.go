...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccgameliftmatchmakingconfiguration/internal"
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) AcceptanceRequired() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccGameliftMatchmakingConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccGameliftMatchmakingConfiguration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
