...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EcsTaskDefinitionVolumesS3FilesVolumeConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ecsTaskDefinition.EcsTaskDefinitionVolumesS3FilesVolumeConfigurationOutputReference",
		reflect.TypeOf((*EcsTaskDefinitionVolumesS3FilesVolumeConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
