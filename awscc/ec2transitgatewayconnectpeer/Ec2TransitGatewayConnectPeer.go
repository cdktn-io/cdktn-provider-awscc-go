...
type Ec2TransitGatewayConnectPeer interface {
	...
	ConnectPeerConfiguration() Ec2TransitGatewayConnectPeerConnectPeerConfigurationOutputReference
	ConnectPeerConfigurationInput() interface{}
	// Experimental.
	...
	PutConnectPeerConfiguration(value *Ec2TransitGatewayConnectPeerConnectPeerConfiguration)
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) ConnectPeerConfiguration() Ec2TransitGatewayConnectPeerConnectPeerConfigurationOutputReference {
	var returns Ec2TransitGatewayConnectPeerConnectPeerConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) ConnectPeerConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"connectPeerConfigurationInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) Tags() Ec2TransitGatewayConnectPeerTagsList {
	var returns Ec2TransitGatewayConnectPeerTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Ec2TransitGatewayConnectPeer) TransitGatewayConnectPeerId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (e *jsiiProxy_Ec2TransitGatewayConnectPeer) PutConnectPeerConfiguration(value *Ec2TransitGatewayConnectPeerConnectPeerConfiguration) {
	if err := e.validatePutConnectPeerConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
		"putConnectPeerConfiguration",
		[]interface{}{value},
	)
}

func (e *jsiiProxy_Ec2TransitGatewayConnectPeer) PutTags(value interface{}) {
