...
type EcsDaemon interface {
	...
	DeploymentConfiguration() EcsDaemonDeploymentConfigurationOutputReference
	...
	PutDeploymentConfiguration(value *EcsDaemonDeploymentConfiguration)
	...
	ResetCapacityProviderArns()
	ResetClusterArn()
	ResetDaemonName()
	ResetDaemonTaskDefinitionArn()
...
func (j *jsiiProxy_EcsDaemon) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_EcsDaemon) DaemonArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"daemonArn",
...
func (j *jsiiProxy_EcsDaemon) DaemonName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"daemonName",
...
func (j *jsiiProxy_EcsDaemon) DaemonNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"daemonNameInput",
...
func (j *jsiiProxy_EcsDaemon) DaemonStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"daemonStatus",
...
func (j *jsiiProxy_EcsDaemon) DeploymentConfiguration() EcsDaemonDeploymentConfigurationOutputReference {
...
func (j *jsiiProxy_EcsDaemon) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_EcsDaemon) Tags() EcsDaemonTagsList {
	var returns EcsDaemonTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_EcsDaemon) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_EcsDaemon) UpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedAt",
...
func (j *jsiiProxy_EcsDaemon)SetDaemonName(val *string) {
	if err := j.validateSetDaemonNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (e *jsiiProxy_EcsDaemon) PutDeploymentConfiguration(value *EcsDaemonDeploymentConfiguration) {
...
func (e *jsiiProxy_EcsDaemon) PutTags(value interface{}) {
...
func (e *jsiiProxy_EcsDaemon) ResetCapacityProviderArns() {
	_jsii_.InvokeVoid(
		e,
		"resetCapacityProviderArns",
		nil, // no parameters
...
func (e *jsiiProxy_EcsDaemon) ResetDaemonName() {
	_jsii_.InvokeVoid(
		e,
		"resetDaemonName",
		nil, // no parameters
...
func (e *jsiiProxy_EcsDaemon) ResetDaemonTaskDefinitionArn() {
	_jsii_.InvokeVoid(
		e,
		"resetDaemonTaskDefinitionArn",
		nil, // no parameters
