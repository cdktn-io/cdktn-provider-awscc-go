...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/mediaconvertqueue/internal"
...
type MediaconvertQueue interface {
	...
	MaximumConcurrentFeedsInput() *float64
	Name() *string
	SetName(val *string)
	NameInput() *string
	// The tree node.
...
func (j *jsiiProxy_MediaconvertQueue) MaximumConcurrentFeeds() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MediaconvertQueue) MaximumConcurrentFeedsInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maximumConcurrentFeedsInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_MediaconvertQueue) Tags() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_MediaconvertQueue) TagsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewMediaconvertQueue(scope constructs.Construct, id *string, config *MediaconvertQueueConfig) MediaconvertQueue {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.mediaconvertQueue.MediaconvertQueue",
...
func (j *jsiiProxy_MediaconvertQueue)SetMaximumConcurrentFeeds(val *float64) {
	if err := j.validateSetMaximumConcurrentFeedsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MediaconvertQueue)SetTags(val *string) {
...
func (m *jsiiProxy_MediaconvertQueue) ResetMaximumConcurrentFeeds() {
	_jsii_.InvokeVoid(
		m,
		"resetMaximumConcurrentFeeds",
		nil, // no parameters
...
func (m *jsiiProxy_MediaconvertQueue) ResetName() {
	_jsii_.InvokeVoid(
		m,
		"resetName",
		nil, // no parameters
