...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dns64EnabledInput", GoGetter: "Dns64EnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv6InternetAccessEnabledInput", GoGetter: "Ipv6InternetAccessEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDns64Enabled", GoMethod: "ResetDns64Enabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpv6InternetAccessEnabled", GoMethod: "ResetIpv6InternetAccessEnabled"},
