...
func (j *jsiiProxy_GuarddutyThreatIntelSet) ExpectedBucketOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expectedBucketOwner",
...
func (j *jsiiProxy_GuarddutyThreatIntelSet) ExpectedBucketOwnerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GuarddutyThreatIntelSet)SetExpectedBucketOwner(val *string) {
...
func (g *jsiiProxy_GuarddutyThreatIntelSet) ResetExpectedBucketOwner() {
	_jsii_.InvokeVoid(
		g,
		"resetExpectedBucketOwner",
		nil, // no parameters
