...
type GluePartition interface {
	...
	PartitionInput() GluePartitionPartitionInputOutputReference
	PartitionInputInput() interface{}
	// Experimental.
	...
	PutPartitionInput(value *GluePartitionPartitionInput)
...
func (j *jsiiProxy_GluePartition) IdentifierPartitionInputValues() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GluePartition) PartitionInput() GluePartitionPartitionInputOutputReference {
	var returns GluePartitionPartitionInputOutputReference
	_jsii_.Get(
		j,
		"partitionInput",
		&returns,
...
func (j *jsiiProxy_GluePartition) PartitionInputInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"partitionInputInput",
...
func NewGluePartition(scope constructs.Construct, id *string, config *GluePartitionConfig) GluePartition {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.gluePartition.GluePartition",
...
func (g *jsiiProxy_GluePartition) PutPartitionInput(value *GluePartitionPartitionInput) {
	if err := g.validatePutPartitionInputParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		g,
