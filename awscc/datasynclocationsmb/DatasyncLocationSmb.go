...
type DatasyncLocationSmb interface {
	...
	CmkSecretConfig() DatasyncLocationSmbCmkSecretConfigOutputReference
	...
	CustomSecretConfig() DatasyncLocationSmbCustomSecretConfigOutputReference
	...
	LocationArn() *string
	LocationUri() *string
	ManagedSecretConfig() DatasyncLocationSmbManagedSecretConfigOutputReference
	...
	PutCmkSecretConfig(value *DatasyncLocationSmbCmkSecretConfig)
	PutCustomSecretConfig(value *DatasyncLocationSmbCustomSecretConfig)
...
func (j *jsiiProxy_DatasyncLocationSmb) CmkSecretConfig() DatasyncLocationSmbCmkSecretConfigOutputReference {
	var returns DatasyncLocationSmbCmkSecretConfigOutputReference
	_jsii_.Get(
		j,
		"cmkSecretConfig",
		&returns,
...
func (j *jsiiProxy_DatasyncLocationSmb) CmkSecretConfigInput() interface{} {
...
func (j *jsiiProxy_DatasyncLocationSmb) CustomSecretConfig() DatasyncLocationSmbCustomSecretConfigOutputReference {
	var returns DatasyncLocationSmbCustomSecretConfigOutputReference
	_jsii_.Get(
		j,
		"customSecretConfig",
		&returns,
...
func (j *jsiiProxy_DatasyncLocationSmb) CustomSecretConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DatasyncLocationSmb) ManagedSecretConfig() DatasyncLocationSmbManagedSecretConfigOutputReference {
	var returns DatasyncLocationSmbManagedSecretConfigOutputReference
	_jsii_.Get(
		j,
		"managedSecretConfig",
		&returns,
...
func (d *jsiiProxy_DatasyncLocationSmb) PutCmkSecretConfig(value *DatasyncLocationSmbCmkSecretConfig) {
...
func (d *jsiiProxy_DatasyncLocationSmb) PutCustomSecretConfig(value *DatasyncLocationSmbCustomSecretConfig) {
...
func (d *jsiiProxy_DatasyncLocationSmb) ResetCmkSecretConfig() {
	_jsii_.InvokeVoid(
		d,
		"resetCmkSecretConfig",
		nil, // no parameters
...
func (d *jsiiProxy_DatasyncLocationSmb) ResetCustomSecretConfig() {
	_jsii_.InvokeVoid(
		d,
		"resetCustomSecretConfig",
		nil, // no parameters
