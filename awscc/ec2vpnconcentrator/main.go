...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpnConcentrator)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Ec2VpnConcentratorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.ec2VpnConcentrator.Ec2VpnConcentratorTags",
		reflect.TypeOf((*Ec2VpnConcentratorTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.ec2VpnConcentrator.Ec2VpnConcentratorTagsList",
		reflect.TypeOf((*Ec2VpnConcentratorTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Ec2VpnConcentratorTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
