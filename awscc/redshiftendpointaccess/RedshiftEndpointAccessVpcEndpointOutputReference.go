...
func NewRedshiftEndpointAccessVpcEndpointOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) RedshiftEndpointAccessVpcEndpointOutputReference {
	_init_.Initialize()
...
func NewRedshiftEndpointAccessVpcEndpointOutputReference_Override(r RedshiftEndpointAccessVpcEndpointOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
