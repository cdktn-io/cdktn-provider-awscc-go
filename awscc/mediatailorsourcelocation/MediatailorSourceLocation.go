...
func (j *jsiiProxy_MediatailorSourceLocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MediatailorSourceLocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MediatailorSourceLocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MediatailorSourceLocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MediatailorSourceLocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.100.0/docs/resources/mediatailor_source_location awscc_mediatailor_source_location} Resource.
...
func (j *jsiiProxy_MediatailorSourceLocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MediatailorSourceLocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MediatailorSourceLocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func MediatailorSourceLocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_MediatailorSourceLocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MediatailorSourceLocation) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MediatailorSourceLocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MediatailorSourceLocation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MediatailorSourceLocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MediatailorSourceLocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
