...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53GlobalresolverAccessSource)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "accessSourceId", GoGetter: "AccessSourceId"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAwsccRoute53GlobalresolverAccessSourceTagsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccRoute53GlobalresolverAccessSourceTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
