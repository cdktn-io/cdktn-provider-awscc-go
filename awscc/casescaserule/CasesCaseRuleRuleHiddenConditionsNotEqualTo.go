...
type CasesCaseRuleRuleHiddenConditionsNotEqualTo struct {
	...
	OperandOne *CasesCaseRuleRuleHiddenConditionsNotEqualToOperandOne `field:"optional" json:"operandOne" yaml:"operandOne"`
	...
	OperandTwo *CasesCaseRuleRuleHiddenConditionsNotEqualToOperandTwo `field:"optional" json:"operandTwo" yaml:"operandTwo"`
