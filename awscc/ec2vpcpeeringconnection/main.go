...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "assumeRoleRegionInput", GoGetter: "AssumeRoleRegionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAssumeRoleRegion", GoMethod: "ResetAssumeRoleRegion"},
