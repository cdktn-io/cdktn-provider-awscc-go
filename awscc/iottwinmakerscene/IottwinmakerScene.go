...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/iottwinmakerscene/internal"
...
func (j *jsiiProxy_IottwinmakerScene) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_IottwinmakerScene) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_IottwinmakerScene) GeneratedSceneMetadata() cdktn.StringMap {
...
func (j *jsiiProxy_IottwinmakerScene) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IottwinmakerScene) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_IottwinmakerScene) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IottwinmakerScene)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IottwinmakerScene)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IottwinmakerScene)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func IottwinmakerScene_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IottwinmakerScene) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IottwinmakerScene) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_IottwinmakerScene) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_IottwinmakerScene) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_IottwinmakerScene) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_IottwinmakerScene) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
