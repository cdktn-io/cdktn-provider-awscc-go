...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/ec2vpcendpointservicepermissions/internal"
...
func (j *jsiiProxy_Ec2VpcEndpointServicePermissions) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Ec2VpcEndpointServicePermissions) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Ec2VpcEndpointServicePermissions) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Ec2VpcEndpointServicePermissions) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Ec2VpcEndpointServicePermissions) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Ec2VpcEndpointServicePermissions)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Ec2VpcEndpointServicePermissions)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Ec2VpcEndpointServicePermissions)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Ec2VpcEndpointServicePermissions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Ec2VpcEndpointServicePermissions) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2VpcEndpointServicePermissions) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_Ec2VpcEndpointServicePermissions) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_Ec2VpcEndpointServicePermissions) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_Ec2VpcEndpointServicePermissions) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_Ec2VpcEndpointServicePermissions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
