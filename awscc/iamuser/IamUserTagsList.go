...
func (j *jsiiProxy_IamUserTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewIamUserTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IamUserTagsList {
	_init_.Initialize()
...
func NewIamUserTagsList_Override(i IamUserTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_IamUserTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_IamUserTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IamUserTagsList) Resolve(context cdktn.IResolveContext) interface{} {
