...
func (j *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) QuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference {
	_init_.Initialize()
...
func NewQuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference_Override(q QuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (q *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (q *jsiiProxy_QuicksightTopicDataSetsNamedEntitiesDefinitionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
