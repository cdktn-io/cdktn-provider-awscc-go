...
type KinesisvideoStream interface {
	...
	StreamStorageConfiguration() KinesisvideoStreamStreamStorageConfigurationOutputReference
	StreamStorageConfigurationInput() interface{}
	...
	PutStreamStorageConfiguration(value *KinesisvideoStreamStreamStorageConfiguration)
	...
	ResetStreamStorageConfiguration()
	ResetTags()
...
func (j *jsiiProxy_KinesisvideoStream) StreamStorageConfiguration() KinesisvideoStreamStreamStorageConfigurationOutputReference {
	var returns KinesisvideoStreamStreamStorageConfigurationOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KinesisvideoStream) StreamStorageConfigurationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (k *jsiiProxy_KinesisvideoStream) PutStreamStorageConfiguration(value *KinesisvideoStreamStreamStorageConfiguration) {
	if err := k.validatePutStreamStorageConfigurationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
		"putStreamStorageConfiguration",
		[]interface{}{value},
	)
}
...
func (k *jsiiProxy_KinesisvideoStream) ResetStreamStorageConfiguration() {
	_jsii_.InvokeVoid(
		k,
		"resetStreamStorageConfiguration",
		nil, // no parameters
