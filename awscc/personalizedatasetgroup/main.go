...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.personalizeDatasetGroup.PersonalizeDatasetGroupTags",
		reflect.TypeOf((*PersonalizeDatasetGroupTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.personalizeDatasetGroup.PersonalizeDatasetGroupTagsList",
		reflect.TypeOf((*PersonalizeDatasetGroupTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PersonalizeDatasetGroupTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
