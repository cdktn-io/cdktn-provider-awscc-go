...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SmsvoiceSenderId)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SmsvoiceSenderIdConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.smsvoiceSenderId.SmsvoiceSenderIdTags",
		reflect.TypeOf((*SmsvoiceSenderIdTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.smsvoiceSenderId.SmsvoiceSenderIdTagsList",
		reflect.TypeOf((*SmsvoiceSenderIdTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SmsvoiceSenderIdTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
