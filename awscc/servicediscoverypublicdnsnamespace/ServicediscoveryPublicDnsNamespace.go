...
type ServicediscoveryPublicDnsNamespace interface {
	...
	PutProperties(value *ServicediscoveryPublicDnsNamespaceProperties)
...
func (j *jsiiProxy_ServicediscoveryPublicDnsNamespace) HostedZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"hostedZoneId",
...
func (j *jsiiProxy_ServicediscoveryPublicDnsNamespace) Properties() ServicediscoveryPublicDnsNamespacePropertiesOutputReference {
	var returns ServicediscoveryPublicDnsNamespacePropertiesOutputReference
	_jsii_.Get(
		j,
		"properties",
		&returns,
...
func (j *jsiiProxy_ServicediscoveryPublicDnsNamespace) PropertiesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"propertiesInput",
...
func (j *jsiiProxy_ServicediscoveryPublicDnsNamespace) PublicDnsNamespaceId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServicediscoveryPublicDnsNamespace) Tags() ServicediscoveryPublicDnsNamespaceTagsList {
	var returns ServicediscoveryPublicDnsNamespaceTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (s *jsiiProxy_ServicediscoveryPublicDnsNamespace) PutProperties(value *ServicediscoveryPublicDnsNamespaceProperties) {
...
func (s *jsiiProxy_ServicediscoveryPublicDnsNamespace) PutTags(value interface{}) {
...
func (s *jsiiProxy_ServicediscoveryPublicDnsNamespace) ResetProperties() {
	_jsii_.InvokeVoid(
		s,
		"resetProperties",
		nil, // no parameters
