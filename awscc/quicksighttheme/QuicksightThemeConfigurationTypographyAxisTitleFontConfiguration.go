...
type QuicksightThemeConfigurationTypographyAxisTitleFontConfiguration struct {
	...
	FontSize *QuicksightThemeConfigurationTypographyAxisTitleFontConfigurationFontSize `field:"optional" json:"fontSize" yaml:"fontSize"`
	...
	FontWeight *QuicksightThemeConfigurationTypographyAxisTitleFontConfigurationFontWeight `field:"optional" json:"fontWeight" yaml:"fontWeight"`
}
