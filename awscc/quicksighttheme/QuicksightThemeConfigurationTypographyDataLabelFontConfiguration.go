...
type QuicksightThemeConfigurationTypographyDataLabelFontConfiguration struct {
	...
	FontSize *QuicksightThemeConfigurationTypographyDataLabelFontConfigurationFontSize `field:"optional" json:"fontSize" yaml:"fontSize"`
	...
	FontWeight *QuicksightThemeConfigurationTypographyDataLabelFontConfigurationFontWeight `field:"optional" json:"fontWeight" yaml:"fontWeight"`
}
