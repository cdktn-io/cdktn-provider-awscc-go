...
type QuicksightThemeConfigurationTypographyLegendTitleFontConfiguration struct {
	...
	FontSize *QuicksightThemeConfigurationTypographyLegendTitleFontConfigurationFontSize `field:"optional" json:"fontSize" yaml:"fontSize"`
	...
	FontWeight *QuicksightThemeConfigurationTypographyLegendTitleFontConfigurationFontWeight `field:"optional" json:"fontWeight" yaml:"fontWeight"`
}
