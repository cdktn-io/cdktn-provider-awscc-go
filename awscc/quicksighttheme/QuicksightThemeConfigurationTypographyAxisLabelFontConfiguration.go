...
type QuicksightThemeConfigurationTypographyAxisLabelFontConfiguration struct {
	...
	FontSize *QuicksightThemeConfigurationTypographyAxisLabelFontConfigurationFontSize `field:"optional" json:"fontSize" yaml:"fontSize"`
	...
	FontWeight *QuicksightThemeConfigurationTypographyAxisLabelFontConfigurationFontWeight `field:"optional" json:"fontWeight" yaml:"fontWeight"`
}
