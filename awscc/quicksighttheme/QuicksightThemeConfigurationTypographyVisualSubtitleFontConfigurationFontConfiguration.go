...
type QuicksightThemeConfigurationTypographyVisualSubtitleFontConfigurationFontConfiguration struct {
	...
	FontSize *QuicksightThemeConfigurationTypographyVisualSubtitleFontConfigurationFontConfigurationFontSize `field:"optional" json:"fontSize" yaml:"fontSize"`
	...
	FontWeight *QuicksightThemeConfigurationTypographyVisualSubtitleFontConfigurationFontConfigurationFontWeight `field:"optional" json:"fontWeight" yaml:"fontWeight"`
}
