...
type QuicksightThemeConfigurationTypographyVisualSubtitleFontConfiguration struct {
	...
	FontConfiguration *QuicksightThemeConfigurationTypographyVisualSubtitleFontConfigurationFontConfiguration `field:"optional" json:"fontConfiguration" yaml:"fontConfiguration"`
