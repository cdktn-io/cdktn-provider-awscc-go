...
func (b *jsiiProxy_B2BiPartnershipCapabilityOptionsOutboundEdiX12WrapOptionsOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (b *jsiiProxy_B2BiPartnershipCapabilityOptionsOutboundEdiX12WrapOptionsOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_B2BiPartnershipCapabilityOptionsOutboundEdiX12WrapOptionsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *B2BiPartnershipCapabilityOptionsOutboundEdiX12WrapOptions; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_B2BiPartnershipCapabilityOptionsOutboundEdiX12WrapOptionsOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewB2BiPartnershipCapabilityOptionsOutboundEdiX12WrapOptionsOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
