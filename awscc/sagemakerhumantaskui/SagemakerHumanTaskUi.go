...
func (j *jsiiProxy_SagemakerHumanTaskUi) CreationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_SagemakerHumanTaskUi) HumanTaskUiArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"humanTaskUiArn",
...
func (j *jsiiProxy_SagemakerHumanTaskUi) Tags() SagemakerHumanTaskUiTagsList {
	var returns SagemakerHumanTaskUiTagsList
	_jsii_.Get(
		j,
		"tags",
		&returns,
...
func (j *jsiiProxy_SagemakerHumanTaskUi) UiTemplateInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"uiTemplateInput",
...
func NewSagemakerHumanTaskUi(scope constructs.Construct, id *string, config *SagemakerHumanTaskUiConfig) SagemakerHumanTaskUi {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.sagemakerHumanTaskUi.SagemakerHumanTaskUi",
...
func (s *jsiiProxy_SagemakerHumanTaskUi) PutTags(value interface{}) {
...
func (s *jsiiProxy_SagemakerHumanTaskUi) ResetUiTemplate() {
	_jsii_.InvokeVoid(
		s,
		"resetUiTemplate",
		nil, // no parameters
