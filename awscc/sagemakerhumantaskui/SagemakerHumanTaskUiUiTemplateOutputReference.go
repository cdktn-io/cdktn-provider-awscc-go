...
func (j *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func NewSagemakerHumanTaskUiUiTemplateOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) SagemakerHumanTaskUiUiTemplateOutputReference {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.sagemakerHumanTaskUi.SagemakerHumanTaskUiUiTemplateOutputReference",
...
func (j *jsiiProxy_SagemakerHumanTaskUiUiTemplateOutputReference)SetInternalValue(val interface{}) {
