...
func (j *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) IpAddressType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressType",
...
func (j *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) IpAddressTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipAddressTypeInput",
...
func NewCloudfrontVpcOriginVpcOriginEndpointConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference {
	_init_.Initialize()
...
func NewCloudfrontVpcOriginVpcOriginEndpointConfigOutputReference_Override(c CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference)SetIpAddressType(val *string) {
...
func (c *jsiiProxy_CloudfrontVpcOriginVpcOriginEndpointConfigOutputReference) ResetIpAddressType() {
	_jsii_.InvokeVoid(
		c,
		"resetIpAddressType",
		nil, // no parameters
