...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*LogsQueryDefinitionParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.logsQueryDefinition.LogsQueryDefinitionParametersList",
		reflect.TypeOf((*LogsQueryDefinitionParametersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogsQueryDefinitionParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
