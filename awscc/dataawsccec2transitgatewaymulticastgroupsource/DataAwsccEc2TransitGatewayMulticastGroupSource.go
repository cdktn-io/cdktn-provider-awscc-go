...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccec2transitgatewaymulticastgroupsource/internal"
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) GroupMember() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) GroupSource() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"groupSource",
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccEc2TransitGatewayMulticastGroupSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccEc2TransitGatewayMulticastGroupSource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
