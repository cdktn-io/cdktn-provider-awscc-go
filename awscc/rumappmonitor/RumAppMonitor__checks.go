...
func (r *jsiiProxy_RumAppMonitor) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*RumAppMonitorTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_RumAppMonitor) validateSetPlatformParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
