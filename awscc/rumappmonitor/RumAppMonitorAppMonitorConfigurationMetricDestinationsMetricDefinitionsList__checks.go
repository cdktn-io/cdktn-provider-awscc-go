...
func (r *jsiiProxy_RumAppMonitorAppMonitorConfigurationMetricDestinationsMetricDefinitionsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_RumAppMonitorAppMonitorConfigurationMetricDestinationsMetricDefinitionsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewRumAppMonitorAppMonitorConfigurationMetricDestinationsMetricDefinitionsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
