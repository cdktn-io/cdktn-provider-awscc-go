...
func (j *jsiiProxy_RumAppMonitor) Platform() *string {
	var returns *string
	_jsii_.Get(
		j,
		"platform",
...
func (j *jsiiProxy_RumAppMonitor) PlatformInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"platformInput",
...
func (j *jsiiProxy_RumAppMonitor)SetPlatform(val *string) {
...
func (r *jsiiProxy_RumAppMonitor) ResetPlatform() {
	_jsii_.InvokeVoid(
		r,
		"resetPlatform",
		nil, // no parameters
