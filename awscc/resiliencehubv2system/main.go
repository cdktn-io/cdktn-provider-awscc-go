...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*Resiliencehubv2SystemTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.resiliencehubv2System.Resiliencehubv2SystemTagsList",
		reflect.TypeOf((*Resiliencehubv2SystemTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Resiliencehubv2SystemTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
