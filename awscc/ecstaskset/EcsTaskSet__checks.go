...
func (e *jsiiProxy_EcsTaskSet) validatePutLoadBalancersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsTaskSetLoadBalancers; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EcsTaskSet) validatePutServiceRegistriesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsTaskSetServiceRegistries; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_EcsTaskSet) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*EcsTaskSetTags; received %#v (a %T)", value, value)
		}
	}
