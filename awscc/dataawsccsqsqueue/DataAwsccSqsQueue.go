...
import (
	...
	"github.com/cdktn-io/cdktn-provider-awscc-go/awscc/dataawsccsqsqueue/internal"
...
type DataAwsccSqsQueue interface {
	...
	ContentBasedDeduplication() cdktn.IResolvable
	// Experimental.
	Count() interface{}
	// Experimental.
	...
	SqsManagedSseEnabled() cdktn.IResolvable
...
func (j *jsiiProxy_DataAwsccSqsQueue) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataAwsccSqsQueue) ContentBasedDeduplication() cdktn.IResolvable {
...
func (j *jsiiProxy_DataAwsccSqsQueue) FifoQueue() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
		"fifoQueue",
...
func (j *jsiiProxy_DataAwsccSqsQueue) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataAwsccSqsQueue) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataAwsccSqsQueue) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataAwsccSqsQueue) SqsManagedSseEnabled() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAwsccSqsQueue) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/data-sources/sqs_queue awscc_sqs_queue} Data Source.
...
func (j *jsiiProxy_DataAwsccSqsQueue)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataAwsccSqsQueue)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataAwsccSqsQueue)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataAwsccSqsQueue_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataAwsccSqsQueue) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSqsQueue) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataAwsccSqsQueue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataAwsccSqsQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
