...
func (j *jsiiProxy_PipesPipeTargetParametersTimestreamParametersMultiMeasureMappingsMultiMeasureAttributeMappingsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipesPipeTargetParametersTimestreamParametersMultiMeasureMappingsMultiMeasureAttributeMappingsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PipesPipeTargetParametersTimestreamParametersMultiMeasureMappingsMultiMeasureAttributeMappingsList {
	_init_.Initialize()
...
func (j *jsiiProxy_PipesPipeTargetParametersTimestreamParametersMultiMeasureMappingsMultiMeasureAttributeMappingsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipesPipeTargetParametersTimestreamParametersMultiMeasureMappingsMultiMeasureAttributeMappingsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PipesPipeTargetParametersTimestreamParametersMultiMeasureMappingsMultiMeasureAttributeMappingsList) Resolve(context cdktn.IResolveContext) interface{} {
