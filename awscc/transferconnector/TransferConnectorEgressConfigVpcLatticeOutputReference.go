...
func (j *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference)SetInternalValue(val interface{}) {
...
func (t *jsiiProxy_TransferConnectorEgressConfigVpcLatticeOutputReference) ResetResourceConfigurationArn() {
	_jsii_.InvokeVoid(
		t,
		"resetResourceConfigurationArn",
		nil, // no parameters
