...
type TransferConnectorAs2ConfigOutputReference interface {
	cdktn.ComplexObject
	AsyncMdnConfig() TransferConnectorAs2ConfigAsyncMdnConfigOutputReference
	AsyncMdnConfigInput() interface{}
	...
	PutAsyncMdnConfig(value *TransferConnectorAs2ConfigAsyncMdnConfig)
	ResetAsyncMdnConfig()
...
func (j *jsiiProxy_TransferConnectorAs2ConfigOutputReference) AsyncMdnConfig() TransferConnectorAs2ConfigAsyncMdnConfigOutputReference {
	var returns TransferConnectorAs2ConfigAsyncMdnConfigOutputReference
	_jsii_.Get(
		j,
		"asyncMdnConfig",
		&returns,
...
func (j *jsiiProxy_TransferConnectorAs2ConfigOutputReference) AsyncMdnConfigInput() interface{} {
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) PutAsyncMdnConfig(value *TransferConnectorAs2ConfigAsyncMdnConfig) {
	if err := t.validatePutAsyncMdnConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TransferConnectorAs2ConfigOutputReference) ResetAsyncMdnConfig() {
	_jsii_.InvokeVoid(
		t,
		"resetAsyncMdnConfig",
		nil, // no parameters
