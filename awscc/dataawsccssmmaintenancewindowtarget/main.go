...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsmMaintenanceWindowTarget)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "windowTargetId", GoGetter: "WindowTargetId"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccSsmMaintenanceWindowTargetTargetsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
