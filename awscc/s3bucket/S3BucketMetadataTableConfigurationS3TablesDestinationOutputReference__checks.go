...
func (s *jsiiProxy_S3BucketMetadataTableConfigurationS3TablesDestinationOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	if terraformAttribute == nil {
		return fmt.Errorf("parameter terraformAttribute is required, but nil was provided")
	}
...
func (s *jsiiProxy_S3BucketMetadataTableConfigurationS3TablesDestinationOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_S3BucketMetadataTableConfigurationS3TablesDestinationOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *S3BucketMetadataTableConfigurationS3TablesDestination; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_S3BucketMetadataTableConfigurationS3TablesDestinationOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewS3BucketMetadataTableConfigurationS3TablesDestinationOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
