...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "configSnapshotDeliveryPropertiesInput", GoGetter: "ConfigSnapshotDeliveryPropertiesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putConfigSnapshotDeliveryProperties", GoMethod: "PutConfigSnapshotDeliveryProperties"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "registerProviderFeatureUsage", GoMethod: "RegisterProviderFeatureUsage"},
			_jsii_.MemberMethod{JsiiMethod: "resetConfigSnapshotDeliveryProperties", GoMethod: "ResetConfigSnapshotDeliveryProperties"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.configDeliveryChannel.ConfigDeliveryChannelConfig",
		reflect.TypeOf((*ConfigDeliveryChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-awscc.configDeliveryChannel.ConfigDeliveryChannelConfigSnapshotDeliveryProperties",
		reflect.TypeOf((*ConfigDeliveryChannelConfigSnapshotDeliveryProperties)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.configDeliveryChannel.ConfigDeliveryChannelConfigSnapshotDeliveryPropertiesOutputReference",
		reflect.TypeOf((*ConfigDeliveryChannelConfigSnapshotDeliveryPropertiesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
