...
type ConfigDeliveryChannel interface {
	...
	ConfigSnapshotDeliveryProperties() ConfigDeliveryChannelConfigSnapshotDeliveryPropertiesOutputReference
	ConfigSnapshotDeliveryPropertiesInput() interface{}
	// Experimental.
	...
	PutConfigSnapshotDeliveryProperties(value *ConfigDeliveryChannelConfigSnapshotDeliveryProperties)
	...
	ResetConfigSnapshotDeliveryProperties()
	ResetName()
...
func (j *jsiiProxy_ConfigDeliveryChannel) ConfigSnapshotDeliveryProperties() ConfigDeliveryChannelConfigSnapshotDeliveryPropertiesOutputReference {
	var returns ConfigDeliveryChannelConfigSnapshotDeliveryPropertiesOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConfigDeliveryChannel) ConfigSnapshotDeliveryPropertiesInput() interface{} {
...
func NewConfigDeliveryChannel(scope constructs.Construct, id *string, config *ConfigDeliveryChannelConfig) ConfigDeliveryChannel {
	...
	_jsii_.Create(
		"@cdktn/provider-awscc.configDeliveryChannel.ConfigDeliveryChannel",
...
func (c *jsiiProxy_ConfigDeliveryChannel) PutConfigSnapshotDeliveryProperties(value *ConfigDeliveryChannelConfigSnapshotDeliveryProperties) {
	if err := c.validatePutConfigSnapshotDeliveryPropertiesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
		"putConfigSnapshotDeliveryProperties",
		[]interface{}{value},
	)
}
...
func (c *jsiiProxy_ConfigDeliveryChannel) ResetConfigSnapshotDeliveryProperties() {
	_jsii_.InvokeVoid(
		c,
		"resetConfigSnapshotDeliveryProperties",
		nil, // no parameters
