...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataAwsccLogsQueryDefinitionParameters)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-awscc.dataAwsccLogsQueryDefinition.DataAwsccLogsQueryDefinitionParametersList",
		reflect.TypeOf((*DataAwsccLogsQueryDefinitionParametersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAwsccLogsQueryDefinitionParametersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
