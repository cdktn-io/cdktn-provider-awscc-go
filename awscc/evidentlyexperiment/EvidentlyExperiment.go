...
func (j *jsiiProxy_EvidentlyExperiment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_EvidentlyExperiment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_EvidentlyExperiment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_EvidentlyExperiment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_EvidentlyExperiment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.103.0/docs/resources/evidently_experiment awscc_evidently_experiment} Resource.
...
func (j *jsiiProxy_EvidentlyExperiment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_EvidentlyExperiment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_EvidentlyExperiment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func EvidentlyExperiment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_EvidentlyExperiment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EvidentlyExperiment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (e *jsiiProxy_EvidentlyExperiment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (e *jsiiProxy_EvidentlyExperiment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_EvidentlyExperiment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (e *jsiiProxy_EvidentlyExperiment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
