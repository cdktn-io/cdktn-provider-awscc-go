...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "emitSystemFieldDimensionsInput", GoGetter: "EmitSystemFieldDimensionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fieldSelectionCriteria", GoGetter: "FieldSelectionCriteria"},
			_jsii_.MemberProperty{JsiiProperty: "fieldSelectionCriteriaInput", GoGetter: "FieldSelectionCriteriaInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEmitSystemFieldDimensions", GoMethod: "ResetEmitSystemFieldDimensions"},
			_jsii_.MemberMethod{JsiiMethod: "resetFieldSelectionCriteria", GoMethod: "ResetFieldSelectionCriteria"},
