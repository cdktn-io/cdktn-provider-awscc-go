...
func (j *jsiiProxy_QuicksightDataSourceAlternateDataSourceParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSourceAlternateDataSourceParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightDataSourceAlternateDataSourceParametersList {
	_init_.Initialize()
...
func NewQuicksightDataSourceAlternateDataSourceParametersList_Override(q QuicksightDataSourceAlternateDataSourceParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSourceAlternateDataSourceParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSourceAlternateDataSourceParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightDataSourceAlternateDataSourceParametersList) Resolve(context cdktn.IResolveContext) interface{} {
