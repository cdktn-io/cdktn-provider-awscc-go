...
type QuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParameters struct {
	...
	S3TablesParameters *QuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersS3TablesParameters `field:"optional" json:"s3TablesParameters" yaml:"s3TablesParameters"`
