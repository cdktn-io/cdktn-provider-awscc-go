...
func (j *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewQuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) QuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersList {
	_init_.Initialize()
...
func NewQuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersList_Override(q QuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (q *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (q *jsiiProxy_QuicksightDataSourceCredentialsCredentialPairAlternateDataSourceParametersList) Resolve(context cdktn.IResolveContext) interface{} {
