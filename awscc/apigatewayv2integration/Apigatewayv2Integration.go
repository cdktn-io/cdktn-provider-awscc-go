...
type Apigatewayv2Integration interface {
	...
	ResponseParameters() Apigatewayv2IntegrationResponseParametersMap
...
func (j *jsiiProxy_Apigatewayv2Integration) IntegrationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationId",
...
func (j *jsiiProxy_Apigatewayv2Integration) ResponseParameters() Apigatewayv2IntegrationResponseParametersMap {
	var returns Apigatewayv2IntegrationResponseParametersMap
	_jsii_.Get(
		j,
		"responseParameters",
		&returns,
...
func (j *jsiiProxy_Apigatewayv2Integration) TimeoutInMillis() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"timeoutInMillis",
...
func (j *jsiiProxy_Apigatewayv2Integration) TimeoutInMillisInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Apigatewayv2Integration) TlsConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tlsConfigInput",
...
func (j *jsiiProxy_Apigatewayv2Integration)SetTimeoutInMillis(val *float64) {
...
func (a *jsiiProxy_Apigatewayv2Integration) ResetTimeoutInMillis() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeoutInMillis",
		nil, // no parameters
