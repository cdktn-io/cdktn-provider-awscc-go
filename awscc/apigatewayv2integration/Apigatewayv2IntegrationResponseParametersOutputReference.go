...
type Apigatewayv2IntegrationResponseParametersOutputReference interface {
	...
	ResponseParameters() Apigatewayv2IntegrationResponseParametersResponseParametersList
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) ResponseParameters() Apigatewayv2IntegrationResponseParametersResponseParametersList {
	var returns Apigatewayv2IntegrationResponseParametersResponseParametersList
	_jsii_.Get(
		j,
		"responseParameters",
		&returns,
...
func (j *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) ResponseParametersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func NewApigatewayv2IntegrationResponseParametersOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) Apigatewayv2IntegrationResponseParametersOutputReference {
	_init_.Initialize()

	if err := validateNewApigatewayv2IntegrationResponseParametersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectKey); err != nil {
		panic(err)
	}
...
func NewApigatewayv2IntegrationResponseParametersOutputReference_Override(a Apigatewayv2IntegrationResponseParametersOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectKey *string) {
	_init_.Initialize()
...
func (a *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) PutResponseParameters(value interface{}) {
...
func (a *jsiiProxy_Apigatewayv2IntegrationResponseParametersOutputReference) ResetResponseParameters() {
	_jsii_.InvokeVoid(
		a,
		"resetResponseParameters",
		nil, // no parameters
