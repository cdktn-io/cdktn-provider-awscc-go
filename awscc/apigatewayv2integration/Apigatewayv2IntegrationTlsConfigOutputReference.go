...
func (j *jsiiProxy_Apigatewayv2IntegrationTlsConfigOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_Apigatewayv2IntegrationTlsConfigOutputReference)SetInternalValue(val interface{}) {
